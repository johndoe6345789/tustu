...
public class d extends Q implements Cloneable {
  ...
  public static m a(F paramF, int paramInt) {
    if (paramInt < 0 || paramInt > 5)
      throw new x("Unknown Command:" + paramInt); 
  ...
  public static m c(F paramF, int paramInt) {
    ...
    arrayOfInt1 = c.a(paramInt, arrayOfInt1, true);
    int[] arrayOfInt2 = { 
        119, paramF.x(), 17, 0, 2, 0, 4, arrayOfInt1[0], arrayOfInt1[1], arrayOfInt1[2], 
        arrayOfInt1[3] };
    m m = m.a(paramF, arrayOfInt2);
  ...
  public static m a(F paramF, int[] paramArrayOfint, int paramInt) {
    ...
    System.arraycopy(arrayOfInt2, 0, arrayOfInt3, arrayOfInt1.length + paramArrayOfint.length, arrayOfInt2.length);
  ...
  public static m a(F paramF, int paramInt1, int paramInt2) {
    ...
    int[] arrayOfInt3 = { 
        119, paramF.x(), 17, 0, 5, 0, 8, arrayOfInt1[0], arrayOfInt1[1], arrayOfInt1[2], 
        arrayOfInt1[3], arrayOfInt2[0], arrayOfInt2[1], arrayOfInt2[2], arrayOfInt2[3] };
    m m = m.a(paramF, arrayOfInt3);
    m.a(800);
  ...
  public static m a(F paramF, char[] paramArrayOfchar, int paramInt) {
    ...
    arrayOfInt1 = c.a(paramInt, arrayOfInt1, true);
    int[] arrayOfInt2 = { 
        119, paramF.x(), 17, 0, 6, 0, 6, paramArrayOfchar[0], paramArrayOfchar[1], paramArrayOfchar[2], 
        paramArrayOfchar[3], arrayOfInt1[2], arrayOfInt1[3], 8, 0 };
    m m = m.a(paramF, arrayOfInt2);
    m.v("SD Delete File");
    return m;
  }
  ...
  public static m a(F paramF, Date paramDate) {
    ...
    arrayOfInt1[8] = 90;
    int[] arrayOfInt2 = { 
        119, paramF.x(), 7, 2, 126, 0, 9, arrayOfInt1[0], arrayOfInt1[1], arrayOfInt1[2], 
        arrayOfInt1[3], arrayOfInt1[4], arrayOfInt1[5], arrayOfInt1[6], arrayOfInt1[7], arrayOfInt1[8] };
    m m = m.a(paramF, arrayOfInt2);
    m.v("SD RTC Set ");
    return m;
  }
