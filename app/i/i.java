...
public class i {
  ...
  private synchronized boolean b(String paramString1, String paramString2) {
    File file = new File(j.z(), "MLV.pipe");
    if (file.exists()) {
      ...
      try {
        ...
        Logger.getLogger(i.class.getName()).log(Level.WARNING, "MLV Pipe File not found, but it was there..", fileNotFoundException);
        return false;
      } catch (IOException iOException) {
        Logger.getLogger(i.class.getName()).log(Level.WARNING, "Unable to write to MLV Pipe File", iOException);
        return false;
      } finally {
