...
class k extends MouseInputAdapter {
  ...
  public k(h paramh, Container paramContainer) {
  ...
  private void a(MouseEvent paramMouseEvent) {
    ...
    if (this.d instanceof a && this.e == null) {
      ...
      this.e.b();
      this.e = null;
    } else if (this.b.contains(this.d) && (paramMouseEvent.getID() == 500 || paramMouseEvent.getID() == 504 || paramMouseEvent.getID() == 505 || this.c)) {
      Point point = SwingUtilities.convertPoint(this.a, point1, this.d);
      this.d.dispatchEvent(new MouseEvent(this.d, i, paramMouseEvent.getWhen(), paramMouseEvent.getModifiers(), point.x, point.y, paramMouseEvent.getClickCount(), paramMouseEvent.isPopupTrigger()));
    } 
  }
