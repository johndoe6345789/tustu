...
public class ExceptionClose extends ExceptionPrintstacktrace implements GInterfaceAn, L, bZ, QInterfaceHotel, CInterfaceDelta, bc {
  ...
  public ExceptionClose(R paramR, D paramD) {
    ...
    try {
      ManagerUsingConcurrentHashMap.ExceptionInVPackage().ExceptionInVPackage(paramR.c(), paramD.ExceptionInVPackage(), this);
