...
public class j {
  public static String a = "config" + File.separator + "settingGroups.xml";
  ...
  public static final String f = "TuneView" + File.separator;
  
  public static final String g = a.h;
  
  public static String h = a.k;
  ...
  public static File a(Locale paramLocale) {
  ...
  public static File b() {
    ...
    if (!file.exists()) {
      ...
      if (!file1.mkdirs())
        throw new a("Unable to create user ECU definition dir:\n" + file.getAbsolutePath()); 
      file1.delete();
    } else if (file.isFile()) {
      file.delete();
      file.mkdir();
  ...
  public static File c(Locale paramLocale) {
    String str1 = a(paramLocale).getAbsolutePath() + File.separator;
  ...
  public static void a(File paramFile, double paramDouble) {
    for (long l = a(paramFile); l > paramDouble * 1024.0D * 1024.0D; l = a(paramFile)) {
      File file = null;
      File[] arrayOfFile = paramFile.listFiles();
      for (byte b = 0; b < arrayOfFile.length; b++) {
      ...
      if (file != null && !file.delete()) {
        D.a("Unable to delete oldest restore point file:\n" + file.getAbsolutePath());
        break;
      } 
    } 
  }
  
  public static File a(File paramFile, FileFilter paramFileFilter) {
    File file = null;
  ...
  public static void b(File paramFile) {
    ...
    a.a().b(a.A, paramFile.getAbsolutePath());
  }
  ...
  public static void a(File paramFile, i parami) {
    i i1 = d(paramFile);
    if (i1 == null || !i1.e().equals(parami.e()) || !i1.i().equals(parami.i()) || (parami.n() != null && (i1.n() == null || !i1.n().equals(parami.n()))) || !i1.j().equals(parami.j())) {
      ...
      try {
        ...
        Properties properties = parami.a();
  ...
  public static File j() {
    ...
    String str = a.a().c(a.z, file1.getAbsolutePath());
    File file2 = new File(str);
    return file2.exists() ? file2 : new File(u());
  }
  
  public static File k() {
    File file1 = new File(u(), f);
    String str = a.a().c(a.B, file1.getAbsolutePath());
    File file2 = new File(str);
    return file2.exists() ? file2 : a((a)null);
  }
  ...
  public static void e(File paramFile) {
    if (!paramFile.isDirectory())
      paramFile = paramFile.getParentFile(); 
    a.a().b(a.z, paramFile.getAbsolutePath());
  }
  ...
  public static File[] n() {
    try {
      ...
      throw new a(iOException.getMessage());
    } 
  }
  ...
  public static File a(Window paramWindow, String paramString) {
    File file = d(paramString);
    if (file == null)
      try {
        R r = f.a(paramWindow, paramString);
        if (r != null && r.a())
          file = r.c(); 
      } catch (a a) {
        bV.d(a.getMessage(), paramWindow);
      }  
    if (file == null) {
  ...
  public static File e(String paramString) {
    try {
      ...
      return t.a(arrayOfFile, paramString);
    } catch (IOException iOException) {
      throw new a(iOException.getMessage());
    } 
  }
  ...
  public static File[] f(String paramString) {
    ...
    if (!file.exists())
      throw new a("Dash & Gauge directory not found, expected at:\n" + file.getAbsolutePath() + "\nYour installation appears corrupt."); 
  ...
  public static File b(a parama) {
    return parama.K();
  }
  
  public static File a(a parama, R paramR) {
    String str = paramR.c() + "_" + X.a() + "." + a.cw;
  ...
  public static File r() {
    return J.a() ? new File(FileSystemView.getFileSystemView().getDefaultDirectory() + File.separator + X.b(a.b, " ", "") + "Projects/") : new File(FileSystemView.getFileSystemView().getHomeDirectory() + File.separator + X.b(a.b, " ", "") + "Projects/");
  }
  
  public static String s() {
    return u() + a.a().a(a.q, "DefaultProject");
  }
  
  public static String t() {
    String str = a.a().c(a.aW, "");
    if (str.equals("") || !(new File(str)).exists()) {
      String str1 = a.a().c(a.aV, r().getAbsolutePath());
  ...
  public static String u() {
    String str = a.a().c(a.aV, r().getAbsolutePath());
    boolean bool = false;
    ...
    if (!bool1 || bool) {
      ...
      for (byte b = 0; arrayOfFile != null && b < arrayOfFile.length; b++) {
        ...
        if (bool2) {
          ...
          try {
            String str2 = ae.a(str1, str, null);
            if (!str2.equals(ae.a)) {
              D.b("Tried to extract sample Project, but failed. Will try again:\n" + str1);
              str2 = ae.a(str1, str, null);
              if (!str2.equals(ae.a)) {
                D.a("Failed second attempt to extract sample Project, Giving up:\n" + str1);
              } else {
            ...
            D.a("Failed to extract sample Project, Will try any others:\n" + str1, zipException, null);
          } catch (IOException iOException) {
            D.a("Failed to extract sample Project, Will try any others:\n" + str1, iOException, null);
          } 
        } else {
          D.d("Found file " + arrayOfFile[b].getName() + " in the example projects dir, but it is not a valid project or archive.");
        } 
      } 
      a.a().b(a.aV, str);
      try {
  ...
  public static File A() {
    ...
    if (J.d()) {
      File file1 = new File(E() + ".efianalytics" + File.separator + a.b + File.separator);
      if (file1.exists() && !file1.equals(file))
        try {
          t.a(file, file1, false);
          t.b(file1);
        } catch (a a) {
          Logger.getLogger(j.class.getName()).log(Level.WARNING, "Files to migrate .efianalytics to .efiAnalytics", (Throwable)a);
        }  
    } 
    return file;
  }
