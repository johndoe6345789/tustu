...
public class f extends a {
  ...
  private f(SeekableByteChannel paramSeekableByteChannel, long paramLong) {
  ...
  public String toString() {
    return "DLBLOCK [lnkDlNext=" + this.c + ", lnkDlData=" + Arrays.toString(this.d) + ", flags=" + this.e + ", count=" + this.f + ", equalLength=" + this.g + ", offset=" + Arrays.toString(this.h) + "]";
  }
  ...
  public static f b(SeekableByteChannel paramSeekableByteChannel, long paramLong) {
    ...
    paramSeekableByteChannel.read(byteBuffer);
    byteBuffer.rewind();
    long[] arrayOfLong1 = new long[(int)f1.d()];
    for (byte b1 = 0; b1 < arrayOfLong1.length; b1++)
      arrayOfLong1[b1] = d.g(byteBuffer); 
    f1.a(d.a(byteBuffer));
    ...
    for (byte b2 = 0; b2 < arrayOfLong2.length; b2++)
      arrayOfLong2[b2] = d.e(byteBuffer); 
    f1.b(arrayOfLong2);
    f1.c(arrayOfLong1[0]);
