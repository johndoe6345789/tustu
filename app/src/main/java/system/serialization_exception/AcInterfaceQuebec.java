...
public class AcInterfaceQuebec {
  ...
  public String a(double paramDouble) {
    if (this.b.e() == 0) return X.c(paramDouble, e());
    if (this.b.e() == 1) {
      int i = c.a((byte) (int) paramDouble);
      return "0x" + X.a(Integer.toHexString(i), '0', 2).toUpperCase();
    }
    return (paramDouble == 0.0D && this.b.h() != null && this.b.h().length() > 0)
        ? this.b.h()
        : ((paramDouble != 0.0D && this.b.i() != null && this.b.h().length() > 0)
            ? this.b.i()
            : X.c(paramDouble, e()));
  }
  ...
  public String f() {
    return (this.b.e() != 0 && this.b.j() != null)
        ? this.b.j()
        : ((this.c.e() != null) ? this.c.e() : "");
  }
  ...
  public void c(int paramInt) {
    ...
    this.h = 0;
    for (byte b = 0; b < this.g.length; b++) this.g[b] = Double.NaN;
  }
