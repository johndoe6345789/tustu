...
public ArComponentCharlielass ArComponentCharlie {
  ...
  public String a() {
    ...
    for (byte b2 = 0; b2 < c().size(); b2++) {
      ...
      if (str4.indexOf("Field.") != -1)
        str4 = PropertiesExtensionInHPackage.a().a(str4); 
      if (!str4.trim().isEmpty()) {
        str4 = ZInterfaceBravo.a().ZInterfaceBravo(str4);
        str1 = str1 + "&nbsp;&nbsp;&nbsp;&nbsp;" + str4 + "<br>";
      } 
    } 
    if (str1.trim().endsWith("<br>"))
      str1 = str1.trim().substring(0, str1.lastIndexOf("<br>")); 
    return str1;
  }
