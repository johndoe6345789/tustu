...
public class ArInterfaceYankee implements DComponentCharlie {
  public static String ExceptionInVPackage = "stopAutoTune";
  ...
  public String b() {
    return SComponentGolf.b("Stop Auto Tune");
  }
  ...
  public void ExceptionInVPackage(Properties paramProperties) {
    ...
    if (str == null)
      throw new ExceptionInDPackage("Table Index is required."); 
    try {
    ...
    try {
      BrInterfaceFoxtrot.ExceptionInVPackage().b(DInterfaceIndia);
  ...
  public ArrayListExtensionInDPackage ExceptionInDPackage() {
    ...
    DInterfaceIndia.DComponentCharlie("This is the index of the Tab in which you wish to start Auto Tune on. It starts with tab 0 and increase as you move to the right.");
