...
public class ManagerUsingDatagramSocket extends OutputStream {
  ...
  public ManagerUsingDatagramSocket() {}

  public ManagerUsingDatagramSocket(DatagramSocket paramDatagramSocket) {
  ...
  public void write(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    ...
    try {
      while (this.c.length - this.e <= i) {
        System.arraycopy(
            paramArrayOfbyte, paramInt1 + paramInt2 - i, this.c, this.e, this.c.length - this.e);
