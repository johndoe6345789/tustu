...
public class DiscoveredDevice {
  ...
  public Properties a() {
    ...
    if (this.i != null) properties.setProperty("projectUUID", this.i);
  ...
  public static DiscoveredDevice a(Properties paramProperties) {
    ...
    byte b = 0;
    for (String str2 = "CAN_DEVICE_" + b + "_";
        paramProperties.get(str2 + "projectName") != null;
        str2 = "CAN_DEVICE_" + ++b + "_") {
  ...
  private boolean a(String paramString1, String paramString2) {
    return ((((paramString1 == null) ? 1 : 0) ^ ((paramString2 == null) ? 1 : 0)) != 0)
        ? false
        : ((paramString1 != null) ? paramString1.equals(paramString2) : true);
  }
