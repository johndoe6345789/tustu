...
public class Network {
  ...
  private void a(i parami) {
    for (k k : this.AInterfaceOscar) k.a(parami);
  }
  ...
  private void AInterfaceCharlie() {
    ...
    for (AInterfaceOscar AInterfaceOscar : arrayList) AInterfaceOscar.a(null);
  }
  ...
  private void a(String paramString1, String paramString2) {
    ...
    if (hashMap.get(AInterfaceCharlie) != null
        && !((String) hashMap.get(AInterfaceCharlie)).isEmpty())
      str1 = str1 + " - " + (String) hashMap.get(AInterfaceCharlie);
    str1 = str1 + " IP:" + paramString1;
    if (hashMap.get(i) != null && !((String) hashMap.get(i)).equals("0")) str1 = str1 + " In Use";
    String str2 = (String) hashMap.get(d);
    String str3 = "";
    if (hashMap.get(e) != null) {
      str3 = str3 + (String) hashMap.get(e);
    } else {
      if (str2 != null) str3 = str3 + "Serial# " + str2 + " ";
      if (hashMap.get(b) != null) str3 = str3 + (String) hashMap.get(b) + " ";
    }
    ...
    if (!this.AInterfaceOscar.isEmpty()) {
      ...
      if (i.j() == null) i.g((String) hashMap.get(AInterfaceCharlie));
      i.b(paramString1);
      i.h(paramString1);
      ...
      if (str7 != null && I.a(str7)) i.a((int) I.a(str7).doubleValue());
      String str8 = (String) hashMap.get(i);
      if (str8 != null && str8.equals("1")) i.a(true);
      i.e(str3);
    ...
    for (byte b = 1; hashMap.containsKey(IOHashMap + b + "_" + b); b++) {
      ...
      if (hashMap.get(str + AInterfaceCharlie) != null
          && !((String) hashMap.get(str + AInterfaceCharlie)).isEmpty())
      ...
      if (hashMap.get(str + g) != null && ((String) hashMap.get(str + g)).equalsIgnoreCase("UDP")) {
        this.r = AInterfaceOscar.b;
      } else if (hashMap.get(str + g) != null
          && ((String) hashMap.get(str + g)).equalsIgnoreCase("TCP")) {
        this.r = IOHashMap.b;
      }
  ...
  private void d() {
    ...
    DatagramPacket datagramPacket =
        new DatagramPacket(
            arrayOfByte, arrayOfByte.length, InetAddress.getByName("255.255.255.255"), this.p);
    datagramSocket.send(datagramPacket);
    if (t) System.out.println(">>> Request packet sent to: 255.255.255.255 (DEFAULT)");
