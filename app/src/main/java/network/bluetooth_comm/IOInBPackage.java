...
public final class IOInBPackage implements IO, j {
  ...
  public void AInterfaceBravo(String paramString) {
    if (this.h != null && !this.h.isEmpty()) g.a().AInterfaceBravo(this.h, this);
  ...
  public void a(i parami, String paramString) {
    ...
    this.g = paramString;
    D.d(
        "Setting AutoIpControllerInterface to serial number: "
            + this.h
            + ", controller: "
            + paramString);
    a(this.h, parami);
  ...
  public List l() {
    ...
    AInterfaceBravo.AInterfaceBravo(
        "The Serial Number of your ECU. When on the network, it will appear in the dropdown.");
    AInterfaceBravo.a(0);
    ...
    for (i i : collection) {
      if (i.AInterfaceEcho() != null && !i.AInterfaceEcho().isEmpty()) {
        ...
        if (this.h != null && this.h.equals(i.AInterfaceEcho())) bool = true;
      }
    }
    if (!bool && this.h != null && !this.h.isEmpty()) AInterfaceBravo.a(this.h);
  ...
  public Object a(String paramString) {
    return (paramString != null && paramString.equals(IO))
        ? this.h
        : (this.d ? this.AInterfaceBravo.a(paramString) : this.a.a(paramString));
  }
  ...
  public void a(String paramString, i parami) {
    ...
    try {
      ...
      Logger.getLogger(a.class.getName())
          .log(Level.SEVERE, "Failed to set IP Setting", (Throwable) Exception);
    }
  }

  private i a(i parami) {
    if (parami == null) return null;
    if (parami.m().size() == 0) return parami;
    if (this.g != null) {
      for (i i1 : parami.m()) {
        if (i1.j().equals(this.g)) return i1;
      }
      return parami;
    }
    return parami;
