    ...
    try {
      if (this.l == null || !this.l.isBound()) {
        ...
        try {
          ...
          String str =
              arrayOfByte[0] + ":" + arrayOfByte[1] + ":" + arrayOfByte[2] + ":" + arrayOfByte[3];
          this.c = str;
      ...
      for (AInterfaceRomeo r1 : l()) {
        try {
          ...
          Logger.getLogger(m.class.getName())
              .log(Level.WARNING, "Failed to set Setting", (Throwable) Exception);
        }
      }
      m1.a(socket);
  ...
  public void w() {
    ...
    if (this.l != null) {
      try {
        ...
        Logger.getLogger(m.class.getName())
            .log(Level.SEVERE, "Error trying to stop TCP Slave Server", iOException);
      }
      this.l = null;
    }
  }
