...
public class RegistrationMessages {
  ...
  public static String g =
      "Your system clock appears to be wrong.\nThis version of "
          + b
          + " requires your clock to be correct to operate.\n"
  ...
  public static String h =
      "The registration you are using appears to have been used extensively!\n"
          + "It will now be disabled!\n\n"
          + "If you are the rightful owner of this registration, contact EFI Analytics to get a new"
          + " registration.\n"
          + "Otherwise please obtain a valid registration key.";

  public static String i =
      "Your registration appears to be invalid!\n"
          + "Please obtain a valid registration key to run the registered version of "
          + b;
  ...
  public static String j =
      "This version of "
          ...
          + "visit www.EFIAnalytics.com/"
          + b
          + "/ to upgrade to the latest version\nbefore this copy is disabled.";

  public static String k =
      "Malformed command line! Expected parameters:\n"
