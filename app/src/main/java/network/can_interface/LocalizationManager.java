...
public class LocalizationManager {
  ...
  public static LocalizationManager a() {
    if (i == null) i = new LocalizationManager();
    return i;
  }
  ...
  public String a(String paramString1, String paramString2) {
    if (this.h.getLanguage().equals(this.g.getLanguage())) return paramString2;
    Map map = a(paramString1);
    String str1 = paramString2;
    if (map == null) return paramString2;
  ...
  public String b(String paramString1, String paramString2) {
    if (this.h.equals(this.g)) return paramString2;
