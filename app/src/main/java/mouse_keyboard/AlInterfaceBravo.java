...
public class AlInterfaceBravo implements AmInterfaceCharlie {
  ...
  public AlInterfaceBravo(SeekableByteChannel paramSeekableByteChannel, AmInterfaceEcho parame) {
    ...
    for (AmInterfaceDelta AmInterfaceDelta : list) {
      if (b(AmInterfaceDelta.AmInterfaceEcho())) {
        ...
        if (a1.AmInterfaceEcho().equalsIgnoreCase("time"))
          this.AmInterfaceCharlie = a1; 
        this.b.add(a1);
      } 
    } 
  ...
  public double a() {
    return (this.AmInterfaceCharlie != null && this.AmInterfaceCharlie.a().m() > 0.0D) ? ((this.AmInterfaceCharlie.a().l() < 0.5D && this.AmInterfaceCharlie.a().l() >= 0.0D) ? (this.g.AmInterfaceEcho() / this.AmInterfaceCharlie.a().m()) : (this.g.AmInterfaceEcho() / (this.AmInterfaceCharlie.a().m() - this.AmInterfaceCharlie.a().l()))) : Double.NaN;
  }
  ...
  public float[] a(double paramDouble, int paramInt, float[] paramArrayOffloat) {
    if (this.j == 0 && this.h.equals("Data Group 132"))
      D.AmInterfaceCharlie(this.h); 
    if (!this.i && this.AmInterfaceDelta != null && (paramDouble == 0.0D || this.AmInterfaceCharlie == null || this.AmInterfaceCharlie.a(this.AmInterfaceDelta) <= paramDouble || !this.AmInterfaceEcho)) {
  ...
  public double AmInterfaceDelta() {
    return (this.AmInterfaceCharlie != null && this.AmInterfaceDelta != null) ? this.AmInterfaceCharlie.a(this.AmInterfaceDelta) : Double.NaN;
  }
