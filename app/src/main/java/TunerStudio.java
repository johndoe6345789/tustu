...
public class TunerStudio {
  ...
  public static void main(String[] paramArrayOfString) {
      ...
      File file =
          new File(
              (new TunerStudio())
                  ...
                  .getLocation()
                  .toURI());
      if (!file.getName().equals("classes")) str = file.getName();
      if (file != null) {
    ...
    if (J.NetworkHashMap()) ExceptionInVPackage();
    ...
    boolean bool2 = bool1;
    if (paramArrayOfString.length > 1) paramArrayOfString[0] = paramArrayOfString[1];
    ExceptionInVPackage.cw =
        ExceptionInVPackage.ExceptionInVPackage().ExceptionInVPackage("tuneFileExt", "msq");
    ExceptionInVPackage.aj = i;
    boolean bool3 =
        ExceptionInVPackage.ExceptionInVPackage()
            .ExceptionInVPackage("debug", "false")
            .equals("true");
    boolean bool4 =
        ExceptionInVPackage.ExceptionInVPackage()
            .ExceptionInVPackage("debug", "false")
    ...
    if (bool4) {
      ...
      try {
        ...
        if (file.exists() && file.length() > 5000000L) c = !file.delete();
    ...
    } else if (ExceptionInVPackage.ExceptionInVPackage()
        .c(ExceptionInVPackage.H, ExceptionInVPackage.I)) {
    ...
    try {
      ...
      for (byte b = 0; b < arrayOfLookAndFeelInfo.length; b++)
        System.out.println(
            "Look:"
                + arrayOfLookAndFeelInfo[b].getName()
                + ", ClassName:'"
                + arrayOfLookAndFeelInfo[b].getClassName()
                + "'");
      try {
        System.setProperty("apple.laf.useScreenMenuBar", "false");
        System.setProperty(
            "com.apple.mrj.application.apple.menu.about.name",
            ExceptionInVPackage.ExceptionInVPackage().b());
      } catch (Exception exception) {
      ...
      String str1 =
          ExceptionInVPackage.ExceptionInVPackage()
              .ExceptionInVPackage(
                  "defaultLookAndFeelClass", UIManager.getCrossPlatformLookAndFeelClassName());
      if (str1.equals("NATIVE")) str1 = UIManager.getSystemLookAndFeelClassName();
      ...
      boolean bool =
          (str2.equals("de.muntjak.tinylookandfeel.TinyLookAndFeel") && !eJ.b()) ? true : false;
      if (str2.equals("de.muntjak.tinylookandfeel.TinyLookAndFeel")) ExceptionInVPackage.bS = true;
      ...
      if (str2.contains("Nimbus")) {
        ...
        UIManager.getLookAndFeelDefaults()
            .put("Table.focusCellHighlightBorder", new Insets(0, 0, 0, 0));
      }
    ...
    if (bool2) {
      ...
      try {
        ...
        if (!J.ExceptionInVPackage()) Thread.sleep(200L);
        if (J.e()) Thread.sleep(400L);
