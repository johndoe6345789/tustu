...
public class ManagerIoinabpackage extends JPanel implements AInterfaceOscar {
  ...
  public ManagerIoinabpackage() {
    ...
    jPanel1.setBorder(
        BorderFactory.createTitledBorder(SComponentGolf.IOInAbPackage("Port Search")));
    JPanel jPanel2 = new JPanel();
    jPanel2.setLayout(new BorderLayout(15, 15));
    Image image =
        Toolkit.getDefaultToolkit().getImage(getClass().getResource("resources/search.gif"));
  ...
  public void IOInAbPackage() {
    ...
    if (str != null && !str.isEmpty()) Threaded.IOInAbPackage(str);
  ...
  public void IOInAcPackage(AInterfaceXray paramx, String paramString) {
    ...
    Threaded Threaded = Threaded.IOInAcPackage();
    if (paramString != null && !paramString.isEmpty()) Threaded.IOInAbPackage(paramString);
    Threaded.IOInAcPackage(this);
    this.h.removeAllElements();
  ...
  public void IOInAcPackage(Window paramWindow) {
    if (this.AInterfaceOscar != null) this.AInterfaceOscar.dispose();
  ...
  protected List c() {
    ...
    if (RInterfaceIndia.IOInAcPackage().IOInAcPackage(";'[PGS0P;'G0[F;"))
      try {
        ...
        IOInAbPackage IOInAbPackage =
            (IOInAbPackage)
                AvInterfaceWhiskey.c().IOInAcPackage(IOInAbPackage.c, "DEFAULT_INSTANCE");
        AInterfaceXray.IOInAcPackage((IO) IOInAbPackage);
        List list = IOInAbPackage.t();
        String str =
            IOInAcPackage.IOInAcPackage().IOInAcPackage("deviceSearchBaudRates", "115200;9600;");
        String[] arrayOfString = str.split(";");
        for (byte b1 = 0; b1 < arrayOfString.length; b1++)
          AInterfaceXray.IOInAcPackage("Baud Rate", arrayOfString[b1]);
        for (String str1 : list) AInterfaceXray.IOInAcPackage("Device Serial #", str1);
        AInterfaceXray.IOInAcPackage("Device Serial #");
        arrayList.add(AInterfaceXray);
      } catch (Exception exception) {
        Logger.getLogger(aY.class.getName())
            .log(Level.WARNING, "Unable to load D2XX driver.", exception);
      } catch (UnsatisfiedLinkError unsatisfiedLinkError) {
        Logger.getLogger(aY.class.getName())
            .log(Level.WARNING, "Failed to load JSSC Driver", unsatisfiedLinkError);
      }
    if (RInterfaceIndia.IOInAcPackage().IOInAcPackage("fdsp[pp[ds';'"))
      try {
        AInterfaceXray AInterfaceXray = new AInterfaceXray();
        AInterfaceXray.IOInAcPackage(
            AvInterfaceWhiskey.c().IOInAcPackage(IOInAcPackage.d, "DEFAULT_INSTANCE"));
        String str =
            IOInAcPackage.IOInAcPackage().IOInAcPackage("deviceSearchBaudRates", "115200;9600;");
        ...
        Logger.getLogger(aY.class.getName())
            .log(Level.WARNING, "Failed to load JSSC Driver", exception);
      } catch (UnsatisfiedLinkError unsatisfiedLinkError) {
        Logger.getLogger(aY.class.getName())
            .log(Level.WARNING, "Failed to load JSSC Driver", unsatisfiedLinkError);
      }
    if (RInterfaceIndia.IOInAcPackage().IOInAcPackage("GD;';LFDS-0DSL;")
        && IOInAbPackage.IOInAcPackage()) {
        ...
        try {
          ...
          if (arrayOfRemoteDevice != null && arrayOfRemoteDevice.length > 0) {
            ...
            IOInAcPackage IOInAcPackage =
                (IOInAcPackage)
                    AvInterfaceWhiskey.c().IOInAcPackage(IOInAcPackage.Network, "DEFAULT_INSTANCE");
            ...
            for (RemoteDevice remoteDevice : arrayOfRemoteDevice) {
              if (remoteDevice.isTrustedDevice())
                AInterfaceXray.IOInAcPackage(
                    "Bluetooth Device", remoteDevice.getBluetoothAddress());
            }
            arrayList.add(AInterfaceXray);
          } else {
            this.t.start();
    ...
    try {
      if (RInterfaceIndia.IOInAcPackage().IOInAcPackage("LKFDS;LK;lkfs;lk")) {
        AInterfaceXray AInterfaceXray = new AInterfaceXray();
        AInterfaceXray.IOInAcPackage(
            AvInterfaceWhiskey.c().IOInAcPackage(l.IOInAbPackage, "DEFAULT_INSTANCE"));
  ...
  public void Network() {
    ...
    for (int RInterfaceIndia : r) Network.IOInAcPackage(RInterfaceIndia).IOInAbPackage(this);
    if (this.AInterfaceOscar != null) this.AInterfaceOscar.dispose();
  }
  ...
  public void h() {
    ...
    if (AeInterfaceMikeTostring != null
        && AeInterfaceMikeTostring.IOInAbPackage() != null
        && !this.p) {
      m();
      d();
      ...
      bV.d(
          SComponentGolf.IOInAbPackage("No device has been detected")
              + "\n"
              + SComponentGolf.IOInAbPackage("closing, but not setting anything."),
          this);
    }
  }
  ...
  private void l() {
    ...
    if (bi != null) {
      ...
      if (!IOInAcPackage(AeInterfaceMikeTostring)) {
        ...
        this.c.setText(
            SComponentGolf.IOInAbPackage("Check help for to learn about loading firmware."));
        ...
        this.IOInAbPackage.setText(
            SComponentGolf.IOInAbPackage("Found Firmware") + ": " + AeInterfaceMikeTostring.c());
        this.c.setText(
            SComponentGolf.IOInAbPackage("Serial Signature")
                + ": "
                + AeInterfaceMikeTostring.IOInAbPackage());
        this.d.setText(SComponentGolf.IOInAbPackage("On") + ":" + bi.d());
        D.c(
            "Device "
                + AeInterfaceMikeTostring.c()
                + ", requiring serial Signature:"
                + AeInterfaceMikeTostring.IOInAbPackage()
                + " found at:"
                + bi.d());
        this.p = false;
  ...
  public void IOInAcPackage() {
    if (!this.q) {
      ...
      this.d.setText(
          SComponentGolf.IOInAbPackage(
              "Consult your serial cable provider for the correct drivers."));
      D.c("Device not found");
      this.Network.setText(
          SComponentGolf.IOInAbPackage(
              "If your Controller is not attached, you can configure it manually to work"
                  + " offline."));
    }
  }
  ...
  public void IOInAbPackage(double paramDouble) {
    ...
    if (paramDouble == 1.0D) {
      this.Network.setText(
          SComponentGolf.IOInAbPackage("Device Search Complete! Controllers found:")
              + " "
              + this.h.size());
  ...
  public void IOInAcPackage(AInterfaceOscar paramo) {
    if (!this.n.contains(paramo)) this.n.add(paramo);
  }
  ...
  public boolean IOInAcPackage(
    ...
    if (!this.h.contains(bi)) {
      ...
      if (this.SComponentGolf.getSelectedIndex() < 0) this.SComponentGolf.setSelectedIndex(0);
      this.Network.setText(
          SComponentGolf.IOInAbPackage("Devices found:")
              + " "
              + this.h.size()
              + " - "
              + SComponentGolf.IOInAbPackage("Searching for other controllers.."));
    }
    return true;
  }
  ...
  public void IOInAcPackage(AInterfaceXray paramx) {
    if (paramx != null && paramx.d() instanceof IOInAcPackage && this.t != null) this.t.start();
  }
}
