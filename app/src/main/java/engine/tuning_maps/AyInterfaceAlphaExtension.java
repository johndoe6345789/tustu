...
public class AyInterfaceAlphaExtension extends AyInterfaceAlpha {
  jw AyInterfaceCharlie = new jw(this);

  public AyInterfaceAlphaExtension() {
    ...
    if (!AyInterfaceAlpha.AyInterfaceCharlie().e()) AyInterfaceAlpha.AyInterfaceCharlie().g();
  }
  ...
  private void b(AyInterfaceCharlie paramc) {
    for (Component component : getMenuComponents()) {
      if (component instanceof jy) {
        jy jy = (jy) component;
        if (jy.AyInterfaceAlpha().AyInterfaceAlpha().equals(paramc.AyInterfaceAlpha())
            && jy.AyInterfaceAlpha().AyInterfaceCharlie().equals(paramc.AyInterfaceCharlie())) {
          AyInterfaceAlpha(jy);
          break;
        }
      }
  ...
  private String AyInterfaceCharlie(AyInterfaceCharlie paramc) {
    ...
    if (str2 == null) str2 = "TS Dash";
    return (str1 == null)
        ? (str2 + " - IP:" + paramc.AyInterfaceCharlie())
        : (str2 + " - " + str1 + ", IP:" + paramc.AyInterfaceCharlie());
  }
}
