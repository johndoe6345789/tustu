...
public class ManagerJpanelextensioninrpackage implements fS {
  ...
  public ManagerJpanelextensioninrpackage(Window paramWindow) {
    this.h = paramWindow;
    hD hD = new hD(this);
    this.SComponentGolf =
        new fL("New " + ExceptionInVPackage.JPanelExtensionInRPackage + " Project", hD);
    try {
  ...
  public void ExceptionInVPackage() {
    JDialog jDialog =
        this.SComponentGolf.ExceptionInVPackage(
            this.h, SComponentGolf.JPanelExtensionInRPackage("Create New Project"));
  ...
  public boolean JPanelExtensionInRPackage() {
    ...
    if (ExceptionInVPackage.A() != null) {
      ...
      if (this.i != null)
        try {
          h.ExceptionInVPackage().ExceptionInVPackage((GInterfaceAi) this.i);
    ...
    try {
      ...
      String str1 =
          file1.getName().toLowerCase().endsWith(".ecu")
              ? "mainController.ecu"
              : "mainController.ini";
      ...
      try {
        if (this.e != null) this.e.AInterfaceCharlie();
      } catch (ExceptionInVPackage a1) {
      ...
      f.ExceptionInVPackage()
          .ExceptionInVPackage(
              dd.ExceptionInVPackage().AInterfaceCharlie(),
              this.JPanelExtensionInRPackage.SComponentGolf().getAbsolutePath());
    } catch (ExceptionInVPackage a1) {
      bV.d(
          "Error creating Project "
              + this.JPanelExtensionInRPackage.f()
              + "\nProject Location:"
              + this.JPanelExtensionInRPackage.SComponentGolf().getAbsolutePath()
              + "\nError Message:\n"
              + a1.getMessage()
              ...
              + ExceptionInVPackage.JPanelExtensionInRPackage
              + " and opening this project,\n all will most likely be fine.",
          (Component) this.AInterfaceCharlie);
      a1.printStackTrace();
      return false;
    }
    return true;
  ...
  public void AInterfaceCharlie() {
    ...
    if (r != null) {
      J ThreadedFile = r.C();
      if (ThreadedFile != null) ThreadedFile.AInterfaceCharlie();
  ...
  public boolean ExceptionInVPackage(Container paramContainer) {
      ...
      try {
        s[] arrayOfS =
            v.ExceptionInVPackage()
                .JPanelExtensionInRPackage(this.JPanelExtensionInRPackage.h().getAbsolutePath());
        arrayOfS =
            (new I())
                .ExceptionInVPackage(
                    arrayOfS, this.JPanelExtensionInRPackage.h().getAbsolutePath());
    ...
    if (paramContainer instanceof aF) return ((aF) paramContainer).e();
    ...
    if (paramContainer instanceof aG) {
      ...
      ManagerUsingArrayList.ExceptionInVPackage((aG) paramContainer);
    }
    return true;
  }
  ...
  private R d() {
    ...
    if (this.JPanelExtensionInRPackage.h() == null) return null;
    R r = new R();
    ...
    for (byte b1 = 0; b1 < arrayOfR.length; b1++) r.ExceptionInVPackage(arrayOfR[b1]);
    ManagerUsingFile ManagerUsingFile = new ManagerUsingFile();
    try {
      if (r.AInterfaceCharlie("tsCanId") == null)
        r = ManagerUsingFile.ExceptionInVPackage(r, ThreadedFile.G, false);
      r =
          ManagerUsingFile.ExceptionInVPackage(
              r, this.JPanelExtensionInRPackage.h().getCanonicalPath());
      r.q(this.JPanelExtensionInRPackage.SComponentGolf().getAbsolutePath());
      r.AInterfaceCharlie(
          AInterfaceCharlie.ExceptionInVPackage()
              .ExceptionInVPackage(
                  r, ExceptionInVPackage.ba, AvInterfaceWhiskey.AInterfaceCharlie(), null, null));
      ...
      if (ExceptionInVPackage.JPanelExtensionInRPackage.equals(ExceptionInVPackage.as)) {
        ExceptionInVPackage ExceptionInVPackage = new ExceptionInVPackage();
        r.O().ExceptionInVPackage((GInterfaceCr) ExceptionInVPackage);
        JPanelExtensionInRPackage b2 = new JPanelExtensionInRPackage();
        r.O().ExceptionInVPackage((GInterfaceCv) b2);
        r.O().d(true);
      }
    } catch (Exception exception) {
      exception.printStackTrace();
  ...
  public boolean JPanelExtensionInRPackage(Container paramContainer) {
    if (paramContainer.equals(this.f)) {
      ...
      if (arrayOfS == null || arrayOfS.length == 0) this.SComponentGolf.ExceptionInVPackage();
      ...
      try {
        ...
        AeInterfaceMikeTostring AeInterfaceMikeTostring = this.JPanelExtensionInRPackage.k();
        ad1.k();
        ad1.ExceptionInVPackage(r);
        if (list != null && str != null) {
          ad1.ExceptionInVPackage("DetectedDevice", str, list, AeInterfaceMikeTostring);
          ad1.AInterfaceCharlie();
        } else {
          list = new ArrayList();
          list.add(new AInterfaceCharlie("Baud Rate", ExceptionInVPackage.AInterfaceCharlie));
          ad1.ExceptionInVPackage(
              "DetectedDevice", ExceptionInVPackage.d, list, new AeInterfaceMikeTostring());
        }
      } catch (ExceptionInVPackage ExceptionInVPackage) {
        D.ExceptionInVPackage(
            "Error setting configuration to comm settings.", (Exception) ExceptionInVPackage, ad1);
      }
      ...
      try {
        Z z;
        if (r.i().startsWith("MS3 Format")
            && (r.i().endsWith("P") || r.i().endsWith("E") || r.i().endsWith("U"))) {
      ...
      RInterfaceOscar RInterfaceOscar =
          RInterfacePapa.ExceptionInVPackage().JPanelExtensionInRPackage();
