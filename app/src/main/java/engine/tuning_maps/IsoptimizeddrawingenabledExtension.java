...
public class IsoptimizeddrawingenabledExtension extends Isoptimizeddrawingenabled
    implements AeInterfaceEcho, PropertiesExtension, NInterfaceGolf {
  ...
  public void e_() {
    if (this.PropertiesExtension != null && this.b != null) this.PropertiesExtension.b(this.b);
    removeAll();
  ...
  public boolean PropertiesExtension() {
    if (this.PropertiesExtension == null) c();
    return true;
  }
  ...
  public void b() {
    if (this.PropertiesExtension != null) this.PropertiesExtension.b();
  }
}
