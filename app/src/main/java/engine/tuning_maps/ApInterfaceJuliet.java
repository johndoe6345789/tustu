...
class ApInterfaceJuliet extends Thread {
  ...
  public void run() {
    ...
    File file2 =
        new File(
            this.PropertiesExtension + File.separator + PropertiesExtension.ThreadedFile, "dummy");
    file2.mkdirs();
    file2.delete();
    ...
    try {
      ...
      boolean bool =
          bV.PropertiesExtension(
              SComponentGolf.b("Project has been imported.\nWould you like to open it now?"),
              dd.PropertiesExtension().c(),
              true);
      if (bool) this.d.PropertiesExtension(dd.PropertiesExtension().c(), file1.getAbsolutePath());
      ...
      hq.PropertiesExtension()
          .b(
              "Archive import Failed! "
                  + this.PropertiesExtension.getName()
                  + "\nMessage: "
