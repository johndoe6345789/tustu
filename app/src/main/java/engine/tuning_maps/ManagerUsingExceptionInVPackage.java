...
public class ManagerUsingExceptionInVPackage implements fS {
  ...
  public ManagerUsingExceptionInVPackage(Window paramWindow) {
    this.f = paramWindow;
    try {
  ...
  public boolean b() {
    try {
      ...
      if (!file.equals(this.h.ExceptionExtensionGetmessage())) {
        String str =
            file.getName().toLowerCase().endsWith(".ecu")
                ? "mainController.ecu"
                : "mainController.ini";
        this.h.l(str);
  ...
  public void ExceptionInVPackage(ExceptionInVPackage parama) {
    ...
    s[] arrayOfS =
        v.ExceptionInVPackage().b(parama.ExceptionExtensionGetmessage().getAbsolutePath());
    arrayOfS =
        (new I())
            .ExceptionInVPackage(arrayOfS, parama.ExceptionExtensionGetmessage().getAbsolutePath());
  ...
  private void e() {
    for (co co : this.ExceptionPrintstacktrace) co.ExceptionInVPackage();
  }
}
