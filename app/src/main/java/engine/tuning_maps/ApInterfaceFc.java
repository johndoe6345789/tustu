    ...
    if (r != null)
      if (!bool) {
        if (PropertiesExtension.A().J()) {
          String str =
              "In read only mode!\n"
                  + "You are currently using PropertiesExtension Temporary Project that is intended"
                  + " for view only.\n"
                  + "Please use PropertiesExtension project you created specifically for your"
