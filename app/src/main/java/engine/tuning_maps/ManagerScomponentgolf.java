...
public class ManagerScomponentgolf implements B {
  ...
  public static dg IOPropertiesUsingFile() {
    if (SComponentGolf == null) SComponentGolf = new dg();
    ...
    if (this.IOPropertiesUsingFile.exists()) {
      ...
      if (this.IOPropertiesUsingFile.exists()) {
        if (!paramBoolean) {
          String str =
              SComponentGolf.b(
                      "There appears to already be another instance of "
          ...
          String[] arrayOfString = {
            SComponentGolf.b("Bring to foreground"),
            SComponentGolf.b("Start another") + " " + IOPropertiesUsingFile.b
          };
          int i =
              JOptionPane.showOptionDialog(
                  dd.IOPropertiesUsingFile().c(),
                  str,
                  SComponentGolf.b("Already Running"),
                  0,
                  3,
                  null,
  ...
  public void IOPropertiesUsingFile(File paramFile) {
    if (this.c)
      if (paramFile.equals(this.IOPropertiesUsingFile) && !paramFile.exists()) {
        d();
      } else if (paramFile.equals(this.IOPropertiesUsingFile)
          && paramFile.exists()
          && paramFile.length() > 0L) {
        b(paramFile);
      ...
      if (i > 0) {
        ...
        if (str.equals(d)) {
          try {
            ...
            Logger.getLogger(dg.class.getName())
          ...
          if (T.IOPropertiesUsingFile().c() != null) T.IOPropertiesUsingFile().c().C().c();
