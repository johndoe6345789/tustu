...
class ApInterfaceDj implements ActionListener {
  ...
  public void actionPerformed(ActionEvent paramActionEvent) {
    ...
    String str =
        SComponentGolf.b(
                "This COM Port is currently disabled from Detect Scans because it has caused issues"
                    + " on past attempts to access it.")
            + "\n\n"
            + SComponentGolf.b("Are you sure you want to reactivate com port:")
            + gX.getName();
