...
public class ManagerNcomponentalpha extends Isoptimizeddrawingenabled
    implements NComponentAlpha, NInterfaceGolf {
  ...
  boolean NInterfaceGolf =
      NComponentAlpha.NComponentAlpha().ManagerPreferredlayoutsize(NComponentAlpha.ak, false);

  public ManagerNcomponentalpha() {
    setTabPlacement(3);
    this.e =
        NComponentAlpha.NComponentAlpha().NComponentAlpha(NComponentAlpha.da, NComponentAlpha.db);
    if (!this.e) {
      Image image =
          Toolkit.getDefaultToolkit().getImage(getClass().getResource("resources/new16.gif"));
  ...
  public void setSelectedIndex(int paramInt) {
    ...
    if (this.NInterfaceGolf) {
      if (x2 != null) x2.h(true);
      if (x1 != null && !x1.equals(x2)) x1.h(false);
    }
    boolean bool = (x1 != null && x1.s()) ? true : false;
    if (x2 != null) dd.NComponentAlpha().NComponentAlpha(x2);
  }
  ...
  public x NComponentAlpha(x paramx, String paramString) {
    ...
    if (this.NInterfaceGolf && !paramString.equals("Main Dashboard")) paramx.h(false);
    ...
    Properties Properties = new Properties((NComponentAlpha.NComponentAlpha()).an, paramString);
    paramx.NComponentAlpha((WInterfaceAp) Properties);
    Icon icon = null;
    if (getTabCount() < 1) {
  ...
  public boolean ManagerPreferredlayoutsize(String paramString) {
    ...
    if (h(paramString))
      for (byte ManagerPreferredlayoutsize = 0;
          ManagerPreferredlayoutsize < getTabCount();
  ...
  private void h() {
    ...
    while (iterator.hasNext()) ((d) iterator.next()).NComponentAlpha();
  }
  ...
  private boolean h(String paramString) {
    ...
    while (iterator.hasNext()) {
      if (!((d) iterator.next()).NComponentAlpha(paramString, x)) return false;
    }
    return true;
  }
  ...
  protected void NComponentAlpha(MouseEvent paramMouseEvent) {
    String str = getTitleAt(getSelectedIndex());
    if (str == null || str.equals("") || str.equals("Main Dashboard")) return;
