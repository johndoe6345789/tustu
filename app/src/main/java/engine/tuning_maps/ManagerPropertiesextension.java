...
public class ManagerPropertiesextension extends JPanel implements S, AeInterfaceEcho {
  ...
  public static String Isoptimizeddrawingenabled =
      SComponentGolf.b("Diagnostics & High Speed Loggers");
  ...
  public void c() {
    ...
    int j =
        PropertiesExtension.PropertiesExtension()
            .PropertiesExtension(PropertiesExtension.aH, RInterfaceIndia);
  ...
  public void PropertiesExtension(PropertiesExtension parama) {
    if (this.SComponentGolf != null) this.SComponentGolf.b();
  }
}
