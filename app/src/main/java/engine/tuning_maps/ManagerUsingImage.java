...
public class ManagerUsingImage extends JPanel implements AeInterfaceEcho, ExceptionInVPackage {
  ...
  public void ExceptionInVPackage(ExceptionInVPackage parama, R paramR) {
    ...
    if (this.ApInterfaceBravo != null) this.ApInterfaceBravo.ExceptionInVPackage(parama, paramR);
  }

  public void e_() {
    this.ExceptionInVPackage = null;
    this.ApComponentCharlie = null;
    if (this.ApInterfaceBravo != null) this.ApInterfaceBravo.e_();
  }
  ...
  public boolean ExceptionInVPackage() {
    ...
    try {
      if (bool) {
        d();
        IComponentGolf.ExceptionInVPackage()
            .ExceptionInVPackage((IInterfaceFoxtrot) new ApComponentCharlie());
        IComponentGolf.ExceptionInVPackage()
            .ExceptionInVPackage((IInterfaceFoxtrot) new ApInterfaceBravo());
