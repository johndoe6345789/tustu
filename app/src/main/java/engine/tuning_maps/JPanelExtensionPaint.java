...
public class JPanelExtensionPaint extends JPanel implements S, n {
  JPanel a = new JPanel();
  ...
  public JPanelExtensionPaint(boolean paramBoolean) {
  ...
  public void b(String paramString) {
    ...
    if (paramString != null && paramString.indexOf(File.separator) >= 0)
      str =
          paramString.substring(paramString.lastIndexOf(File.separator) + 1, paramString.length());
    this.d.setText(str);
  ...
  public void c(R paramR) {
    ...
    try {
      ...
      Logger.getLogger(iW.class.getName())
          .log(Level.SEVERE, "Error Initializing Status Bar", interruptedException);
    } catch (InvocationTargetException invocationTargetException) {
      Logger.getLogger(iW.class.getName())
          .log(Level.SEVERE, "Error Initializing Status Bar", invocationTargetException);
    }
  }
