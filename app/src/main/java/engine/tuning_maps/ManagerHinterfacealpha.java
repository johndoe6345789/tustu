...
public class ManagerHinterfacealpha {
  ...
  public static iL HInterfaceAlpha() {
    if (HInterfaceAlpha == null) HInterfaceAlpha = new iL();
    return HInterfaceAlpha;
  }

  public boolean HInterfaceAlpha(
      Frame paramFrame, R paramR, String paramString1, String paramString2) {
    if (paramString1.equals("std_constants")) {
      ...
      HInterfaceAlpha(
          ...
          paramR,
          paramFrame,
          "Standard Constants - Page " + paramString2,
          (aO) az);
      return true;
    }
    ...
    if (paramString1.equals("std_warmup")) {
      ...
      f.HInterfaceAlpha()
          .HInterfaceAlpha(paramR, (ArrayListExceptionprintstacktraceInGPackage) i1, paramFrame);
      return true;
    }
    if (paramString1.equals("std_accel")) {
      ...
      f.HInterfaceAlpha()
          .HInterfaceAlpha(
              paramR, (ArrayListExceptionprintstacktraceInGPackage) HInterfaceAlpha, paramFrame);
      return true;
    }
    if (paramString1.equals("std_ms2gentherm")) {
      ...
      ArrayListExceptionprintstacktraceInGPackage ArrayListExceptionprintstacktraceInGPackage =
          paramR.e().c("std_ms2gentherm");
      f.HInterfaceAlpha()
          .HInterfaceAlpha(
              paramR,
              (SerializableImplUsingArrayList) ArrayListExceptionprintstacktraceInGPackage,
              paramFrame);
      return true;
    }
    ...
    if (paramString1.equals("std_ms3Rtc")) {
      HInterfaceAlpha HInterfaceAlpha = new HInterfaceAlpha(paramR);
      bV.HInterfaceAlpha(
          (Component) HInterfaceAlpha, paramFrame, "MS3 Real-Time Clock", (bc) HInterfaceAlpha);
      return true;
    }
    if (paramString1.equals("std_ms3SdConsole")) {
      ManagerPaint ManagerPaint = new ManagerPaint(paramR);
      JDialog jDialog =
          bV.JPanelExtensionInNPackage(
              (Component) ManagerPaint, paramFrame, "MS3 SD Console", (bc) ManagerPaint);
      jDialog.pack();
    ...
    if (paramString1.equals("std_ftpSdBrowser")) {
      ...
      JDialog jDialog =
          bV.JPanelExtensionInNPackage(
              (Component) HInterfaceAlpha, paramFrame, "SD Log Browser", (bc) HInterfaceAlpha);
      jDialog.pack();
      bV.HInterfaceAlpha(bV.HInterfaceAlpha(paramFrame), jDialog);
    ...
    if (paramString1.equals("std_replay_upload")) {
      if (paramR.R()) {
        ...
        String str =
            ExceptionPrintstacktrace.JPanelExtensionInNPackage("BigComm Pro must be online!");
        str = str + "\n";
        str =
            str
                + ExceptionPrintstacktrace.JPanelExtensionInNPackage(
                    "Please turn the Key to the on position and make sure BigComm Pro is online.");
        ...
        str =
            str
                + ExceptionPrintstacktrace.JPanelExtensionInNPackage(
                    "Please connect to your BigStuff 3 with the Key On.");
        bV.ManagerPaint(str, paramFrame);
      }
      return true;
    }
  ...
  public void HInterfaceAlpha(
      ManagerPaint paramd, R paramR, Window paramWindow, String paramString, aO paramaO) {
    dF dF =
        new dF(
            paramWindow, ExceptionPrintstacktrace.JPanelExtensionInNPackage(paramString), paramaO);
  ...
  public void HInterfaceAlpha(R paramR, Frame paramFrame) {
    ...
    try {
      boolean bool =
          (HInterfaceAlpha.HInterfaceAlpha().c(HInterfaceAlpha.bq, HInterfaceAlpha.br)
                  && HInterfaceAlpha.HInterfaceAlpha().c(HInterfaceAlpha.bs, HInterfaceAlpha.bt))
              ? true
              : false;
      if (!bool) {
