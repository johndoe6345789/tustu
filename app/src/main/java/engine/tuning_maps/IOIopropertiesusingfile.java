...
public class IOIopropertiesusingfile {
  ...
  public static String[] b =
      new String[] {
        "C:\\Program Files\\EFIAnalytics\\MegaLogViewerHD\\MegaLogViewer.exe",
        "C:\\Program Files (x86)\\EFIAnalytics\\MegaLogViewerHD\\MegaLogViewer.exe",
        "C:\\Program Files(x86)\\EFIAnalytics\\MegaLogViewerHD\\MegaLogViewer.exe",
        "C:\\Program Files\\EFIAnalytics\\MegaLogViewerHD\\MegaLogViewerHD.exe",
        "C:\\Program Files (x86)\\EFIAnalytics\\MegaLogViewerHD\\MegaLogViewerHD.exe",
        "C:\\Program Files(x86)\\EFIAnalytics\\MegaLogViewerHD\\MegaLogViewerHD.exe",
        "c:\\Program Files(x86)\\EFIAnalytics\\MegaLogViewer\\MegaLogViewer(x64).exe",
        "c:\\Program Files(x86)\\EFIAnalytics\\MegaLogViewer\\MegaLogViewer.exe",
        "c:\\Program Files (x86)\\EFIAnalytics\\MegaLogViewer\\MegaLogViewer(x64).exe",
        "c:\\Program Files\\EFIAnalytics\\MegaLogViewer\\MegaLogViewer(x64).exe",
        "c:\\Program Files (x86)\\EFIAnalytics\\MegaLogViewer\\MegaLogViewer.exe",
        "C:\\Program Files (x86)\\EFIAnalytics\\BigStuffLog\\BigStuffLog.exe",
        "c:\\Program Files\\EFIAnalytics\\MegaLogViewer\\MegaLogViewer.exe",
        "c:\\Program Files\\MegaSquirt\\MegaLogViewer\\MegaLogViewer.exe",
        "/Applications/MegaLogViewerHD.app/Contents/Java/MegaLogViewer.sh",
        "/Applications/MegaLogViewerMS.app/Contents/Java/MegaLogViewer.sh"
      };

  public IOIopropertiesusingfile(et paramet) {
  ...
  public void IOPropertiesUsingFile(String paramString) {
    ...
    if (!bool1) {
      bool =
          !IOInIPackage.IOPropertiesUsingFile().IOPropertiesUsingFile("openLog", paramString)
              ? true
              : false;
    } else {
      bool = true;
    }
    if (bool) b(paramString);
  }
  ...
  public void b(String paramString) {
    ...
    if (file2.exists() && !file2.delete()) {
      ...
      if (AbstractUsingArrayList.k() != null
          && AbstractUsingArrayList.k().u()
          && AbstractUsingArrayList.k().n().equals(paramString)) {
      ...
      try {
        ...
        Logger.getLogger(hp.class.getName())
            .log(
                Level.SEVERE,
                "Failed to store MLV launch file: " + file2.getAbsolutePath(),
                iOException);
      }
    }
    if (!bool)
  ...
  private String IOPropertiesUsingFile() {
    ...
    if (IOInIPackage == 1) return IOPropertiesUsingFile(jFrame);
    if (IOInIPackage == 4) aN.IOPropertiesUsingFile(IOPropertiesUsingFile.D);
    return null;
  }
  ...
  private String IOPropertiesUsingFile(Frame paramFrame) {
    ...
    if (str2 != null && !str2.equals("")) c(str2);
    return str2;
  }
  ...
  private String b() {
    return (this.IOPropertiesUsingFile == null)
        ? null
        : this.IOPropertiesUsingFile.IOPropertiesUsingFile(c);
  }
