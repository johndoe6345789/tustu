...
public class JMenuExtensionSetpopupmenuvisibleExtensionInApPackage
    extends JMenuExtensionSetpopupmenuvisible implements SInterfaceFoxtrot {
  String c = null;

  public JMenuExtensionSetpopupmenuvisibleExtensionInApPackage(
