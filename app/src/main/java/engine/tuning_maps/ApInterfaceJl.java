...
public class ApInterfaceJl extends JPanel implements jK {
  R a = null;

  JTextPane b = new JTextPane();

  public ApInterfaceJl() {
  ...
  public void e(R paramR) {
    ...
    if (paramR != null) {
      ...
      if (this.a.Q() != null && this.a.Q().length() > 32768) {
        String str1 =
            X.b(this.a.Q(), "<br><br><br><br><br><br><br><br><br><br><br><br><br><br>", "");
  ...
  public void b(R paramR) {
    if (this.a != null && this.a.equals(paramR)) c();
  }

  public void c(R paramR) {
    if (this.a != null && this.a.equals(paramR)) b();
  }
