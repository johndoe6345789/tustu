...
class ApComponentQuebec extends Thread {
  ...
  public void run() {
    ...
    try {
      ...
      if (ExceptionInVPackage.ExceptionInVPackage().t() != null
          && ExceptionInVPackage.ExceptionInVPackage().t().exists()) {
        D.d("Making copy of AppDebug for packaging.");
      ...
      String str =
          SComponentGolf.b("A Debug Package named " + file1.getName() + " has been created.");
      if (bool) {
      ...
      str =
          str
              + "\n\n"
              + SComponentGolf.b(
                  "Please email this Debug package and any other information about your problem"
                      + " to:");
