...
public class ManagerAeinterfaceecho extends d
    implements AeInterfaceEcho, AcInterfaceFoxtrot, ExceptionInVPackage, JDialogExtensionDispose {
  ...
  public static String d =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Start Data Logging");

  public static String AeInterfaceEcho =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
          "Start capturing ExceptionInVPackage new Data Log to ExceptionInVPackage file.");

  public static String AcInterfaceFoxtrot =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Open Data Log");

  public static String JDialogExtensionDispose =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Compare Log");

  public static String h =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Open 2nd Data Log");

  public static String IOProperties =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
          "Open an existing data log file.");

  public static String j =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Open TS-Dash Log");

  public static String k =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
          "Only enabled if ExceptionInVPackage TS Dash is detected on the same subnet. You are then"
              + " able to download and open ExceptionInVPackage log directly from your Dashboard.");

  public static String l =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Stop Data Logging");

  public static String m =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
          "Stop capturing Log to ExceptionInVPackage file.");

  public static String n =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Log Viewing Settings.");

  public static String o =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("View Hot Key List.");

  public static String p =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("View in MegaLogViewer");

  public static String q =
      JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
          "When checked, log file values will be published to the entire application if offline.");
  ...
  public ManagerAeinterfaceecho() {
    ...
    this.JPanelExtensionUsingFileAccessPreferences =
        new JPanelExtensionUsingFileAccessPreferences();
    ...
    JMenu jMenu =
        new JMenu(JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("File"));
    JMenuItem jMenuItem =
        new JMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Open Log"));
      ...
      if (IOProperties.ExceptionInVPackage().ExceptionInVPackage(" a09kmfds098432lkg89vlk")) {
        ...
        this.z.setSelected(
            ExceptionInVPackage.ExceptionInVPackage()
                .AcComponentCharlie(ExceptionInVPackage.P, ExceptionInVPackage.Q));
  ...
  private void IOProperties() {
    ...
    if (n != null) {
      ...
      if (a1.h()) {
        ...
        if (!Double.isNaN(d1) && d1 > 0.0D) str2 = str2 + "DA: " + d1 + "<br>";
        if (str2.length() > 0) {
          this.B.setText(str1);
  ...
  private void ExceptionInVPackage(JPopupMenu paramJPopupMenu) {
    ...
    jCheckBoxMenuItem1 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("1 Table View"),
            IOProperties.P.equals(str1));
    image =
    ...
    jCheckBoxMenuItem1 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("No Table View"),
            IOProperties.O.equals(str1));
    image =
        Toolkit.getDefaultToolkit().getImage(getClass().getResource("resources/layout1Table.png"));
    imageIcon = new ImageIcon(image);
    jCheckBoxMenuItem1.setIcon(imageIcon);
    ...
    boolean bool1 =
        JPanelExtensionUsingFileAccessPreferences.ExceptionInVPackage()
            .ExceptionInVPackage("fileEditing");
    ...
    JCheckBoxMenuItem jCheckBoxMenuItem2 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Zoom Graph In / Out (Default)"),
            IOProperties.H.equals(str2));
    ...
    jCheckBoxMenuItem2 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Page Data Forward / Back"),
            IOProperties.I.equals(str2));
    ...
    JCheckBoxMenuItem jCheckBoxMenuItem4 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Show Graph Text"));
    ...
    jCheckBoxMenuItem4 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Show Graph Text without Min/Max"));
    jCheckBoxMenuItem4.setState((bool2 && !bool3));
    ...
    IOProperties = new IOProperties();
    int j =
        IOProperties.JPanelExtensionUsingFileAccessPreferences("lineTraceSize", IOProperties.ae);
    ...
    JCheckBoxMenuItem jCheckBoxMenuItem6 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Keep Graph Centered"));
    jCheckBoxMenuItem6.setState(
        IOProperties.ExceptionInVPackage("holdGraphCentered", IOProperties.x));
    ...
    JMenu jMenu6 =
        new JMenu(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Trace Value Positions"));
    String str3 = IOProperties.AeInterfaceEcho(IOProperties.S, IOProperties.T);
    JCheckBoxMenuItem jCheckBoxMenuItem7 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Show Cursor Values At Top"),
            str3.equals("top"));
    ...
    JCheckBoxMenuItem jCheckBoxMenuItem8 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Show Cursor Values At Bottom"),
            str3.equals("bottom"));
    ...
    JCheckBoxMenuItem jCheckBoxMenuItem9 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Show Cursor Values by Field Name"),
            str3.equals("withLabels"));
    ...
    JCheckBoxMenuItem jCheckBoxMenuItem10 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Alphabetize Field Lists"));
    ...
    int k =
        Integer.parseInt(
            IOProperties.JPanelExtensionUsingFileAccessPreferences(
                "numberOfGraphs", "" + IOProperties.t));
    ...
    int n =
        Integer.parseInt(
            IOProperties.JPanelExtensionUsingFileAccessPreferences(
                "numberOfOverlays", "" + IOProperties.u));
    ...
    jMenuItem2.setEnabled(
        JPanelExtensionUsingFileAccessPreferences.ExceptionInVPackage()
            .ExceptionInVPackage("selectableFields"));
    paramJPopupMenu.add(jMenuItem2);
    JCheckBoxMenuItem jCheckBoxMenuItem12 =
        new JCheckBoxMenuItem(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                "Quick Trace Selection"));
    boolean bool6 =
    ...
    jCheckBoxMenuItem13.setState(
        IOProperties.ExceptionInVPackage(IOProperties.aJ, IOProperties.aK));
    jCheckBoxMenuItem13.setToolTipText(
        "Will place ExceptionInVPackage toolbar above graph to quickly switch and commpare loaded"
            + " logs.");
    jCheckBoxMenuItem13.addItemListener(new cL(this));
    paramJPopupMenu.add(jCheckBoxMenuItem13);
    JCheckBoxMenuItem jCheckBoxMenuItem14 =
        new JCheckBoxMenuItem("Keep Index in sync with MegaLogViewer");
    jCheckBoxMenuItem14.setState(
        IOProperties.ExceptionInVPackage(IOProperties.aD, IOProperties.aE));
    ...
    if (IOProperties.ExceptionInVPackage().ExceptionInVPackage("timeslipData")) {
      ...
      jCheckBoxMenuItem15.setState(
          IOProperties.ExceptionInVPackage(IOProperties.aB, IOProperties.aC));
      jCheckBoxMenuItem15.setToolTipText(
      ...
      jCheckBoxMenuItem16.setState(
          IOProperties.ExceptionInVPackage(IOProperties.az, IOProperties.aA));
      jCheckBoxMenuItem16.setToolTipText(
      ...
      jCheckBoxMenuItem17.setState(
          IOProperties.ExceptionInVPackage(IOProperties.ax, IOProperties.ay));
      jCheckBoxMenuItem17.setToolTipText(
  ...
  public void AcInterfaceFoxtrot() {
    ...
    String str2 =
        k.ExceptionInVPackage(
            ...
            "Export Settings",
            arrayOfString,
            "LogViewerSettings_" + str1 + ".settings");
  ...
  public void JDialogExtensionDispose() {
    String[] arrayOfString = {"settings"};
    String str =
        k.ExceptionInVPackage((Component) this, "Import Settings", arrayOfString, "*.settings");
    ...
    try {
      ...
      k.ExceptionInVPackage(
          "Unable to open settings file " + str + "\nSee log for more detail.", (Component) this);
      exception.printStackTrace();
    }
    ArrayList<bB> arrayList = new ArrayList();
    ...
    if (!by.ExceptionInVPackage()) {
      ...
      for (String str1 : IOProperties.AeInterfaceEcho.stringPropertyNames()) {
        if (ExceptionInVPackage(str1, list)) IOProperties.d(str1);
      }
    }
    ...
    k.ExceptionInVPackage(
        ...
        (Component) bq.ExceptionInVPackage().JPanelExtensionUsingFileAccessPreferences());
  ...
  public void ExceptionInVPackage(String paramString, boolean paramBoolean) {
    ...
    if (this.JPanelExtensionUsingFileAccessPreferences.l() != null
        && k.ExceptionInVPackage(
            JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences(
                    "Log file must be reloaded for change to take effect.")
                + "\n"
                + JDialogExtensionDispose.JPanelExtensionUsingFileAccessPreferences("Reload now?"),
            (Component) this,
            true)) {
  ...
  private void p() {
    ...
    if (arrayOfString != null && arrayOfString.length > 0) AcComponentCharlie(arrayOfString[0]);
    IOProperties.JDialogExtensionDispose();
  }
  ...
  private void q() {
    if (this.F == null) {
      ...
      int IOProperties =
          IOProperties.JPanelExtensionUsingFileAccessPreferences(IOProperties.am, -1);
  ...
  public String[] ExceptionInVPackage(String paramString) {
    ...
    String[] arrayOfString2 =
        bV.ExceptionInVPackage(
            (Component) this, paramString, arrayOfString1, (String) null, str2, true, null, true);
  ...
  public void ExceptionInVPackage(String[] paramArrayOfString, boolean paramBoolean) {
    ...
    this.JPanelExtensionUsingFileAccessPreferences.ExceptionInVPackage(
        paramArrayOfString, paramBoolean);
  ...
  public void AcComponentCharlie(String paramString) {
    ...
    this.A.setToolTipText(
        "<html>" + X.JPanelExtensionUsingFileAccessPreferences(this.A.getText(), " - ", "<br>"));
  }
  ...
  public boolean ExceptionInVPackage() {
    ...
    if (this.AcComponentCharlie == null) this.AcComponentCharlie = bY.ExceptionInVPackage();
    ...
    if (this.G
        ...
        && !T.ExceptionInVPackage().AcComponentCharlie().R()) {
      String[] arrayOfString = new String[1];
      arrayOfString[0] = str;
      ExceptionInVPackage(arrayOfString, false);
    }
  ...
  public void JPanelExtensionUsingFileAccessPreferences() {
    if (this.AcComponentCharlie != null) {
      cb.ExceptionInVPackage()
          .JPanelExtensionUsingFileAccessPreferences((KeyEventDispatcher) this.AcComponentCharlie);
