...
public class IOInAbPackage extends a {
  ...
  public synchronized void f() {
    List list;
    if (k() == 3) throw new l("FTDI Device already connected:" + n());
    if (k() == 2) throw new l("FTDI Device already connecting:" + n());
    b(2);
    this.b = null;
    c();
    try {
      ...
      Logger.getLogger(b.class.getName())
          .log(Level.SEVERE, "Exception getting devices.", (Throwable) fTD2XXException);
      throw new l("Unable to get list of FTDI Devices.");
    } catch (Error error) {
      b(0);
      b();
      Logger.getLogger(b.class.getName())
          .log(Level.SEVERE, "System Error atteempting to get FTDI Devices.", error);
      throw new l("Unable to get list of FTDI Devices.");
    }
  ...
  public List t() {
    ...
    try {
      ...
      for (FTDevice fTDevice : list) arrayList.add(fTDevice.getDevSerialNumber());
    } catch (FTD2XXException fTD2XXException) {
    }
    return arrayList;
  }
  ...
  public List l() {
    ...
    b1.a("Device Serial #");
    b1.b(
        "FTDI USB Device ID. This can be used to distinctly identify a specific USB device or left"
            + " on Auto to connect to the 1st found.");
    b1.a(4);
    b1.a(g);
    try {
      List list = FTDevice.getDevices(true);
      for (FTDevice fTDevice : list) b1.a(fTDevice.getDevSerialNumber());
    } catch (Exception exception) {
    ...
    for (byte b3 = 0; b3 < arrayOfString.length; b3++) b2.a(arrayOfString[b3]);
    this.d.add(b2);
    return this.d;
  }
  ...
  public Object a(String paramString) {
    if (paramString.equals("Device Serial #")) return this.h;
    if (paramString.equals("Baud Rate")) return this.f + "";
    D.c("Unknown Setting Name: " + paramString);
    return null;
  }
  ...
  public String n() {
    if (this.b == null) return "USB D2XX, Serial #" + g + " @ " + this.f + " Baud";
    if (b(this.h)) {
      NInterfaceIndiaImpl.a().a("Counterfeit FTDI Chip!! " + this.h);
      D.b("The serial cable being used appears to be using a Counterfeit FTDI chipset!!!");
  ...
  private boolean b(String paramString) {
    return (paramString.equals("A50285BI")
        || paramString.equals("FTB6SPL3")
        || paramString.equals("A601CKQK")
        || paramString.contains("0000000")
        || paramString.equals("A5XK3RJJ")
        || paramString.equals("18F54CB7")
        || paramString.equals("A5XK3RJT")
        || paramString.equals(""));
  }
}
