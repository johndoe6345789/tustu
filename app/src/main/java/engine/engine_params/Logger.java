...
public class Logger {
  ...
  public CloneableImplUsingLogger a(CloneableImplUsingLogger parame) {
    a.info(
        "Receive Discover from "
            + parame.d()
            + " Request IP "
            + parame.CloneableImplUsingLogger().toString());
  ...
  private CloneableImplUsingLogger a(CloneableImplUsingLogger parame, g paramg) {
    ...
    CloneableImplUsingLogger e1 =
        NetworkLoggerInBwPackage.b(parame, inetAddress, paramg.d(), this.c, "", a.a());
    e1.a(this.c);
    return e1;
  }
  ...
  private CloneableImplUsingLogger b(CloneableImplUsingLogger parame, g paramg) {
    ...
    InetAddress inetAddress = paramg.a();
    CloneableImplUsingLogger e1 =
        NetworkLoggerInBwPackage.a(parame, inetAddress, paramg.d(), this.c, "", a.a());
    e1.a(this.c);
    return e1;
  }
  ...
  private CloneableImplUsingLogger c(CloneableImplUsingLogger parame, g paramg) {
    ...
    if (this.c != null) inetAddress = this.c;
    CloneableImplUsingLogger e1 =
        NetworkLoggerInBwPackage.b(parame, inetAddress, paramg.d(), this.c, "", a.a());
    e1.a(inetAddress);
    return e1;
  ...
  private CloneableImplUsingLogger d(CloneableImplUsingLogger parame, g paramg) {
    ...
    CloneableImplUsingLogger e1 =
        NetworkLoggerInBwPackage.a(parame, inetAddress, paramg.d(), inetAddress, "", a.a());
    e1.a(inetAddress);
