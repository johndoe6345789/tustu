...
public class IOInAePackage implements AInterfaceGolf {
  ...
  public byte[] a(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    ...
    if (inputStream.available() > 0) {
      ...
      while (inputStream.available() > 0)
        stringBuffer
            .append("0x")
            .append(Integer.toString(inputStream.read(), 16).toUpperCase())
            .append(" ");
      a(stringBuffer.toString());
    }
    if (J.I()) a("TX", paramArrayOfbyte);
    boolean bool = true;
    if (bool) {
    ...
    if (J.I() && paramInt1 > 0) a("RX", arrayOfByte);
    return arrayOfByte;
  }

  private byte[] a(byte[] paramArrayOfbyte) {
    if (this.a.b(this.e) == null) return paramArrayOfbyte;
  ...
  private byte[] a(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    if (this.a.a(this.e) == null) return paramArrayOfbyte2;
