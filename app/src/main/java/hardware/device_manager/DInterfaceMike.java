...
public class DInterfaceMike implements S, c {
  ...
  public void b(Properties paramProperties) {
    if (this.j != null && !this.j.isEmpty()) {
      ...
      if (c1 != null) c1.b(paramProperties);
    }
  }
  ...
  public void k() {
    ...
    if (this.k == null) str = str + e("Parameters have not been set.") + "\n";
    if (this.j == null) {
    ...
    if (!str.isEmpty()) throw new e(str);
  }
  ...
  private String e(String paramString) {
    try {
      ...
      Logger.getLogger(m.class.getName())
          .log(Level.SEVERE, "Failed to get Translation", (Throwable) b1);
      return paramString;
    }
  }
  ...
  public void c(Properties paramProperties) {
    ...
    if (str != null)
      try {
        ...
        Logger.getLogger(m.class.getName())
            .log(Level.WARNING, "Failed to parse ActionParameters: " + str, e);
      }
  }
  ...
  public Properties m() {
    ...
    if (this.j != null) properties.setProperty(d, this.j);
    if (this.k != null) properties.setProperty(e, this.k.TInterfaceAlpha());
    return properties;
  }
  ...
  public void n() {
    if (this.j != null && this.j.equals("loadCalFile")) {
      c c1 = g.TInterfaceAlpha().b(this.j);
      if (c1 instanceof l) ((l) c1).c(this.k);
    }
  }
