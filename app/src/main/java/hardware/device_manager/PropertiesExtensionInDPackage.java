...
public class PropertiesExtensionInDPackage extends Properties {
  static String a = "=";
  ...
  public static b a(String paramString) {
    b b1 = new b();
    if (paramString == null || paramString.indexOf(a) == -1) return b1;
    if (paramString.indexOf(b) == -1) paramString = paramString + b;
    try {
  ...
  public static String a(Properties paramProperties) {
    ...
    try {
      ...
      while (iterator.hasNext()) {
        ...
        if (iterator.hasNext()) stringBuilder.append(b);
      }
    } catch (UnsupportedEncodingException unsupportedEncodingException) {
