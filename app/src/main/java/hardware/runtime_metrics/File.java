...
public class File {
  ...
  public void a(R paramR) {
    if (this.l) {
      ...
      String str2 = null;
      if (str1.startsWith("MS/Extra")
          || str1.startsWith("MSnS-extra")
          || str1.startsWith("MS1/Extra")) {
        str2 = this.c;
      } else if (!str1.startsWith("20")) {
        if (str1.startsWith("MS2Extra")
            || str1.startsWith("MSII Rev")
            || (str1.startsWith("Monsterfirmware") && !str1.contains("pw"))) {
          str2 = this.f;
  ...
  private int b(String paramString) {
    ...
    if (str.contains("-dev")) str = X.b(str, "-dev", "");
    if (str.length() == 6 && I.a(str)) return Integer.parseInt(str);
