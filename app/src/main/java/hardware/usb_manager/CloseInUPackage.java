...
public class CloseInUPackage implements bc, dy {
  ...
  public CloseInUPackage(R paramR1, R paramR2, ArrayList paramArrayList) {
    ...
    this.f = paramR2;
    z z = new z(ac.a().b());
    ArrayList<ArrayListExceptionprintstacktraceInGPackage> arrayList1 =
        z.a(paramR1, paramArrayList);
    ...
    for (b4 = 0; b4 < arrayList2.size(); b4++) {
      ...
      if (ArrayListExceptionprintstacktraceInGPackage instanceof CloneableImpl
          || (ArrayListExceptionprintstacktraceInGPackage.Z() == 1
              && ArrayListExceptionprintstacktraceInGPackage.j(0) instanceof CloneableImpl)) {
    ...
    while (iterator.hasNext()) this.c.add(((Manager) iterator.next()).aL());
  }
  ...
  public Component a(int paramInt) {
    ...
    if (e == null) {
      ...
      ArrayListExceptionprintstacktraceInGPackage bv2 =
          new ArrayListExceptionprintstacktraceInGPackage();
      bv2.i(1);
      List<ArrayListExceptionprintstacktraceInGPackage> list =
          (List) this.b.get(Integer.valueOf(paramInt));
      for (byte b = 0; b < list.size(); b++) {
        ArrayListExceptionprintstacktraceInGPackage ArrayListExceptionprintstacktraceInGPackage =
            list.get(b);
        String str =
            ExceptionprintstacktraceInGPackage.c(
                this.e, ArrayListExceptionprintstacktraceInGPackage.aL());
        ...
        if (!bool) {
          ...
          GComponentBq = new GComponentBq();
          GComponentBq.e(
              "To view, click Exit & Go offline, then when you go back online enter the correct"
                  + " password.");
          bv3.a((Abstract) GComponentBq);
          list.set(b, bv3);
        }
      }
      for (ArrayListExceptionprintstacktraceInGPackage ArrayListExceptionprintstacktraceInGPackage :
          list) {
        if (ArrayListExceptionprintstacktraceInGPackage instanceof CloneableImpl
            || ArrayListExceptionprintstacktraceInGPackage instanceof G.bm) {
          ArrayListExceptionprintstacktraceInGPackage bv3 =
              new ArrayListExceptionprintstacktraceInGPackage();
          bv3.i(2);
          try {
  ...
  private ArrayList a(
      ArrayList<TableModelListenerRequestfocusinwindow> paramArrayList,
      ExceptionEqualsinaipackage parambh) {
  ...
  private ArrayList b(
      ArrayList<ManagerIinterfacecharlie> paramArrayList, ExceptionEqualsinaipackage parambh) {
    for (byte b = 0; b < parambh.getComponentCount(); b++) {
