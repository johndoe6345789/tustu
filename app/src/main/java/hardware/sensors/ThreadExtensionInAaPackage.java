...
class ThreadExtensionInAaPackage extends Thread {
  ThreadExtensionInAaPackage(
      JDialogExtensionInAzPackage parama, JDialogExtensionInAzPackage parama1) {}

  public void run() {
    try {
      Thread.sleep(200L);
      DInterfaceCharlie DInterfaceCharlie =
          h.JDialogExtensionInAzPackage().JDialogExtensionInAzPackage(this.b.b);
      if (DInterfaceCharlie.b() != null) this.b.b = DInterfaceCharlie.b();
      ...
      Logger.getLogger(JDialogExtensionInAzPackage.class.getName())
