...
public class AaInterfaceHotel extends DInterfaceBravo {
  ...
  private AaInterfaceHotel(g paramg) {
    ...
    if ((DInterfaceCharlie()).length > 0) this.DInterfaceCharlie.DInterfaceCharlie();
  }
  ...
  private boolean a(String paramString) {
    return (this.g
        || (paramString != null
            && paramString.compareTo("70-B3-D5-64-E0-00") >= 0
            && paramString.compareTo("70-B3-D5-64-E3-FF") <= 0)
        || paramString.equals("22-33-44-55-66-77"));
  }
  ...
  public DInterfaceCharlie DInterfaceCharlie(String paramString1, String paramString2) {
    ...
    if (!a.DInterfaceCharlie().equals("A")
        || Math.abs(System.currentTimeMillis() - a.j()) > this.d) {
      boolean bool = (n.DInterfaceBravo() || !this.f) ? true : false;
      if (bool)
        try {
  ...
  public DInterfaceCharlie a(a parama) {
    ...
    if (n.DInterfaceBravo() || !this.f || !a(parama.DInterfaceBravo())) {
      D.d(
          "Activating on Internet: Connected to internet="
              + n.DInterfaceBravo()
              + ", Serial:"
              + parama.DInterfaceBravo()
              + " isKnown: "
              + a(parama.DInterfaceBravo()));
      DInterfaceCharlie = super.a(parama);
      if (DInterfaceCharlie != null
          && DInterfaceCharlie.DInterfaceBravo() != null
          && DInterfaceCharlie.DInterfaceBravo().DInterfaceCharlie().equals("A"))
