...
class ComboBoxFilterRunnable implements Runnable {
  ComboBoxFilterRunnable(e parame, String paramString) {}
  ...
  public void run() {
    if (this.a.isEmpty()) {
      ...
      this.b.e = true;
      e.b(this.b);
      for (String str : this.b.d) this.b.a(str);
      ...
      e.b(this.b);
      this.b.e = true;
      for (String str : arrayList) this.b.a(str);
      this.b.e = false;
