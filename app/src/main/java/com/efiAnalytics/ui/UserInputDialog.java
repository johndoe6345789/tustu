...
public class UserInputDialog extends JDialog implements ActionListener {
  ...
  public UserInputDialog(
    ...
    boolean bool =
        ((paramString1 != null && paramString1.contains("\n")) || paramString1.contains("<br>"))
            ? true
            : false;
    if (bool) {
      jPanel.setLayout(new BorderLayout());
      paramString1 = X.b(paramString1, "\n", "<br>");
      if (!paramString1.startsWith("<html>")) paramString1 = "<html>" + paramString1;
    } else {
    ...
    if (paramString2 != null) this.b.setText(paramString2);
    if (bool) {
  ...
  public void actionPerformed(ActionEvent paramActionEvent) {
    if (paramActionEvent.getSource() instanceof JTextField) b();
