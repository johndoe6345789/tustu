...
public class ImageExporter {
  public boolean ExceptionInVPackage(
      Component paramComponent, String paramString1, String paramString2, String paramString3) {
    ...
    return (paramString2.toLowerCase().indexOf("jpg") > 0
            || paramString2.toLowerCase().indexOf("jpeg") > 0)
        ? ExceptionInVPackage(bufferedImage, paramString1, paramString2)
        : ((paramString2.toLowerCase().indexOf("png") > 0)
            ? b(bufferedImage, paramString1, paramString2)
            : false);
  }

  public BufferedImage ExceptionInVPackage(Component paramComponent) {
    BufferedImage bufferedImage =
        new BufferedImage(paramComponent.getWidth(), paramComponent.getHeight(), 5);
  ...
  public BufferedImage ExceptionInVPackage(Component paramComponent, String paramString) {
    BufferedImage bufferedImage =
        new BufferedImage(
            paramComponent.getWidth(),
            paramComponent.getHeight() + paramComponent.getFont().getSize(),
            5);
    Graphics graphics = bufferedImage.getGraphics();
    paramComponent.paint(graphics);
    ...
    graphics.fillRect(
        0,
        paramComponent.getHeight(),
        bufferedImage.getWidth(),
        bufferedImage.getHeight() - paramComponent.getHeight());
  ...
  public File ExceptionInVPackage(
      Component paramComponent, File paramFile, int paramInt1, int paramInt2) {
    BufferedImage bufferedImage1 = ExceptionInVPackage(paramComponent);
    BufferedImage bufferedImage2 =
        cN.ExceptionInVPackage(
            bufferedImage1, paramInt1, paramInt2, RenderingHints.VALUE_INTERPOLATION_BICUBIC);
  ...
  public boolean ExceptionInVPackage(
      BufferedImage paramBufferedImage, String paramString1, String paramString2) {
