...
public class Table3DColorMapPanel extends JComponent {
  ...
  private Image Table3DColorMapPanel() {
    if (this.g == null
        || this.g.getWidth(null) != Table3DColorMapPanel()
        || this.g.getHeight(null) != Table3DColorMapPanel())
    ...
    for (i = 0; i < this.a.size(); i++) {
      if (paramDouble < cC.a(this.a.get(i))) {
        ...
        if (i > 0) {
          ...
          d =
              (paramDouble - ((cC) this.a.get(i - 1)).a())
                  / (((cC) this.a.get(i)).a() - ((cC) this.a.get(i - 1)).a());
        }
        break;
      }
    }
    if (color2 == null) return ((cC) this.a.get(this.a.size() - 1)).b();
