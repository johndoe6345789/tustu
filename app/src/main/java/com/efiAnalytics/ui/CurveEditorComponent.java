...
public class CurveEditorComponent extends JComponent implements FocusListener {
  ...
  protected Image b() {
    if (this.p == null
        || this.p.getWidth(null) != getWidth()
        || this.p.getHeight(null) != getHeight()) {
  ...
  private void b(Graphics paramGraphics) {
    bP bP1;
    if (this.X == Double.MIN_VALUE || Double.isNaN(this.X)) return;
  ...
  private void c(Graphics paramGraphics) {
    if (H() < i()) return;
    if (h() <= i() || Math.abs((p() - H()) / (h() - i())) < this.e) return;
    try {
  ...
  private void d(Graphics paramGraphics) {
    ...
    i =
        (fontMetrics.stringWidth(arrayOfString[1]) > i)
            ? fontMetrics.stringWidth(arrayOfString[1])
            : i;
    ...
    paramGraphics.drawString(
        arrayOfString[0],
        (int) rectangle.getX() + eJ.a(2),
        (int) rectangle.getY() + fontMetrics.getHeight() - eJ.a(2));
    paramGraphics.drawString(
        arrayOfString[1],
        (int) rectangle.getX() + eJ.a(2),
        (int) rectangle.getY() + 2 * fontMetrics.getHeight() - eJ.a(2));
  }
  ...
  private Rectangle c(int paramInt1, int paramInt2) {
    ...
    if ((a(bP2, rectangle) || a(bP3, rectangle))
        && rectangle.getY() + rectangle.getHeight() + (k * 2) < getHeight()) {
      rectangle.setLocation(
          (int) rectangle.getX(), (int) (rectangle.getY() + rectangle.getHeight() + (k * 2)));
      return rectangle;
    }
    return rectangle;
  }
  ...
  private boolean a(bP parambP, Rectangle paramRectangle) {
    ...
    return (parambP == null)
        ? false
        : ((parambP.d() > paramRectangle.getX()
            && parambP.d() < paramRectangle.getX() + paramRectangle.getWidth() + i
            && parambP.f() > paramRectangle.getY()
            && parambP.f() < paramRectangle.getY() + paramRectangle.getHeight() + i));
  }
      ...
      for (byte b2 = 0; b2 < this.an.i(); b2++) {
        if (this.as == null || this.as.a(b2)) {
          ...
          if (bP1.c() >= this.M && bP1.c() <= this.K && bP1.e() >= this.P && bP1.e() <= this.N) {
            ...
            arrayOfInt2[b1] = m;
            b1++;
            if (Double.isNaN(this.aq) || bP1.c() < this.aq) this.aq = bP1.c();
            if (Double.isNaN(this.ar) || bP1.c() > this.ar) this.ar = bP1.c();
          }
        }
      }
      this.ao.b(bool);
  ...
  private void g(Graphics paramGraphics) {
    ...
    for (m = 0; m < this.T; m++) {
      ...
      paramGraphics.drawString(
          str1,
          i3 - fontMetrics1.stringWidth(str1) / 2 + i4,
          (F()).top + k + fontMetrics1.getHeight());
    }
    if (this.U > 1) {
      for (m = 0; m < this.U; m++) {
        ...
        paramGraphics.drawString(
            str1,
            (F()).left - fontMetrics1.stringWidth(str1),
            i3 + fontMetrics1.getHeight() / 3 + i4);
      }
    } else {
      m = (F()).top;
    ...
    for (n = 0; n < this.I.size(); n++) {
      String str1 = b(n);
      if (str1 != null && !str1.isEmpty() && !arrayList2.contains(str1)) arrayList2.add(str1);
      String str2 = c(n);
      if (str2 != null && !str2.isEmpty() && !arrayList1.contains(str2)) arrayList1.add(str2);
    }
    ...
    for (i2 = 0; i2 < i1; i2++) {
      ...
      if (str1 != null) {
        if (i1 > 1) paramGraphics.setColor(a(i2));
        paramGraphics.drawString(
            str1, i3, (F()).top + k + fontMetrics1.getHeight() + this.ai.getSize() + eJ.a(2));
      }
      if (str2 != null) {
        if (i1 > 1) paramGraphics.setColor(a(i2));
        int i4 =
            (int)
                ((F()).top
                    + (i2 + 0.5D) * k / i1
                    - (str2.length() * (int) (fontMetrics2.getHeight() * 0.85D) / 2));
  ...
  public String c(int paramInt) {
    bQ bQ = m(paramInt);
    if (bQ.b() == null || bQ.b().isEmpty()) bQ = m(0);
  ...
  private bP M() {
    ...
    for (bQ bQ : this.I) {
      bP bP2 = a(bQ);
      if (bP1 == null || (bP2 != null && bP2.c() > bP1.c())) bP1 = bP2;
    }
    return bP1;
  }
  ...
  private bP a(bQ parambQ) {
    bP bP1 = null;
    for (bP bP2 : parambQ) {
      if (bP1 == null || bP2.c() > bP1.c()) bP1 = bP2;
    }
    return bP1;
  }
  ...
  private bP N() {
    ...
    for (bQ bQ : this.I) {
      bP bP2 = b(bQ);
      if (bP1 == null || (bP2 != null && bP2.e() > bP1.e())) bP1 = bP2;
    }
    return bP1;
  }
  ...
  private bP b(bQ parambQ) {
    bP bP1 = null;
    for (bP bP2 : parambQ) {
      if (bP1 == null || bP2.e() > bP1.e()) bP1 = bP2;
    }
    return bP1;
  }
  ...
  public void a(double paramDouble) {
    ...
    this.R = 0;
    if (paramDouble < 1.0D)
      for (byte b = 1; str.charAt(b) == '0' || str.charAt(b) == '.'; b++) this.R++;
  }
  ...
  public void a(GInterfaceDj paramdj) {
    ...
    this.S = 0;
    if (paramdj.a() < 1.0D)
      for (byte b = 1; str.charAt(b) == '0' || str.charAt(b) == '.'; b++) this.S++;
  }
  ...
  public void b(double paramDouble) {
    if (this.L == Double.MIN_VALUE) g(paramDouble);
  ...
  private double d(int paramInt1, int paramInt2) {
    return Double.isNaN(((bP) ((bQ) this.I.get(paramInt1)).get(paramInt2)).g())
        ? j()
        : ((bP) ((bQ) this.I.get(paramInt1)).get(paramInt2)).g();
  }

  public void d(double paramDouble) {
    if (this.O == Double.MIN_VALUE) h(paramDouble);
    if (paramDouble > this.O) paramDouble = this.O;
    this.N = paramDouble;
    o();
  }
  ...
  private bP e(int paramInt1, int paramInt2) {
    return (paramInt2 >= 0
            && paramInt1 >= 0
            && paramInt1 < this.I.size()
            && paramInt2 < m(paramInt1).size())
        ? (bP) m(paramInt1).get(paramInt2)
        : null;
  }
  ...
  private void g(int paramInt1, int paramInt2) {
    ...
    for (bS bS : this.n) bS.a(paramInt1, paramInt2, bP1.c());
  }

  private void h(int paramInt1, int paramInt2) {
    bP bP1 = e(paramInt1, paramInt2);
    for (bS bS : this.n) bS.b(paramInt1, paramInt2, bP1.e());
  }

  private void S() {
    bP[] arrayOfBP = (bP[]) this.c.toArray((Object[]) new bP[this.c.size()]);
    for (bR bR : this.o) bR.a((ef[]) arrayOfBP);
  }
  ...
  public Dimension getPreferredSize() {
    ...
    if (T() && this.T > 7) dimension.width = this.T * eJ.a(38);
    return dimension;
  }
  ...
  private int a(bP parambP, int paramInt1, int paramInt2) {
    if (parambP.c() > h()) return B;
    if (parambP.c() < i()) return A;
    if (parambP.e() > d(paramInt1, paramInt2)) return y;
    if (parambP.e() < k()) return z;
    if (paramInt2 + 1 < m(paramInt1).size()) {
      bP bP1 = e(paramInt1, paramInt2 + 1);
      if (parambP.c() >= bP1.c()) return C;
    }
    if (paramInt2 > 0) {
      bP bP1 = e(paramInt1, paramInt2 - 1);
      if (parambP.c() <= bP1.c()) return C;
  ...
  public void a(Rectangle paramRectangle) {
    ...
    for (bQ bQ : this.I) {
      for (bP bP1 : bQ) {
        if (paramRectangle.contains(bP1.d(), bP1.f())) this.c.add(bP1);
      }
    }
    o();
    S();
  ...
  public void b(boolean paramBoolean) {
    ...
    if (paramBoolean || !this.am) this.c.clear();
    bP bP1 = e(this.d.d, this.d.c);
    if (bP1 != null && !this.c.contains(bP1)) this.c.add(bP1);
    o();
    S();
  }
  ...
  private bQ m(int paramInt) {
    while (this.I.size() <= paramInt) this.I.add(new bQ(this));
  ...
  public int C() {
    ...
    for (int i = bQ.size() - 1; i >= 0; i--) {
      if (((bP) bQ.get(i)).c() < this.aq) return (i < bQ.size() - 1) ? i : (bQ.size() - 1);
    }
    return 0;
  }
  ...
  public int D() {
    ...
    for (byte b = 0; b < bQ.size() - 1; b++) {
      if (((bP) bQ.get(b)).c() > this.ar) return (b > 0) ? b : 0;
    }
