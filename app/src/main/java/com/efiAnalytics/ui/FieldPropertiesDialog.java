...
public class FieldPropertiesDialog extends JDialog implements ActionListener {
  ...
  public FieldPropertiesDialog(
      Frame paramFrame, n paramn, String paramString1, String paramString2, String paramString3) {
    ...
    if (paramString1 != null && paramString1.isEmpty() && paramn != null) {
      ...
      for (String str : list) this.h.addItem(str);
      jPanel2.add(this.h);
    } else {
      jPanel2.add(this.d);
    }
