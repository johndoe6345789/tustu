...
public class MessageDialog extends JDialog implements ActionListener {
  ...
  public MessageDialog(Frame paramFrame, String paramString, boolean paramBoolean) {
    ...
    while (stringTokenizer.hasMoreElements()) panel.add(new Label(stringTokenizer.nextToken()));
    add(new Label(""), "West");
    add(new Label(""), "East");
    add(new Label(""), "North");
    a(paramBoolean);
    ...
    Dimension dimension1 =
        (paramFrame != null) ? paramFrame.getSize() : Toolkit.getDefaultToolkit().getScreenSize();
