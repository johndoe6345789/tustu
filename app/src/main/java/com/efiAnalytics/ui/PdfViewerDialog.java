...
public class PdfViewerDialog {
  ...
  public PdfViewerDialog(Window paramWindow) {
    ...
    PropertiesManager propertiesManager =
        new PropertiesManager(
            ...
            properties,
            ResourceBundle.getBundle("org.icepdf.ri.resources.MessageBundle"));
    SwingViewBuilder swingViewBuilder = new SwingViewBuilder(this.a, propertiesManager);
    propertiesManager.setBoolean(
        "application.toolbar.show.annotation", Boolean.FALSE.booleanValue());
    propertiesManager.setBoolean(
        "application.toolbar.show.utility.save", Boolean.FALSE.booleanValue());
    ...
    this.a
        ...
        .setAnnotationCallback(
            (AnnotationCallback) new MyAnnotationCallback(this.a.getDocumentViewController()));
  ...
  public void a(URL paramURL) {
    ...
    if (paramURL.getRef() != null && paramURL.getRef().contains("page=")) {
      ...
      if (destination != null) this.a.getDocumentViewController().setDestinationTarget(destination);
    }
