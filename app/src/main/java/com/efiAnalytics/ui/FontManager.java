...
public class FontManager {
  ...
  public File a(String paramString, File paramFile) {
    ...
    if (this.c.get(paramString) != null) return null;
    ...
    if (paramFile != null && paramFile.exists() && paramFile.isDirectory()) {
      ...
      for (byte b = 0; b < arrayOfFile.length; b++) {
        try {
          ...
          if (file == null && str2.startsWith(paramString)) file = arrayOfFile[b];
        } catch (FontFormatException fontFormatException) {
          D.a(
              "Unable to load font, invalid font file '"
                  + paramString
                  + "' from file: "
      ...
      if (file != null) this.b.put(paramString, file);
      return file;
    }
    return null;
  }
  ...
  public Font a(String paramString, int paramInt1, int paramInt2) {
    try {
      if (paramString == null || paramString.equals("")) return new Font("", paramInt1, paramInt2);
      ...
      if (this.g != null) {
        File file = (File) this.b.get(paramString);
        if (file == null) file = b(paramString, this.g);
  ...
  private boolean a(String[] paramArrayOfString, String paramString) {
    for (String str : paramArrayOfString) {
      if (str.equals(paramString)) return true;
    }
    return false;
  }
    ...
    if (paramFile != null && paramFile.exists() && paramFile.isDirectory()) {
      ...
      for (byte b = 0; b < arrayOfFile.length; b++) {
        try {
          ...
          Logger.getLogger(fp.class.getName())
              .log(Level.SEVERE, (String) null, fontFormatException);
