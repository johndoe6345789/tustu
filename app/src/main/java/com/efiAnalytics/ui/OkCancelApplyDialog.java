...
public class OkCancelApplyDialog extends JDialog {
  ...
  public OkCancelApplyDialog(
      Window paramWindow, JComponent paramJComponent, String paramString, a parama, int paramInt) {
  ...
  private JPanel a(int paramInt) {
    ...
    if (bool) {
      if ((paramInt | 0x1) == paramInt) jPanel.add(jButton1);
      if ((paramInt | 0x2) == paramInt) jPanel.add(jButton2);
      if ((paramInt | 0x4) == paramInt) jPanel.add(jButton3);
    } else {
      if ((paramInt | 0x4) == paramInt) jPanel.add(jButton3);
      if ((paramInt | 0x2) == paramInt) jPanel.add(jButton2);
      if ((paramInt | 0x1) == paramInt) jPanel.add(jButton1);
