...
public class DialogUtilities {
  ...
  private static String b(String paramString) {
    if (g != null) paramString = g.a(paramString);
    return paramString;
  }
  ...
  public static Rectangle a(Rectangle paramRectangle) {
    ...
    for (byte b = 0; b < arrayOfGraphicsDevice.length; b++) {
      ...
      if (rectangle.contains(paramRectangle.x, paramRectangle.y)
          || rectangle.contains(paramRectangle.x + paramRectangle.width, paramRectangle.y)
          || rectangle.contains(
              paramRectangle.x + paramRectangle.width, paramRectangle.y + paramRectangle.height)
          || rectangle.contains(paramRectangle.x, paramRectangle.y + paramRectangle.height)) {
        bool = false;
        if (paramRectangle.x < rectangle.x) paramRectangle.x = rectangle.x;
        if (paramRectangle.y < rectangle.y) paramRectangle.y = rectangle.y;
        if (paramRectangle.width > rectangle.width) paramRectangle.width = rectangle.width;
        if (paramRectangle.height > rectangle.height) paramRectangle.height = rectangle.height;
    ...
    if (bool) {
      ...
      if (paramRectangle.x < 0) paramRectangle.x = 0;
      if (paramRectangle.y < 0) paramRectangle.y = 0;
  ...
  public static Rectangle b(Rectangle paramRectangle) {
    if (a(paramRectangle.x, paramRectangle.y)
        && a(paramRectangle.x + paramRectangle.width, paramRectangle.y)
        && a(paramRectangle.x, paramRectangle.y + paramRectangle.height)
        && a(paramRectangle.x + paramRectangle.width, paramRectangle.y + paramRectangle.height))
      return paramRectangle;
    Point point = b();
    if (paramRectangle.x < 0) paramRectangle.x = 0;
    if (paramRectangle.x > point.x - 100) paramRectangle.x = point.x - 100;
    if (paramRectangle.y < 0) paramRectangle.y = 0;
    if (paramRectangle.y > point.y - 100) paramRectangle.y = point.y - 100;
    return paramRectangle;
  }
  ...
  public static boolean a(int paramInt1, int paramInt2) {
    ...
    for (byte b = 0; b < arrayOfGraphicsDevice.length; b++) {
      GraphicsDevice graphicsDevice = arrayOfGraphicsDevice[b];
      Rectangle rectangle = graphicsDevice.getDefaultConfiguration().getBounds();
      if (rectangle.contains(paramInt1, paramInt2)) return true;
    }
    return false;
  }
  ...
  public static Point b() {
    ...
    for (byte b = 0; b < arrayOfGraphicsDevice.length; b++) {
      GraphicsDevice graphicsDevice = arrayOfGraphicsDevice[b];
      Rectangle rectangle = graphicsDevice.getDefaultConfiguration().getBounds();
      if (rectangle.x + rectangle.width > i) i = rectangle.x + rectangle.width;
      if (rectangle.y + rectangle.height > j) j = rectangle.y + rectangle.height;
    }
  ...
  public static void a(Window paramWindow, Component paramComponent) {
    ...
    Dimension dimension = Toolkit.getDefaultToolkit().getScreenSize();
    if ((paramComponent.getLocation()).x < 0
        || (paramComponent.getLocation()).y < 0
        || ((paramComponent.getLocation()).x + paramComponent.getWidth() > dimension.width && !h())
        || (paramComponent.getLocation()).y + paramComponent.getHeight() > dimension.height) {
      i = ((paramComponent.getLocation()).x < 0) ? 0 : (paramComponent.getLocation()).x;
      i =
          (i + paramComponent.getWidth() > dimension.width)
              ? (dimension.width - paramComponent.getWidth())
              : i;
      j = ((paramComponent.getLocation()).y < 0) ? 0 : (paramComponent.getLocation()).y;
      j =
          (j + paramComponent.getHeight() > dimension.height)
              ? (dimension.height - paramComponent.getHeight())
              : j;
      paramComponent.setLocation(i, j);
    }
  }
  ...
  public static void a(Component paramComponent1, Component paramComponent2) {
    int i =
        (paramComponent1.getLocationOnScreen()).x
            + (paramComponent1.getWidth() - paramComponent2.getWidth()) / 2;
    int j =
        (paramComponent1.getLocationOnScreen()).y
            + (paramComponent1.getHeight() - paramComponent2.getHeight()) / 2;
  ...
  public static String[] a(
    ...
    if (bool) {
      ...
      if (paramString3 != null) b.setCurrentDirectory(new File(paramString3));
      ...
      if (paramArrayOfString != null && paramArrayOfString.length > 0) {
        ...
        if (paramBoolean1) {
          ...
          dd dd = new dd(str2);
          for (byte b = 0; b < paramArrayOfString.length; b++) dd.b(paramArrayOfString[b]);
      ...
      if (paramap != null)
        try {
          ...
          if (j > 0 && k > 0) b.setPreferredSize(new Dimension(j, k));
      ...
      if (b.getCurrentDirectory() != null && b.getSelectedFile() != null)
        str1 =
            b.getCurrentDirectory().getAbsolutePath()
                + File.separator
                + b.getSelectedFile().getName();
      if (paramap != null) {
  ...
  public static String a(
      String paramString1, Component paramComponent, String paramString2, ck paramck) {
  ...
  public static void IOInXPackage(String paramString, Component paramComponent) {
    if (SwingUtilities.isEventDispatchThread()) {
      ...
      try {
        ...
        Logger.getLogger(bV.class.getName())
  ...
  public static boolean a(
    ...
    int i =
        JOptionPane.showOptionDialog(
            ...
            3,
            null,
            (Object[]) paramArrayOfString,
            paramArrayOfString[bool]);
    return (i == 0);
  }
  ...
  public static int b(
    ...
    return JOptionPane.showOptionDialog(
        ...
        paramString1,
        paramString2,
        (paramArrayOfString.length == 3) ? 1 : 0,
        3,
        null,
        (Object[]) paramArrayOfString,
        paramArrayOfString[bool]);
  ...
  public static String a(
      Component paramComponent, boolean paramBoolean, String paramString1, String paramString2) {
  ...
  public static Color a(Component paramComponent, String paramString, Color paramColor) {
    if (e == null) e = new JColorChooser();
    e.setColor(paramColor);
    f = paramColor;
    JDialog jDialog =
        JColorChooser.createDialog(paramComponent, paramString, true, e, new cc(), new cd());
    Point point = paramComponent.getMousePosition();
    if (point != null) {
      Point point1 = paramComponent.getLocationOnScreen();
      jDialog.setLocation(
          point.x + point1.x - jDialog.getWidth() / 2,
          point.y + point1.y - jDialog.getHeight() / 2);
      Dimension dimension = Toolkit.getDefaultToolkit().getScreenSize();
      if ((jDialog.getLocation()).x < 0
          || (jDialog.getLocation()).y < 0
          || (jDialog.getLocation()).x + jDialog.getWidth() > dimension.width
          || (jDialog.getLocation()).y + jDialog.getHeight() > dimension.height) {
        byte b1 = ((jDialog.getLocation()).x < 0) ? 0 : (jDialog.getLocation()).x;
        b1 =
            (b1 + jDialog.getWidth() > dimension.width)
                ? (dimension.width - jDialog.getWidth())
                : b1;
        byte b2 = ((jDialog.getLocation()).y < 0) ? 0 : (jDialog.getLocation()).y;
        b2 =
            (b2 + jDialog.getHeight() > dimension.height)
                ? (dimension.height - jDialog.getHeight())
                : b2;
  ...
  public static JDialog a(
      Component paramComponent1, Component paramComponent2, String paramString, bc parambc) {
    paramString = b(paramString);
    JDialog jDialog = b(paramComponent1, paramComponent2, paramString, parambc);
    jDialog.pack();
    if (paramComponent2 != null) a(b(paramComponent2), jDialog);
    jDialog.setVisible(true);
    return jDialog;
  }

  public static JDialog b(
      Component paramComponent1, Component paramComponent2, String paramString, bc parambc) {
  ...
  public static JDialog a(
    ...
    if (parambc != null) jButton.addActionListener(new bb(parambc));
  ...
  public static void a(Container paramContainer, boolean paramBoolean) {
    for (byte b = 0; b < paramContainer.getComponentCount(); b++) {
      ...
      if (component instanceof Container) a((Container) component, paramBoolean);
    }
  }
  ...
  public static String a(Component paramComponent, String paramString) {
    ...
    int i =
        JOptionPane.showOptionDialog(
            window, jPanel, "Password", 1, -1, null, (Object[]) arrayOfString, arrayOfString[0]);
    if (i == 0) {
  ...
  public static int i() {
    return JOptionPane.showConfirmDialog(
        b, b("Are you sure want to delete this file?"), b("Confirm"), 0);
  }
}
