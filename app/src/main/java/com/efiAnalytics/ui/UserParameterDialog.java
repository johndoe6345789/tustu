...
public class UserParameterDialog extends JDialog implements ActionListener {
  ...
  public UserParameterDialog(
    ...
    if (paramString2 == null) paramString2 = a("User defined values required for this formula.");
  ...
  public String a() {
    ...
    for (byte b = 0; b < this.e.size(); b++) {
      ...
      if (this.i != null) this.i.b("userParameter_" + str1, jTextField.getText());
    }
    return str;
  }
  ...
  public void actionPerformed(ActionEvent paramActionEvent) {
    if (paramActionEvent.getSource() == this.b) c();
  ...
  private boolean d() {
    for (JTextField jTextField : this.f) {
      if (this.m != null) {
        if (!this.m.a(jTextField.getText())) return false;
        continue;
      }
      ...
      if (jTextField.equals("")) bV.d(a("You must enter a value."), this.g);
    }
    return true;
  }
}
