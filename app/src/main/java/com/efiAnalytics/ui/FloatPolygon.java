...
public class FloatPolygon implements Shape, Serializable {
  ...
  public Object FloatPolygon() {
    ...
    for (byte b = 0; b < this.a; b++) dL1.a(this.b[b], this.c[b]);
    return dL1;
  }
  ...
  private void FloatPolygon() {
    ...
    for (byte b = 1; b < this.a; b++) this.e.lineTo(this.b[b], this.c[b]);
  ...
  public boolean FloatPolygon(double paramDouble1, double paramDouble2) {
    if (this.a <= 2 || !this.d.contains(paramDouble1, paramDouble2)) return false;
    FloatPolygon();
