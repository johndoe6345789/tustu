...
public class RangeSliderPanel extends JPanel {
  ...
  private void a(Graphics paramGraphics) {
    ...
    paramGraphics.draw3DRect(
        rectangle.x - 1, rectangle.y - 1, rectangle.width + 2, rectangle.height + 2, false);
    Point point1 = b();
    Point point2 = c();
    ...
    if (this.d != c) {
      ...
      paramGraphics.draw3DRect(
          rectangle.x + 1, rectangle.y + rectangle.height / 2, rectangle.width - 2, 1, false);
    }
    if (this.d == c) {
      this.n =
          new Rectangle(
              point1.x - this.j / 2, this.j / 2, point1.x + this.i / 2, point1.y + this.j / 2);
      this.m =
          new Rectangle(
              point2.x - this.j / 2, this.j / 2, point2.x + this.i / 2, point2.y + this.j / 2);
    } else {
      this.n =
          new Rectangle(
              point1.x - this.i / 2, point1.y - 1 - this.j / 2, this.i, point1.y + this.j / 2);
      this.m =
          new Rectangle(
              point2.x - this.i / 2, point2.y - 1 - this.j / 2, this.i, point2.y + this.j / 2);
    }
    paramGraphics.setColor(Color.lightGray);
  ...
  private Point f(double paramDouble) {
    ...
    return (this.d == c)
        ? new Point(
            ...
            rectangle.y + rectangle.height - (int) (rectangle.height * paramDouble))
        : new Point(
            rectangle.x + (int) (rectangle.width * paramDouble),
  ...
  public double a() {
    return (this.d == c)
        ? ((this.f - this.e) / (getHeight() - this.k.top - this.k.bottom))
        : ((this.f - this.e) / (getWidth() - this.k.left - this.k.right));
  }

  public void c(double paramDouble) {
    if (paramDouble < this.e) paramDouble = this.e;
    if (paramDouble >= this.h) d(paramDouble + a());
    this.g = paramDouble;
    repaint();
    e();
  }
  ...
  public void d(double paramDouble) {
    if (paramDouble > this.f) paramDouble = this.f;
    if (paramDouble < this.g) c(paramDouble - a());
    this.h = paramDouble;
    repaint();
    f();
  }
  ...
  private void e() {
    ...
    while (iterator.hasNext()) ((ev) iterator.next()).a(d);
  }

  private void f() {
    double d = this.h;
    Iterator<ev> iterator = this.a.iterator();
    while (iterator.hasNext()) ((ev) iterator.next()).b(d);
  }

  public Dimension getPreferredSize() {
    return (this.d == c)
        ? new Dimension(
            this.k.left + this.j + this.k.right, this.k.top + this.i + this.k.bottom + eJ.a(100))
        : new Dimension(
            this.k.left + this.i + this.k.right + eJ.a(100), this.k.top + this.j + this.k.bottom);
  }
