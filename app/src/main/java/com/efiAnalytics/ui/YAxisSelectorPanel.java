...
public class YAxisSelectorPanel extends JPanel {
  ManagerRemovelayoutcomponent ManagerRemovelayoutcomponent =
      new ManagerRemovelayoutcomponent(
          0, 5, eJ.ManagerRemovelayoutcomponent(6), eJ.ManagerRemovelayoutcomponent(6));
