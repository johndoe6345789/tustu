...
public abstract class AbstractChartComponent extends JComponent {
  ...
  public void paint(Graphics paramGraphics) {
    if (this.e == null
        || getWidth() != this.e.getWidth(null)
        || getHeight() != this.e.getHeight(null)) {
  ...
  public void d(Graphics paramGraphics) {
    ...
    if (!rectangle.contains(p(), o())) return;
    ...
    paramGraphics.drawString(
        "X: " + a(p()), rectangle.x + this.h, rectangle.y + paramGraphics.getFont().getSize());
  ...
  public void a(int paramInt, Color paramColor) {
    if (this.c.size() <= paramInt) c(paramInt);
  ...
  public Color c(int paramInt) {
    if (this.c.size() <= paramInt) for (int i = this.c.size(); i <= paramInt; i++) this.c.add(f(i));
    ...
    if (this.d == null) {
      ...
      this.d =
          new Rectangle(
              ...
              this.l.getSize() + b,
              getWidth() - b - this.w,
              getHeight() - this.l.getSize() - b - this.x);
    }
    return this.d;
  }
