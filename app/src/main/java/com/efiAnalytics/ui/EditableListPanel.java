...
public class EditableListPanel extends JPanel implements ListSelectionListener {
  ...
  public EditableListPanel() {
    ...
    Image image =
        Toolkit.getDefaultToolkit().getImage(getClass().getResource("resources/plus.gif"));
  ...
  private void f() {
    ...
    this.e.setEnabled(
        (this.a.getSelectedValue() != null && this.a.getSelectedIndex() < this.b.getSize() - 1));
  ...
  protected void d() {
    if (this.a.getSelectedValue() != null
        && this.a.getSelectedIndex() > 0
        && a(this.a.getSelectedValue(), this.a.getSelectedIndex() - 1, this.a.getSelectedIndex())) {
  ...
  protected void e() {
    if (this.a.getSelectedValue() != null
        && this.a.getSelectedIndex() < this.b.getSize() - 1
        && a(this.a.getSelectedValue(), this.a.getSelectedIndex() - 1, this.a.getSelectedIndex())) {
      E e = this.b.get(this.a.getSelectedIndex());
      int i = this.a.getSelectedIndex();
      this.b.remove(this.a.getSelectedIndex());
  ...
  private void g() {
    ...
    while (iterator.hasNext()) ((eh) iterator.next()).a(this.b);
  }
  ...
  private boolean a(Object paramObject, int paramInt1, int paramInt2) {
    Iterator<eh> iterator = this.i.iterator();
    while (iterator.hasNext()) {
      if (!((eh) iterator.next()).a(paramObject, paramInt1, paramInt2)) return false;
    }
    return true;
  }
  ...
  private void c(Object paramObject) {
    Iterator<eh> iterator = this.i.iterator();
    while (iterator.hasNext()) ((eh) iterator.next()).a(paramObject);
  }

  private void d(Object paramObject) {
    Iterator<eh> iterator = this.i.iterator();
    while (iterator.hasNext()) ((eh) iterator.next()).b(paramObject);
  }
