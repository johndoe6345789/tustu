...
enum Operator {
  ...
  static {
    h = (Map)Stream.<Operator>of(values()).collect(Collectors.toMap(Object::toString, paramOperator -> paramOperator));
  }
  ...
  static {
    ...
    d = new Operator("MULTIPLY", 3, "x", (paramDouble1, paramDouble2) -> paramDouble1 * paramDouble2);
