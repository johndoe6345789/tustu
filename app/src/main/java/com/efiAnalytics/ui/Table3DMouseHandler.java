    ...
    if (this.e.isEnabled()) {
      ...
      for (byte b = 0; b < eM.b(this.e).o(); b++) {
        for (byte b1 = 0; b1 < eM.b(this.e).p(); b1++) {
          if ((arrayOfEZ[b1][b]).a + eM.c(this.e) > paramMouseEvent.getX()
              && (arrayOfEZ[b1][b]).a - eM.c(this.e) < paramMouseEvent.getX()
              && (arrayOfEZ[b1][b]).b + eM.c(this.e) > paramMouseEvent.getY()
              && (arrayOfEZ[b1][b]).b - eM.c(this.e) < paramMouseEvent.getY()) {
            this.e.f(b1);
            this.e.e(b);
            this.e.repaint();
  ...
  public void mouseDragged(MouseEvent paramMouseEvent) {
    if (this.e.isEnabled()) {
      ...
      if (this.d == true) {
        double d =
            this.e.a.a(
                eM.b(this.e).a(eM.d(this.e)), eM.b(this.e).b(eM.e(this.e)), paramMouseEvent.getY());
