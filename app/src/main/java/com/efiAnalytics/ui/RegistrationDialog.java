...
public class RegistrationDialog extends JDialog implements ClipboardOwner {
  ...
  private void e() {
    ...
    while (stringTokenizer.hasMoreTokens()) {
      ...
      if (str1.startsWith("[Registration]")) bool = true;
    }
  }
  ...
  private void f() {
    ...
    if (str2.isEmpty()) str1 = str1 + a("First Name") + "\n";
    String str3 = this.p.a().trim();
    if (str3.isEmpty()) str1 = str1 + a("Last Name") + "\n";
    String str4 = this.q.a().trim();
    if (str4.isEmpty()) str1 = str1 + a("eMail Address") + "\n";
    String str5 = this.r.a().trim();
    if (str5.equals("")) str1 = str1 + a("Registration Key") + "\n";
    if (!str1.equals("")) {
    ...
    if (str7 == null || str7.isEmpty()) str7 = str9;
    if (this.k.b(str2, str3, str7, str4, "", this.s.a())) return;
    if (str7 == null || str7.isEmpty() || !str7.equals(str5)) {
      ...
      if (str7 != null && !str7.isEmpty())
        for (B b1 : A.i().j()) {
          if (a(b1.a(), b1.b())) {
            String str13 = str6;
            if (arrayOfString.length == 1) str13 = str13 + " " + arrayOfString[0];
            String str14 = b1.a() + " " + b1.b();
            String[] arrayOfString1 = {"Download " + str14, "Cancel"};
            boolean bool1 =
                bV.a(
                    "The Registration information you entered is for\n"
                        + b1.a()
                        + " "
                        + b1.b()
                        ...
                        + "or downloaded the intended application edition.",
                    "Registration Error",
                    this,
                    arrayOfString1);
            if (bool1) aN.a(b1.c());
    ...
    String str12 = "";
    if (this.k.a(this.h.a())) str12 = this.s.a();
