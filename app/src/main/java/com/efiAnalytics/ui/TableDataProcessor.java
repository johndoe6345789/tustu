...
public class TableDataProcessor {
  ...
  public static double a(s params, int paramInt1, int paramInt2, float paramFloat) {
    ...
    if ((paramInt1 == 0 && paramInt2 == 0)
        || (paramInt1 == i - 1 && paramInt2 == j - 1)
        || (paramInt1 == 0 && paramInt2 == j - 1)
        || (paramInt1 == i - 1 && paramInt2 == 0)) {
      byte b = 3;
    ...
    d2 +=
        f2
            * ((paramInt1 > 0 && paramInt2 > 0)
                ? params.d(paramInt2 - 1, paramInt1 - 1).doubleValue()
                : d1);
    d2 += f2 * ((paramInt2 > 0) ? params.d(paramInt2 - 1, paramInt1).doubleValue() : d1);
    d2 +=
        f2
            * ((paramInt1 + 1 < i && paramInt2 + 1 < j)
                ? params.d(paramInt2 + 1, paramInt1 + 1).doubleValue()
                : d1);
    ...
    d2 +=
        f2
            * ((paramInt1 > 0 && paramInt2 + 1 < j)
                ? params.d(paramInt2 + 1, paramInt1 - 1).doubleValue()
                : d1);
    d2 +=
        f2
            * ((paramInt1 + 1 < i && paramInt2 > 0)
                ? params.d(paramInt2 - 1, paramInt1 + 1).doubleValue()
                : d1);
    return d2;
  }
  ...
  public static s a(s params1, s params2) {
    ...
    if (params1.getRowCount() == params2.getRowCount()
        && params1.getColumnCount() == params2.getColumnCount()) {
      params2.e(params1.a());
      params2.c(params1.b());
      params2.f(params1.z());
      params2.d(params1.v());
      if (params1.w() != null && params1.w().trim().length() > 0) params2.e(params1.w());
  ...
  public static Color a(double paramDouble1, double paramDouble2, double paramDouble3) {
    ...
    return bool
        ? c(paramDouble1, paramDouble2, paramDouble3)
        : b(paramDouble1, paramDouble2, paramDouble3);
  }

  public static void a(
      Graphics2D paramGraphics2D,
    ...
    int i =
        (paramPolygon.ypoints[0] < paramPolygon.ypoints[3])
            ? paramPolygon.ypoints[0]
            : paramPolygon.ypoints[3];
    ...
    for (byte b = 0; b < f3; b++) {
      ...
      int j =
          paramPolygon.xpoints[0]
              - Math.round((paramPolygon.xpoints[0] - paramPolygon.xpoints[3]) * f4);
      int k =
          paramPolygon.xpoints[1]
              - Math.round((paramPolygon.xpoints[1] - paramPolygon.xpoints[2]) * f5);
      GradientPaint gradientPaint =
          new GradientPaint(
              j, (paramPolygon.ypoints[0] + b), color5, k, (paramPolygon.ypoints[1] + b), color6);
  ...
  public static Color a(Color paramColor1, Color paramColor2, float paramFloat) {
    int i =
        Math.round(paramColor1.getRed() * paramFloat + paramColor2.getRed() * (1.0F - paramFloat));
    int j =
        Math.round(
            paramColor1.getGreen() * paramFloat + paramColor2.getGreen() * (1.0F - paramFloat));
    int k =
        Math.round(
            paramColor1.getBlue() * paramFloat + paramColor2.getBlue() * (1.0F - paramFloat));
    int m =
        Math.round(
            paramColor1.getAlpha() * paramFloat + paramColor2.getAlpha() * (1.0F - paramFloat));
  ...
  public static Color a(
      double paramDouble1, double paramDouble2, double paramDouble3, int paramInt) {
    if (paramDouble1 > paramDouble3) paramDouble1 = paramDouble3;
    if (paramDouble1 < paramDouble2) paramDouble1 = paramDouble2;
    if (paramDouble2 == paramDouble3) return Color.WHITE;
