...
public class PersistentDialog extends JDialog implements bc {
  aO o = null;
  ...
  public PersistentDialog(
      Window paramWindow, String paramString, aO paramaO, boolean paramBoolean) {
