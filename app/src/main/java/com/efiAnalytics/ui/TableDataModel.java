...
public class TableDataModel implements WInterfaceAn, TableModel {
  ...
  public void a(int paramInt1, int paramInt2) {
    boolean bool =
        (this.k == null
                || this.k.length != paramInt2
                || this.l == null
                || this.l.length != paramInt1)
            ? true
            : false;
    ...
    if (this.j != null && (this.j.length != paramInt1 || (this.j[0]).length != paramInt2))
      this.j = null;
    if (this.k == null || this.k.length != paramInt2) this.k = new String[paramInt2];
    if (this.l == null || this.l.length != paramInt1) this.l = new String[paramInt1];
    q();
    if (bool) f(paramInt1, paramInt2);
  }
  ...
  public boolean r() {
    for (byte b1 = 0; b1 < this.h.length; b1++) {
      for (byte b2 = 0; b2 < (this.h[0]).length; b2++) {
        if (!this.h[b1][b2].equals(this.i[b1][b2])) return true;
      }
    }
    return false;
  }
  ...
  public boolean b(int paramInt1, int paramInt2) {
    ...
    return (this.h[paramInt1][paramInt2] != null
        && this.i[paramInt1][paramInt2] != null
        && this.h[paramInt1][paramInt2].equals(this.i[paramInt1][paramInt2]));
  }

  public Double c(int paramInt1, int paramInt2) {
    return Double.valueOf(
        (this.i[this.i.length - 1 - paramInt1][paramInt2] != null)
            ? this.i[this.i.length - 1 - paramInt1][paramInt2].doubleValue()
            : Double.NaN);
  }
  ...
  public void a(Double[][] paramArrayOfDouble) {
    if (paramArrayOfDouble.length != this.h.length)
      System.out.println(
          "Clean values sizes don't match for BinTable, Don't know what to do with it");
  ...
  public Object[][] x() {
    ...
    for (byte b1 = 0; b1 < this.l.length; b1++) arrayOfObject[b1][0] = this.l[b1];
  ...
  public Object[][] y() {
    ...
    for (byte b1 = 0; b1 < this.l.length; b1++) {
      if (this.l[b1] != null)
        arrayOfObject[b1][0] =
            Double.valueOf((Double.parseDouble(this.l[b1]) - 100.0D) * 0.145038D);
    }
    return arrayOfObject;
  }
  ...
  public Double d(int paramInt1, int paramInt2) {
    return (this.f == 1 && this.j != null)
        ? this.j[this.j.length - 1 - paramInt1][paramInt2].i()
        : ((this.f == 3 && this.j != null)
            ? this.j[this.j.length - 1 - paramInt1][paramInt2].f()
            : ((this.f == 2 && this.j != null)
                ? this.j[this.j.length - 1 - paramInt1][paramInt2].g()
                : this.h[this.h.length - 1 - paramInt1][paramInt2]));
  }
  ...
  public double a(double paramDouble1, double paramDouble2) {
    ...
    null = 0.0D;
    return this.h[i][j].doubleValue() * (1.0D - d2) * (1.0D - d1)
        + this.h[i][m].doubleValue() * d2 * (1.0D - d1)
        + this.h[k][j].doubleValue() * (1.0D - d2) * d1
        + this.h[k][m].doubleValue() * d2 * d1;
  }
  ...
  public void a(double[][] paramArrayOfdouble) {
    ...
    Double[][] arrayOfDouble =
        new Double[paramArrayOfdouble.length][(paramArrayOfdouble[0]).length];
  ...
  public void a(Object paramObject, int paramInt1, int paramInt2) {
    ...
    boolean bool =
        (this.h[paramInt1][paramInt2] != null
                && (this.h[paramInt1][paramInt2].doubleValue() == this.q
                    || this.h[paramInt1][paramInt2].doubleValue() == this.p))
            ? true
            : false;
    if (double_.doubleValue() > this.q) this.q = double_.doubleValue();
    if (double_.doubleValue() < this.p) this.p = double_.doubleValue();
  ...
  private boolean g(int paramInt1, int paramInt2) {
    for (t t : this.e) {
      if (t.b == paramInt2 && t.a == paramInt1) return true;
    }
    return false;
  }
    ...
    for (byte b1 = 0; b1 < this.h.length; b1++) {
      for (byte b2 = 0; b2 < (this.h[0]).length; b2++) {
        if (d(b1, b2) != null) {
          ...
          if (d > this.q) this.q = d;
          if (d < this.p) this.p = d;
        }
      }
    }
  }
  ...
  public String toString() {
    ...
    str = str + "    \t";
    for (b1 = 0; b1 < this.k.length; b1++) str = str + this.k[b1] + "\t";
    return str;
  }
    ...
    if (this.j == null) {
      ...
      for (byte b1 = 0; b1 < arrayOfB.length; b1++) {
        for (byte b2 = 0; b2 < (arrayOfB[0]).length; b2++) {
          ...
          double d2 =
              arrayOfString.length - fh.a(arrayOfString, Double.parseDouble(a()[b1])) - 1.0D;
      ...
      for (byte b1 = 0; b1 < arrayOfB.length; b1++) {
        for (byte b2 = 0; b2 < (arrayOfB[0]).length; b2++) {
          ...
          arrayOfB[arrayOfB.length - b1 - 1][b2].a(d(b1, b2).doubleValue());
          if (paramc != null) arrayOfB[arrayOfB.length - b1 - 1][b2].a(paramc);
          double d1 = fh.b(params.b(), Double.parseDouble(b()[b2]));
          double d2 =
              params.getRowCount() - fh.a(arrayOfString, Double.parseDouble(a()[b1])) - 1.0D;
          arrayOfB[arrayOfB.length - b1 - 1][b2].c(params.a(d2, d1));
        }
      }
    }
    ...
    if (this.j == null) {
      ...
      for (byte b1 = 0; b1 < arrayOfB.length; b1++) {
        for (byte b2 = 0; b2 < (arrayOfB[0]).length; b2++) {
          arrayOfB[arrayOfB.length - b1 - 1][b2] = new b(paramc);
          Double double_ = d(b1, b2);
          if (double_ == null) double_ = Double.valueOf(Double.NaN);
  ...
  public void c(int paramInt) {
    if (paramInt == 0 || paramInt == 1 || paramInt == 3 || paramInt == 2) this.f = paramInt;
  }
  ...
  public void f(int paramInt1, int paramInt2) {
    for (fa fa : this.s) fa.a(paramInt1, paramInt2);
  }
  ...
  public void b(float paramFloat1, float paramFloat2) {
    for (byte b1 = 0; b1 < this.l.length; b1++)
      this.l[this.l.length - b1 - 1] =
          X.b((paramFloat1 + b1 * (paramFloat2 - paramFloat1) / (this.l.length - 1)), 6);
  }
