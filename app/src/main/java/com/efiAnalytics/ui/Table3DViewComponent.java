...
public class Table3DViewComponent extends JComponent implements FocusListener {
  ...
  private String a(String paramString) {
    if (this.F != null) paramString = this.F.a(paramString);
    return paramString;
  }
  ...
  public void b(Graphics paramGraphics) {
    ...
    if (this.A) {
      eZ eZ1 =
          this.a.a(this.j.a(this.n), this.j.k() - 0.05D * (this.j.l() - this.j.k()), this.j.r());
      eZ eZ2 =
          this.a.a(this.j.i() - 0.05D * (this.j.j() - this.j.i()), this.j.b(this.o), this.j.r());
  ...
  private void a(
    ...
    if (paramBoolean) j = parameZ.b + 2 * paramGraphics.getFont().getSize() + 2;
    paramGraphics.setColor(color);
    paramGraphics.fill3DRect(
        i,
        j,
        getFontMetrics(paramGraphics.getFont()).stringWidth(paramString) + 3,
        paramGraphics.getFont().getSize() + 3,
        false);
    paramGraphics.setColor(paramColor);
    paramGraphics.drawString(
        paramString, i + 2, j + (int) (paramGraphics.getFont().getSize() * 0.9D) + 1);
  }
  ...
  private void a(
      Graphics paramGraphics, double paramDouble1, double paramDouble2, Color paramColor) {
    if (!I()) return;
  ...
  public void a(double paramDouble, int paramInt) {
    ...
    double d8 = d4 * d3;
    if (d5 >= paramDouble) a(i, j, paramInt * this.j.s());
    if (d6 >= paramDouble && j != m) a(i, m, paramInt * this.j.s());
    if (d7 >= paramDouble && i != k) a(k, j, paramInt * this.j.s());
    if (d8 >= paramDouble && j != m && i != k) a(k, m, paramInt * this.j.s());
  }
  ...
  private void j(int paramInt) {
    for (eU eU : this.C) eU.c(paramInt);
  }

  private void k(int paramInt) {
    for (eU eU : this.C) eU.d(paramInt);
  }
  ...
  public Image A() {
    if (this.e == null
        || this.e.getWidth(null) != getWidth()
        || this.e.getHeight(null) != getHeight()) {
  ...
  public void repaint() {
    if (this.g == null) this.g = new eQ(this);
    this.g.a();
  }
