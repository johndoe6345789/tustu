...
public class RegistrationManager extends A {
  ...
  public void a(Component paramComponent) {
    if ((this.a == null || !a(this.a.f())) && this.f > 0) b(paramComponent);
  }
  ...
  public boolean a(String paramString, int paramInt) {
    if (paramString == null || paramString.trim().equals("")) return false;
    if (this.a.a() == null || this.a.a().trim().equals("")) return false;
    if (this.a.e() == null) return false;
    if (this.a.b() == null || this.a.b().trim().equals("")) return false;
    if (this.a.c() == null || this.a.c().trim().equals("")) return false;
    String str = this.a.d();
    if (str == null
        || str.trim().equals("")
        || str.indexOf("@") < 1
        || str.indexOf(".") < 0
        || str.lastIndexOf(".") < str.indexOf("@")) return false;
    if (paramInt == 1) {
    ...
    if (a(this.a.l(), 2)) {
      ...
      if (str1 != null && str1.equals(paramString)) bool = true;
    }
