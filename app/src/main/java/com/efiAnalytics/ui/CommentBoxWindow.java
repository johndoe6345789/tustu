...
public class CommentBoxWindow extends JWindow {
  ...
  public CommentBoxWindow(Window paramWindow, String paramString, boolean paramBoolean) {
    ...
    this.h = paramBoolean;
    this.g = fp.c();
    if (!this.g) D.b("Translucent Windows not supported on this PC.");
    d();
    ...
    if (paramBoolean && !paramString.startsWith("<html")) paramString = "<html>" + paramString;
    if (paramBoolean) {
    ...
    if (paramBoolean) {
      this.d =
          Toolkit.getDefaultToolkit()
              .getImage(getClass().getResource("resources/commentBoxReadOnly.png"));
    } else {
      this.d =
          Toolkit.getDefaultToolkit().getImage(getClass().getResource("resources/commentBox.png"));
    }
  ...
  private void e() {
    ...
    while (iterator.hasNext()) ((fi) iterator.next()).a(this.a.getText());
  }

  private void f() {
    Iterator<fi> iterator = this.b.iterator();
    while (iterator.hasNext()) ((fi) iterator.next()).a();
  }
  ...
  private String a(String paramString) {
    ...
    for (byte b = 0; b < arrayOfString.length; b++) {
      ...
      if (b < arrayOfString.length - 1) stringBuilder.append("<br>");
    }
