...
public class CustomButton extends JComponent {
  ...
  public void paint(Graphics paramGraphics) {
    ...
    if (this.m && this.q != null) paramGraphics.drawImage(this.q, 0, 0, null);
    if (isEnabled() && this.i) {
      ...
      if (this.a != null) paramGraphics.drawString(this.a, this.v, k);
      ...
      paramGraphics.setColor(getForeground());
      if (this.a != null) paramGraphics.drawString(this.a, this.v - 1, k - 1);
      if (this.p != null)
        if (this.t == null) {
  ...
  private void a(Graphics paramGraphics, int paramInt) {
    ...
    paramGraphics.fillRect(
        getWidth() - this.w - 2 + paramInt, (getHeight() - this.w) / 2 + paramInt, this.w, this.w);
  }
      ...
      if (paramMouseEvent.getID() == 502) {
        if (this.j && this.i) {
          ...
          ActionEvent actionEvent =
              new ActionEvent(this, 1001, str, paramMouseEvent.getModifiers());
          a(actionEvent);
        }
        this.i = false;
        repaint(0L);
  ...
  private int e() {
    return (this.a == null || getParent() == null)
        ? 0
        : (this.y ? (((getSize()).width - getFontMetrics(getFont()).stringWidth(this.a)) / 2) : 5);
  }

  public void validate() {
    if (this.m && !isValid() && this.q != null) this.q = b();
    super.validate();
  ...
  public void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (this.m
        && this.q != null
        && this.s != null
        && (this.s.width < (getLocation()).x + (getSize()).width
            || this.s.height < (getLocation()).y + (getSize()).height)) this.q = b();
  }
