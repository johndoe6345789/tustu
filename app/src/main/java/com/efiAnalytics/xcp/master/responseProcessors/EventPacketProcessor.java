...
public class EventPacketProcessor implements BqInterfaceIndia {
  ...
  public void a(F paramF, BnInterfaceKilo paramk, BnInterfaceTango paramt) {
    if (paramt.a() != a())
      throw new ExceptionInBsPackage("PID:EVENT_PACKET Wrong handler! this handler is for 0x" + Integer.toHexString(a()).toUpperCase()); 
    ...
    if (arrayOfByte1.length < 1)
      throw new ExceptionInBsPackage("PID:EVENT_PACKET invalid packet data length, expected at least 2 byte, found: " + (arrayOfByte1.length + 1)); 
