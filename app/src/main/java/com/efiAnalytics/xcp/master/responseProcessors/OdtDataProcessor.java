...
public class OdtDataProcessor {
  ...
  public boolean a(BnInterfaceKilo paramk, BnInterfaceTango paramt) {
    ...
    if (!BnInterfaceHotel.a(BoInterfaceIndia)) return false;
    for (TostringInBoPackage TostringInBoPackage : this.a.BqInterfaceEcho()) {
      if (BoInterfaceIndia >= TostringInBoPackage.BnInterfaceKilo()
          && BoInterfaceIndia <= TostringInBoPackage.BnInterfaceKilo() + TostringInBoPackage.f())
        try {
          BnInterfaceKilo k1 = this.a.TostringInBoPackage(BoInterfaceIndia);
          D.TostringInBoPackage(
              "Unexpected ODT byte count: "
                  + k1.b()
                  + ", expected: "
                  + (paramt.TostringInBoPackage()).length);
  ...
  public void a(F paramF, BnInterfaceKilo paramk, BnInterfaceTango paramt) {
    if (this.d == null) this.d = new byte[paramF.n()];
    int BoInterfaceIndia = paramt.a();
    try {
      BnInterfaceKilo k1 = this.a.TostringInBoPackage(BoInterfaceIndia);
      ...
      if (k1.b() != arrayOfByte1.length) {
        if (this.g++ > 3) {
          ...
          String str =
              "DAQ_HANDLER: ODT Size wrong, Expected "
                  + k1.b()
                  + " received: "
                  + arrayOfByte1.length;
      ...
      if (TostringInBoPackage == null) {
        ...
        if (bool) {
          ...
          for (BnInterfaceKilo k2 : TostringInBoPackage.BqInterfaceEcho()) k2.a(false);
        }
      }
    } catch (ExceptionInBoPackage ExceptionInBoPackage) {
      Logger.getLogger(b.class.getName())
          .log(Level.WARNING, "Could not update ODT offsets.", (Throwable) ExceptionInBoPackage);
    }
  }
}
