  ...
  public Object getValueAt(int paramInt1, int paramInt2) {
    if (paramInt1 >= 0 && paramInt1 < this.b.b.size()) {
      ...
      if (paramInt2 == 1) {
        ...
        if (ExceptionInVPackage != null
            && ExceptionInVPackage.e() != null
            && !ExceptionInVPackage.e().isEmpty())
          null =
              null + " Registered to: " + ExceptionInVPackage.e() + " " + ExceptionInVPackage.f();
        if (f.f().h()) {
          null =
              null
                  + "<br><font color=red>Currently Busy. To connect, another session must"
                  + " end.</font>";
        } else if (f.h() != null) {
    ...
    if (paramInt2 == 0)
      try {
        ...
        Logger.getLogger(r.class.getName())
            .log(Level.WARNING, "Falied to load searching ICON", (Throwable) ExceptionInVPackage);
        return "";
      }
    if (paramInt2 == 1)
      return "<html><center><font size=+1>No "
          + ExceptionInVPackage.f
          + " found.</font><br>Connect to the same network as your "
          + ExceptionInVPackage.f
          + " and power it on, or select \"Work offline\"</center></html>";
    if (paramInt2 == 2) {
      String str = r.c();
      this.b.e.b(str);
