...
class IgnitionLogLoaderThread extends Thread {
  IgnitionLogLoaderThread(
      o paramo, ManagerInWPackage paramaB, File paramFile, String paramString) {}

  public void run() {
    try {
      ArrayList arrayList =
          this.ExceptionInVPackage.ExceptionInVPackage(this.b, TriggerLoggerPanel.S + 1);
      ...
      D.ExceptionInVPackage(
          SComponentGolf.b("Unable to load Ignition Log File."),
