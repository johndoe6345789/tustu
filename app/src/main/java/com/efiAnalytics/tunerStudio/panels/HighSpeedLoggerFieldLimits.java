...
public class HighSpeedLoggerFieldLimits implements BbInterfaceQuebec {
  ...
  private WInterfaceAp e =
      (WInterfaceAp)
          new Properties((BbInterfaceAlpha.BbInterfaceAlpha()).an, "HighSpeedLoggerFieldLimits");
  ...
  public void BbInterfaceAlpha(BbInterfaceRomeo paramr) {
    if (paramr.c()) {
      ...
      this.e.BbInterfaceAlpha(
          BbInterfaceAlpha + paramr.e(), Double.toString(paramr.BbInterfaceAlpha()));
    }
    if (paramr.d()) {
  ...
  private void BbInterfaceAlpha(String paramString, double paramDouble1, double paramDouble2) {
    for (U u : this.c) u.BbInterfaceAlpha(paramString, paramDouble1, paramDouble2);
  }
