...
public class TuneViewComponentLayout implements LayoutManager2 {
  ...
  public void layoutContainer(Container paramContainer) {
    synchronized (paramContainer.getTreeLock()) {
      ...
      if (this.c != null) this.c.setBounds(k, i, m - k, j - i);
      if (this.a.isEditMode() && this.a.isShieldedDuringEdit()) {
        ...
        if (this.a.getBtnSelectEcuConfig() != null) {
          ...
          this.a
              .getBtnSelectEcuConfig()
              .setBounds(this.a.getWidth() - dimension.width, 0, dimension.width, dimension.height);
        }
      } else {
  ...
  public void addLayoutComponent(String paramString, Component paramComponent) {
    if (this.a.getBtnSelectEcuConfig() == null
        || !this.a.getBtnSelectEcuConfig().equals(paramComponent)) this.c = paramComponent;
  }

  public void removeLayoutComponent(Component paramComponent) {
    if (this.c != null && this.c.equals(paramComponent)) this.c = null;
  }
