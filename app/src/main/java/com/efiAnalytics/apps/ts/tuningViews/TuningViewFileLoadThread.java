  ...
  public void run() {
    ...
    try {
      ...
      if (f1 == null) {
        ...
        this.b.e(
            SComponentGolf.b(
                "This Tuning View contains Password Protected Information. You must have the"
      ...
      bV.d(
          "Failed to load Tune View File:\n"
              + ((this.ExceptionInVPackage.ExceptionInVPackage() != null)
                  ? this.ExceptionInVPackage.ExceptionInVPackage().getAbsolutePath()
                  : "null")
              + "\nError:\n"
