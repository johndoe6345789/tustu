...
public class DashLabel extends s implements Serializable {
  ...
  public void setText(String paramString) {
    try {
      ...
      Logger.getLogger(DashLabel.class.getName())
  ...
  protected Font getTextFont() {
    String str2;
    if (this.ExceptionPrintstacktrace != null && sameSize()) return this.ExceptionPrintstacktrace;
    this.c = getSize();
    ...
    if (font.canDisplayUpTo(str2) >= 0) font = cq.a().a("", b + 1, i);
    while (true) {
