...
public class HorizontalBarPainter implements GaugePainter {
  ...
  public void paintGauge(Graphics paramGraphics, s params) {
    ...
    if (gauge.isCounterClockwise()) {
      ...
      paramGraphics.drawImage(
          image, gauge.getWidth(), 0, -gauge.getWidth(), gauge.getHeight(), null);
    } else {
  ...
  protected void paintBar(Graphics paramGraphics, Gauge paramGauge) {
    ...
    if (paramGauge.backgroundImage() != null) {
      ...
      if (this.bgOffImage == null
          || this.bgOffImage.getWidth() != paramGauge.getWidth()
          || this.bgOffImage.getHeight() != paramGauge.getHeight())
        this.bgOffImage =
            cN.a(
                cN.a(image),
                paramGauge.getWidth(),
