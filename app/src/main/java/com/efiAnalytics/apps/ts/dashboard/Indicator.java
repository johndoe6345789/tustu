...
public class Indicator extends SingleChannelDashComponent implements ImageObserver, Serializable {
  ...
  public String onText() {
    try {
      String str = this.i.a();
      if (this.b != null && str.equals(this.b)) return this.d;
      this.b = str;
  ...
  public String offText() {
    try {
      String str = this.j.a();
      if (this.c != null && str.equals(this.c)) return this.f;
      this.c = str;
  ...
  public void paint(Graphics paramGraphics) {
    if (this.p != null && getWidth() > 0 && getHeight() > 0) this.p.paintGauge(paramGraphics, this);
    if (isInvalidState()) paintInvalid(paramGraphics);
    setDirty(false);
  }

  public void paintInvalid(Graphics paramGraphics) {
    if (getOffBackgroundColor().getRed() > 220
        && getOffBackgroundColor().getBlue() < 92
        && getOffBackgroundColor().getGreen() < 92) {
  ...
  public void update(Graphics paramGraphics) {
    if (this.p != null) this.p.updateGauge(paramGraphics, this);
  }

  public void invalidate() {
    if (this.p != null) this.p.invalidate();
    super.invalidate();
  }
  ...
  private void callRepaint() {
    if (getParent() instanceof ac) ((ac) getParent()).a(this);
  }
  ...
  public void paintBackground(Graphics paramGraphics) {
    if (this.p != null) this.p.paintBackground(paramGraphics, this);
  }
