...
public class TableCellCrossHair extends TuneViewComponent implements t {
  ...
  private void setSelectedTable(String paramString) {
    ...
    if (ArrayListExceptionprintstacktraceInGPackage != null) {
      ...
      try {
        this.i =
            ManagerBfcomponentcharlie.ExceptionInVPackage().ExceptionInVPackage(r, paramString);
        if (this.i == null) throw new ExceptionInVPackage("Unknown Table: " + paramString);
  ...
  private void setXValues(double paramDouble) {
    ...
    if (d1 >= ((this.i.b()).length - 2)) {
      double d =
          (Double.parseDouble(this.i.b()[(this.i.b()).length - 1])
                  - Double.parseDouble(this.i.b()[(this.i.b()).length - 2]))
              / 2.0D;
  ...
  private void setYValues(double paramDouble) {
    ...
    if (d1 >= ((this.i.ExceptionInVPackage()).length - 2)) {
      double d =
          (Double.parseDouble(
                      this.i.ExceptionInVPackage()[(this.i.ExceptionInVPackage()).length - 2])
                  - Double.parseDouble(
                      this.i.ExceptionInVPackage()[(this.i.ExceptionInVPackage()).length - 1]))
              / 2.0D;
      d3 =
          Double.parseDouble(
                  this.i.ExceptionInVPackage()[(this.i.ExceptionInVPackage()).length - 1])
      ...
      double d =
          (Double.parseDouble(this.i.ExceptionInVPackage()[0])
                  - Double.parseDouble(this.i.ExceptionInVPackage()[1]))
              / 2.0D;
      ...
      d4 = Double.parseDouble(this.i.ExceptionInVPackage()[this.n]);
      double d5 =
          (d4 - Double.parseDouble(this.i.ExceptionInVPackage()[(int) Math.floor(j) + 1])) / 2.0D;
      double d6 =
          (Double.parseDouble(this.i.ExceptionInVPackage()[(int) Math.floor(j) - 1]) - d4) / 2.0D;
      d3 = d4 + d6;
      d2 = d4 - d5;
    }
    this.c.d(d3);
