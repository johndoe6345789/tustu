...
public class SelectableTableComponent extends SingleChannelDashComponent
    implements t, ay, Serializable {
  ...
  private void addTableSelector() {
    if (this.a == null) {
      if (this.b == null) setEcuConfigurationName(getEcuConfigurationName());
      this.a = new SelectableTablePanel(this.b);
      this.a.a(3);
      this.a.a(this);
      if (this.c != null) this.a.a(this.c);
      if (this.c != null) setSelectedTableName(this.c);
  ...
  public void repaint(long paramLong, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    System.out.println(
        "SelectablTableComponent::Repaint: x="
            + paramInt1
            + ", y="
            + paramInt2
            + ", w="
