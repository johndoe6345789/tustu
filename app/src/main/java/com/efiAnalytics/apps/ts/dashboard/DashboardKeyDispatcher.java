...
public class DashboardKeyDispatcher implements KeyEventDispatcher {
  ...
  public boolean dispatchKeyEvent(KeyEvent paramKeyEvent) {
    if (!this.b.L() || !a(paramKeyEvent.getSource())) return false;
    if (paramKeyEvent.getID() == 401) {
      ...
      if (this.b.L()) {
        if (paramKeyEvent.getModifiers() == 2 && paramKeyEvent.getKeyCode() == 67) x.i(this.b);
        if (paramKeyEvent.getModifiers() == 2 && paramKeyEvent.getKeyCode() == 86) x.j(this.b);
  ...
  private boolean a(Object paramObject) {
    ...
    while (container != null) {
      if (container.equals(paramObject)
          || (x.f(this.b) != null
              && container.equals(x.f(this.b))
              && x.g(this.b).contains(paramObject))) return true;
      container = container.getParent();
      if (container instanceof java.awt.Window) return false;
    }
