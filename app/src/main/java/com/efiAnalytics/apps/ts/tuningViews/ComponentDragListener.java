...
class ComponentDragListener extends MouseAdapter implements MouseMotionListener {
  ...
  public void mousePressed(MouseEvent paramMouseEvent) {
    try {
      if (!this.e.isEnabled()) return;
      this.d = a(paramMouseEvent);
      if (this.d == null) return;
      Point point =
          (this.d.getParent() != null)
              ? this.d.getParent().getMousePosition()
              : this.d.getMousePosition();
      if (point == null) return;
      if (paramMouseEvent.getButton() == 1 || paramMouseEvent.getButton() == 3) {
        boolean bool = ((paramMouseEvent.getModifiers() & 0x2) != 2) ? true : false;
        if (!this.e.c(this.d) || !bool) this.e.a(this.d, bool);
      }
      if (paramMouseEvent.getButton() == 3
          && !(this.d
              instanceof com.efiAnalytics.apps.ts.tuningViews.tuneComps.TuneViewGaugeCluster)) {
      ...
      this.c =
          (this.a.size() == 1
              && ((Integer) this.a.get(0)).intValue() > this.d.getWidth() - J.c(this.e)
              && ((Integer) this.b.get(0)).intValue() > this.d.getHeight() - J.c(this.e));
    } finally {
  ...
  public void mouseReleased(MouseEvent paramMouseEvent) {
    ...
    if (tuneViewComponent == null) return;
    if (this.c) {
  ...
  public void mouseExited(MouseEvent paramMouseEvent) {
    ...
    if (tuneViewComponent != null
        && tuneViewComponent.hasFocus()
        && this.e.getCursor().getType() != 0) this.e.setCursor(Cursor.getDefaultCursor());
  }

  public void mouseDragged(MouseEvent paramMouseEvent) {
    if (!this.e.B() && paramMouseEvent.getSource() instanceof TuneViewComponent)
      this.e.dispatchEvent(paramMouseEvent);
    if (!this.e.isEnabled() || !this.e.B()) return;
    if (this.c) {
      int i = 0;
      int j = 0;
      TuneViewComponent tuneViewComponent = a(paramMouseEvent);
  ...
  public void mouseMoved(MouseEvent paramMouseEvent) {
    if (!this.e.isEnabled()) return;
    TuneViewComponent tuneViewComponent = (this.d != null) ? this.d : a(paramMouseEvent);
    if (J.b(this.e).size() == 1
        && J.b(this.e).contains(tuneViewComponent)
        && paramMouseEvent.getX() > tuneViewComponent.getWidth() - J.c(this.e)
        && paramMouseEvent.getY() > tuneViewComponent.getHeight() - J.c(this.e)) {
  ...
  private TuneViewComponent a(MouseEvent paramMouseEvent) {
    Component component;
    for (component = (Component) paramMouseEvent.getSource();
        !(component instanceof TuneViewComponent) && component.getParent() != null;
        component = component.getParent())
      ;
    return (component instanceof TuneViewComponent)
        ? (TuneViewComponent) component
        : this.e.a(
            component.getX() + paramMouseEvent.getX(), component.getY() + paramMouseEvent.getY());
  }
}
