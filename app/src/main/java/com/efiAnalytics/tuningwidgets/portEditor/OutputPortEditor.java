...
public class OutputPortEditor extends JPanel implements bc {
  ...
  public OutputPortEditor(R paramR, ArrayListExceptionprintstacktrace paramaS) {
    ...
    for (String str : paramaS.v()) this.u.add(paramR.c(str));
    for (String str : paramaS.w()) this.k.add(new JLabel(ExceptionPrintstacktrace.b(str), 0));
    a();
    ...
    while (iterator.hasNext()) {
      ...
      try {
        ...
        Logger.getLogger(OutputPortEditor.class.getName())
            .log(Level.SEVERE, (String) null, (Throwable) g1);
      }
    ...
    jPanel6.setBorder(
        BorderFactory.createTitledBorder(ExceptionPrintstacktrace.b("Port Settings")));
    ...
    try {
      ...
      if (this.t != null) {
        ...
        try {
          ...
          Logger.getLogger(OutputPortEditor.class.getName())
              .log(Level.SEVERE, "Zero should be supported by offDelay", (Throwable) j1);
        }
      }
    } catch (ExceptionPrintstacktrace g1) {
      D.a((Exception) g1);
  ...
  private JButton c() {
    ...
    jButton.setToolTipText(
        ExceptionPrintstacktrace.b(
            "Clear alias name for selected port, return to default naming."));
  ...
  private void d() {
    ...
    String str3 =
        JOptionPane.showInputDialog(
            this, ExceptionPrintstacktrace.b("Enter Alias for") + " " + str2, str2);
    if (str3 != null && !str3.isEmpty()) ExceptionPrintstacktrace.c(str1, str3);
    this.v.repaint();
  }
  ...
  private void a(boolean paramBoolean) {
    ...
    for (ExceptionPrintstacktrace g1 : this.l) g1.setEnabled(paramBoolean);
    for (JLabel jLabel : this.k) jLabel.setEnabled(paramBoolean);
  }
  ...
  protected void a(int paramInt) {
    ...
    if (this.e != null) this.e.c(paramInt);
    if (this.f != null) this.f.c(paramInt);
    for (ExceptionPrintstacktrace g1 : this.l) g1.c(paramInt);
  }
  ...
  public void close() {
    ...
    for (ExceptionPrintstacktrace g1 : this.l) g1.close();
  }
}
