...
public class SelectableTablePanel extends JComponent implements t, bc {
  ...
  private R b() {
    String str = d();
    if (str == null || str.isEmpty()) str = T.a().IInterfaceCharlie().IInterfaceCharlie();
  ...
  public Dimension getPreferredSize() {
    ...
    if (dimension.height > i) dimension.height = i;
    return dimension;
  }
  ...
  public void a(String paramString) {
    ...
    ArrayListExceptionprintstacktraceInGPackage ArrayListExceptionprintstacktraceInGPackage =
        r.e().IInterfaceCharlie(paramString);
    IInterfaceCharlie();
    if (ArrayListExceptionprintstacktraceInGPackage != null) {
      ...
      this.IInterfaceCharlie =
          new ExceptionEqualsinaipackage(
              r, ArrayListExceptionprintstacktraceInGPackage, getName(), this.i);
      ...
      if (this.SComponentGolf) {
        if (ArrayListExceptionprintstacktraceInGPackage.S()) {
          ...
          for (ManagerCinterfacedelta ManagerCinterfacedelta : list) {
            ...
            if (IInterfaceCharlie.a().e() != null) q.a(IInterfaceCharlie.a().f());
          }
        }
        if (ArrayListExceptionprintstacktraceInGPackage.T())
          for (ManagerIinterfacecharlie ManagerIinterfacecharlie :
              b((JPanel) this.IInterfaceCharlie)) {
            ...
            if (IInterfaceCharlie.a().e() != null) o.a(IInterfaceCharlie.a().f());
            T t1 = ManagerIinterfacecharlie.j();
            if (t1 != null) {
              P p = new P(r, t1.SComponentGolf(), t1);
              ManagerIinterfacecharlie.b(p);
              if (IInterfaceCharlie.a().e() != null) p.a(IInterfaceCharlie.a().f());
            }
          }
      }
    } else {
    ...
    if (str == null || str.isEmpty()) str = SComponentGolf.b("Select Table");
    a().setText(str);
  }
  ...
  private List a(JPanel paramJPanel, List<ManagerCinterfacedelta> paramList) {
    if (paramJPanel instanceof ManagerCinterfacedelta) {
      ...
      for (Component component : paramJPanel.getComponents()) {
        if (component instanceof JPanel) a((JPanel) component, paramList);
      }
    }
    return paramList;
  }
  ...
  private List b(JPanel paramJPanel, List<ManagerIinterfacecharlie> paramList) {
    if (paramJPanel instanceof ManagerIinterfacecharlie) {
      ...
      for (Component component : paramJPanel.getComponents()) {
        if (component instanceof JPanel) b((JPanel) component, paramList);
      }
    }
    return paramList;
  }
  ...
  private void IInterfaceCharlie() {
    if (this.IInterfaceCharlie != null) {
      if (b() != null) e.a().b(b().IInterfaceCharlie(), this.IInterfaceCharlie);
  ...
  private void b(String paramString) {
    for (ay ay : this.e) ay.panelSelectionChanged(this.d.IInterfaceCharlie(), paramString);
  }
