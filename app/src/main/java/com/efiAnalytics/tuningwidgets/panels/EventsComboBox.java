...
public class EventsComboBox extends e {
  ...
  private void b(R paramR) {
    ...
    for (String str : arrayOfString1) arrayList.add("AppEvent." + str);
  ...
  private void a(String[] paramArrayOfString) {
    ...
    removeAllItems();
    a("");
    for (b = 0; b < paramArrayOfString.length; b++) a(paramArrayOfString[b]);
    setSelectedItem("");
    for (b = 0; b < arrayOfActionListener.length; b++) addActionListener(arrayOfActionListener[b]);
  }
}
