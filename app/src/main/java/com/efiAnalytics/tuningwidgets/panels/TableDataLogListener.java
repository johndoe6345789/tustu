...
public class TableDataLogListener implements BtInterfaceBp, ExceptionInVPackage {
  ...
  public TableDataLogListener(R paramR, CloneableImpl parambe, p paramp) {
    ...
    if (this.d == null
        && parambe.d() != null
        && parambe.d().equals("rpm")
        && paramR.g("RpmHiRes") != null)
      this.d = ExceptionprintstacktraceInGPackage.j(paramR, "RpmHiRes");
    if (this.d == null && parambe.g() != null && paramR.g(parambe.g()) != null)
      this.d = parambe.g();
    if (this.d == null) D.b("No Data Log field defined for X axis of table: " + parambe.aL());
    if (paramR.IInterfaceCharlie("LKUP_PARAMETER") != null
        && paramR.IInterfaceCharlie("LOAD_AXIS_SCALE") != null) {
      this.i = new TableParameterChangeListener(this);
      try {
        ManagerUsingConcurrentHashMap.ExceptionInVPackage()
            .ExceptionInVPackage(paramR.IInterfaceCharlie(), "LKUP_PARAMETER", this.i);
        ManagerUsingConcurrentHashMap.ExceptionInVPackage()
            .ExceptionInVPackage(paramR.IInterfaceCharlie(), "LOAD_AXIS_SCALE", this.i);
      } catch (ExceptionInVPackage a1) {
        Logger.getLogger(TableDataLogListener.class.getName())
            .log(Level.SEVERE, (String) null, (Throwable) a1);
      }
    }
  }
  ...
  public void b(int paramInt) {
    if (IInterfaceCharlie.ExceptionInVPackage().e() == null) return;
  ...
  private void IInterfaceCharlie() {
    ...
    if (n == null) {
      ...
      if (this.g != null
          && !this.g.equals("UNINITIALIZED")
          && Manager.p() != null
          && this.g != null
          && this.g.equals(Manager.p())
          && this.i == null) return;
      if (Manager != null) {
        this.g = Manager.p();
      } else {
    ...
    if (this.e == null
        && this.IInterfaceCharlie.h() != null
        && this.b.g(this.IInterfaceCharlie.h()) != null) this.e = this.IInterfaceCharlie.h();
    if (this.e == null) this.e = "MAP";
    if (n != null) {
      ...
      if (aM1 != null
          && aM2 != null
          && this.IInterfaceCharlie.f() != null
          && this.IInterfaceCharlie.f().equals("Load")) {
        try {
          ...
          if (str1 != null && str1.contains("TPS") && n.ExceptionInVPackage("TPS") != null) {
            ...
            if (str2.toLowerCase().contains("psi")
                && n.ExceptionInVPackage("PRESS_BOOST") != null) {
              this.e = "PRESS_BOOST";
            } else if (str2.toLowerCase().contains("psi")
                && n.ExceptionInVPackage("BOOST_PSI") != null) {
              this.e = "BOOST_PSI";
          ...
          || (this.e.equals("Load") && j.e() == j.f())
          || (Manager != null
              && Manager.p() != null
              && !Manager.p().isEmpty()
              && j.n() != null
              && !j.n().isEmpty()
              && !j.n().equalsIgnoreCase(Manager.p()))) {
