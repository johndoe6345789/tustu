...
class TriggerConditionPanel extends JPanel {
  ...
  public TriggerConditionPanel(
      SComponentGolf paramg, R paramR, boolean paramBoolean1, boolean paramBoolean2) {
  ...
  public void a(String paramString) {
    if (paramString == null || paramString.trim().equals("")) paramString = SComponentGolf.q;
  ...
  public String a() {
    if (this.a.isSelected()) return SComponentGolf.q;
    ...
    if (this.b.isSelected()) {
      StringBuilder stringBuilder = new StringBuilder();
      stringBuilder
          .append(this.RInterfaceIndia.getSelectedItem().toString())
          .append(" ")
          .append(this.f.getSelectedItem().toString())
          .append(" ")
          .append(this.h.getText());
      return stringBuilder.toString();
    }
