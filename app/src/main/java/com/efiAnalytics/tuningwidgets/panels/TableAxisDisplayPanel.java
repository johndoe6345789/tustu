...
public class TableAxisDisplayPanel extends JPanel implements GComponentCq, bc, TableModelListener {
  ...
  public TableAxisDisplayPanel(R paramR, s params, String paramString) {
    ...
    if (this.b != null) this.f.b(this.b.v());
    ...
    add("West", jPanel);
    if (params.w() != null) this.g.setText(this.i);
    if (params.v() != null) {
      String str;
      if (this.b != null) {
        str = this.h;
        if (this.b.p() != null && !this.b.p().equals("")) str = str + " " + this.b.p();
    ...
    if (paramR != null)
      try {
        ManagerUsingArrayList.ExceptionInVPackage()
            .ExceptionInVPackage(paramR.c(), CloneableImpl.f(), this);
        ManagerUsingArrayList.ExceptionInVPackage()
            .ExceptionInVPackage(paramR.c(), CloneableImpl.d(), this);
      } catch (ExceptionInVPackage ExceptionInVPackage) {
        D.ExceptionInVPackage(
            "Unable to subscribe x or y axis for hightlights.",
