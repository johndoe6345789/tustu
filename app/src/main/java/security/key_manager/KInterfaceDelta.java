...
public class KInterfaceDelta {
  public static double a(
      double[][] paramArrayOfdouble1, double[][] paramArrayOfdouble2, double paramDouble) {
    double d1 = a(paramArrayOfdouble1, paramDouble);
    int i = (int) Math.floor(d1);
    double d2 = d1 - i;
    if (d2 == 0.0D) return paramArrayOfdouble2[i][0];
  ...
  public static double[] a(R paramR, Manager paramaM) {
    ...
    for (byte b = 0; b < arrayOfDouble.length; b++) arrayOfDouble[b] = arrayOfDouble1[b][0];
