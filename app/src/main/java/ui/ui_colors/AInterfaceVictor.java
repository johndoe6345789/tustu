...
public class AInterfaceVictor {
  ...
  private String c(String paramString) {
    String str = "MSCommDriver.";
    if (T.a().c() != null && !T.a().c().c().equals(paramString)) str = str + paramString + ".";
    return str;
  }
  ...
  public static String b() {
    ...
    if (str == null || str.isEmpty()) str = "UnknownHost";
    return str;
  }
  ...
  private void b(String paramString1, String paramString2) {
    if (this.d != null) this.d.a(paramString1, paramString2);
  }
