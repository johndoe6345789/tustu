...
public class AlComponentFoxtrot {
  ...
  public AlComponentFoxtrot(
      SeekableByteChannel paramSeekableByteChannel,
      AmInterfaceEcho parame,
      AmInterfaceCharlie paramc) {
  ...
  private ByteBuffer b() {
    if (this.d == null) {
      AbstractUsingSeekableByteChannel AbstractUsingSeekableByteChannel =
          this.AbstractUsingSeekableByteChannel.AmInterfaceGolf();
      if (AbstractUsingSeekableByteChannel instanceof am.f) {
        ...
        this.AmInterfaceCharlie =
            AmInterfaceGolf.b(this.AmInterfaceGolf, this.k[this.AmInterfaceEcho++]);
