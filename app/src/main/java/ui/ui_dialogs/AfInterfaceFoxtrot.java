...
public class AfInterfaceFoxtrot implements n {
    ...
    for (byte b = 0; b < list.size(); b++) {
      try {
        ...
        if (AdInterfaceAlpha.AdInterfaceAlpha().size() > 0) {
          ...
          if (str.contains("ms3.s19")
              || str.contains("ms3pro-ult.s19")
              || str.contains("ms3pro-evo.s19")
              || str.contains("ms3pro-mini.s19")
              || str.contains("ms3pro-mini.s19")
              || str.contains("ms3pro-mini-plus.s19")
              || str.contains("ms3pro-competition.s19")
              || str.contains("ms3pro-comp.s19")
              || str.contains("ms3pro-plus.s19")
              || str.contains("ms3pro.s19")) return true;
        ...
        Logger.getLogger(ExceptionInAdPackage.class.getName())
            .log(Level.SEVERE, (String) null, (Throwable) ExceptionInAdPackage);
      }
    }
  ...
  public boolean AdInterfaceAlpha(AeInterfaceMike paramm, File paramFile) {
    return paramFile.getName().equals("ms3pro.s19")
        ? (((paramm.b() & AeInterfaceOscar.B) > 0))
        : (paramFile.getName().equals("ms3pro-evo.s19")
            ? (((paramm.b() & AeInterfaceOscar.J) > 0))
            : (paramFile.getName().equals("ms3pro-ult.s19")
                ? (((paramm.b() & AeInterfaceOscar.K) > 0))
                : (paramFile.getName().equals("ms3pro-mini.s19")
                    ? (((paramm.b() & AeInterfaceOscar.L) > 0))
                    : ((paramFile.getName().equals("ms3pro-mini-plus.s19")
                            || paramFile.getName().equals("ms3pro-competition.s19")
                            || paramFile.getName().equals("ms3pro-comp.s19"))
                        ? (((paramm.b() & AeInterfaceOscar.N) > 0))
                        : ((paramFile.getName().equals("ms3pro-mod2.s19")
                                || paramFile.getName().equals("ms3pro-plus.s19"))
                            ? (((paramm.b() & AeInterfaceOscar.M) > 0))
                            : (paramFile.getName().equals("ms3.s19")
                                ? (((paramm.b() & AeInterfaceOscar.B) == 0
                                    && (paramm.b() & AeInterfaceOscar.J) == 0
                                    && (paramm.b() & AeInterfaceOscar.K) == 0
                                    && (paramm.b() & AeInterfaceOscar.L) == 0
                                    && (paramm.b() & AeInterfaceOscar.M) == 0
                                    && (paramm.b() & AeInterfaceOscar.x) > 0))
                                : false))))));
  }
  ...
  public AdInterfaceDelta AdInterfaceAlpha(
    ...
    try {
      ...
      SerializableImplInJPackage SerializableImplInJPackage =
          new SerializableImplInJPackage(this, bool, h);
  ...
  private List AdInterfaceAlpha(AdInterfaceAlpha parama) {
    ...
    for (AdInterfaceDelta AdInterfaceDelta : parama.b()) {
      if (AdInterfaceDelta.AdInterfaceDelta() > 2097152
          && AdInterfaceDelta.AdInterfaceDelta() < 8126464) {
        ...
        if (l == null) l = (l) hashMap.get(Integer.valueOf(i));
        l.AdInterfaceAlpha(AdInterfaceDelta.AdInterfaceDelta());
      }
    }
    return arrayList;
  ...
  public String AdInterfaceAlpha(File paramFile) {
    return paramFile.getName().equalsIgnoreCase("ms3pro.s19")
        ? AeInterfaceOscar.l
        : (paramFile.getName().equalsIgnoreCase("ms3pro-ult.s19")
            ? AeInterfaceOscar.n
            : (paramFile.getName().equalsIgnoreCase("ms3pro-evo.s19")
                ? AeInterfaceOscar.AeInterfaceMike
                : (paramFile.getName().equalsIgnoreCase("ms3pro-mini.s19")
                    ? AeInterfaceOscar.AeInterfaceOscar
                    : ((paramFile.getName().equals("ms3pro-mini-plus.s19")
                            || paramFile.getName().equals("ms3pro-competition.s19")
                            || paramFile.getName().equals("ms3pro-comp.s19"))
                        ? AeInterfaceOscar.IOInAePackage
                        : ((paramFile.getName().equalsIgnoreCase("ms3pro-mod2.s19")
                                || paramFile.getName().equals("ms3pro-plus.s19"))
                            ? AeInterfaceOscar.q
                            : (paramFile.getName().equalsIgnoreCase("ms3.s19")
                                ? AeInterfaceOscar.FileUsingHashMap
                                : ""))))));
  }
  ...
  public List b(AeInterfaceMike paramm) {
    ...
    } else if ((paramm.b() & AeInterfaceOscar.B) == 0
        && (paramm.b() & AeInterfaceOscar.J) == 0
        && (paramm.b() & AeInterfaceOscar.K) == 0
        && (paramm.b() & AeInterfaceOscar.L) == 0
        && (paramm.b() & AeInterfaceOscar.M) == 0
