...
public class AkInterfaceQuebec extends S {
  public AkInterfaceQuebec() {
    super(",", false);
  }
  ...
  public Iterator b() {
    while (this.g.isEmpty()) {
      ...
      if (str.startsWith("Date,Time,")) {
        ...
        arrayList1.add("Date");
        arrayList1.add("Time");
        for (String str1 : str.split(Pattern.quote("\",\""))) arrayList1.add(str1);
      }
      for (String str1 : arrayList1) {
        ...
        while (str1.contains("  ")) str1 = X.b(str1, "  ", " ");
        if (str1.equals("Time")) {
        ...
        str1 = str1.trim();
        String str3 = str1;
        for (byte b = 0; b < 100 && i(str3); b++) str3 = str1 + b;
        str1 = str3;
