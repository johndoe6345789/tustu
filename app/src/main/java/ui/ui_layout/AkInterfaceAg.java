    ...
    if (this.c > 0) {
      ...
      switch (this.b) {
        case 0:
          ...
          for (b = 0; b < this.c; b++) {
            this.d[b] =
                ByteBuffer.wrap(paramaf.s.m.f.o.e, this.u, 8)
                    .order(paramaf.s.m.f.o.k ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN)
                    .getDouble();
            this.u += 8;
          }
        case 11:
      ...
      throw new IllegalArgumentException(
          "Channel conversion type " + paramaf.l.b + " is not supported");
    }
  }
}
