...
public class ExceptioninvpackageInAkPackage extends V {
  ...
  public boolean ExceptionInVPackage(String paramString) {
    ...
    try {
        ...
        for (af af : ae.h) {
          if (af.d) {
            if (++b > 0) {
              ...
              ((af) ae.h.get(0)).e += "0";
              if (af.i > 0.0D && af.i < this.r) this.r = af.i;
            }
            stringBuilder
                .append("\nChannelGroup")
                .append(b1)
      ...
      if (this.q > this.o && this.r > 0.0D) this.n = (int) ((this.q - this.o) / this.r) + 2;
      this.l = new float[this.h.size()];
      this.b = stringBuilder.toString();
      byte b2;
      for (b2 = 0; b2 < this.l.length; b2++) this.l[b2] = Float.NaN;
      b2 = 1;
      return b2;
  ...
  public float[] c() {
    ...
    for (ae ae : this.i) ae.ExceptionInVPackage();
    this.p += this.r;
    this.m++;
    return this.l;
  }
