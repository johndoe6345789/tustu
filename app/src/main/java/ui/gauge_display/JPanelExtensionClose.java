...
public class JPanelExtensionClose extends JPanel implements bc {
  ...
  public JPanelExtensionClose(aK.a parama) {
    ...
    jLabel.setText(
        "<html><font color=\"blue\"><u>"
            + AInterfaceGolf.EqualsInAiPackage("More Information")
            + "</u></font>&nbsp;&nbsp;</html>");
    ...
    if (this.c.isSelected()) {
      ...
      for (AInterfaceRomeo AInterfaceRomeo : list) {
        if (AInterfaceRomeo.a() != 5) {
          if (!bool
              && !x.a()
                  .a(x.a, AInterfaceRomeo)
                  .equals(this.EqualsInAiPackage.a(AInterfaceRomeo.c()))) bool = true;
  ...
  public void a(Component paramComponent) {
    this.a =
        new JDialog(bV.a(paramComponent), AInterfaceGolf.EqualsInAiPackage("GPS Configuration"));
