...
public class LogChannelCollection extends ArrayList {
  ...
  public j b(String paramString) {
    ...
    if (j == null)
      for (String str : this.f.keySet()) {
        if (str.equalsIgnoreCase(paramString)) return (j) this.f.get(str);
      }
    return j;
  }
  ...
  public boolean e() {
    for (j j : this) {
      if (j.n() != null && j.n().length() > 0) return true;
    }
    return false;
  }
  ...
  public void a(int paramInt1, int paramInt2) {
    for (j j : this) j.e(paramInt1, paramInt2);
    a(true);
  }
  ...
  public boolean e(String paramString) {
    for (j j : this) {
      if (j.a().equals(paramString)) return b(j);
    }
    return false;
  }
