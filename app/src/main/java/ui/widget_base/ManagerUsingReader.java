...
public class ManagerUsingReader extends Reader {
  private Reader a;
  ...
  public ManagerUsingReader(Reader paramReader, int paramInt) {
    super(paramReader);
    if (paramInt <= 0) throw new IllegalArgumentException("Buffer size <= 0");
    this.a = paramReader;
    this.b = new char[paramInt];
    this.d = this.c = 0;
  }

  public ManagerUsingReader(Reader paramReader) {
    this(paramReader, i);
  }

  private void b() {
    if (this.a == null) throw new IOException("Stream closed");
  }
  ...
  public int read(char[] paramArrayOfchar, int paramInt1, int paramInt2) {
    synchronized (this.lock) {
      ...
      if (paramInt1 < 0
          ...
          || paramInt2 < 0
          || paramInt1 + paramInt2 > paramArrayOfchar.length
          || paramInt1 + paramInt2 < 0) throw new IndexOutOfBoundsException();
  ...
  String a(boolean paramBoolean) {
    ...
    synchronized (this.lock) {
      ...
      while (true) {
        if (this.d >= this.c) c();
        if (this.d >= this.c) {
          if (stringBuffer != null && stringBuffer.length() > 0) return stringBuffer.toString();
          return null;
        }
        boolean bool1 = false;
        ...
        if (stringBuffer == null) stringBuffer = new StringBuffer(j);
  ...
  public long skip(long paramLong) {
    if (paramLong < 0L) throw new IllegalArgumentException("skip value is negative");
    synchronized (this.lock) {
      b();
      long l = paramLong;
      while (l > 0L) {
  ...
  public boolean ready() {
    synchronized (this.lock) {
      b();
      if (this.g) {
        if (this.d >= this.c && this.a.ready()) c();
        if (this.d < this.c) {
          if (this.b[this.d] == '\n') this.d++;
          this.g = false;
        }
  ...
  public void mark(int paramInt) {
    if (paramInt < 0) throw new IllegalArgumentException("Read-ahead limit < 0");
    synchronized (this.lock) {
      b();
      this.f = paramInt;
      this.e = this.d;
  ...
  public void reset() {
    synchronized (this.lock) {
      b();
      if (this.e < 0) throw new IOException((this.e == -2) ? "Mark invalid" : "Stream not marked");
      this.d = this.e;
      this.g = this.h;
    }
  }
