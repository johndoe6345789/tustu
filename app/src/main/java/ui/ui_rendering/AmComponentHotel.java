...
public class AmComponentHotel extends a {
  ...
  public a f() {
    if (this.h > 0L) {
      ...
      if (str.equals(j.b)) return j.b(this.a, this.h);
      if (str.equals(k.b)) return k.b(this.a, this.h);
  ...
  public static h a(SeekableByteChannel paramSeekableByteChannel) {
    ...
    if (h1.e() != 0) throw new IOException("HDBLOCK hd_flags!=0 not yet supported");
    byteBuffer.get();
