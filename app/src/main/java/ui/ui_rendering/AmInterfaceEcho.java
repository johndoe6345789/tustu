...
public class AmInterfaceEcho extends a {
  ...
  public a g() {
    if (this.f > 0L) {
      ...
      if (str.equals("##DT")) return g.b(this.a, this.f);
      if (str.equals("##DZ")) return null;
      if (str.equals(f.b)) return f.b(this.a, this.f);
      if (str.equals("##HL")) return null;
