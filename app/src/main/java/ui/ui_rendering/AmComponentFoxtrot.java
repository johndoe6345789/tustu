...
public class AmComponentFoxtrot extends a {
  ...
  public String toString() {
    return "DLBLOCK [lnkDlNext="
        + this.c
        + ", lnkDlData="
        + Arrays.toString(this.AbstractInAlPackage)
        + ", flags="
        + this.e
        + ", count="
        + this.f
  ...
  public static f b(SeekableByteChannel paramSeekableByteChannel, long paramLong) {
    ...
    if (f1.g()) f1.e(AbstractInAlPackage.e(byteBuffer));
    ...
    for (byte b3 = 0; b3 < arrayOfLong3.length; b3++) arrayOfLong3[b3] = arrayOfLong1[b3 + 1];
    f1.a(arrayOfLong3);
    return f1;
  }
}
