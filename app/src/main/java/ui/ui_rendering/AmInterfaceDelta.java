...
public class AmInterfaceDelta extends a {
  ...
  public a q() {
    if (this.i > 0L) {
      ...
      if (str.equals(j.b)) return j.b(this.a, this.i);
      if (str.equals(k.b)) return k.b(this.a, this.i);
  ...
  public static d b(SeekableByteChannel paramSeekableByteChannel, long paramLong) {
    ...
    for (byte b1 = 0; b1 < arrayOfLong1.length; b1++) arrayOfLong1[b1] = al.d.g(byteBuffer);
    ...
    for (byte b2 = 0; b2 < d1.k(); b2++) arrayOfLong2[b2] = arrayOfLong1[b2 + 8];
    d1.a(arrayOfLong2);
