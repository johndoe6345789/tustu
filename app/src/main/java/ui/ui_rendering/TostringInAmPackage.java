...
public class TostringInAmPackage extends a {
  ...
  private TostringInAmPackage(SeekableByteChannel paramSeekableByteChannel, long paramLong) {
  ...
  public String toString() {
    return "CCBLOCK [lnkTxName=" + this.c + ", lnkMdUnit=" + this.AbstractInAlPackage + ", lnkMdComment=" + this.e + ", lnkCcInverse=" + this.f + ", lnkCcRef=" + Arrays.toString(this.g) + ", type=" + this.h + ", precision=" + this.i + ", flags=" + this.j + ", refCount=" + this.k + ", valCount=" + this.l + ", phyRangeMin=" + this.m + ", phyRangeMax=" + this.n + ", val=" + Arrays.toString(this.o) + "]";
  }
  ...
  public static b b(SeekableByteChannel paramSeekableByteChannel, long paramLong) {
    ...
    byteBuffer.rewind();
    b1.a(AbstractInAlPackage.a(byteBuffer, 4));
    if (!b1.b().equals(b))
      throw new IOException("Wrong block type - expected '" + b + "', found '" + b1.b() + "'"); 
    byteBuffer.get(new byte[4]);
    b1.a(AbstractInAlPackage.e(byteBuffer));
    b1.b(AbstractInAlPackage.e(byteBuffer));
    byteBuffer = ByteBuffer.allocate((int)b1.c() + 24);
    byteBuffer.order(ByteOrder.LITTLE_ENDIAN);
    paramSeekableByteChannel.position(paramLong + 24L);
    paramSeekableByteChannel.read(byteBuffer);
    byteBuffer.rewind();
    long[] arrayOfLong1 = new long[(int)b1.AbstractInAlPackage()];
    for (byte b2 = 0; b2 < arrayOfLong1.length; b2++)
      arrayOfLong1[b2] = AbstractInAlPackage.g(byteBuffer); 
    b1.a(AbstractInAlPackage.a(byteBuffer));
    b1.b(AbstractInAlPackage.a(byteBuffer));
    b1.a(AbstractInAlPackage.b(byteBuffer));
    b1.b(AbstractInAlPackage.b(byteBuffer));
    b1.c(AbstractInAlPackage.b(byteBuffer));
    b1.a(AbstractInAlPackage.f(byteBuffer));
    b1.b(AbstractInAlPackage.f(byteBuffer));
    double[] arrayOfDouble = new double[b1.g()];
    for (byte b3 = 0; b3 < arrayOfDouble.length; b3++)
      arrayOfDouble[b3] = AbstractInAlPackage.f(byteBuffer); 
    b1.a(arrayOfDouble);
    b1.c(arrayOfLong1[0]);
    b1.AbstractInAlPackage(arrayOfLong1[1]);
    b1.e(arrayOfLong1[2]);
    b1.f(arrayOfLong1[3]);
