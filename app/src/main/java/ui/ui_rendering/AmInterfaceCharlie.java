...
public class AmInterfaceCharlie extends a {
  ...
  public AbstractInAlPackage g() {
    return (this.AbstractInAlPackage > 0L) ? AbstractInAlPackage.b(this.a, this.AbstractInAlPackage) : null;
  }
  
  public String toString() {
    return "CGBLOCK [lnkCgNext=" + this.c + ", lnkCnFirst=" + this.AbstractInAlPackage + ", lnkTxAcqName=" + this.e + ", lnkSiAcqSource=" + this.f + ", lnkSrFirst=" + this.g + ", lnkMdComment=" + this.h + ", recordId=" + this.i + ", cycleCount=" + this.j + ", flags=" + this.k + ", pathSeparator=" + this.l + ", dataBytes=" + this.m + ", invalBytes=" + this.n + "]";
  }
