...
public class PathTostring extends a {
  ...
  public static i a(Path paramPath, SeekableByteChannel paramSeekableByteChannel) {
    ...
    if (!i1.f().startsWith("4")) throw new IOException("Unsupported MDF4 format: " + i1.f());
    i1.AbstractInAlPackage(AbstractInAlPackage.a(byteBuffer, 8));
    byteBuffer.get(new byte[4]);
    i1.a(AbstractInAlPackage.b(byteBuffer));
    if (i1.g() < 400) throw new IOException("Unsupported MDF4 version, must be >400: " + i1.g());
    i1.b(AbstractInAlPackage.b(byteBuffer));
    if (i1.i() != 0)
      throw new IOException(
          "Only finalized MDF file can be read, found unfinalized standard flag '" + i1.h() + "'");
    i1.c(AbstractInAlPackage.b(byteBuffer));
    if (i1.i() != 0)
      throw new IOException(
          "Only finalized MDF file can be read, found unfinalized custom flag '" + i1.i() + "'");
    return i1;
  }
}
