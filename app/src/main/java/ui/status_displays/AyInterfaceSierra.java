...
public class AyInterfaceSierra extends JPanel {
  ...
  public AyInterfaceSierra(PropertiesExtension parama) {
    ...
    setBorder(BorderFactory.createTitledBorder(SComponentGolf.b("Automatic Saved Restore Points")));
    add("North", jLabel);
    ...
    this.e = new JButton(SComponentGolf.b("Compare to Current"));
    ...
    jPanel2.add(jPanel3);
    this.d = new JButton(SComponentGolf.b("Load Restore Point"));
