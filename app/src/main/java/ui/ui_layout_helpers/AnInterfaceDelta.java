...
public class AnInterfaceDelta extends a {
  ...
  AnInterfaceDelta(am.d paramd, TostringInAmPackage paramb) {
    super(paramd, paramb);
    if (paramb == null) throw new IOException("CCBLOCK Cannot be null for Rational Convertion");
  ...
  public double a(double paramDouble) {
    return (this.d * paramDouble * paramDouble + this.e * paramDouble + this.f)
        / (this.g * paramDouble * paramDouble + this.h * paramDouble + this.i);
  }
}
