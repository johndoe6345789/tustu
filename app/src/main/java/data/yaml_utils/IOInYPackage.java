...
public class IOInYPackage implements GInterfaceBu {
  ...
  public void IOInBiPackage(boolean paramBoolean) {
    if (paramBoolean && this.IOInBiPackage.c("inpshare_test1") != null && this.IOInBiPackage.c("inpshare_test2") != null)
      try {
        int BiInterfaceIndia = (int)this.IOInBiPackage.c("inpshare_test2").j(this.IOInBiPackage.h());
        ...
        if (AeInterfaceMike != null)
          d.b(AeInterfaceMike.IOInBiPackage()); 
