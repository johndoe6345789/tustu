...
public class YInterfaceFoxtrot implements GInterfaceBo {
  ...
  public int a(v paramv) {
    boolean bool1 = false;
    if (bool1 || (this.p && System.currentTimeMillis() - this.o < 1800000L)) return e();
    ...
    try {
      ...
      if (arrayOfInt1[0] == 114
          && arrayOfInt1[1] == 112
          && arrayOfInt1[2] == 109
          && arrayOfInt1[3] == 33
          && arrayOfInt1[4] == 61
          && arrayOfInt1[5] == 48) return 0;
      ...
      for (j = 0; j < arrayOfByte5.length; j++) {
        if (arrayOfByte5[j] != arrayOfByte7[j]) return 0;
      }
      D.c("-" + a.a + "-");
      ...
      if (this.n) iOException.printStackTrace();
      return e();
    } catch (VInterfaceBravo b1) {
      if (this.n) b1.printStackTrace();
  ...
  private byte[] a(byte[] paramArrayOfbyte) {
    ...
    if (arrayOfByte == null) return paramArrayOfbyte;
