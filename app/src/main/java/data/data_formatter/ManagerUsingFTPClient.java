...
public class ManagerUsingFTPClient implements RemoteFileAccess {
  ...
  public ManagerUsingFTPClient(R paramR, GComponentBo parambo, File paramFile) {
    ...
    this.a = parambo;
    this.IO = paramFile;
    if (parambo.a() != null && !parambo.a().isEmpty()) this.i = parambo.a();
    if (this.i == null || this.i.equals("connectedController")) this.i = b();
    this.j = parambo.b();
    if (parambo.c() != null && !parambo.c().isEmpty()) this.d = parambo.c();
    if (parambo.d() != null && !parambo.d().isEmpty()) this.e = parambo.d();
  ...
  public DirectoryFiles getFilesIn(DirectoryIdentifier paramDirectoryIdentifier) {
    ...
    try {
      ...
      String str =
          (paramDirectoryIdentifier == null || paramDirectoryIdentifier.getDirectoryId() == null)
              ? "."
              : paramDirectoryIdentifier.getDirectoryId();
    ...
    if (this.a.IO() != null && this.a.IO().b() != null && !this.a.IO().b().isEmpty()) {
      ...
      try {
        ...
        Logger.getLogger(e.class.getName())
            .log(Level.WARNING, "Failed to evaluate BrowseEnable condtion: " + str, (Throwable) g1);
      }
    }
  }

  private void d() {
    if (this.a.ExceptionPrintstacktrace() != null
        && this.a.ExceptionPrintstacktrace().b() != null
        && !this.a.ExceptionPrintstacktrace().b().isEmpty()) {
  ...
  private FTPClient e() {
    if (!this.h.isConnected()) {
      ...
      try {
        if (!this.h.login(this.d, this.e)
            || !FTPReply.isPositiveCompletion(this.h.getReplyCode())) {
          a(this.h);
          IO();
      ...
      if (this.a.h()) this.h.enterLocalPassiveMode();
      try {
  ...
  public File readRemoteFile(File paramFile, RemoteFileDescriptor paramRemoteFileDescriptor) {
    ...
    try {
      ...
      InputStream inputStream =
          fTPClient.retrieveFileStream("./" + paramRemoteFileDescriptor.getName());
      a(this.h);
  ...
  private void a(FTPClient paramFTPClient) {
    ...
    if (arrayOfString != null && arrayOfString.length > 0)
      for (String str : arrayOfString) D.d("SERVER: " + str);
  }
