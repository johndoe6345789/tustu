...
public final class IODateTostring {
  private String a = "";
  ...
  private int BiInterfaceIndia = 0;
  ...
  public IODateTostring() {}

  public IODateTostring(String paramString) {
    a(paramString);
  }
  ...
  public void a(String paramString) {
    ...
    try {
      ...
      throw new h(BiInterfaceIndia.getMessage());
    }
  ...
  public void b(int paramInt) {
    if (paramInt > 7) throw new BiInterfaceIndia("Invalid Error Code: " + paramInt);
    this.g = paramInt;
  }
  ...
  public String BiInterfaceIndia() {
    return this.l;
  }
  ...
  public void k(String paramString) {
    try {
      this.BiInterfaceIndia = Integer.parseInt(paramString);
    } catch (Exception exception) {
      this.BiInterfaceIndia = 0;
