...
public class IOInAiPackage {
  ...
  public IOInAiPackage(R paramR, r paramr) {
    this.a = paramR;
    this.b = paramr;
  }
  ...
  public File a(File paramFile, RemoteFileDescriptor paramRemoteFileDescriptor) {
    ...
    m m =
        d.a(
            this.a.O(),
            (int) paramRemoteFileDescriptor.getDirectory().getNumericId(),
            (int) (l / 512L));
    o o = o.d(this.a);
    o o1 = o.a(m, false, 2000);
    if (o1 == null)
      throw new RemoteAccessException(
          "Communication failure. File " + paramRemoteFileDescriptor.getName() + " not read.");
    if (o1.a() == 3) throw new RemoteAccessException(o1.c());
    ...
    if (this.b != null) this.b.a(paramRemoteFileDescriptor);
    this.c = 0;
    this.d = 0;
    aa aa = new aa();
    ...
    try {
      ...
      do {
        ...
        m m1 = d.d(this.a.O(), b++);
        aa.b();
        if (bool) D.c("Reading file block. Time: " + aa.c());
        o.a(3000);
        o1 = o.a(m1, false, 15000);
        aa.b();
        if (bool) D.c("Complete Read file block. Time: " + aa.c());
        o.a(3000);
        if (o1 == null || o1.a() == 3) {
          String str = (o1 == null) ? "ECU returned no data" : o1.c();
          throw new RemoteAccessException(str);
        }
        if (o1.g() == null || (o1.g()).length <= 0) continue;
        if (bool) D.c("Begin handing data to writer. Time: " + aa.c());
        ...
        aa.b();
        if (bool) D.c("Complete data prep, passing data to writer. Time: " + aa.c());
        i.a(arrayOfByte2);
        aa.b();
        if (bool) D.c("Writer has the data. Time: " + aa.c());
      ...
      if (this.e) {
        RemoteAccessException remoteAccessException =
            new RemoteAccessException(
                "Download File " + paramRemoteFileDescriptor.getName() + " Cancelled.");
