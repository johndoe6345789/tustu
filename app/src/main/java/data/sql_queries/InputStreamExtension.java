...
public class InputStreamExtension extends InputStream {
  ...
  public InputStreamExtension(byte[] paramArrayOfbyte) {
  ...
  public synchronized int read(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    ...
    if (this.a >= this.c) {
      if (this.a == this.c && this.d) b(a());
      if (this.a >= this.c) return -1;
    }
    if (this.a + paramInt2 > this.c) paramInt2 = this.c - this.a;
  ...
  public synchronized long skip(long paramLong) {
    if (this.a + paramLong > this.c) paramLong = (this.c - this.a);
  ...
  private void b(byte[] paramArrayOfbyte) {
    ...
    if (paramArrayOfbyte == null)
      throw new IOException(
          "TIMEOUT on wait for next buffer. Expected more buffers, Log file likely truncated.");
    this.f = paramArrayOfbyte;
    this.a = 0;
    this.c = paramArrayOfbyte.length;
    this.b = 0;
  ...
  public synchronized byte[] a() {
    ...
    if (!this.e.isEmpty()) {
      ...
      Logger.getLogger(a.class.getName())
          .log(
              Level.WARNING,
              "TIMEOUT on wait for next buffer. Expected more buffers, did not get it in 3000 ms."
                  + " Log file likely truncated.");
    }
    return arrayOfByte;
  }
}
