...
public class AiInterfaceNovember {
  ...
  public void a(u paramu, M paramM) {
    ...
    long l2 =
        AjInterfaceCharlie.g()
            + AjInterfaceCharlie.AjInterfaceBravo()
            + (paramu.getFileCount() * 32 / paramu.a());
    ...
    try {
      ...
      for (j = 0; j < AjInterfaceCharlie.e(); j++) {
        ...
        for (int i1 = k + 1; i1 <= m && !bool; i1++) {
          ...
          if (!bool1) a(this.a.O(), arrayOfInt1, i1);
          o.a(3000);
          if (paramM != null)
            if (i > 0) {
      ...
      if (paramM != null) paramM.AjInterfaceBravo();
    }
  }
  ...
  public AjInterfaceCharlie a(F paramF) {
    ...
    AjInterfaceCharlie.AjInterfaceBravo(
        AjInterfaceCharlie.AjInterfaceBravo(arrayOfInt, 11, 2, false, false));
    ...
    if (i == 0) i = AjInterfaceCharlie.AjInterfaceBravo(arrayOfInt, 32, 4, false, false);
  ...
  public int[] a(F paramF, int paramInt) {
    ...
    if (o1 == null) throw new RemoteAccessException("Unable to read MS3 SD Sector. No Response");
    if (o1.a() == 3)
      throw new RemoteAccessException(
          "Unable to read MS3 SD Sector. \nMessage:\n" + o1.AjInterfaceCharlie());
    return o1.e();
  }
