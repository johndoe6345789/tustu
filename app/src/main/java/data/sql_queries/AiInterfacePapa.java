...
public class AiInterfacePapa implements q {
  ...
  public void c() {
    if (!this.a.R()) throw new w(a("Not currently connected to an MS3."));
    if (!this.c) throw new w(a("MS3 is not currently capturing an SD Log, can not stop."));
    try {
      m m = d.a(this.a.O(), 2);
      m.v("SD Stop Logging");
  ...
  public Date ExceptionPrintstacktrace() {
    ...
    if (o1.a() == 3) throw new RemoteAccessException(o1.c());
    if (o1.a() == 2 && o1.e() == null) throw new RemoteAccessException(o1.c());
    int[] arrayOfInt = o1.e();
  ...
  public void a(u paramu, M paramM) {
    ...
    try {
      ...
      try {
        if (this.a.O().T()) GInterfaceDh.b(this.a);
      } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
        Logger.getLogger(p.class.getName())
            .log(Level.WARNING, "Failed to stop turbo baud.", (Throwable) ExceptionPrintstacktrace);
      }
    }
  }
