...
public class SComponentGolf {
  ...
  public static String c(String paramString) {
    return (ExceptionInVPackage.A() != null) ? ExceptionInVPackage.ExceptionInVPackage().b("configFileText", paramString) : paramString;
  }
  ...
  public static void b(String paramString1, String paramString2) {
    ...
    try {
      boolean bool = RInterfaceMike.ExceptionInVPackage("lt401vette", "pass", "TunerStudioMS", ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.aN, ""), ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.cF, ""), locale2.getLanguage(), locale1.getLanguage(), paramString1, paramString2);
      D.c("Translation submittion finished: " + bool);
    } catch (ExceptionExtension ExceptionExtension) {
      Logger.getLogger(g.class.getName()).log(Level.SEVERE, (String)null, (Throwable)ExceptionExtension);
    } 
  }
