...
class AxComponentXray implements ab {
  ArrayList a = null;

  public AxComponentXray(ArrayList paramArrayList) {
  ...
  private void b() {
    ...
    if (bool1) {
      if (b1 == 0 || b2 == this.a.size() - 1) throw new I("Invalid Ternary Expression");
      x x1 = a(0, b1);
      x x2 = a(b1 + 1, b2);
  ...
  public double b(S paramS) {
    ...
    if (!(ab1 instanceof ab)) throw new I("Reason Unknown.");
    ab ab2 = ab1;
    return ab2.b(paramS);
  }
