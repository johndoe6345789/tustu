...
class AxComponentGolf extends e {
  ...
  private ac b(String paramString, List<ab> paramList) {
    if (paramList.size() != 1) throw new A(paramString, paramList.size(), 1);
  ...
  private ac i(String paramString, List<ab> paramList) {
    if (paramList.size() != 2) throw new A(paramString, paramList.size(), 2);
