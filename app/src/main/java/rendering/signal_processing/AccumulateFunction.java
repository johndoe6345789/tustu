...
public class AccumulateFunction extends AbstractInAxPackage implements GInterfaceDj {
  ...
  protected AccumulateFunction(
      AxInterfaceAb paramab1, AxInterfaceAb paramab2, AxInterfaceAb paramab3) {
    this.a = paramab2;
    this.b = paramab1;
    this.c = paramab3;
  }
  ...
  public String toString() {
    return (this.c == null)
        ? ("accumulate( " + this.b.toString() + " )")
        : ("accumulate( " + this.b.toString() + ", " + this.c.toString() + " )");
  }
