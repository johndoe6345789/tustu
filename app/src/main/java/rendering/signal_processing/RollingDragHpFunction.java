...
public class RollingDragHpFunction extends AbstractInAxPackage {
  ...
  private void a() {
    this.e =
        0.034667D * (this.d - 35.0D) * (this.d - 45.0D)
            + -0.063333D * (this.d - 20.0D) * (this.d - 45.0D)
            + 0.032D * (this.d - 20.0D) * (this.d - 35.0D);
    this.f =
        7.704E-7D * (this.d - 35.0D) * (this.d - 45.0D)
            + -8.33333E-7D * (this.d - 20.0D) * (this.d - 45.0D)
            + 3.148E-7D * (this.d - 20.0D) * (this.d - 35.0D);
  }
