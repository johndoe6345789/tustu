...
public class LastValueFunction extends AbstractInAxPackage {
  ...
  private int c(CloneableImplInAxPackage paramS) {
    if (this.c > Integer.MIN_VALUE) return this.c;
    if (this.b != null) {
  ...
  public String toString() {
    return (this.b != null)
        ? ("lastValue( " + this.a.toString() + ", " + this.b.toString() + " )")
        : ("lastValue( " + this.a.toString() + " )");
  }
}
