...
public class RInterfaceMike {
  ...
  protected void b(
      ...
      String paramString7) {
    try {
      ReviewActions.submitUserReview(
          paramString1,
          paramString2,
          paramString3,
          paramString4,
  ...
  protected void b(
    ...
    try {
      MutationResult mutationResult =
          TranslationActions.addUpdateProposedStaticTranslation(
              paramString1,
              paramString2,
              paramString3,
              paramString4,
      ...
      if (mutationResult.getReturnCode() != 0) {
        ...
        throw new k(
            "Proposed Translation call failed. Short Message: "
                + mutationResult.getShortMessage()
                + "\nLong Message:"
                + mutationResult.getLongMessage());
      }
    } catch (Exception exception) {
