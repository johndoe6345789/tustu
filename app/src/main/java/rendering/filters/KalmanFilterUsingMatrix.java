...
public class KalmanFilterUsingMatrix {
  protected Matrix a;
  ...
  public static KalmanFilter create(
      double paramDouble1,
      double paramDouble2,
      double paramDouble3,
      double paramDouble4,
    ...
    filter.c(
        new Matrix(
            new double[][] {
              {1.0D, 0.0D, paramDouble3, 0.0D},
              {0.0D, 1.0D, 0.0D, paramDouble3},
              {0.0D, 0.0D, 1.0D, 0.0D},
              {0.0D, 0.0D, 0.0D, 1.0D}
            }));
