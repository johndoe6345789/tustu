...
public class hZ extends w implements TableModelListener {
  ...
  private boolean b(hY paramhY) {
    return ((int)Math.log10(paramhY.F()) + paramhY.IOProperties() <= 3 && paramhY.h() < 1 && J.a() && (int)Math.log10(paramhY.B()) + paramhY.g() <= 3);
  }
  ...
  public void b() {
    s s = (s)h().getModel();
    String str = IOJFileChooser.a("{Y-Axis Override for " + s.z() + "}", false, "Override Y-Axis Field.", true, (Component)this);
    if (str != null && !str.equals("")) {
      s.d(str);
      if (this.w != null)
