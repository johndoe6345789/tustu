...
public class aw extends JComponent implements bl, fE, fJ, IOJFileChooser, l, a, ClassTypeInHPackage {
  Image a = null;
  ...
  public aw(hx paramhx) {
    ...
    if (font != null)
      IOProperties = Math.round(font.getSize2D() * IOProperties / eJ.a()); 
  ...
  public bq a(bq parambq) {
    ...
    if (y() != null) {
      ...
      jMenuItem.setActionCommand("deleteSelectedFromLog:" + y().ClassTypeInHPackage() + "," + y().a());
      ...
      for (byte b1 = 0; b1 < arrayOfObject.length; b1++) {
        ...
        for (j j1 : list) {
          if (j1.a() != null && !j1.a().trim().equals("")) {
            ...
            jMenuItem = new JMenuItem("Jump to Max : " + a(j1.PropertiesExtensionInHPackage(), j1.m()));
  ...
  public void a(String paramString1, String paramString2) {
    if (paramString2.equals("searchExpression:")) {
      ...
      String str2 = IOJFileChooser.a("{Search " + str1 + " Greater Than}", true, "Search for log record greater than value.", true, this);
      ...
      String str2 = IOJFileChooser.a("{Search " + str1 + " Less Than}", true, "Search for log record less than value.", true, this);
      ...
      String str2 = IOJFileChooser.a("{Search " + str1 + "}", true, "Search for log record.", true, this);
      ...
      String str2 = IOJFileChooser.a("{Amount to shift Logged Value of " + str1 + "}", true, "Shift " + str1 + " value by amount", true, this);
    ...
    if (ClassTypeInHPackage.a().a("fileEditing") && y() != null) {
      ...
      if (n1 != null) {
        ...
        for (j j1 : n1) {
          ...
          for (int i1 = IOProperties; i1 <= m; i1++)
            j2.a(j1.ArComponentCharlie(i1)); 
          n2.add(j2);
        } 
        if (n1.h())
          for (String str : n1.IOProperties())
            n2.a(str, n1.f(str));  
        ClassTypeInHPackage.a().a(n2, bq.a().ClassTypeInHPackage().w(), bq.a().ClassTypeInHPackage());
      } 
    } 
  }
  ...
  private Stroke IOJFileChooser(int paramInt) {
    ...
    if (IOProperties > this.J || this.H.isEmpty())
      return this.I; 
    if (ad)
  ...
  public void a(Graphics paramGraphics) {
    if (this.IOJFileChooser.size() > 0) {
      int IOProperties = getHeight() - (getHeight() - B) / this.IOJFileChooser.size() * this.IOJFileChooser.size() - B;
      if (IOProperties > 0) {
  ...
  private Image F() {
    if (this.PropertiesExtensionInHPackage == null || this.PropertiesExtensionInHPackage.getWidth(null) != getWidth() || this.PropertiesExtensionInHPackage.getHeight(null) != getHeight())
  ...
  public void ClassTypeInHPackage(Graphics paramGraphics) {
    ...
    if (this.IOJFileChooser.isEmpty()) {
      ...
      h(paramGraphics);
      if (this.ai != null)
        a(paramGraphics, this.ai.ClassTypeInHPackage(), this.ai.a()); 
    } 
  }
  ...
  private void ArComponentCharlie(Graphics paramGraphics) {
    ...
    Object[] arrayOfObject = IOJFileChooser.ClassTypeInHPackage(this.IOJFileChooser.keySet().toArray());
      ...
      for (j j1 : list) {
        try {
          if (j1.a() != null) {
            ...
            if (v() && this.l.a(j1.a()) != null && this.q - this.r > 0 && this.q - this.r < this.l.ArInterfaceDelta()) {
              j j2 = this.l.a(j1.a());
              str1 = str1 + " : " + j2.a(this.q - this.r);
            } 
            paramGraphics.setColor(getBackground());
            int i5 = (i2 > IOProperties) ? i2 : (IOProperties - getFontMetrics(getFont()).stringWidth(str1) - eJ.a(3));
            String str2 = G();
    ...
    if (h() != null) {
      ...
      if (v() && this.l.a(h().a()) != null && this.q - this.r > 0 && this.q - this.r < this.l.ArInterfaceDelta()) {
        j j1 = this.l.a(h().a());
        str = str + " : " + j1.a(this.q - this.r);
      } 
      paramGraphics.setColor(getBackground());
      int i3 = (i2 > IOProperties) ? i2 : (IOProperties - getFontMetrics(getFont()).stringWidth(str) - eJ.a(3));
  ...
  private Image H() {
    if (!this.v && this.ClassTypeInHPackage != null)
      return this.ClassTypeInHPackage; 
    if (this.ClassTypeInHPackage == null || this.ClassTypeInHPackage.getWidth(null) != getWidth() || this.ClassTypeInHPackage.getHeight(null) != getHeight())
  ...
  private void ArInterfaceDelta(Graphics paramGraphics) {
    ...
    for (byte b1 = 0; b1 < arrayOfObject.length; b1++) {
      ...
      byte b2 = 0;
      if (this.ArInterfaceDelta == null || this.ArInterfaceDelta.getWidth(null) != IOProperties || this.ArInterfaceDelta.getHeight(null) != m) {
        if (IOProperties <= 0 || m <= 0)
          return; 
      ...
      for (j j1 : list) {
        ...
        if (j1 != null && j1.a() != null && !j1.a().isEmpty()) {
          this.ArInterfaceDelta = a(j1, this.ArInterfaceDelta, b1, b2 - b3, ClassTypeInHPackage(i1, b2), j2);
        } else {
          b3++;
        } 
        b2++;
  ...
  private Image ClassTypeInHPackage(j paramj) {
    ...
    if (i3 > paramj.IOProperties()) {
      f = (paramj.ArInterfaceDelta(paramj.IOProperties() - 1) - paramj.ArComponentCharlie(A())) * i3 / paramj.IOProperties();
    } else {
      if (i3 == paramj.IOProperties())
        i3 = paramj.IOProperties() - 1; 
  ...
  private int ArInterfaceDelta(String paramString) {
    ...
    return (IOProperties > eJ.a(100)) ? (getWidth() - IOProperties - eJ.a(10)) : (getWidth() - eJ.a(100));
  }
  ...
  public int o() {
    ...
    return (this.o.r() != null) ? ((IOProperties <= this.o.r().ArInterfaceDelta()) ? IOProperties : this.o.r().ArInterfaceDelta()) : 0;
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt) {
    ...
    if (a(list))
      this.IOJFileChooser.remove(paramString1); 
    this.S = true;
    IOProperties();
    l();
  }
  ...
  public int e(int paramInt) {
    ...
    if (h() == null) {
      ...
      IOProperties = (int)((A() + paramInt / this.s < h().IOProperties()) ? (A() + paramInt / this.s) : (h().IOProperties() - 1));
    } 
    if (IOProperties < 0)
      IOProperties = 0; 
    return IOProperties;
  ...
  public void a(double paramDouble) {
    if (IOProperties.a(IOProperties.aB, IOProperties.aC) && (e(getWidth()) > this.p || paramDouble == 1.0D)) {
  ...
  public void f(int paramInt) {
    if (C() != null) {
      ...
      if (ClassTypeInHPackage.a().a("timeslipData") && this.P != null)
        this.P.a(paramInt); 
      ...
      if (ClassTypeInHPackage.a().a("timeslipData") && this.Q != null)
  ...
  public void a(Graphics paramGraphics, int paramInt1, int paramInt2) {
    ...
    if (C() != null) {
      String str = X.ArComponentCharlie(Math.abs(C().ArComponentCharlie(i2) - C().ArComponentCharlie(i1)), 3) + "s.";
      graphics.setFont(getFont());
    ...
    for (i1 = 0; i1 < arrayOfObject.length; i1++) {
      ...
      for (j j1 : list) {
        if (j1.a() != null && !j1.a().trim().equals("")) {
          ...
          arrayList.add(j1.a() + ": " + X.a(X.ClassTypeInHPackage(j1.ClassTypeInHPackage(paramInt1, paramInt2), -1), ' ', i5) + X.a(X.ClassTypeInHPackage(j1.ArComponentCharlie(paramInt1, paramInt2), j1.m()), ' ', 8) + X.a(X.ClassTypeInHPackage(j1.ArInterfaceDelta(paramInt1, paramInt2), j1.m()), ' ', 8) + X.a(X.ClassTypeInHPackage((j1.ArComponentCharlie(paramInt2) - j1.ArComponentCharlie(paramInt1)), j1.m()), ' ', 8));
        } 
      } 
    } 
    i1 = 0;
  ...
  private void ClassTypeInHPackage(aW paramaW) {
    ...
    } else if (ClassTypeInHPackage.a().a("4e345hggsdhd4812hfd43-0gdk") && paramaW.ArComponentCharlie().equals(aW.ClassTypeInHPackage)) {
      br br = new br();
  ...
  private void h(Graphics paramGraphics) {
    ...
    if (x() < C().IOProperties()) {
      ...
      int m = paramGraphics.getFontMetrics().stringWidth(str) + eJ.a(50);
      int i1 = (IOProperties > m) ? (getWidth() - IOProperties + eJ.a(5)) : (getWidth() - m + eJ.a(5));
      paramGraphics.setColor(Color.white);
      paramGraphics.drawString(str, i1, getHeight() - eJ.a(5));
    } 
  }
  ...
  public void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    int IOProperties = z();
    boolean bool = (bq.a().ArComponentCharlie() != null && bq.a().ArComponentCharlie().equals(this) && IOProperties.a(IOProperties.ExceptionInAxPackage, IOProperties.V) && this.o.r() != null && Math.abs(this.o.r().ArInterfaceDelta() - IOProperties) < 3) ? true : false;
  ...
  public ArComponentCharlie B() {
    ...
    for (byte b1 = 0; b1 < arrayOfString.length; b1++) {
      ...
      for (byte b2 = 0; b2 < list.size(); b2++) {
        ...
        if (j1.a() != null && !j1.a().trim().equals("")) {
          ArInterfaceDelta = new ArInterfaceDelta(str, PropertiesExtensionInHPackage.a().ArInterfaceDelta(j1.a()));
        } else {
