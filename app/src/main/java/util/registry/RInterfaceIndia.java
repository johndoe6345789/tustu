  ...
  public String c() {
    if (a("87gdjkjd98fes")) {
      ...
      return (calendar.getTime().getTime() > System.currentTimeMillis())
          ? ("Try new: <a href=https://www.efianalytics.com/register/upgradeSoftware.jsp?regKey="
              + str
              + "\">"
              + SComponentGolf.b("TunerStudio MS Ultra")
              + "</a><br>"
              + SComponentGolf.b("For a limited time, free trial for registered users!"))
          : ("<br>Upgrade to:<br><a"
                 + " href=https://www.efianalytics.com/register/upgradeSoftware.jsp?regKey="
              + str
              + "\">"
              + SComponentGolf.b("TunerStudio MS Ultra")
              + "</a> "
              + SComponentGolf.b("Now!")
              + "<br>"
              + SComponentGolf.b("Featuring Tuning and Dyno Views!"));
    }
    return "";
  }
