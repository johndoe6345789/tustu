...
public class RComponentNovember {
  et a = (et) new dQ(a.a().d(), "recentlyOpenedProject");
  ...
  public void a(String paramString) {
    ...
    while (arrayList.contains(paramString)) arrayList.remove(paramString);
  ...
  public ArrayList a() {
    ...
    for (byte b = 0; b < this.b; b++) {
      ...
      if (str != null && str.trim().length() > 0 && (new File(str)).exists()) arrayList.add(str);
    }
    return arrayList;
  }
