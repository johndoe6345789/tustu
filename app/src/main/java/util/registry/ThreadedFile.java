...
public class ThreadedFile {
  ...
  public static final String i =
      "." + File.separator + "Dash" + File.separator + "backgrounds" + File.separator;

  public static final String j =
      "." + File.separator + "Dash" + File.separator + "Needles" + File.separator;

  public static final String k =
      "." + File.separator + "inc" + File.separator + "ms2ReferenceTables.ini";

  public static final String l =
      "." + File.separator + "inc" + File.separator + "ms2GeneralPorts.ini";

  public static final String m =
      "." + File.separator + "inc" + File.separator + "ms1BaseVeAnalyzeMaps.ini";

  public static final String n =
      "." + File.separator + "inc" + File.separator + "ms1ExtraVeAnalyzeMaps.ini";

  public static final String o =
      "." + File.separator + "inc" + File.separator + "ms3VeAnalyzeMaps.ini";

  public static final String p =
      "." + File.separator + "inc" + File.separator + "ms2ExtraVeAnalyzeMaps.ini";

  public static final String q =
      "." + File.separator + "inc" + File.separator + "ms2VeAnalyzeMaps.ini";

  public static final String r =
      "." + File.separator + "inc" + File.separator + "monsterFirmware1VeAnalyzeMaps.ini";

  public static final String s =
      "." + File.separator + "inc" + File.separator + "bs3Gen4VEAnalyzeMaps.ini";

  public static final String t =
      "." + File.separator + "inc" + File.separator + "ms1BaseWueAnalyzeMaps.ecu";

  public static final String u =
      "." + File.separator + "inc" + File.separator + "ms1ExtraWueAnalyzeMaps.ecu";

  public static final String v =
      "." + File.separator + "inc" + File.separator + "ms2WueAnalyzeMaps.ecu";

  public static final String w =
      "." + File.separator + "inc" + File.separator + "ms3_1.2_WueAnalyzeMap.ecu";

  public static final String x =
      "." + File.separator + "inc" + File.separator + "ms3_1.0_WueAnalyzeMap.ecu";
  ...
  public static final String A =
      "." + File.separator + "inc" + File.separator + "ms1BaseDefaultTools.ini";

  public static final String B =
      "." + File.separator + "inc" + File.separator + "ms1ExtraDefaultTools.ini";

  public static final String C =
      "." + File.separator + "inc" + File.separator + "msIIBGDefaultTools.ini";

  public static final String D =
      "." + File.separator + "inc" + File.separator + "ms2ExtraDefaultTools.ini";

  public static final String E =
      "." + File.separator + "inc" + File.separator + "ms3DefaultTools.ini";

  public static final String F = "content" + File.separator;

  public static final String G =
      "." + File.separator + "inc" + File.separator + "canPcVariables.ini";
    ...
    if (!file.exists()) {
      ...
      if (!file1.mkdirs())
        throw new ExceptionInVPackage(
            "Unable to create user ECU definition dir:\n" + file.getAbsolutePath());
      file1.delete();
    } else if (file.isFile()) {
      file.delete();
      file.mkdir();
  ...
  public static long ExceptionInVPackage(File paramFile) {
    ...
    if (arrayOfFile != null) {
      for (byte b = 0; b < arrayOfFile.length; b++) l += arrayOfFile[b].length();
      return l;
    }
    return 0L;
  }
  ...
  public static void ExceptionInVPackage(File paramFile, double paramDouble) {
    for (long l = ExceptionInVPackage(paramFile);
        l > paramDouble * 1024.0D * 1024.0D;
        l = ExceptionInVPackage(paramFile)) {
      File file = null;
      File[] arrayOfFile = paramFile.listFiles();
      for (byte b = 0; b < arrayOfFile.length; b++) {
        if (!arrayOfFile[b].isDirectory()
            && arrayOfFile[b].canWrite()
            && (file == null || arrayOfFile[b].lastModified() < file.lastModified()))
          file = arrayOfFile[b];
      }
      if (file != null)
        D.d(
            "Maintain Restore Point size to "
                + paramDouble
                + " size. Deleting:\n"
                + file.getAbsolutePath());
      if (file != null && !file.delete()) {
        D.ExceptionInVPackage(
            "Unable to delete oldest restore point file:\n" + file.getAbsolutePath());
        break;
      }
    }
  }
  ...
  public static File d() {
    ...
    if (!file.exists()) {
      ...
      if (!file1.mkdirs())
        throw new ExceptionInVPackage(
            "Unable to create Start Screen Root dir:\n" + file.getAbsolutePath());
      file1.delete();
    } else if (file.isFile()) {
      file.delete();
      file.mkdir();
  ...
  public static void b(File paramFile) {
    if (!paramFile.isDirectory()) paramFile = paramFile.getParentFile();
  ...
  public static void ExceptionInVPackage(File paramFile, i parami) {
    i i1 = d(paramFile);
    if (i1 == null
        || !i1.e().equals(parami.e())
        || !i1.i().equals(parami.i())
        || (parami.n() != null && (i1.n() == null || !i1.n().equals(parami.n())))
        || !i1.j().equals(parami.j())) {
      File file = c(paramFile);
      file.delete();
      ...
      try {
        ...
        Logger.getLogger(j.class.getName())
            .log(Level.SEVERE, "Failed to save Serial File to project.", iOException);
      } finally {
        if (fileWriter != null)
          try {
            fileWriter.close();
  ...
  public static List b(String paramString) {
    ...
    for (File file1 : file.listFiles(k)) {
      i i = d(file1);
      if (i != null && i.e().equalsIgnoreCase(paramString)) arrayList.add(file1);
    }
    return arrayList;
  }
  ...
  public static File j() {
    ...
    String str =
        ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.z, file1.getAbsolutePath());
  ...
  public static File k() {
    ...
    String str =
        ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.B, file1.getAbsolutePath());
    File file2 = new File(str);
  ...
  public static File ExceptionInVPackage(Window paramWindow, String paramString) {
    ...
    if (file == null)
      try {
        ...
        if (r != null && r.ExceptionInVPackage()) file = r.c();
    ...
    if (file == null) {
      ...
      bV.d(
          "Can not find the Controller Definition file (ini,ecu) for\nSerial Signature: '"
              + paramString
              + "'\n\nPlease select the appropriate configuration file.",
          paramWindow);
      ...
      if (str2 == null || str2.equals("")) {
        String str =
            "The ECU Definition File:\n"
                + str1
                + "\nDoes not appear valid, there is no serial signature defined.";
        if (!bV.ExceptionInVPackage(str, paramWindow, true)) return null;
      } else if (!paramString.equals(str2)) {
        String str =
            "Signatures do not match!\nIn Tune File ("
                + ExceptionInVPackage.cw
                + "): "
                + paramString
                + "\nIn Definition file: "
                + str2
  ...
  public static File[] VComponentFoxtrot(String paramString) {
    ...
    if (!file.exists())
      throw new ExceptionInVPackage(
          "Dash & Gauge directory not found, expected at:\n"
              + file.getAbsolutePath()
  ...
  public static File r() {
    return J.ExceptionInVPackage()
        ? new File(
            FileSystemView.getFileSystemView().getDefaultDirectory()
                + File.separator
                + X.b(ExceptionInVPackage.b, " ", "")
                + "Projects/")
        : new File(
  ...
  public static String s() {
    return u()
        + ExceptionInVPackage.ExceptionInVPackage()
            .ExceptionInVPackage(ExceptionInVPackage.q, "DefaultProject");
  }
  ...
  public static String t() {
    ...
    if (str.equals("") || !(new File(str)).exists()) {
      String str1 =
          ExceptionInVPackage.ExceptionInVPackage()
              .c(ExceptionInVPackage.aV, r().getAbsolutePath());
  ...
  public static String u() {
    String str =
        ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.aV, r().getAbsolutePath());
    boolean bool = false;
    ...
    if (!bool1 || bool) {
      n.j.ExceptionInVPackage()
          .ExceptionInVPackage("One time setup, Copying Default Projects and components..");
      ...
      for (byte b = 0; arrayOfFile != null && b < arrayOfFile.length; b++) {
        ...
        if (bool2) {
          ...
          try {
            ...
            if (b + 1 < arrayOfFile.length) Thread.sleep(500L);
          } catch (InterruptedException interruptedException) {
            D.b(
                "copy project process interrupted. Copying to project folder.\n"
          ...
          try {
            ...
            if (!str2.equals(ae.ExceptionInVPackage)) {
              ...
              if (!str2.equals(ae.ExceptionInVPackage)) {
                D.ExceptionInVPackage(
                    "Failed second attempt to extract sample Project, Giving up:\n" + str1);
              } else {
            ...
            File file =
                new File(
                    ...
                    arrayOfFile[b]
                        .getName()
                        .substring(0, arrayOfFile[b].getName().lastIndexOf(".")));
            n.ExceptionInVPackage(file.getAbsolutePath());
          } catch (ZipException zipException) {
            D.ExceptionInVPackage(
                "Failed to extract sample Project, Will try any others:\n" + str1,
                zipException,
                null);
          } catch (IOException iOException) {
            D.ExceptionInVPackage(
          ...
          D.d(
              "Found file "
                  + arrayOfFile[b].getName()
                  + " in the example projects dir, but it is not ExceptionInVPackage valid project"
                  + " or archive.");
        }
      }
  ...
  public static File A() {
    ...
    if (J.d()) {
      File file1 =
          new File(E() + ".efianalytics" + File.separator + ExceptionInVPackage.b + File.separator);
      if (file1.exists() && !file1.equals(file))
        try {
          ...
          Logger.getLogger(j.class.getName())
              .log(
                  Level.WARNING,
                  "Files to migrate .efianalytics to .efiAnalytics",
