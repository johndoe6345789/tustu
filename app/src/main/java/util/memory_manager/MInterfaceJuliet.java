...
class MInterfaceJuliet {
  ...
  public double a() {
    return (this.AmInterfaceEcho != null && this.AmInterfaceEcho.m() > 0.0D) ? ((this.AmInterfaceEcho.l() < 0.5D && this.AmInterfaceEcho.l() >= 0.0D) ? (this.b.AmInterfaceEcho() / this.AmInterfaceEcho.m()) : (this.b.AmInterfaceEcho() / (this.AmInterfaceEcho.m() - this.AmInterfaceEcho.l()))) : Double.NaN;
  }
