...
public class IOJMenu {
  ...
  public static c ExceptionInVPackage() {
    if (ExceptionInVPackage == null) ExceptionInVPackage = new c();
  ...
  public void ExceptionInVPackage(String paramString, File paramFile) {
    try {
      ...
      for (byte ClassTypeInHPackage = 0;
          ClassTypeInHPackage < this.ClassTypeInHPackage.getMenuComponentCount();
          ClassTypeInHPackage++) {
      ...
      if (this.c != null) this.c.add(jCheckBoxMenuItem);
      this.ClassTypeInHPackage.add(jCheckBoxMenuItem);
    } catch (ExceptionInVPackage ExceptionInVPackage) {
      Logger.getLogger(c.class.getName())
          .log(Level.INFO, "Error saving Settings File.", (Throwable) ExceptionInVPackage);
    ...
    do {
      if (ActionListenerInGPackage != null)
        bV.d(
            ...
            (Component) bq.ExceptionInVPackage().ClassTypeInHPackage());
      ActionListenerInGPackage =
          new ActionListenerInGPackage(
              (Frame) bq.ExceptionInVPackage().ClassTypeInHPackage(),
              "{New Setting Profile Name}",
              false,
              "       Save current setting components as",
              true);
    } while (ActionListenerInGPackage.ExceptionInVPackage
        && !t.ExceptionInVPackage(ActionListenerInGPackage.ExceptionInVPackage()));
  ...
  public void ExceptionInVPackage(String paramString, List paramList) {
    ...
    try {
      if (!file.exists() && !file.createNewFile())
        k.ExceptionInVPackage(
            "Unable to write to file\n"
                ...
                + "\nFailed to save setting profile.",
            (Component) bq.ExceptionInVPackage().ClassTypeInHPackage());
      ...
      k.ExceptionInVPackage(
          "Unable to save settings to " + file.getAbsolutePath() + "\nSee log for more detail.",
          (Component) bq.ExceptionInVPackage().ClassTypeInHPackage());
  ...
  public boolean ClassTypeInHPackage(String paramString) {
    ...
    if (d().equals(paramString)) IOProperties.c("SettingProfile", "");
    return bool;
  }
  ...
  public void c(String paramString) {
    ...
    if (ExceptionInVPackage(paramString, true)) {
      ...
      ClassTypeInHPackage.ExceptionInVPackage()
          .ClassTypeInHPackage((Frame) bq.ExceptionInVPackage().ClassTypeInHPackage());
    }
  }
  ...
  public boolean ExceptionInVPackage(String paramString, boolean paramBoolean) {
    ...
    try {
      FileInputStream fileInputStream =
          new FileInputStream(ExceptionInVPackage.ExceptionInVPackage(paramString));
    ...
    if (arrayList.isEmpty()) {
      bV.d(
          "There are no settings in this file to import.",
          (Component) bq.ExceptionInVPackage().ClassTypeInHPackage());
      return false;
    }
