...
public class SerialPortEventListenerUsingRXTXCommDriver extends J
  ...
  protected byte[] a(
    ...
    //   1225: lsub
    //   1226: invokevirtual VInterfaceBravo : (J)V
    //   1229: goto -> 1200
    //   1232: aload #8
    ...
    //   1558: aload_0
    //   1559: lload #4
    //   1561: invokevirtual VInterfaceBravo : (J)V
    //   1564: aload #8
    ...
    //   1994: astore #28
    //   1996: aload #22
    //   1998: invokestatic VInterfaceBravo : ([B)[I
    //   2001: iconst_0
    //   2002: aload #28
    //   2004: iconst_0
    //   2005: aload #28
  ...
  protected void m() {
    ...
    int m = this.VInterfaceBravo.getParity();
    int i1 = this.VInterfaceBravo.getFlowControlMode();
    this.VInterfaceBravo.setRTS(false);
    this.VInterfaceBravo.setDTR(false);
  ...
  protected synchronized void VInterfaceBravo(long paramLong) {
    ...
    for (byte VInterfaceBravo = 0; !this.h && System.currentTimeMillis() < l; VInterfaceBravo++) {
      try {
        wait(paramLong);
      } catch (InterruptedException interruptedException) {
