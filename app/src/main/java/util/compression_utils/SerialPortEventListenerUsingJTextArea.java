...
public class SerialPortEventListenerUsingJTextArea implements n, SerialPortEventListener {
  ...
  public SerialPortEventListenerUsingJTextArea(
      ActionListenerUsingJButton paramhs,
      n paramn,
      JTextArea paramJTextArea1,
      JTextArea paramJTextArea2) {
    this.b = paramhs;
  ...
  public void a() {
    ...
    try {
      ...
      try {
        ...
        Logger.getLogger(k.class.getName())
            .log(Level.SEVERE, (String) null, (Throwable) serialPortException1);
      }
    }
    this.h.a(this.f);
  ...
  public void b() {
    ...
    try {
      this.a.setParams(
          this.OutputStreamExtension.b(),
          this.OutputStreamExtension.f(),
          this.OutputStreamExtension.g(),
          this.OutputStreamExtension.h());
    } catch (SerialPortException serialPortException) {
      throw new m("Unsupported parameter");
    }
    try {
      this.a.setFlowControlMode(
          this.OutputStreamExtension.SerialPortEventListener()
              | this.OutputStreamExtension.OutputStreamExtension());
    } catch (SerialPortException serialPortException) {
  ...
  public void a(int[] paramArrayOfint) {
    if (this.f == null) throw new IOException("Port is not open.");
    boolean bool = false;
    if (bool) {
  ...
  public void a(o paramo) {
    if (paramo.a() == 1) {
      ...
      if (arrayOfInt != null) {
        for (byte b = 0; b < arrayOfInt.length; b++) a(arrayOfInt[b]);
  ...
  public void serialEvent(SerialPortEvent paramSerialPortEvent) {
    ...
    switch (paramSerialPortEvent.getEventType()) {
      case 1:
        ...
        this.SerialPortEventListener.setCaretPosition(
            this.SerialPortEventListener.getText().length());
        break;
    }
  }
}
