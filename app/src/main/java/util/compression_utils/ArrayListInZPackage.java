...
public class ArrayListInZPackage {
  ...
  public J a(
      R paramR,
      String paramString1,
      AInterfaceIndia parami,
      AInterfaceIndia parami1,
      String paramString2) {
      ...
      if (t1.a() == null && str != null) {
        ...
        try {
          ...
          Logger.getLogger(c.class.getName())
              .log(
                  Level.SEVERE,
                  "Failed to instantiate ControllerInterface",
                  instantiationException);
        } catch (IllegalAccessException illegalAccessException) {
          Logger.getLogger(c.class.getName())
              .log(
                  Level.SEVERE,
                  "Failed to instantiate ControllerInterface, IllegalAccess",
                  illegalAccessException);
        } catch (UnsatisfiedLinkError unsatisfiedLinkError) {
          Logger.getLogger(c.class.getName())
              .log(
                  Level.SEVERE,
                  "Failed to instantiate ControllerInterface, UnsatisfiedLinkError",
                  unsatisfiedLinkError);
        } catch (NoClassDefFoundError noClassDefFoundError) {
          Logger.getLogger(c.class.getName())
              .log(
                  Level.SEVERE,
                  "Failed to instantiate ControllerInterface, NoClassDefFoundError",
                  noClassDefFoundError);
        } catch (Error error) {
          Logger.getLogger(c.class.getName())
              .log(Level.SEVERE, "Failed to instantiate ControllerInterface, Other", error);
        }
        if (IO == null) {
          ...
          try {
            ...
            Logger.getLogger(c.class.getName())
                .log(Level.SEVERE, "Failed to instantiate ControllerInterface, Other", exception);
          } catch (Error error) {
            Logger.getLogger(c.class.getName())
                .log(Level.SEVERE, "Failed to instantiate ControllerInterface, Other", error);
          }
          ...
          try {
            ...
            Logger.getLogger(c.class.getName())
                .log(Level.SEVERE, "Failed to set ControllerInterface settings", error);
          }
        }
        if (IO != null) t1.a(IO);
      }
    ...
    try {
      ...
      Logger.getLogger(c.class.getName())
          .log(Level.SEVERE, "Failed to instantiate ControllerInterface", instantiationException);
    } catch (IllegalAccessException illegalAccessException) {
      Logger.getLogger(c.class.getName())
          .log(
              Level.SEVERE,
      ...
      Logger.getLogger(c.class.getName())
          .log(
              Level.SEVERE,
              "Failed to instantiate ControllerInterface, Generl Exception",
              exception);
    } catch (Error error) {
      Logger.getLogger(c.class.getName())
          .log(Level.SEVERE, "Failed to instantiate ControllerInterface, Error", error);
    }
    return null;
  }
  ...
  public boolean a(String paramString) {
    for (d d : this.AInterfaceIndia) {
      if (d.a().equals(paramString)) return true;
    }
    return false;
  }
}
