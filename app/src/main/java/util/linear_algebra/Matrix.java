...
public class Matrix implements Serializable, Cloneable {
  ...
  public Matrix a() {
    ...
    for (byte b2 = 0; b2 < this.b; b2++) {
      for (byte b3 = 0; b3 < this.c; b3++) arrayOfDouble[b2][b3] = this.a[b2][b3];
    }
    return b1;
  }
  ...
  public double[][] c() {
    ...
    for (byte b1 = 0; b1 < this.b; b1++) {
      for (byte b2 = 0; b2 < this.c; b2++) arrayOfDouble[b1][b2] = this.a[b1][b2];
    }
  ...
  public Matrix f() {
    ...
    double[][] arrayOfDouble = b1.b();
    for (byte b2 = 0; b2 < this.b; b2++) {
      for (byte b3 = 0; b3 < this.c; b3++) arrayOfDouble[b3][b2] = this.a[b2][b3];
    }
    return b1;
  }
  ...
  public Matrix a(double paramDouble) {
    ...
    double[][] arrayOfDouble = b1.b();
    for (byte b2 = 0; b2 < this.b; b2++) {
      for (byte b3 = 0; b3 < this.c; b3++) arrayOfDouble[b2][b3] = paramDouble * this.a[b2][b3];
    }
    return b1;
  }
  ...
  public Matrix c(Matrix paramb) {
    ...
    for (byte b2 = 0; b2 < paramb.c; b2++) {
      byte b3;
      for (b3 = 0; b3 < this.c; b3++) arrayOfDouble1[b3] = paramb.a[b3][b2];
      for (b3 = 0; b3 < this.b; b3++) {
        double[] arrayOfDouble2 = this.a[b3];
        double d = 0.0D;
        for (byte b4 = 0; b4 < this.c; b4++) d += arrayOfDouble2[b4] * arrayOfDouble1[b4];
  ...
  public Matrix d(Matrix paramb) {
    return (this.b == this.c)
        ? (new MatrixInverter(this)).a(paramb)
        : (new MatrixOrthogonalizer(this)).a(paramb);
  }
  ...
  public static Matrix b(int paramInt1, int paramInt2) {
    ...
    for (byte b2 = 0; b2 < paramInt1; b2++) {
      for (byte b3 = 0; b3 < paramInt2; b3++) arrayOfDouble[b2][b3] = (b2 == b3) ? 1.0D : 0.0D;
    }
    return b1;
  }
