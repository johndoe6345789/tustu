...
public class UInterfaceBravo {
  ...
  public static String c =
      " && AppEvent.dataLoggingActive == 0 && isTrueFor(!logPlaybackActive(), 2)";
  ...
  public static String SInterfaceAlpha(SInterfaceJuliet paramj, int paramInt) {
    ...
    if (str2.trim().isEmpty()) str2 = str1;
    return str2;
  }
  ...
  public static double SInterfaceAlpha(R paramR) {
    ...
    if (arrayOfString.length == 3
        && (arrayOfString[1].equals("<")
            || arrayOfString[1].equals("=")
            || arrayOfString[1].equals(">"))
        && I.SInterfaceAlpha(arrayOfString[2])) {
  ...
  public static void SInterfaceAlpha(R paramR, int paramInt) {
    ...
    try {
      SInterfaceEcho.SInterfaceAlpha()
          .SInterfaceAlpha(paramR.c(), (SInterfaceAlpha) SInterfaceJuliet);
    } catch (q q) {
