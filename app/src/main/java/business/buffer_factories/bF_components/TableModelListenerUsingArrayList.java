...
public class TableModelListenerUsingArrayList extends JPanel implements TableModelListener {
  ...
  public TableModelListenerUsingArrayList(y paramy) {
    ...
    for (byte b = 0; b < arrayOfString1.length && !bool; b++) {
      for (byte b1 = 0; b1 < (arrayOfString1[0]).length && !bool; b1++) {
        if (arrayOfString1[b][b1] != null && arrayOfString1[b][b1].length() > 0) bool = true;
      }
    }
    if (bool) {
  ...
  private JToolBar f() {
    ...
    Image image =
        Toolkit.getDefaultToolkit().getImage(w.class.getResource("resources/equal_sign_16.png"));
    ...
    this.r.add(jButton);
    image =
        Toolkit.getDefaultToolkit().getImage(w.class.getResource("resources/minus_sign_16.png"));
    image = eJ.a(image, this);
    imageIcon = new ImageIcon(image);
    jButton = new JButton(null, imageIcon);
    jButton.setFocusable(false);
    ...
    this.r.add(jButton);
    image =
        Toolkit.getDefaultToolkit().getImage(w.class.getResource("resources/times_sign_16.png"));
    image = eJ.a(image, this);
    imageIcon = new ImageIcon(image);
    jButton = new JButton(null, imageIcon);
    jButton.setFocusable(false);
  ...
  public Dimension getPreferredSize() {
    byte b1 = (!d() || this.a.h().f()) ? 0 : (this.SComponentGolf.getPreferredSize()).height;
    byte b2 = (d() && this.a.h().f()) ? (this.SComponentGolf.getPreferredSize()).width : 0;
    if (this.q > 0 && !this.p) return c(this.q);
    ...
    if (this.a.h().f()) i = Math.max((this.SComponentGolf.getPreferredSize()).height, i);
  ...
  public void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    if (this.a != null && paramInt3 > 0 && paramInt4 > 0) {
      if (Math.abs(paramInt4 - this.n) > 3 || this.o != paramInt3) {
        this.n = paramInt4;
        byte b1 =
            (this.a.h().f() || !this.SComponentGolf.isVisible())
                ? 0
                : (this.SComponentGolf.getPreferredSize()).height;
        byte b2 =
            (this.a.h().f() && this.SComponentGolf.isVisible())
                ? (this.SComponentGolf.getPreferredSize()).width
                : 0;
        ...
        this.e =
            (paramInt4 - (getInsets()).top - (getInsets()).bottom - b1)
                / (this.a.getModel().getRowCount() + 1);
        if (this.e > 0) {
          this.a.setRowHeight(this.e);
          i4 =
              paramInt4
                  - b1
                  - this.e * this.a.getModel().getRowCount()
                  - (getInsets()).top
                  - (getInsets()).bottom;
  ...
  public void a(ef[] paramArrayOfef) {
    if (!b(paramArrayOfef)) {
      ...
      if (paramArrayOfef.length > 0) this.a.changeSelection(i, j, false, false);
      if (paramArrayOfef.length > 1) this.a.changeSelection(k, m, false, true);
    }
  }

  private boolean b(ef[] paramArrayOfef) {
    List<ef> list = k();
    if (list.size() != paramArrayOfef.length) return false;
    for (byte b = 0; b < paramArrayOfef.length; b++) {
      if (paramArrayOfef[b].a() != ((ef) list.get(b)).a()
          || paramArrayOfef[b].b() != ((ef) list.get(b)).b()) return false;
    }
    return true;
  }
  ...
  private List k() {
    ...
    for (byte b = 0; b < arrayOfInt1.length; b++) {
      for (byte b1 = 0; b1 < arrayOfInt2.length; b1++) {
        ...
        if ((!this.a.h().SComponentGolf() || r.a() != 0)
            && (!this.a.h().h() || r.a() != this.a.h().a() - 1))
  ...
  public void a(eo parameo) {
    if (!this.l.contains(parameo)) this.l.add(parameo);
  }

  private void a(List paramList) {
    ef[] arrayOfEf = (ef[]) paramList.toArray((Object[]) new ef[paramList.size()]);
    for (eo eo : this.l) eo.a(arrayOfEf);
  }
  ...
  public void b(boolean paramBoolean) {
    ...
    for (Component component : this.r) {
      if (component instanceof r) ((r) component).setEnabled(isEnabled());
    }
    if (!paramBoolean) {
