...
class JTableExtensionGetcelleditor extends JTable {
  ...
  public JTableExtensionGetcelleditor(
      d paramd, Object[][] paramArrayOfObject, String[] paramArrayOfString) {
  ...
  public TableCellRenderer getCellRenderer(int paramInt1, int paramInt2) {
    if (this.a == null) this.a = new p(this.b);
  ...
  public TableCellEditor getCellEditor(int paramInt1, int paramInt2) {
    ...
    if (tableCellEditor != null) tableCellEditor.cancelCellEditing();
