...
public class ManagerGetcolumnname implements TableModel {
  ...
  private boolean d(int paramInt1, int paramInt2) {
    for (A a : this.j) {
      if (a.b == paramInt2 && a.a == paramInt1) return true;
    }
    return false;
  }
  ...
  private void a(Double paramDouble, int paramInt1, int paramInt2) {
    for (B b : this.b) b.a(paramInt1, paramInt2, paramDouble.doubleValue());
    if (this.e) {
      int i = paramInt2;
      paramInt2 = paramInt1;
      paramInt1 = i;
  ...
  public void a(B paramB) {
    if (!this.b.contains(paramB)) this.b.add(paramB);
  }
  ...
  public void addTableModelListener(TableModelListener paramTableModelListener) {
    if (!this.c.contains(paramTableModelListener)) this.c.add(paramTableModelListener);
  }
  ...
  public String[][] d() {
    if (this.e) {
      ...
      for (byte b1 = 0; b1 < arrayOfString1.length; b1++) arrayOfString1[b1][0] = this.d.a(b1);
      return arrayOfString1;
    }
    String[][] arrayOfString = new String[k()][1];
    for (byte b = 0; b < arrayOfString.length; b++) arrayOfString[b][0] = c(b).b();
  ...
  public String[] e() {
    ...
    if (h()) {
      ...
      for (byte b1 = 0; b1 < arrayOfString1.length; b1++)
        arrayOfString1[b1] =
            X.c(
                ((C) this.a.get(this.a.size() - 1)).a(b1).doubleValue(),
                ((C) this.a.get(this.a.size() - 1)).c());
      return arrayOfString1;
    }
    String[] arrayOfString = new String[b()];
    for (byte b = 0; b < arrayOfString.length; b++) arrayOfString[b] = this.d.a(b);
    return arrayOfString;
  }
  ...
  public Double[][] i() {
    ...
    for (byte b = 0; b < this.a.size(); b++) {
      C c = this.a.get(b);
      for (byte b1 = 0; b1 < c.a(); b1++) arrayOfDouble[b][b1] = c.a(b1);
    }
  ...
  public void a(Double[][] paramArrayOfDouble) {
    for (byte b = 0; b < this.a.size(); b++) {
      C c = this.a.get(b);
      for (byte b1 = 0; b1 < c.a(); b1++) c.b(b1, paramArrayOfDouble[b][b1]);
    }
  }
