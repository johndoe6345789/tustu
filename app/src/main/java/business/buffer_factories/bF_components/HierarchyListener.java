...
public class HierarchyListener extends JTable implements ClipboardOwner, HierarchyListener {
  ...
  public HierarchyListener(y paramy) {
    super(paramy);
  ...
  protected TableModel createDefaultDataModel() {
    ...
    for (byte b = 0; b < c.a(); b++) c.a(b, Double.valueOf(50.0D));
    y.a(c);
    return y;
  }
  ...
  public void e() {
    ...
    for (int i = getSelectedRow(); i < y.getRowCount() && stringTokenizer.hasMoreTokens(); i++) {
      ...
      for (int j = getSelectedColumn();
          j < y.getColumnCount() && stringTokenizer1.hasMoreTokens();
          j++) {
  ...
  public TableCellRenderer getCellRenderer(int paramInt1, int paramInt2) {
    y y = (y) getModel();
    if (!getFont().equals(this.b)) setFont(this.b);
    if (y.f()) {
      x().a(paramInt2);
    } else {
      x().a(paramInt1);
    ...
    if (color != null) {
      ...
      color =
          fh.a(double_.doubleValue(), y.a(paramInt1, paramInt2).d(), y.a(paramInt1, paramInt2).e());
      x().setBackground(color);
      x().setForeground(Color.black);
    } else {
    ...
    if (getModel().getValueAt(paramInt1, paramInt2) != null) {
      double d =
          ((Double) y.getValueAt(paramInt1, paramInt2)).doubleValue()
              - Double.valueOf(y.c(paramInt1, paramInt2)).doubleValue();
      ...
      if (!y.b(paramInt1, paramInt2) && x() != null) {
        try {
          ...
          stringBuilder
              .append("<html>")
              .append(b("Beginning Value"))
              .append(": ")
              .append(X.c(y.c(paramInt1, paramInt2), b()));
  ...
  private Image z() {
    if (this.j == null
        || this.j.getWidth(null) != getWidth()
        || this.j.getHeight(null) != getHeight()) this.j = createImage(getWidth(), getHeight());
    return this.j;
  }
    ...
    for (byte b = 0; b < i; b++) {
      for (byte b1 = 0; b1 < j; b1++) {
        if (b1 >= k && b1 <= m) {
          double d1 = d - k;
          double d2 =
              ((Double) y.getValueAt(b, k)).doubleValue() * (1.0D - d1)
                  + ((Double) y.getValueAt(b, m)).doubleValue() * d1;
  ...
  public void k() {
    ...
    if (arrayOfInt1 != null && arrayOfInt1.length > 0) b((d(arrayOfInt1[0], arrayOfInt2[0]) * u()));
  }

  public void l() {
    if (!this.E || (!d() && getSelectedColumn() >= 0 && getSelectedRow() >= 0)) return;
    s();
    y y = (y) getModel();
  ...
  public void n() {
    ...
    String str =
        bV.a(
            "{" + b("Multiply Selected Cells by: ex. 1.2 = raise by 20%") + "}",
            true,
            b("Scale Cells"),
            true,
            this);
  ...
  public void o() {
    ...
    this.e = false;
    String str =
        bV.a("{" + b("Increase Selected Cells by") + ":}", true, b("Add To Cells"), true, this);
    this.e = true;
    requestFocus();
    if (str != null && !str.equals("")) {
      double d = Double.parseDouble(str);
    ...
    if (r().f()) {
      if (arrayOfInt2.length > 1)
        for (byte b = 0; b < arrayOfInt1.length; b++) {
          ...
          double d2 =
              ((Double) h().getValueAt(arrayOfInt2[arrayOfInt2.length - 1], arrayOfInt1[b]))
                  .doubleValue();
  ...
  public void q() {
    ...
    String str =
        bV.a(
            "{" + b("Decrease Selected Cells by") + ":}",
            true,
            b("Subtract From Cells"),
            true,
            this);
    this.e = true;
    requestFocus();
    ...
    for (byte b = 0; b < getColumnCount(); b++) {
      for (byte b1 = 0; b1 < getRowCount(); b1++) {
        if (isCellSelected(b1, b)) {
          ...
          if (double_ != null) y.setValueAt(Double.valueOf(paramDouble), b1, b);
        }
      }
    }
    repaint();
  ...
  public void t() {
    ...
    this.e = false;
    String str =
        bV.a("{" + b("Set Selected Cells to") + ":}", true, b("Set Cell Values"), true, this);
    this.e = true;
    requestFocus();
    if (str != null && !str.equals("")) {
      double d = Double.parseDouble(str);
  ...
  public void b(int paramInt1, int paramInt2) {
    ...
    if (d()) jPopupMenu.add(b("Paste CTRL-V")).addActionListener(g);
    jPopupMenu.addSeparator();
    ...
    if (paramKeyEvent.getID() == 401 && paramKeyEvent.getKeyCode() == 10 && isEditing()) {
      this.F = true;
        ...
        && (I.a(paramKeyEvent.getKeyChar() + "")
            || (paramKeyEvent.getKeyCode() == 8 && !this.r.isEmpty()))
        && ((paramKeyEvent.getKeyCode() != 46 && paramKeyEvent.getKeyCode() != 110)
            || (!this.r.isEmpty() && !this.r.contains(".")))) {
      this.s = System.currentTimeMillis();
      if (paramKeyEvent.getKeyCode() == 8) {
        if (!this.r.isEmpty()) this.r = this.r.substring(0, this.r.length() - 1);
  ...
  protected N x() {
    if (this.w == null) this.w = new N(this, this);
    return this.w;
  }
  ...
  private void a(String paramString1, String paramString2) {
    if (this.y != null) this.y.a(paramString1, paramString2);
  }
