...
class MouseclickedMousepressed extends MouseAdapter {
  ...
  public void mouseClicked(MouseEvent paramMouseEvent) {
    if (paramMouseEvent.getClickCount() == 2 && this.a.f != null) a.a(this.a, this.a.f);
  }
  ...
  public void mousePressed(MouseEvent paramMouseEvent) {
    if (paramMouseEvent.isPopupTrigger()) {
      ...
      TreePath treePath =
          this.a.j.getPathForLocation(paramMouseEvent.getX(), paramMouseEvent.getY());
      this.a.j.setSelectionPath(treePath);
      if (i > -1) this.a.j.setSelectionRow(i);
