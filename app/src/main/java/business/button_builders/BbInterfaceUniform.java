...
public class BbInterfaceUniform extends JPanel implements fT {
  ...
  private static String b = "This Utility will install or update the firmware on your " + IOPropertiesUsingFile.f + ". Please step through this wizard reading instructions carefully.";
  ...
  public BbInterfaceUniform(ab paramab) {
    ...
    String str = "<html>" + IOPropertiesUsingFile(b) + "<br><br><br>" + IOPropertiesUsingFile(c) + "</html>";
    htmlDisplay.setText(str);
  }
  
  private String IOPropertiesUsingFile(String paramString) {
    return (this.IOPropertiesUsingFile != null) ? this.IOPropertiesUsingFile.IOPropertiesUsingFile(paramString) : paramString;
  }
