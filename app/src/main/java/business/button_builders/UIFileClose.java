...
public class UIFileClose extends JPanel implements AeInterfaceEcho, bc, fT {
  ...
  private static final File AeInterfaceQuebec =
      new File(ThreadedFile.C(), "firmwareLoader/tuneRestore.html");
  ...
  public void close() {
    ...
    ExceptionInVPackage.ExceptionInVPackage()
        .b(ExceptionInVPackage.bw, Boolean.toString(this.ThreadedFile));
  ...
  public boolean ExceptionInVPackage() {
    ...
    this.ExceptionInVPackage =
        new File(
            ...
            "PreFirmwareUpgrade_"
                + X.ExceptionInVPackage(new Date())
                + "."
                + ExceptionInVPackage.cw);
    NetworkHashMap.ExceptionInVPackage()
        .AeInterfaceEcho(this.b, this.ExceptionInVPackage.getAbsolutePath());
  ...
  private void ExceptionInVPackage(FileUsingHashMap paramk, AeInterfaceMikeTostring parambT) {
    ...
    if (file1 == null) {
      String str =
          "Unable to update project ECU Definition file. No proper match found in this firmware"
              + " package.\n"
    ...
    if (ExceptionInVPackage == null)
      throw new ExceptionInVPackage(
          "Unable to update project ECU Definition file. No Project open.");
  ...
  private void NetworkHashMap() {
    this.i =
        ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.bu, ExceptionInVPackage.bv);
  ...
  private void SComponentGolf() {
    ...
    NetworkHashMap.ExceptionInVPackage().c(false);
    NetworkHashMap.ExceptionInVPackage()
        .ExceptionInVPackage(bV.b(this), this.b, this.ExceptionInVPackage.getAbsolutePath());
  }

  public void ExceptionInVPackage(
      FileUsingHashMap paramk, AeInterfaceQuebec paramq, IOInAePackage paramp) {
  ...
  private void h() {
    ...
    this.d.setEnabled(false);
    if (this.l.SComponentGolf()) c();
    z z = new z(this);
    z.start();
  }

  private boolean i() {
    if (!this.l.SComponentGolf()) this.n = System.currentTimeMillis();
    ...
    if (this.b == null)
      throw new ExceptionInVPackage(
          "There is no Main Configuration set, can not load calibration.");
    this.b.C().ExceptionInVPackage(this.SComponentGolf);
    this.b.O().b(false);
    ...
    try {
      ...
      while (b < 3) {
        ...
        if (AeInterfaceMikeTostring == null
            || (AeInterfaceMikeTostring.ExceptionInVPackage()).length == 3) {
          bV.d(
              SComponentGolf.b("Is your Controller powered and boot jumper removed?")
                  + "\n"
                  + SComponentGolf.b("If so, try power cycling your controller."),
              this);
          b++;
        }
      }
      ...
      throw new ExceptionInVPackage(
          "Unable to read serial signature, can not restore calibration.");
    } catch (l l) {
    ...
    if (T.ExceptionInVPackage().c() != null) T.ExceptionInVPackage().c().C().c();
    NetworkHashMap();
    return true;
  }
