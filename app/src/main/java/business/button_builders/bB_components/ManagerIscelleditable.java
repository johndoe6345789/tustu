...
class ManagerIscelleditable extends DefaultTableModel {
  String[] a =
      new String[] {h.a(this.b, "Field Name"), h.a(this.b, "Scaling"), h.a(this.b, "Digits")};
  ...
  public Object getValueAt(int paramInt1, int paramInt2) {
    if (this.b.c().size() > 0) {
      if (paramInt2 == 0) return ((r) this.b.c().get(paramInt1)).e();
      if (paramInt2 == 1) {
        r r1 = this.b.c().get(paramInt1);
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder
            .append(h.a(this.b, "Min"))
            .append(": ")
            .append(r1.c() ? "Auto" : Double.valueOf(r1.a()))
            .append(" / ")
            .append(h.a(this.b, "Max"))
            .append(": ")
            .append(r1.d() ? "Auto" : Double.valueOf(r1.b()));
