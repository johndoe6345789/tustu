...
public class JPanelExtensionSetenabled extends JPanel {
  ...
  public void a(List paramList) {
    ...
    this.c.addItem(" ");
    for (String str : paramList) this.c.addItem(str);
  }
  ...
  public boolean a(r paramr1, r paramr2) {
    return (paramr1.e().equals(paramr2.e())
        && (paramr1.a() == paramr2.a() || (Double.isNaN(paramr1.a()) && Double.isNaN(paramr2.a())))
        && (paramr1.b() == paramr2.b()
            || (Double.isNaN(paramr1.b()) && Double.isNaN(paramr2.b()))));
  }
