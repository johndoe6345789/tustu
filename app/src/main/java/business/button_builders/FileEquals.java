...
class FileEquals {
  ...
  public boolean equals(Object paramObject) {
    return (paramObject instanceof K && this.c != null)
        ? ((K) paramObject).a().equals(this.c)
        : ((paramObject instanceof File && this.c != null)
            ? ((File) paramObject).equals(this.c)
            : super.equals(paramObject));
  }

  public String toString() {
    String str = null;
    if (this.b.j != null) str = this.b.j.a(this.c);
    if (str == null) str = this.d.h().a(this.c);
    return (str == null || str.isEmpty())
        ? this.c.getName()
        : (this.a
            ? (str + " (" + this.c.getName() + ") - Recommended")
            : (str + " (" + this.c.getName() + ")"));
  }
}
