...
public class UICloseInBlPackage extends JPanel implements bc {
  ...
  public UICloseInBlPackage(ApplicationPlugin paramApplicationPlugin) {
    ...
    try {
      ...
      if (paramApplicationPlugin.getHelpUrl() != null && paramApplicationPlugin.getHelpUrl().length() > 0) {
        JMenuItem jMenuItem1 = new JMenuItem(SComponentGolf.b("Online Help for " + paramApplicationPlugin.getDisplayName()));
  ...
  public void b() {
    ...
    String str2 = "<html><body><center><h2>" + this.IOPropertiesUsingFile.getDisplayName() + " version " + this.IOPropertiesUsingFile.getVersion() + "</h2><h3>implemented as IOPropertiesUsingFile " + IOPropertiesUsingFile.b + " Plugin</h3></center>Written by " + this.IOPropertiesUsingFile.getAuthor() + "<br><br>" + str1 + "<br>";
    if (this.IOPropertiesUsingFile.getHelpUrl() != null)
      str2 = str2 + "<br>For More Information on this plugin see: <IOPropertiesUsingFile href=\"" + this.IOPropertiesUsingFile.getHelpUrl() + "\">Online Help</IOPropertiesUsingFile>"; 
    str2 = str2 + "</body></html>";
