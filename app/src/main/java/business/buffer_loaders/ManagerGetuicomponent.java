...
public class ManagerGetuicomponent implements UiSettingServer {
  ...
  public JComponent getUiComponent(String paramString) {
    ...
    if (this.a.e().c(paramString) != null) {
      ArrayListExceptionprintstacktraceInGPackage ArrayListExceptionprintstacktraceInGPackage =
          this.a.e().c(paramString);
      return (JComponent)
          new ExceptionEqualsinaipackage(this.a, ArrayListExceptionprintstacktraceInGPackage);
    }
  ...
  private void a(Component paramComponent) {
    ...
    if (paramComponent instanceof Container) {
      ...
      for (byte b = 0; b < container.getComponentCount(); b++) a(container.getComponent(b));
    }
  }
    ...
    if (this.b == null) {
      ...
      while (iterator.hasNext()) {
        ...
        if (!(ArrayListExceptionprintstacktraceInGPackage instanceof CloneableImpl)
            && !(ArrayListExceptionprintstacktraceInGPackage instanceof CloneableImplInGPackage))
  ...
  public List getUiTable() {
    if (this.c == null) {
      ...
      while (iterator.hasNext()) this.c.add(q.a(iterator.next()));
    }
    return this.c;
  }
}
