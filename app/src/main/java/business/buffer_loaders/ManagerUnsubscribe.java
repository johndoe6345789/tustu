...
public class ManagerUnsubscribe implements ControllerParameterServer {
  ...
  public void subscribe(
      String paramString1,
      String paramString2,
      ControllerParameterChangeListener paramControllerParameterChangeListener) {
    try {
  ...
  public ControllerParameter getControllerParameter(String paramString1, String paramString2) {
    R r = T.a().c(paramString1);
    if (r == null) throw new ControllerException("No Controller Configuration loaded");
    Manager Manager = r.c(paramString2);
    if (Manager == null)
      throw new ControllerException(
          "Controller Parameter not found in working controller configuration.\n" + r.c());
  ...
  public void updateParameter(
      String paramString1, String paramString2, double[][] paramArrayOfdouble) {
    try {
      R r = T.a().c(paramString1);
      Manager Manager = r.c(paramString2);
  ...
  public void burnData(String paramString) {
    R r = T.a().c(paramString);
    if (r == null) throw new ControllerException("No Controller found by name of: " + paramString);
  }
}
