...
public class AyInterfaceAlpha implements e {
  ...
  private void h() {
    this.e.clear();
    for (e e1 : this.b) e1.a();
  }

  private void i() {
    j();
    for (e e1 : this.b) e1.b();
  }
  ...
  private void b(c paramc) {
    for (p p : this.c) p.d(paramc);
  }

  private void c(c paramc) {
    for (p p : this.c) p.c(paramc);
  }

  private boolean a(List paramList, c paramc) {
    for (c c1 : paramList) {
      if (c1.a().equals(paramc.a()) && c1.c().equals(paramc.c())) return true;
    }
    return false;
  }
