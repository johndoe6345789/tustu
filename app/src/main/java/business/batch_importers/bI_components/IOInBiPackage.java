...
public class IOInBiPackage {
  ...
  private static byte[] b(
      byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2, int paramInt1, int paramInt2) {
  ...
  private static byte[] b(
    ...
    int i =
        ((paramInt2 > 0) ? (paramArrayOfbyte1[paramInt1] << 24 >>> 8) : 0)
            | ((paramInt2 > 1) ? (paramArrayOfbyte1[paramInt1 + 1] << 24 >>> 16) : 0)
            | ((paramInt2 > 2) ? (paramArrayOfbyte1[paramInt1 + 2] << 24 >>> 24) : 0);
    switch (paramInt2) {
      case 3:
  ...
  public static String a(byte[] paramArrayOfbyte) {
    ...
    try {
      ...
      if (!a) throw new AssertionError(iOException.getMessage());
    }
    if (!a && str == null) throw new AssertionError();
    return str;
  }
  ...
  public static byte[] b(byte[] paramArrayOfbyte, int paramInt1, int paramInt2, int paramInt3) {
    if (paramArrayOfbyte == null) throw new NullPointerException("Cannot serialize a null array.");
    if (paramInt1 < 0)
  ...
  private static int b(
      ...
      int paramInt2,
      int paramInt3) {
    if (paramArrayOfbyte1 == null) throw new NullPointerException("Source array was null.");
    if (paramArrayOfbyte2 == null) throw new NullPointerException("Destination array was null.");
    if (paramInt1 < 0 || paramInt1 + 3 >= paramArrayOfbyte1.length)
      throw new IllegalArgumentException(
          String.format(
              "Source array with length %d cannot have offset of %d and still process four bytes.",
              new Object[] {
                Integer.valueOf(paramArrayOfbyte1.length), Integer.valueOf(paramInt1)
              }));
    if (paramInt2 < 0 || paramInt2 + 2 >= paramArrayOfbyte2.length)
      throw new IllegalArgumentException(
          String.format(
              "Destination array with length %d cannot have offset of %d and still store three"
                  + " bytes.",
              new Object[] {
                Integer.valueOf(paramArrayOfbyte2.length), Integer.valueOf(paramInt2)
              }));
    byte[] arrayOfByte = c(paramInt3);
    if (paramArrayOfbyte1[paramInt1 + 2] == 61) {
      int j =
          (arrayOfByte[paramArrayOfbyte1[paramInt1]] & 0xFF) << 18
              | (arrayOfByte[paramArrayOfbyte1[paramInt1 + 1]] & 0xFF) << 12;
    ...
    if (paramArrayOfbyte1[paramInt1 + 3] == 61) {
      int j =
          (arrayOfByte[paramArrayOfbyte1[paramInt1]] & 0xFF) << 18
              | (arrayOfByte[paramArrayOfbyte1[paramInt1 + 1]] & 0xFF) << 12
              | (arrayOfByte[paramArrayOfbyte1[paramInt1 + 2]] & 0xFF) << 6;
      paramArrayOfbyte2[paramInt2] = (byte) (j >>> 16);
    ...
    int i =
        (arrayOfByte[paramArrayOfbyte1[paramInt1]] & 0xFF) << 18
            | (arrayOfByte[paramArrayOfbyte1[paramInt1 + 1]] & 0xFF) << 12
            | (arrayOfByte[paramArrayOfbyte1[paramInt1 + 2]] & 0xFF) << 6
            | arrayOfByte[paramArrayOfbyte1[paramInt1 + 3]] & 0xFF;
  ...
  public static byte[] c(byte[] paramArrayOfbyte, int paramInt1, int paramInt2, int paramInt3) {
    ...
    if (paramInt2 == 0) return new byte[0];
    if (paramInt2 < 4)
      throw new IllegalArgumentException(
      ...
      if (b1 >= -5) {
        if (b1 >= -1) {
          ...
          if (b > 3) {
            ...
            b = 0;
            if (paramArrayOfbyte[k] == 61) break;
          }
        }
      } else {
        throw new IOException(
            String.format(
                ...
                new Object[] {Integer.valueOf(paramArrayOfbyte[k] & 0xFF), Integer.valueOf(k)}));
      }
    }
  ...
  public static byte[] a(String paramString, int paramInt) {
    if (paramString == null) throw new NullPointerException("Input string was null.");
    float f = q.c();
  ...
  public static String b(String paramString) {
    ...
    try {
      ...
      while ((j = b.read(arrayOfByte, i, 4096)) >= 0) i += j;
