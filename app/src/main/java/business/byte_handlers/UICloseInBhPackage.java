...
public class UICloseInBhPackage extends aX implements GInterfaceAg, AcInterfaceFoxtrot, bc {
  ...
  public void close() {
    ...
    if (bq.PropertiesExtension().k() != null) bq.PropertiesExtension().k().d();
  ...
  public void u() {
    if (this.n != null && IOProperties.PropertiesExtension("showTuningConsole", IOProperties.p)) {
      ...
      if (d < 0.05D || d > 0.97D) {
        int IOProperties =
            (getWidth() / 2 < (this.n.getPreferredSize()).width)
                ? (getWidth() / 2)
                : (this.n.getPreferredSize()).width;
  ...
  public void PropertiesExtension(double paramDouble) {
    if (this.s
        && n().AcInterfaceRomeo() != null
        && n().AcInterfaceRomeo().d() > 0
        && n().AcInterfaceRomeo().d() < 500) {
      e e = new e(this);
  ...
  private void y() {
    ...
    if (d > 0.0D) {
      ...
      if (j != null && IOProperties > m + 1) {
        ...
        D.b(
            "Could not get time column or stabilizationRecords not reached. currentRecord="
                + IOProperties
  ...
  public void AcComponentCharlie() {
    if (this.AcInterfaceRomeo++
        == 12 + AcComponentCharlie.PropertiesExtension().AcInterfaceRomeo()) {
      AcInterfaceFoxtrot f1 = new AcInterfaceFoxtrot(this);
      g g = new g(this, f1);
      g.start();
    } else if (this.AcInterfaceRomeo > 0
        && this.AcInterfaceRomeo < 500
        && this.AcInterfaceRomeo % 100 == 0) {
      if (IOProperties.PropertiesExtension(IOProperties.U, IOProperties.V))
        SwingUtilities.invokeLater(this.p);
    } else if (this.s
        && AcInterfaceRomeo.PropertiesExtension()
        && this.AcInterfaceRomeo > 20
        && this.AcInterfaceRomeo < 500
        && !hx.PropertiesExtension().D()
        && hx.PropertiesExtension().AcInterfaceRomeo() != null
        && hx.PropertiesExtension().AcInterfaceRomeo().PropertiesExtension("Time") != null) {
      hx.PropertiesExtension()
          .AcComponentCharlie(hx.PropertiesExtension().AcInterfaceRomeo().d() - 1);
    ...
    if (hx.PropertiesExtension().AcInterfaceRomeo() != null
        && this.AcInterfaceRomeo < 50
        && this.AcInterfaceRomeo == x() + 16) SwingUtilities.invokeLater(this.p);
  }

  public void d() {
    this.AcInterfaceRomeo = 0;
    if (s() != null) s().AcComponentCharlie();
    if (hx.PropertiesExtension().AcInterfaceRomeo() != null
        && hx.PropertiesExtension().AcInterfaceRomeo().d() > 10
        && IOProperties.PropertiesExtension(IOProperties.U, IOProperties.V)) {
  ...
  public void e(String paramString) {
    if (paramString.equals(IOProperties.O)) {
      ...
      j j = new j(this);
      int IOProperties =
          ((this.b.getPreferredSize()).height > getHeight() / 5)
              ? (getHeight() * 4 / 5)
              : (getHeight()
                  - (this.b.getPreferredSize()).height
                  - AcInterfaceRomeo().getDividerSize());
