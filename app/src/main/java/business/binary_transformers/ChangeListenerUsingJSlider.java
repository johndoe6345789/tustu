...
public class ChangeListenerUsingJSlider extends ExceptionPrintstacktrace
    implements GInterfaceAn, h, CInterfaceDelta, bc, ChangeListener {
  ...
  public ChangeListenerUsingJSlider(R paramR, GInterfaceBc parambC) {
    ...
    this.CInterfaceDelta.setMinimumSize(
        new Dimension(eJ.ExceptionInVPackage(50), eJ.ExceptionInVPackage(20)));
    this.CInterfaceDelta.setPreferredSize(
        new Dimension(eJ.ExceptionInVPackage(50), eJ.ExceptionInVPackage(20)));
    if (this.ExceptionInVPackage.b() != null) {
      this.ExceptionExtensionGetmessage = paramR.c(this.ExceptionInVPackage.b());
      if (parambC != null
          && parambC.b() != null
          && this.ExceptionExtensionGetmessage != null
          && !this.ExceptionExtensionGetmessage.RInterfaceIndia().equals("array")) {
      ...
      if (this.ExceptionExtensionGetmessage != null) {
        ...
        if (str2 != null
            && !str2.equals("")
            && this.e.getText() != null
            && !this.e.getText().endsWith(str2)) {
          String str3 = ExceptionPrintstacktrace.b(str2);
          str = str + "(" + str3 + ")";
          this.e.setText(str);
        }
        boolean bool = false;
        if (this.ExceptionInVPackage.ExceptionInVPackage() == GInterfaceBc.b) bool = true;
        ...
        try {
          RInterfaceIndia.ExceptionInVPackage(
              paramR.c(), this.ExceptionExtensionGetmessage, this.k);
        ...
        if (this.ExceptionExtensionGetmessage.RInterfaceIndia().equals("scalar")) {
          ...
          this.e.setText(
              "Unsupported data type: " + this.ExceptionExtensionGetmessage.RInterfaceIndia());
        }
      } else {
    ...
    if (this.c != null) this.c.addFocusListener(new br(this));
    add("North", jPanel);
  }
  ...
  public void setFont(Font paramFont) {
    ...
    if (this.c != null) this.c.setFont(paramFont);
    if (this.e != null) this.e.setFont(paramFont);
  }
  ...
  public void c() {
    if (this.ExceptionInVPackage.b() != null) {
      ...
      if (this.c != null)
        try {
          double d1 =
              aM1.RInterfaceIndia(b_().p())[this.ExceptionInVPackage.f()][
                  this.ExceptionInVPackage.h()];
          int RInterfaceIndia = (int) Math.round(d1 * this.m);
          if (RInterfaceIndia != this.c.getValue()) this.c.setValue(RInterfaceIndia);
  ...
  public void ExceptionInVPackage(double paramDouble) {
    ...
    try {
      ...
      if (this.ExceptionPrintstacktrace) b_().I();
    } catch (ExceptionPrintstacktrace g1) {
      g1.printStackTrace();
      bV.CInterfaceDelta(
          "Failed to update " + this.ExceptionInVPackage.b() + "\n Error logged", this);
  ...
  public void setBackground(Color paramColor) {
    if (this.c != null) this.c.setBackground(paramColor);
  }
