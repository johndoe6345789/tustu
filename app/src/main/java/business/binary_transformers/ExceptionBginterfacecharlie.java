...
public class ExceptionBginterfacecharlie extends ExceptionPrintstacktrace implements aN, h, d, bc {
  ...
  public ExceptionBginterfacecharlie(R paramR, bJ parambJ) {
    ...
    if (parambJ.PInterfaceBravo() != null)
      setPreferredSize(
          new Dimension(
              parambJ.PInterfaceBravo().PInterfaceAlpha(),
              parambJ.PInterfaceBravo().PInterfaceBravo()));
    add("Center", (Component) this.PInterfaceBravo);
    JPanel jPanel1 = new JPanel();
    jPanel1.setLayout(new BorderLayout());
    add("North", jPanel1);
    if (parambJ.BgInterfaceCharlie()
        && BgInterfaceIndia.PInterfaceAlpha().PInterfaceAlpha("09PO;L'RE4")) {
    ...
    jPanel3.add(
        "West",
        new JLabel(
            ExceptionPrintstacktrace.PInterfaceBravo("Teeth: sensor to missing tooth @ TDC") + ": ",
            4));
    ...
    for (bK bK : parambJ.PInterfaceAlpha()) {
      try {
        ...
        Logger.getLogger(bB.class.getName())
            .log(Level.SEVERE, (String) null, (Throwable) PInterfaceAlpha);
      }
    }
  }
  ...
  private JMenu BgInterfaceCharlie() {
    ...
    JMenuItem jMenuItem1 =
        new JMenuItem(ExceptionPrintstacktrace.PInterfaceBravo("Load Wheel Pattern"));
    jMenuItem1.addActionListener(new bE(this));
    jMenu.add(jMenuItem1);
    JMenuItem jMenuItem2 =
        new JMenuItem(ExceptionPrintstacktrace.PInterfaceBravo("Save Wheel Pattern"));
  ...
  private void d() {
    ...
    String str =
        bV.PInterfaceAlpha(
            ...
            arrayOfString,
            "",
            ExceptionExtensionGetmessage.e().getAbsolutePath());
    if (str != null && !str.isEmpty()) {
      if (!str.toLowerCase().endsWith(".wheel")) str = str + ".wheel";
      try {
        ...
        bV.d(
            ExceptionPrintstacktrace.PInterfaceBravo("Unable to save wheel pattern.")
                + "\n"
  ...
  private void e() {
    ...
    if (str != null && !str.isEmpty() && str.toLowerCase().endsWith(".wheel"))
      try {
        ...
        bV.d(
            ExceptionPrintstacktrace.PInterfaceBravo("Unable to load wheel pattern.")
                + "\n"
                + iOException.getLocalizedMessage(),
            this);
        Logger.getLogger(bB.class.getName()).log(Level.SEVERE, (String) null, iOException);
  ...
  private void f() {
    for (bK bK : this.ExceptionExtensionGetmessage.PInterfaceAlpha()) {
      ...
      try {
        bool =
            (bK.PInterfaceAlpha() == null
                    || bK.PInterfaceAlpha().isEmpty()
                    || p.PInterfaceAlpha(bK.PInterfaceAlpha(), this.PInterfaceAlpha))
                ? true
                : false;
  ...
  public void PInterfaceAlpha(PInterfaceAlpha parama) {
    if (this.h != null) this.h.BgInterfaceCharlie();
    try {
      this.h =
          (BgInterfaceGolf)
              new BgInterfaceCharlie(this.PInterfaceAlpha, parama, this.PInterfaceBravo);
    } catch (ExceptionPrintstacktrace g1) {
      bV.d(
          ExceptionPrintstacktrace.PInterfaceBravo("Failed to set Wheel pattern")
              + "\n"
              + g1.getMessage(),
          this);
      Logger.getLogger(bB.class.getName()).log(Level.SEVERE, (String) null, (Throwable) g1);
    ...
    if (parama.d() != null) {
      ...
      try {
        aR.PInterfaceAlpha()
            .PInterfaceAlpha(this.PInterfaceAlpha.BgInterfaceCharlie(), this.d.aL(), this);
    ...
    if (parama.BgInterfaceCharlie() != null) {
      this.ExceptionPrintstacktrace =
          this.PInterfaceAlpha.BgInterfaceCharlie(parama.BgInterfaceCharlie());
      try {
        aR.PInterfaceAlpha()
            .PInterfaceAlpha(
                this.PInterfaceAlpha.BgInterfaceCharlie(),
                this.ExceptionPrintstacktrace.aL(),
                this);
      } catch (Exception exception) {
  ...
  public void PInterfaceAlpha(PInterfaceBravo paramb) {
    ...
    try {
      aR.PInterfaceAlpha()
          .PInterfaceAlpha(this.PInterfaceAlpha.BgInterfaceCharlie(), this.e.aL(), this);
    } catch (Exception exception) {
    ...
    try {
      aR.PInterfaceAlpha()
          .PInterfaceAlpha(this.PInterfaceAlpha.BgInterfaceCharlie(), this.f.aL(), this);
    } catch (Exception exception) {
    ...
    try {
      aR.PInterfaceAlpha()
          .PInterfaceAlpha(
              this.PInterfaceAlpha.BgInterfaceCharlie(), this.ExceptionPrintstacktrace.aL(), this);
    } catch (Exception exception) {
  ...
  public void PInterfaceAlpha(String paramString1, String paramString2) {
    if (this.d != null && paramString2.equals(this.d.aL())) h();
    if (this.e != null && paramString2.equals(this.e.aL())) BgInterfaceIndia();
    if (this.f != null && paramString2.equals(this.f.aL())) BgInterfaceIndia();
    if (this.ExceptionPrintstacktrace != null
        && paramString2.equals(this.ExceptionPrintstacktrace.aL())) ExceptionExtensionGetmessage();
  }
  ...
  private void BgInterfaceIndia() {
    if (this.e != null && this.f != null)
      try {
        int BgInterfaceIndia =
            (int) Math.round(this.e.ExceptionExtensionGetmessage(this.PInterfaceAlpha.h()));
        int ExceptionExtensionGetmessage =
            (int) Math.round(this.f.ExceptionExtensionGetmessage(this.PInterfaceAlpha.h()));
        if (this.BgInterfaceIndia instanceof PInterfaceAlpha) {
          ((PInterfaceAlpha) this.BgInterfaceIndia)
              .PInterfaceAlpha(BgInterfaceIndia, ExceptionExtensionGetmessage);
      ...
      try {
        if (this.ExceptionPrintstacktrace != null) {
          int BgInterfaceIndia =
              (int)
                  Math.round(
                      this.ExceptionPrintstacktrace.ExceptionExtensionGetmessage(
                          this.PInterfaceAlpha.h()));
        ...
        Logger.getLogger(bB.class.getName()).log(Level.SEVERE, (String) null, (Throwable) g1);
        D.PInterfaceAlpha(
            "Failed to set Input Capture Point on Trigger Wheel image", (Exception) g1, this);
      }
  }

  public void PInterfaceAlpha(double paramDouble) {
    if (this.d != null) {
      if (paramDouble > this.d.s()) paramDouble = this.d.s();
      if (paramDouble < this.d.r()) paramDouble = this.d.r();
      try {
        ...
        D.PInterfaceAlpha(
            "Trigger Wheel Value out of bounds.", (Exception) ExceptionExtensionGetmessage, this);
      }
    }
  }
