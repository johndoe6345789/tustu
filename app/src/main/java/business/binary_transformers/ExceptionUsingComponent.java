...
public class ExceptionUsingComponent extends ExceptionPrintstacktrace
    implements GInterfaceAn, L, bZ, ca, QInterfaceHotel, o, bc, cP {
  ...
  public ExceptionUsingComponent(R paramR, GComponentBq parambq) {
    ...
    try {
      RInterfaceIndia.ExceptionInVPackage(
          paramR.c(), this.f.ExceptionExtensionGetmessage(), this.q);
    } catch (ExceptionInVPackage ExceptionInVPackage) {
      Logger.getLogger(aV.class.getName())
          .log(
              Level.WARNING,
              "Unable to monitor label changes for " + this.f.l(),
    ...
    if (this.f.b() != null) {
      ...
      if (Manager != null) {
        ...
        try {
          ...
          Logger.getLogger(aV.class.getName())
              .log(
                  Level.WARNING,
                  "Unable to monitor units changes for " + Manager.aL(),
                  (Throwable) ExceptionInVPackage);
        }
        if (parambq.RInterfaceIndia()) {
          try {
            this.m =
                (JLabel) QInterfaceHotel.ExceptionInVPackage().ExceptionInVPackage(JLabel.class);
            this.m.setText("                             ");
          ...
          try {
            this.RInterfaceIndia =
                (y) QInterfaceHotel.ExceptionInVPackage().ExceptionInVPackage(y.class);
          } catch (Exception exception) {
          ...
          this.QInterfaceHotel = this.RInterfaceIndia;
            ...
            || Manager.RInterfaceIndia().equals("bits")
            || Manager.RInterfaceIndia().equals("array")) {
          try {
            this.ExceptionExtensionGetmessage =
                (A) QInterfaceHotel.ExceptionInVPackage().ExceptionInVPackage(A.class);
            if (parambq.k()) {
          ...
          if (!Manager.RInterfaceIndia().equals("array")) {
            ...
            this.r.setToolTipText(
                "<html> <b>D</b> or DOWN Arrow to decrease value<br> <b>+</b> or UP Arrow to"
                    + " increase value.</html>");
          }
          this.t = new aX(this);
      ...
      setFont(font);
      this.n.setFont(font);
      if (this.QInterfaceHotel != null) this.QInterfaceHotel.setFont(font);
      try {
        if (Manager != null) RInterfaceIndia.ExceptionInVPackage(paramR.c(), Manager, this);
      } catch (ExceptionInVPackage ExceptionInVPackage) {
        Logger.getLogger(aV.class.getName())
    ...
    if (this.QInterfaceHotel != null) this.QInterfaceHotel.addFocusListener(this.u);
  ...
  public void requestFocus() {
    if (this.QInterfaceHotel != null) this.QInterfaceHotel.requestFocus();
  }

  public void setFont(Font paramFont) {
    super.setFont(paramFont);
    if (this.QInterfaceHotel != null) this.QInterfaceHotel.setFont(paramFont);
    if (this.n != null) this.n.setFont(paramFont);
  }
  ...
  public void c(boolean paramBoolean) {
    ...
    if (this.r != null) this.r.setVisible(paramBoolean);
  }

  public boolean e() {
    return (this.ExceptionExtensionGetmessage != null
        && this.ExceptionExtensionGetmessage.isEditable());
  }
  ...
  public synchronized void f() {
    if (this.f != null && (this.f.b() != null || this.f.RInterfaceIndia())) {
      ...
      if (this.RInterfaceIndia != null) {
        try {
          if (!n().p().ExceptionExtensionGetmessage()
              && !this.RInterfaceIndia.ExceptionInVPackage(Manager.f(n().p()))
              && this.RInterfaceIndia.getItemCount() > 0) {
            if (isEnabled()) b(this.RInterfaceIndia.ExceptionInVPackage());
        ...
        try {
          ...
          D.ExceptionInVPackage(
              "Error in configuration, accessing ivalid index or addressing out of page.",
        ...
        if (this.f.ExceptionExtensionGetmessage() != null && this.f.RInterfaceIndia()) {
          try {
            ...
            if (this.f.k()) {
              int RInterfaceIndia =
                  Integer.parseInt(this.f.ExceptionExtensionGetmessage().ExceptionInVPackage());
  ...
  public int ExceptionPrintstacktrace() {
    if (this.ExceptionExtensionGetmessage != null) {
      ...
      if (d > Manager.s()) return 1;
      if (d < Manager.ExceptionInVPackage(this.f.f())) return 2;
    }
    return 0;
  }
  ...
  public void b(String paramString) {
    try {
      if (this.f == null || !p.ExceptionInVPackage(this.f.aJ(), n())) return;
    } catch (ExceptionPrintstacktrace g1) {
    }
    Manager Manager = n().c(this.f.b());
    try {
      if (Manager.RInterfaceIndia().equals("bits")) {
        ...
        if (d > Manager.s()) {
          String str =
              this.f.b()
                  + " "
                  + ExceptionPrintstacktrace.b("value")
                  + " "
                  + d
                  + " "
                  + ExceptionPrintstacktrace.b("is too high.")
                  + "\n"
                  + ExceptionPrintstacktrace.b("Must be less than:")
                  + " "
                  + Manager.s();
          ...
          String str =
              this.f.b()
                  ...
                  + d
                  + " "
                  + ExceptionPrintstacktrace.b("is too low.")
                  + "\n"
                  + ExceptionPrintstacktrace.b("Must be greater than:")
                  + " "
                  + Manager.ExceptionInVPackage(this.f.f());
          ExceptionInVPackage(str, this);
          RInterfaceIndia();
          f();
        } else {
      ...
      if (ExceptionExtensionGetmessage.ExceptionInVPackage() == 2) {
        String str1 =
            (this.n != null && !this.n.getText().isEmpty()) ? this.n.getText() : this.f.b();
        String str2 =
            str1
                + " value of "
        ...
        if (Manager.u() instanceof SerializableImplTostring) {
          SerializableImplTostring SerializableImplTostring =
              (SerializableImplTostring) Manager.u();
          String[] arrayOfString = SerializableImplTostring.b();
          if (arrayOfString != null
              && arrayOfString.length == 1
              && arrayOfString[0].equals(SerializableImplTostring.c().trim())) {
            String str =
                ExceptionprintstacktraceInGPackage.b(
                    this.ExceptionPrintstacktrace, arrayOfString[0]);
            if (str != null)
              str2 =
                  str2
                      + "\n\n"
        ...
        if (Manager.t() instanceof SerializableImplTostring) {
          SerializableImplTostring SerializableImplTostring =
              (SerializableImplTostring) Manager.t();
          String[] arrayOfString = SerializableImplTostring.b();
          if (arrayOfString != null
              && arrayOfString.length == 1
              && arrayOfString[0].equals(SerializableImplTostring.c().trim())) {
  ...
  public void close() {
    ...
    if (this.RInterfaceIndia != null) this.RInterfaceIndia.b(this);
  ...
  public boolean k() {
    ...
    if (str != null) {
      Manager Manager = n().c(this.f.b());
      if (Manager != null && !Manager.C()) return true;
    }
    return false;
  }
  ...
  public void setBackground(Color paramColor) {
    if (this.QInterfaceHotel != null) this.QInterfaceHotel.setBackground(paramColor);
  }

  public void setForeground(Color paramColor) {
    if (this.QInterfaceHotel != null) this.QInterfaceHotel.setForeground(paramColor);
  }
  ...
  public FocusListener[] getFocusListeners() {
    return (this.QInterfaceHotel != null)
        ? this.QInterfaceHotel.getFocusListeners()
  ...
  public void ExceptionInVPackage(int paramInt) {
    if (this.ExceptionExtensionGetmessage != null) this.ExceptionExtensionGetmessage.b(paramInt);
  }
  ...
  private void c(String paramString) {
    for (K k : this.x) k.b(paramString);
  }

  private void d(String paramString) {
    for (K k : this.x) k.ExceptionInVPackage(paramString);
  }
}
