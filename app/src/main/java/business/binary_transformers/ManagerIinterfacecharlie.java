...
public class ManagerIinterfacecharlie extends JPanel
    implements GInterfaceAn, GComponentCq, L, CInterfaceDelta, bS, bc {
  ...
  static final String ExceptionExtensionGetmessage =
      ExceptionPrintstacktrace.b("Selection Follow Mode") + " (CTRL+F)";
  ...
  public ManagerIinterfacecharlie(
      R paramR, CloneableImplInGPackage parambm, boolean paramBoolean, et paramet) {
    this.ExceptionInVPackage = paramR;
    this.q = parambm;
    if (paramet == null) paramet = new aQ(this);
    this.z = paramet;
    ...
    if (parambm.E()) {
      ...
      for (b1 = 0; b1 < parambm.ExceptionExtensionGetmessage(); b1++) {
        ...
        if (Manager == null)
          throw new ExceptionInVPackage(
              "CurveGraph X Parameter "
                  + parambm.CInterfaceDelta(b1)
                  + " not found in the current configuration.");
      ...
      for (b1 = 0; b1 < parambm.CInterfaceDelta(); b1++) {
        ...
        try {
          bool =
              (str != null
                      && RInterfaceIndia.ExceptionInVPackage(str, (GInterfaceAi) paramR) != 0.0D)
                  ? true
                  : false;
      ...
      if (this.b.size() == 0)
        bV.CInterfaceDelta(
            "No Y Axis Bins for CurveGraph "
                + parambm.aL()
                + "\nthe Y Axis must have at least 1 Y Axis Bin assigned.",
            this);
      ...
      for (b2 = 0; b2 < parambm.ExceptionPrintstacktrace(); b2++)
        RInterfaceIndia.ExceptionInVPackage(
            paramR.IInterfaceCharlie(), parambm.IInterfaceCharlie(b2), this);
      t();
      b2 = 0;
      for (byte b3 = 0; b3 < this.b.size(); b3++) {
        ManagerUsingConcurrentHashMap aR1 = ManagerUsingConcurrentHashMap.ExceptionInVPackage();
        try {
          aR1.ExceptionInVPackage(
              paramR.IInterfaceCharlie(), ((Manager) this.b.get(b3)).aL(), this);
          if (this.IInterfaceCharlie != null && this.IInterfaceCharlie.size() > b2)
            aR1.ExceptionInVPackage(
                paramR.IInterfaceCharlie(), ((Manager) this.IInterfaceCharlie.get(b2)).aL(), this);
        } catch (ExceptionInVPackage a1) {
          a1.printStackTrace();
          D.ExceptionInVPackage(
              "Error subscribing to ParameterValue Changes.", (Exception) a1, this);
        }
        if (this.IInterfaceCharlie.size() > b2 + 1) b2++;
      }
      try {
        v();
      } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
        D.ExceptionInVPackage(
            "Error accessing curve parameters", (Exception) ExceptionPrintstacktrace, this);
      }
      try {
        if (parambm.l() != null)
          ManagerUsingArrayList.ExceptionInVPackage()
              .ExceptionInVPackage(paramR.IInterfaceCharlie(), parambm.l(), this);
      } catch (ExceptionInVPackage a1) {
        D.ExceptionInVPackage(
            "Unable to subscribe x or y axis for hightlights.", (Exception) a1, this);
      }
      ...
      if (!this.F) {
        ...
        for (byte b = 0; b < this.b.size(); b++) {
          ...
          if (this.IInterfaceCharlie != null
              && this.IInterfaceCharlie.size() > b2
              && !((Manager) this.IInterfaceCharlie.get(b2)).H()
              && !this.p.l()) {
            ...
            ArrayListExceptionprintstacktraceInGPackage.ExceptionInVPackage(
                (ArrayListExceptionprintstacktraceInGPackage) bj1);
          }
          GComponentBj GComponentBj = new GComponentBj();
          IInterfaceCharlie IInterfaceCharlie =
              new IInterfaceCharlie(
                  (this.p.IInterfaceCharlie(b) != null)
                      ? this.p.IInterfaceCharlie(b)
                      : ((Manager) this.b.get(b)).aL());
          if (parambm.k() > b) GInterfaceDb = parambm.e(b);
          ...
          if (this.IInterfaceCharlie == null
              && this.IInterfaceCharlie.isEmpty()
              && this.p.l()
              && parambm.s() != null) {
      ...
      if (parambm.r() != null || parambm.w()) {
        ...
        try {
          ...
          D.ExceptionInVPackage(
              "Configuration File Error.", (Exception) ExceptionPrintstacktrace, this);
        }
      } else {
        this.u = new aL(this, this.r);
        this.p.add(this.u);
  ...
  private boolean IInterfaceCharlie(String paramString) {
    if (paramString == null || paramString.trim().isEmpty()) return true;
    try {
      ExceptionInVPackage a1 =
          CInterfaceDelta.ExceptionInVPackage().ExceptionInVPackage(paramString);
      double d1 = a1.ExceptionInVPackage(IInterfaceCharlie.ExceptionInVPackage().e(), 0);
      return true;
    } catch (Exception exception) {
      String str =
          ExceptionPrintstacktrace.b(
                  "Invalid Expression! Expression should reference fields within the data log.")
              + "\n"
  ...
  private void r() {
    if (this.p.A() != null && !this.p.A().x() && this.p.B() != null) {
      ...
      if (this.p.z() == 0) {
        ...
        for (byte b = 0; b < arrayOfInt.length; b++) arrayOfInt[b] = b;
      } else {
  ...
  private void s() {
    ...
    if (this.q.l() != null) {
      String str =
          ExceptionprintstacktraceInGPackage.ExceptionExtensionGetmessage(
              this.ExceptionInVPackage, this.q.l());
    ...
    if (bool1) {
      ...
      if (n != null) {
        ...
        if (str1 != null && n.ExceptionInVPackage(str1) != null) {
          if (this.p.A() != null) this.p.A().b(this.N);
        ...
        if (str2 != null && n.ExceptionInVPackage(str2) != null) {
          if (this.p.B() != null) this.p.B().b(this.N);
    ...
    for (byte b = 0; b < this.q.k(); b++) {
      ...
      try {
        bool =
            (str != null
                    && RInterfaceIndia.ExceptionInVPackage(
                            str, (GInterfaceAi) this.ExceptionInVPackage)
                        != 0.0D)
                ? true
                : false;
      } catch (ExceptionInAxPackage u) {
    ...
    if (this.p.z() > 0) {
      String str =
          bV.ExceptionInVPackage(
              "{" + ExceptionPrintstacktrace.b("Set Selected Cells to") + ":}",
              true,
              ExceptionPrintstacktrace.b("Set Cell Values"),
              true,
              this);
      requestFocus();
  ...
  public void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    if (this.w != null && this.w.isVisible()) {
      ...
      i2 =
          (i2 < ExceptionExtensionGetmessage * 4 / 5) ? (ExceptionExtensionGetmessage * 4 / 5) : i2;
      int i3 = i2;
  ...
  public void IInterfaceCharlie() {
    ...
    if (this.v != null) this.v.ExceptionInVPackage();
    if (this.w != null) this.w.ExceptionInVPackage();
  }
  ...
  public void ExceptionInVPackage(bP parambP) {
    e();
    this.J = parambP;
    if (parambP != null) parambP.ExceptionInVPackage();
  }

  public void b(bP parambP) {
    if (this.v != null) this.v.ExceptionInVPackage(parambP);
    if (this.w != null) this.w.ExceptionInVPackage(parambP);
  }

  public boolean f() {
    if (!this.r.isVisible() && this.p.w() < 0) this.p.b(this.I.ExceptionInVPackage);
    this.r.setVisible(!this.r.isVisible());
    this.z.ExceptionInVPackage("showText", this.r.isVisible() + "");
    if (this.u != null) this.u.setVisible(this.r.isVisible());
  ...
  protected void ExceptionPrintstacktrace() {
    try {
      for (byte b = 0; b < this.b.size(); b++) {
        double[][] arrayOfDouble =
            ((Manager) this.b.get(b)).RInterfaceIndia(this.ExceptionInVPackage.p());
        for (byte b1 = 0; b1 < arrayOfDouble.length; b1++) {
          ...
          if (arrayOfDouble[b1][0] < this.p.k()) this.p.e(arrayOfDouble[b1][0]);
        }
      }
    } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
      D.ExceptionInVPackage(
          "Error pulling curve y parameter values for CurveGraph: " + this.p,
    ...
    try {
      ...
      if (this.IInterfaceCharlie != null && this.IInterfaceCharlie.size() > 0) {
        for (byte b = 0; b < this.IInterfaceCharlie.size(); b++) {
          arrayOfDouble =
              ((Manager) this.IInterfaceCharlie.get(b))
                  .RInterfaceIndia(this.ExceptionInVPackage.p());
          for (byte b1 = 0; b1 < arrayOfDouble.length; b1++) {
            if (b == this.IInterfaceCharlie.size() - 1
                && this.b.size() > this.IInterfaceCharlie.size()) {
            ...
            if (arrayOfDouble[b1][0] > this.p.h()) this.p.b(arrayOfDouble[b1][0]);
      ...
      D.ExceptionInVPackage(
          "Error pulling x curve parameters", (Exception) ExceptionPrintstacktrace, this);
    }
    this.p.repaint();
  }
  ...
  private void ExceptionInVPackage(ef[] paramArrayOfef) {
    ...
    if (this.v != null) this.v.ExceptionInVPackage(paramArrayOfef);
    if (this.w != null) this.w.ExceptionInVPackage(paramArrayOfef);
  }
  ...
  private void ExceptionInVPackage(int paramInt) {
    if (this.r != null) b(this.r, paramInt);
  }
  ...
  public void close() {
    ...
    if (this.r != null) this.r.ExceptionInVPackage();
    if (this.v != null) this.v.close();
    if (this.w != null) this.w.close();
    e();
    this.H = true;
    if (this.K != null) IInterfaceCharlie.ExceptionInVPackage().b(this.K);
    if (this.p != null && this.p.A() != null) this.p.A().b(this.N);
    if (this.p != null && this.p.B() != null) this.p.B().b(this.N);
  }
  ...
  private boolean ExceptionInVPackage(ArrayList paramArrayList, String paramString) {
    Iterator<Manager> iterator = paramArrayList.iterator();
    while (iterator.hasNext()) {
      if (((Manager) iterator.next()).aL().equals(paramString)) return true;
    }
    return false;
  }
  ...
  public void ExceptionInVPackage(int paramInt1, int paramInt2, double paramDouble) {
    if (this.IInterfaceCharlie.isEmpty()) return;
    paramInt1 =
        (paramInt1 < this.IInterfaceCharlie.size())
            ? paramInt1
            : (this.IInterfaceCharlie.size() - 1);
    try {
      if (!this.ExceptionInVPackage.p().ExceptionExtensionGetmessage()
          && p.ExceptionInVPackage(this.P, this.ExceptionInVPackage))
        try {
          ((Manager) this.IInterfaceCharlie.get(paramInt1))
              .ExceptionInVPackage(this.ExceptionInVPackage.p(), paramDouble, paramInt2, 0);
        } catch (ExceptionExtensionGetmessage ExceptionExtensionGetmessage) {
          this.p.ExceptionInVPackage(
              paramInt1, paramInt2, ExceptionExtensionGetmessage.IInterfaceCharlie());
        } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
          D.ExceptionInVPackage(
              "Unable to set Curve X value of " + paramDouble,
              (Exception) ExceptionPrintstacktrace,
              this);
        }
    } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
  ...
  public void b(int paramInt1, int paramInt2, double paramDouble) {
    if (!this.ExceptionInVPackage.p().ExceptionExtensionGetmessage())
      try {
        ((Manager) this.b.get(paramInt1))
            .ExceptionInVPackage(this.ExceptionInVPackage.p(), paramDouble, paramInt2, 0);
      } catch (ExceptionExtensionGetmessage ExceptionExtensionGetmessage) {
        if (w()) this.p.b(paramInt1, paramInt2, ExceptionExtensionGetmessage.IInterfaceCharlie());
      } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
        D.ExceptionInVPackage(
            "Unable to set Curve Y value of " + paramDouble,
            (Exception) ExceptionPrintstacktrace,
            this);
      }
  }
  ...
  private void v() {
    ...
    for (b1 = 0; b1 < this.b.size(); b1++) {
      String str =
          (this.q.f(b1) != null)
              ? ExceptionPrintstacktrace.b(this.q.f(b1).ExceptionInVPackage())
              : null;
      ...
      if (this.IInterfaceCharlie.size() > 0) {
        boolean bool =
            (b1 < this.IInterfaceCharlie.size()) ? b1 : (this.IInterfaceCharlie.size() - 1);
        if (!((Manager) this.IInterfaceCharlie.get(bool)).p().equals(""))
          str =
              str
                  + " ("
                  + ExceptionPrintstacktrace.b(((Manager) this.IInterfaceCharlie.get(bool)).p())
                  + ")";
        ...
        if (b1 == 0)
          this.p.ExceptionPrintstacktrace(
              Math.max(IInterfaceCharlie(this.IInterfaceCharlie), this.p.q()));
      } else {
        this.p.ExceptionInVPackage(str, b1);
      }
    }
    ...
    for (byte b2 = 0; b2 < this.b.size(); b2++) {
      ...
      if (this.q.IInterfaceCharlie(b2) != null) {
        str =
            ExceptionPrintstacktrace.b(this.q.IInterfaceCharlie(b2).ExceptionInVPackage())
                + " "
                + ExceptionPrintstacktrace.b(((Manager) this.b.get(b2)).p());
      } else {
    ...
    if (d2 < this.q.b() || d2 > this.q.IInterfaceCharlie()) d2 = this.q.b();
    if (d1 == d2) {
    ...
    for (byte b3 = 0; b3 < this.b.size(); b3++) {
      double[][] arrayOfDouble1 =
          ((Manager) this.b.get(b3)).RInterfaceIndia(this.ExceptionInVPackage.p());
      double[][] arrayOfDouble2 = null;
      if (this.IInterfaceCharlie != null && this.IInterfaceCharlie.size() > 0) {
        arrayOfDouble2 =
            ((Manager) this.IInterfaceCharlie.get(b1))
                .RInterfaceIndia(this.ExceptionInVPackage.p());
        ...
        if (this.q.s() == null) {
          ...
          for (byte b = 0; b < arrayOfDouble2.length; b++)
            arrayOfDouble2[b][0] =
                (this.q.RInterfaceIndia() - this.q.h()) * b / arrayOfDouble2.length;
        } else {
          double[] arrayOfDouble = this.q.s();
          arrayOfDouble2 = new double[arrayOfDouble.length][1];
          for (byte b = 0; b < arrayOfDouble2.length; b++) arrayOfDouble2[b][0] = arrayOfDouble[b];
        }
      ...
      if (this.IInterfaceCharlie.size() > 0
          && (d5 < ExceptionInVPackage(this.IInterfaceCharlie) || d5 > b(this.IInterfaceCharlie))) {
        d5 = this.q.h();
      ...
      if (bool2 && this.IInterfaceCharlie != null) {
        ...
        for (byte b = 0; b < arrayOfDouble2.length; b++) {
          ...
          if (arrayOfDouble2[b][0] > d4 + ((Manager) this.IInterfaceCharlie.get(0)).B() * 2.0D) {
            double d6 =
                (arrayOfDouble2[b][0] + ((Manager) this.IInterfaceCharlie.get(0)).B() * 2.0D
                        > this.p.q())
                    ? arrayOfDouble2[b][0]
                    : (arrayOfDouble2[b][0] + ((Manager) this.IInterfaceCharlie.get(0)).B() * 2.0D);
            d4 = d6;
        ...
        for (byte b = 0; b < arrayOfDouble2.length; b++) {
          try {
            ...
            bV.CInterfaceDelta(
                "Invalid number of values for curve. All X and Y arrats must be of the same size.",
                this);
          }
        }
      }
      if (bool1) {
        ...
        for (byte b = 0; b < arrayOfDouble1.length; b++) {
          if (arrayOfDouble1[b][0] > d1 + ((Manager) this.b.get(b3)).B() * 2.0D) {
            double d6 =
                (arrayOfDouble1[b][0] + ((Manager) this.b.get(b3)).B() * 2.0D > this.p.r())
                    ? arrayOfDouble1[b][0]
                    : (arrayOfDouble1[b][0] + ((Manager) this.b.get(b3)).B() * 2.0D);
            d1 = d6;
          }
      ...
      this.p.b(d4);
      this.p.l((int) d3);
      if (this.IInterfaceCharlie.size() > b1 + 1) b1++;
    }
    if (this.q.z()) this.p.ExceptionInVPackage(true);
  }
  ...
  private boolean ExceptionInVPackage(Component paramComponent) {
    if (paramComponent instanceof Container) {
      ...
      for (Component component : container.getComponents()) {
        if (ExceptionInVPackage(component)) return true;
      }
    }
  ...
  private void CInterfaceDelta(String paramString) {
    for (K k : this.O) k.b(paramString);
  }

  private void e(String paramString) {
    for (K k : this.O) k.ExceptionInVPackage(paramString);
  }
  ...
  public void setEnabled(boolean paramBoolean) {
    ...
    if (this.u != null) this.u.setEnabled(paramBoolean);
    if (this.r != null) this.r.setEnabled(paramBoolean);
    if (this.v != null) this.v.setEnabled(paramBoolean);
    if (this.w != null) this.w.setEnabled(paramBoolean);
  }

  public void n() {
    if (this.A == null || !this.A.isAlive()) this.A = new aP(this);
  ...
  private void f(String paramString) {
    if (paramString.startsWith(CInterfaceDelta)) {
      String str =
          bV.ExceptionInVPackage(
              this, true, CInterfaceDelta, X.ExceptionInVPackage(this.p.RInterfaceIndia()));
      if (str != null && !str.equals("")) {
        double d1 = Double.parseDouble(str);
        if (d1 < ExceptionInVPackage(this.IInterfaceCharlie) || d1 > b(this.IInterfaceCharlie)) {
          bV.CInterfaceDelta(
              str
                  + " is out of range, value must be between "
                  + ExceptionInVPackage(this.IInterfaceCharlie)
                  + " and "
                  + b(this.IInterfaceCharlie),
              this);
          return;
        }
      ...
      String str =
          bV.ExceptionInVPackage(
              this, true, ExceptionPrintstacktrace, X.ExceptionInVPackage(this.p.k()));
      if (str != null && !str.equals("")) {
        double d1 = Double.parseDouble(str);
      ...
      String str =
          bV.ExceptionInVPackage(
              this, true, h, X.ExceptionInVPackage(this.p.ExceptionExtensionGetmessage()));
      if (str != null && !str.equals("")) {
        double d1 = Double.parseDouble(str);
        if (d1 < ExceptionInVPackage(this.b) || d1 > b(this.b)) {
          bV.CInterfaceDelta(
      ...
      String str =
          bV.ExceptionInVPackage(
              this, true, k + " (s)", X.ExceptionInVPackage((this.p.G() / 1000)));
      if (str != null && !str.equals("")) {
  ...
  private void b(int paramInt1, int paramInt2) {
    ...
    if (str1.length() > 0) {
      jMenuItem =
          jPopupMenu.add("Reset Y Axis Maximum to Default (" + this.q.IInterfaceCharlie() + ")");
    ...
    if (str1.length() > 0) {
      jMenuItem =
          jPopupMenu.add("Reset X Axis Maximum to Default (" + this.q.RInterfaceIndia() + ")");
    ...
    if (RInterfaceIndia.ExceptionInVPackage().ExceptionInVPackage(";lkdsaop9ewqewqgd")) {
      ...
      if (str1.length() > 0) {
        jMenuItem =
            jPopupMenu.add(
                "Reset Coarse Step Count to Default (" + this.q.ExceptionInVPackage() + ")");
  ...
  public double ExceptionInVPackage(String paramString, double paramDouble) {
    ...
    if (str == null || str.equals("")) return paramDouble;
    try {
  ...
  public Double[][] o() {
    Double[][] arrayOfDouble;
    if (this.F && this.v != null) return this.v.e().RInterfaceIndia();
    if (this.F && this.w != null) return this.w.e().RInterfaceIndia();
    int ExceptionExtensionGetmessage = 0;
    if (this.q.z()) {
      arrayOfDouble = new Double[this.b.size()][((Manager) this.b.get(0)).b()];
    } else {
      arrayOfDouble =
          new Double[this.b.size() + this.IInterfaceCharlie.size()][((Manager) this.b.get(0)).b()];
      for (byte b = 0; b < this.IInterfaceCharlie.size(); b++) {
