...
class TableModelListenerTablechanged implements GInterfaceAn, TableModelListener {
  ...
  public TableModelListenerTablechanged(bQ parambQ, R paramR, s params, String paramString) {
    ...
    ManagerUsingConcurrentHashMap.a().a(paramR.c(), this.b.aL(), this);
    ManagerUsingConcurrentHashMap.a().a(paramR.c(), this.c.aL(), this);
    ManagerUsingConcurrentHashMap.a().a(paramR.c(), this.d.aL(), this);
