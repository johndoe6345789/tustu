...
public class NoteIconLabel extends JLabel {
  ...
  public NoteIconLabel(R paramR, String paramString) {
    if (!RInterfaceIndia.a().a("lkjfgblkjgdoijre98u")) return;
    this.a = paramR;
    this.b = paramString;
    if (c == null || d == null)
      try {
        Image image =
            Toolkit.getDefaultToolkit().getImage(getClass().getResource("resources/comment3.png"));
        image = image.getScaledInstance(eJ.a(14), eJ.a(14), 4);
        d = new ImageIcon(image);
        image =
            Toolkit.getDefaultToolkit().getImage(getClass().getResource("resources/comment2.png"));
        image = image.getScaledInstance(eJ.a(14), eJ.a(14), 4);
  ...
  public void a() {
    ...
    if (str == null) str = "";
    if (str.contains("</head>")) str = "<html>" + str.substring(str.indexOf("</head>") + 7);
  ...
  private void b() {
    if (this.a.o(this.b) != null && this.a.o(this.b).length() > 0) {
      ...
      if (!stringBuilder.toString().startsWith("<html>")) stringBuilder.insert(0, "<html>");
      if (!stringBuilder.toString().endsWith("</html>")) stringBuilder.append("</html>");
