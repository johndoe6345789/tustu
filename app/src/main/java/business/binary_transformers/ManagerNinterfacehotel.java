...
public class ManagerNinterfacehotel implements am {
  ...
  private boolean i() {
    if (this.l == k) {
      ...
      if (this.f.n() && this.SComponentGolf.n() && this.f.d() == this.NInterfaceHotel.d() && this.SComponentGolf.d() == this.NInterfaceHotel.d() && GInterfaceAj.ExceptionInVPackage(this.ExceptionInVPackage, arrayList)) {
        this.l = i + j;
      } else {
        this.l = 0;
      } 
  ...
  public void NInterfaceHotel() {
    ...
    ArrayListExceptionprintstacktraceInGPackage.s(SComponentGolf.b("Resize Table") + " " + ExceptionprintstacktraceInGPackage.c(this.ExceptionInVPackage, this.b.aL()));
    ...
    ArrayListExceptionprintstacktraceInGPackage.ExceptionInVPackage((Abstract)GComponentBq);
    NInterfaceHotel.ExceptionInVPackage().ExceptionInVPackage(this.ExceptionInVPackage, ArrayListExceptionprintstacktraceInGPackage, bV.c());
  }
