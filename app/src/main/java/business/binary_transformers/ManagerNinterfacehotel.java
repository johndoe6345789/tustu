...
public class ManagerNinterfacehotel implements am {
  ...
  Manager SComponentGolf;

  Manager NInterfaceHotel;
  ...
  public ManagerNinterfacehotel(R paramR, CloneableImpl parambe, s params) {
  ...
  private boolean i() {
    if (this.l == k) {
      ...
      if (this.f.n()
          && this.SComponentGolf.n()
          && this.f.d() == this.NInterfaceHotel.d()
          && this.SComponentGolf.d() == this.NInterfaceHotel.d()
          && GInterfaceAj.ExceptionInVPackage(this.ExceptionInVPackage, arrayList)) {
        this.l = i + j;
      } else {
        this.l = 0;
      }
  ...
  public int SComponentGolf() {
    ...
    int j = GInterfaceAj.ExceptionInVPackage(this.ExceptionInVPackage, this.NInterfaceHotel.d(), i);
    if (i()) j -= this.SComponentGolf.e();
  ...
  private void b(int paramInt1, int paramInt2) {
    ...
    if (!ExceptionInVPackage(paramInt1, paramInt2))
      throw new ExceptionInVPackage(
          SComponentGolf.b("Requires more table cells than available contiguous RAM."));
  }
  ...
  public void NInterfaceHotel() {
    ...
    ArrayListExceptionprintstacktraceInGPackage.s(
        SComponentGolf.b("Resize Table")
            + " "
            + ExceptionprintstacktraceInGPackage.c(this.ExceptionInVPackage, this.b.aL()));
    GComponentBq GComponentBq = new GComponentBq();
    GComponentBq.e(" ");
    ArrayListExceptionprintstacktraceInGPackage.ExceptionInVPackage((Abstract) GComponentBq);
    GComponentBq = new GComponentBq();
    GComponentBq.b(this.d.aL());
    GComponentBq.e(SComponentGolf.b("Number of Rows"));
    ArrayListExceptionprintstacktraceInGPackage.ExceptionInVPackage((Abstract) GComponentBq);
    GComponentBq = new GComponentBq();
    GComponentBq.b(this.e.aL());
    GComponentBq.e(SComponentGolf.b("Number of Columns"));
    ArrayListExceptionprintstacktraceInGPackage.ExceptionInVPackage((Abstract) GComponentBq);
    NInterfaceHotel.ExceptionInVPackage()
        .ExceptionInVPackage(
            this.ExceptionInVPackage, ArrayListExceptionprintstacktraceInGPackage, bV.c());
  }
      ...
      for (byte b = 0; b < i; b++) {
        ...
        if (b == paramInt) {
          if (b == i - 1) {
            ...
            str =
                X.b(
                    (Double.parseDouble(s1.ExceptionInVPackage()[b - 1])
                            + Double.parseDouble(s1.ExceptionInVPackage()[b]))
                        / 2.0D,
                    this.c.J());
          }
        } else {
      ...
      for (byte b = 0; b < j; b++) {
        ...
        if (b == paramInt) {
          if (b == j - 1) {
            ...
            str =
                X.b(
                    (Double.parseDouble(s1.b()[b - 1]) + Double.parseDouble(s1.b()[b])) / 2.0D,
                    this.c.J());
          }
        } else {
          str = s1.b()[bool];
