...
public class BtInterfaceCharlie implements BsInterfaceAlpha {
  ...
  public BtInterfaceCharlie() {
    ...
    this.BsInterfaceAlpha.put(
        Integer.valueOf(BuInterfaceCharlie.BsInterfaceAlpha()), BuInterfaceCharlie);
    BuInterfaceDelta BuInterfaceDelta = new BuInterfaceDelta();
    this.BsInterfaceAlpha.put(
        Integer.valueOf(BuInterfaceDelta.BsInterfaceAlpha()), BuInterfaceDelta);
    ThreadedInBuPackage ThreadedInBuPackage = new ThreadedInBuPackage();
    this.BsInterfaceAlpha.put(
        Integer.valueOf(ThreadedInBuPackage.BsInterfaceAlpha()), ThreadedInBuPackage);
    BuInterfaceBravo BuInterfaceBravo = new BuInterfaceBravo();
    this.BsInterfaceAlpha.put(
        Integer.valueOf(BuInterfaceBravo.BsInterfaceAlpha()), BuInterfaceBravo);
    BuInterfaceFoxtrot BuInterfaceFoxtrot = new BuInterfaceFoxtrot();
    this.BsInterfaceAlpha.put(
        Integer.valueOf(BuInterfaceFoxtrot.BsInterfaceAlpha()), BuInterfaceFoxtrot);
  }
  ...
  public void BsInterfaceAlpha(BnInterfaceOscar paramo, BnInterfaceTango paramt) {
    if (paramt.BsInterfaceAlpha() != BsInterfaceAlpha())
      throw new ExceptionInBsPackage(
          "PID:USER_CMD Wrong handler! this handler is for 0x"
    ...
    try {
      ...
      ExceptionInBsPackage ExceptionInBsPackage =
          (ExceptionInBsPackage) this.BsInterfaceAlpha.get(Integer.valueOf(i));
      if (ExceptionInBsPackage == null) {
        TostringInBnPackage TostringInBnPackage =
            BnInterfaceUniform.BsInterfaceAlpha().BuInterfaceBravo();
        TostringInBnPackage.BsInterfaceAlpha(254);
        D.BsInterfaceAlpha(
            "USER_COMMAND: No Sub handler for sub command code 0x"
