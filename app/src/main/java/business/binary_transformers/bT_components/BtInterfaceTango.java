  ...
  public void BsInterfaceAlpha(BnInterfaceOscar paramo, bN.t paramt) {
    if (paramt.BsInterfaceAlpha() != BsInterfaceAlpha())
      throw new ExceptionInBsPackage(
          "PID:DAQ_SET_DAQ_PTR Wrong handler! this handler is for 0x"
    ...
    if (arrayOfByte.length != 5)
      throw new ExceptionInBsPackage(
          "PID:DAQ_SET_DAQ_PTR invalid packet data length, expected 6 bytes, found: "
    ...
    try {
      ...
      if (TostringInBoPackage == null
          ...
          || j > TostringInBoPackage.BsInterfaceAlpha()
