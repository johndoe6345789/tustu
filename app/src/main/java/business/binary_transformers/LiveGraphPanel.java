...
public class LiveGraphPanel extends dl implements GComponentCq, bc {
    ...
    if (parambr != null && parambr.b() > 0) {
      ...
      for (byte b = 0; b < arrayOfBs.length; b++) {
        try {
          ExceptionInVPackage(
              paramR.c(),
              arrayOfBs[b].ExceptionInVPackage(),
              arrayOfBs[b].e(),
              (arrayOfBs[b].d() == null) ? null : new Color(arrayOfBs[b].d().ExceptionInVPackage()),
              arrayOfBs[b].b(),
              arrayOfBs[b].c(),
              arrayOfBs[b].f(),
              arrayOfBs[b].ExceptionPrintstacktrace());
        } catch (ExceptionInVPackage ExceptionInVPackage) {
          D.ExceptionInVPackage(
              "Can not add line to Graph.", (Exception) ExceptionInVPackage, this);
        }
      }
    }
    addMouseListener(new v(this));
  ...
  public void ExceptionInVPackage(
    ...
    t.b(paramString2);
    if (paramColor == null) paramColor = ExceptionInVPackage(this.c.size());
    t.ExceptionInVPackage(paramColor);
    if (paramString3 == null || paramString3.equals("")) paramString3 = SerializableImpl.e();
    if (paramDouble1 != paramDouble2) {
      ...
      t.b(paramBoolean1);
      t.c(paramString3);
      if (GInterfaceAh != null) t.d(GInterfaceAh.l());
    ...
    ManagerUsingArrayList.ExceptionInVPackage()
        .ExceptionInVPackage(paramString1, paramString2, this);
  }
  ...
  public void setCurrentOutputChannelValue(String paramString, double paramDouble) {
    ...
    if (t != null) {
      ...
      D.c(
          "LiveGraph::Registered as OuputChannelListener, but I don't have the channel "
              + paramString);
    }
  }
  ...
  public void b() {
    if (this.ExceptionInVPackage == null) this.ExceptionInVPackage = new u(this);
