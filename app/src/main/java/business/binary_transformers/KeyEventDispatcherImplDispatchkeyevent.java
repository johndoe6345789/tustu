...
public class KeyEventDispatcherImplDispatchkeyevent implements KeyEventDispatcher {
  ...
  public boolean dispatchKeyEvent(KeyEvent paramKeyEvent) {
    ...
    if (paramKeyEvent.getID() == 401) {
      if (((paramKeyEvent.getModifiersEx() & 0x40) == 64 && paramKeyEvent.getKeyCode() == 38)
          || ((paramKeyEvent.getModifiersEx() & 0x40) == 64 && paramKeyEvent.getKeyCode() == 39)
          || paramKeyEvent.getKeyCode() == 521
          || paramKeyEvent.getKeyCode() == 81
          || paramKeyEvent.getKeyCode() == 160
          || paramKeyEvent.getKeyCode() == 46) {
        double d = this.c.l();
      ...
      if (((paramKeyEvent.getModifiersEx() & 0x40) == 64 && paramKeyEvent.getKeyCode() == 40)
          || ((paramKeyEvent.getModifiersEx() & 0x40) == 64 && paramKeyEvent.getKeyCode() == 37)
          || paramKeyEvent.getKeyCode() == 45
          || paramKeyEvent.getKeyCode() == 153
          || paramKeyEvent.getKeyCode() == 87
          || paramKeyEvent.getKeyCode() == 44) {
        double d = this.c.l();
        if ((paramKeyEvent.getModifiersEx() & 0x80) == 128) {
          if (this.c.k()) {
            this.b.a(d, -this.c.i());
