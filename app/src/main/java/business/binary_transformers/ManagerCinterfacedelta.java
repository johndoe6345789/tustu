...
public class ManagerCinterfacedelta extends JPanel implements h, p, CInterfaceDelta, bc {
  ...
  public ManagerCinterfacedelta(R paramR, GInterfaceBi parambi, CloneableImpl parambe, et paramet) {
    ...
    try {
      ...
      bV.CInterfaceDelta(
          "Invalid Title Defined: "
              + GInterfaceDb.toString()
              + "\nError: "
  ...
  private String ExceptionInVPackage(String paramString1, String paramString2) {
    String str = null;
    if (this.j != null) str = this.j.ExceptionInVPackage(paramString1);
  ...
  public void ExceptionInVPackage(boolean paramBoolean) {
    if (paramBoolean) {
      ...
      KeyboardFocusManager.getCurrentKeyboardFocusManager()
          .addKeyEventDispatcher(this.ExceptionPrintstacktrace);
    } else {
      if (this.c == null) {
        bV.CInterfaceDelta(
            this.b.ExceptionInVPackage() + " 2D Table not found in configuration.", this);
        return;
      }
      if (this.ExceptionPrintstacktrace != null) {
        KeyboardFocusManager.getCurrentKeyboardFocusManager()
            .removeKeyEventDispatcher(this.ExceptionPrintstacktrace);
  ...
  public bu e() {
    if (this.CInterfaceDelta == null) {
      ...
      if (this.l != null) this.CInterfaceDelta.e();
    }
  ...
  public void close() {
    ...
    if (this.l != null) {
      this.l.b();
      if (this.l instanceof GInterfaceAg) this.ExceptionInVPackage.C().b((GInterfaceAg) this.l);
    }
    if (this.ExceptionPrintstacktrace != null) {
      KeyboardFocusManager.getCurrentKeyboardFocusManager()
          .removeKeyEventDispatcher(this.ExceptionPrintstacktrace);
  ...
  public void setEnabled(boolean paramBoolean) {
    ...
    if (this.CInterfaceDelta != null) this.CInterfaceDelta.setEnabled(paramBoolean);
    if (this.e != null) this.e.setEnabled(paramBoolean);
