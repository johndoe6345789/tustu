...
public class UIInBcPackage extends JPanel implements m {
  HashMap a = new HashMap<>();

  List b = new ArrayList();

  public UIInBcPackage() {
    setLayout(new GridLayout(0, 1));
  }

  public void a(List<AeInterfaceTango> paramList) {
    a();
    for (byte b = 0; b < paramList.size(); b++) {
      a a = new a(paramList.get(b));
      a.a(this);
      add(a);
      this.a.put(((AeInterfaceTango) paramList.get(b)).a(), a);
    }
  }
  ...
  private void b(String paramString, Object paramObject) {
    for (m m1 : this.b) m1.a(paramString, paramObject);
  }
  ...
  public void c() {
    for (a a : this.a.values()) b(a.getName(), a.a());
  }
