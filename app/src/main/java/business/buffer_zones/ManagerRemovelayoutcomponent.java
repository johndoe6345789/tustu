...
public class ManagerRemovelayoutcomponent implements LayoutManager, Serializable {
  int a;
  ...
  public ManagerRemovelayoutcomponent() {
    this(1, 0, 0, 0);
  }

  public ManagerRemovelayoutcomponent(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
  ...
  public Dimension preferredLayoutSize(Container paramContainer) {
    synchronized (paramContainer.getTreeLock()) {
      ...
      for (byte b = 0; b < i; b++) {
        ...
        if (m < dimension.width) m = dimension.width;
        if (n < dimension.height) n = dimension.height;
      }
      return new Dimension(
          insets.left + insets.right + k * m + (k - 1) * this.a,
          insets.top + insets.bottom + j * n + (j - 1) * this.b);
    }
  }
      ...
      if (bool) {
        ...
        for (i7 = insets.top + i6; b < j; i7 += i5 + this.b) {
          ...
          for (i8 = insets.left + i2; b1 < k; i8 += i1 + this.a) {
            ...
            if (i9 < i) paramContainer.getComponent(i9).setBounds(i8, i7, i1, i5);
            b1++;
          }
          b++;
        }
