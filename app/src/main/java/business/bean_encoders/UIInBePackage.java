...
public class UIInBePackage extends JPanel implements p {
  ...
  public UIInBePackage() {
    ...
    if (arrayOfString.length > 1) {
      ...
      for (String str : arrayOfString) this.h.addItem(str);
    ...
    jScrollPane.setPreferredSize(
        new Dimension(eJ.ExceptionInVPackage(640), eJ.ExceptionInVPackage(500)));
  ...
  private void ExceptionInVPackage() {
    ...
    if (str2.equals(str1)) return;
    if (!str2.equals(str1) && this.c.c()) {
      boolean bool =
          bV.ExceptionInVPackage(
              SComponentGolf.b(
                  "There are unsaved changes, Are you sure you want to close without saving?"),
              this,
              true);
      if (!bool) {
  ...
  private void c() {
    if (NetworkHashMap.ExceptionInVPackage().b(this.DefaultMutableTreeNodeExtension)) this.c.b();
  }
  ...
  private void d() {
    ...
    if (this.i.ExceptionInVPackage.ExceptionInVPackage() != null) {
      DefaultMutableTreeNodeExtension =
          (DefaultMutableTreeNodeExtension) this.i.ExceptionInVPackage.getParent();
    } else {
      DefaultMutableTreeNodeExtension = this.i.ExceptionInVPackage;
    }
    q =
        r.ExceptionInVPackage(
            DefaultMutableTreeNodeExtension.toString(), this.DefaultMutableTreeNodeExtension);
    if (q == null) {
    ...
    if (q instanceof GInterfaceAh) {
      ...
      String str2 =
          bV.ExceptionInVPackage(
              this,
              false,
              SComponentGolf.b(str1),
              SComponentGolf.b("My") + X.b(DefaultMutableTreeNodeExtension.toString(), " ", ""));
  ...
  private void NetworkHashMap() {
    if (this.i.b != null)
      if (this.i.b instanceof SerializableImpl) {
        ...
        if (this.c.ExceptionInVPackage(SerializableImpl.aL())
            && bV.ExceptionInVPackage(
                SComponentGolf.b("There are Gauge Templates referencing this OutputChannel.")
                    + "\n"
                    + SComponentGolf.b("Would you like to delete these Gauge Templates also?."),
                this,
                true)) this.c.b(SerializableImpl.aL());
