...
public class BeComponentSierra extends JPanel {
          ...
          if (SerializableImpl != null
              ...
              && !bV.ExceptionInVPackage(
                  ExceptionPrintstacktrace.b(
                          "There is an existing OuputChannel in the main config by that name.")
                      + "\n"
                      + ExceptionPrintstacktrace.b(
                          "Are you sure you want to over-ride that channel?"),
                  this,
                  true)) return;
  ...
  public void ExceptionInVPackage(Q paramQ) {
    if (c()) {
      ...
      if ((!(component instanceof o) || ((o) component).c())
          && bV.ExceptionInVPackage(
              ExceptionPrintstacktrace.b("Would you like to save the current settings?"),
              this,
              true)) {
        ExceptionInVPackage();
      } else {
    ...
    if (paramQ instanceof SerializableImpl) {
      ...
      e().ExceptionInVPackage(
              (((SerializableImplExceptionprintstacktrace) paramQ).ExceptionInVPackage() == null));
    }
  ...
  private j e() {
    if (this.b == null) this.b = new j(this.d);
    return this.b;
  }

  private c f() {
    if (this.ExceptionInVPackage == null) this.ExceptionInVPackage = new c(this.d);
  ...
  public void ExceptionInVPackage(R paramR) {
    this.d = paramR;
    if (this.ExceptionInVPackage != null) this.ExceptionInVPackage.ExceptionInVPackage(paramR);
    if (this.b != null) this.b.ExceptionInVPackage(paramR);
    if (this.c != null) this.c.ExceptionInVPackage(paramR);
  }

  public void ExceptionInVPackage(B paramB) {
    if (paramB != null) paramB.b(this.e);
    this.h = paramB;
