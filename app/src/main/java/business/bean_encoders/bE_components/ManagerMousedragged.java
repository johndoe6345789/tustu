...
class ManagerMousedragged extends MouseAdapter {
  int a = eJ.a(10);
  ...
  public void mouseReleased(MouseEvent paramMouseEvent) {
    if (paramMouseEvent.getButton() == 1
        && this.c.x != null
        && this.c.x.getX() < (paramMouseEvent.getX() - this.a)
        && this.c.x.getY() < (paramMouseEvent.getY() - this.a)
    ...
    if (paramMouseEvent.getButton() != 1) this.b = null;
    this.c.x = null;
    this.c.repaint();
  }
