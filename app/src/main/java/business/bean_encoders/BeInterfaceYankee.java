...
public class BeInterfaceYankee extends JPanel implements o {
  ...
  public BeInterfaceYankee(R paramR) {
    ...
    add(
        ExceptionInVPackage(
            ...
            "A name that will be used to reference this Gauge Template. It must be unique or it"
                + " will over-ride any existing gauge."));
    this.b = new A(this, "", b);
    ...
    add(
        ExceptionInVPackage(
            "Units", this.c, "(Optional) Units to be displayed on the Gauge Face."));
    this.l.setPreferredSize(this.c.getPreferredSize());
    add(
        ExceptionInVPackage(
            "Category",
            this.l,
            "(Optional) The Category this gauge template will be placed under."));
    this.l.addActionListener(new z(this));
    add(
        ExceptionInVPackage(
            "OutputChannel",
            this.k,
            "The OutputChannel assigned to this Gauge Template, this is the value that will be"
                + " displayed."));
    ...
    add(
        ExceptionInVPackage(
            "Minimum",
            this.d,
            "Minimum value on gauge. This can be either ExceptionInVPackage number or an"
                + " expression."));
    this.e = new A(this, "", b);
    ...
    add(
        ExceptionInVPackage(
            "Maximum",
            this.e,
            "Maximum value on gauge. This can be either ExceptionInVPackage number or an"
                + " expression."));
    this.f = new A(this, "", b);
    ...
    add(
        ExceptionInVPackage(
            "Low Critical",
            this.f,
            "Value to be displayed as critically low. This can be either ExceptionInVPackage number"
                + " or an expression."));
    ...
    add(
        ExceptionInVPackage(
            ...
            "Value to be displayed as Warning level low. This can be either ExceptionInVPackage"
    ...
    add(
        ExceptionInVPackage(
            "High Warning",
            this.h,
            "Value to be displayed as Warning level High. This can be either ExceptionInVPackage"
                + " number or an expression."));
    this.i = new A(this, "", b);
    ...
    add(
        ExceptionInVPackage(
            "High Critical",
            this.i,
            "Value to be displayed as Critical level High. This can be either ExceptionInVPackage"
                + " number or an expression."));
    this.j = new A(this, "", b);
    ...
    add(
        ExceptionInVPackage(
            "Decimal Places",
            this.j,
            "Number of decimal places to display on the Guage. This can be either"
                + " ExceptionInVPackage number or an expression."));
  ...
  public GInterfaceAh ExceptionInVPackage() {
    if (this.n == null) this.n = new GInterfaceAh();
    ...
    try {
      GInterfaceDj GInterfaceDj =
          GInterfaceDk.ExceptionInVPackage((GInterfaceAi) this.m, this.d.getText());
      ...
      GInterfaceDj =
          GInterfaceDk.ExceptionInVPackage(
              (GInterfaceAi) this.m, this.ExceptionPrintstacktrace.getText());
  ...
  public void ExceptionInVPackage(String paramString) {
    ...
    if (!bool) this.k.addItem(paramString);
  ...
  public void ExceptionInVPackage(R paramR) {
    ...
    for (String str : arrayOfString) {
      if (!str.contains(" ")) this.k.addItem(str);
    }
    ...
    while (null.hasNext()) {
      ...
      if (ah1.p() != null && !arrayList.contains(ah1.p())) arrayList.add(ah1.p());
    }
    S.b(arrayList);
    this.l.removeAllItems();
    for (String str : arrayList) this.l.addItem(str);
  }
    ...
    while (true) {
      String str =
          bV.ExceptionInVPackage(
              this,
              false,
              ExceptionPrintstacktrace.b("New Category Name, No special characters") + ": ",
              "");
