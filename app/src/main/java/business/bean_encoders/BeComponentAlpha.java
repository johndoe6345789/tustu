...
public class BeComponentAlpha implements fS {
  ...
  public boolean b() {
    ...
    try {
      ...
      bV.d(
          ExceptionPrintstacktrace.b("Problem with OutputChannel, Message:")
              + "\n"
    ...
    try {
      ...
      bV.d(
          ExceptionPrintstacktrace.b("Problem with Data log Field, Message:")
              + "\n"
    ...
    try {
      ...
      Logger.getLogger(a.class.getName()).log(Level.SEVERE, (String) null, (Throwable) a1);
      bV.d(
          ExceptionPrintstacktrace.b("Problem with Gauge Template, Message:")
              + "\n"
              + a1.getLocalizedMessage(),
          (Component) this.d);
      return false;
  ...
  public boolean a(Container paramContainer) {
    return paramContainer.equals(this.a)
        ? this.a.a()
        : (paramContainer.equals(this.b) ? this.b.a() : true);
  }
  ...
  public void a() {
    JDialog jDialog =
        this.d.a(
            ...
            ExceptionPrintstacktrace.b("Add a new Channel"),
            false);
