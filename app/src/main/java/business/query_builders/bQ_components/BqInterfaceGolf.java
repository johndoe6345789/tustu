...
class BqInterfaceGolf implements BnInterfaceFoxtrot {
    ...
    if (paramt instanceof TostringInBnPackage) {
      ...
      if (i != null) {
        try {
          ...
          Logger.getLogger(BnInterfaceFoxtrot.class.getName())
              .log(Level.SEVERE, (String) null, (Throwable) ExceptionInBsPackage);
        }
      } else {
      ...
      if (BnInterfaceFoxtrot.c(this.b) != null) BnInterfaceFoxtrot.c(this.b).BnInterfaceFoxtrot();
    } else {
      if (BnInterfaceFoxtrot.d(this.b) != null
          && BnInterfaceFoxtrot.d(this.b).a(this.b.c, paramt)) {
        try {
          BnInterfaceFoxtrot.d(this.b).a(BnInterfaceFoxtrot.a(this.b), this.b.c, paramt);
        } catch (ExceptionInBsPackage ExceptionInBsPackage) {
          Logger.getLogger(BnInterfaceFoxtrot.class.getName())
              .log(
                  Level.WARNING, "Unable to process DAQ Message", (Throwable) ExceptionInBsPackage);
        }
      } else {
        if (J.I())
          D.b(
              "Received DTO Type Packet that is unknown? DAQ Running before started?\n"
                  + c.d(paramt.d()));
        if (System.currentTimeMillis() - this.a > 3000L) this.a = System.currentTimeMillis();
      }
      if (BnInterfaceFoxtrot.c(this.b) != null) BnInterfaceFoxtrot.c(this.b).k();
    }
  ...
  public void a(int paramInt, String paramString) {
    D.a(
        "Message validation error: 0x"
            + Integer.toHexString(paramInt).toUpperCase()
            + ", message:"
            + paramString);
  ...
  public void a() {
    BnInterfaceFoxtrot.a(
        this.b,
        (BnInterfaceFoxtrot.a(this.b) != null)
            ? BnInterfaceFoxtrot.a(this.b).BnInterfaceUniform()
            : null);
  }

  public void b() {
    BnInterfaceFoxtrot.b(
        this.b,
        (BnInterfaceFoxtrot.a(this.b) != null)
            ? BnInterfaceFoxtrot.a(this.b).BnInterfaceUniform()
            : null);
