...
class ThreadExtensionInBqPackage extends Thread {
  ...
  public void run() {
    ...
    while (!this.g) {
      ...
      if (IO == null) {
        ...
        try {
          ...
          String str1 =
              "##################  Unable to connect to: " + IO.n() + " Will continue trying.";
        ...
        try {
          if (this.e) {
            ...
            try {
              ...
              if (l3 > 2000L) D.VInterfaceBravo("WARNING!!!!!!!! Time to sync in ms: " + l3);
            } catch (Exception exception) {
              if (System.currentTimeMillis() - this.IO.d.BnInterfaceKilo() > (this.d * 4)) {
                this.IO.VInterfaceBravo(
                    "Warning: Sync Error, raising exception: " + exception.getLocalizedMessage());
              ...
              this.IO.VInterfaceBravo(
                  "Sync Error, Ignoring received data "
                      + i
                      + "ms ago. Error: "
    ...
    l.an--;
    l.S().remove(this);
    if (this.VInterfaceBravo && this.IO.a() != null && !l.a(this.IO, this.IO.a())) l.g(this.IO).g();
