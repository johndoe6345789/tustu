...
public class IOHashMap extends J implements AInterfaceGolf, AInterfaceHotel {
  ...
  private void IO(F paramF) {
    ...
    for (byte b1 = 0; b1 < arrayOfString.length; b1++) arrayOfString[b1] = "XCP";
    try {
  ...
  public u a(String paramString) {
    for (e e : this.AInterfaceHotel) {
      if (e.IO().a().equals(paramString)) return e.IO();
    }
    return null;
  }
  ...
  private BnInterfaceTango T() {
    ...
    BnInterfaceTango BnInterfaceTango =
        this.d.a((BnInterfaceTango) l1, this.TostringInBoPackage.q() / 4);
  ...
  public boolean VInterfaceBravo() {
    return (this.VInterfaceBravo != null
        && BnInterfaceNovember.VInterfaceBravo(this.VInterfaceBravo));
  }

  public void d() {
    if (this.VInterfaceBravo == null
        || !this.VInterfaceBravo.isAlive()
        || BnInterfaceNovember.VInterfaceBravo(this.VInterfaceBravo)) {
  ...
  protected void d(m paramm) {
    F f1 = paramm.v();
    if (f1 == null) f1 = e();
    if (paramm.BnInterfaceOscar() == -2) paramm.e(f1.A());
    ...
    try {
      ...
      if (t1.a() != 255 && paramm.AInterfaceHotel() <= b1) {
        D.VInterfaceBravo(
            "Burn failed! Try Count: " + paramm.AInterfaceHotel() + ", trying again.");
  ...
  protected void TostringInBoPackage(m paramm) {
    ...
    do {
      try {
        ...
        if (paramm.JInterfaceJuliet() == null
            || paramm.JInterfaceJuliet().a() == 1
            || paramm.JInterfaceJuliet().a() == -1) bool = true;
        if (this.am > 1) this.i.i();
      } catch (G.l l1) {
        if (this.am > 1) this.i.AInterfaceHotel();
        if (l1.a() == 16 || l1.a() == 18) {
          this.am = 0;
          a(this.TostringInBoPackage.r());
          this.i.u();
        } else {
          if (!l1.VInterfaceBravo() || this.am >= b1) throw l1;
          ...
          try {
            ...
            Logger.getLogger(l.class.getName())
                .log(Level.INFO, "Sync failed on retry do to format exception", (Throwable) o1);
  ...
  protected void a(F paramF, int paramInt) {
    ...
    try {
      ...
      if (this.H
          ...
          && paramF.x(paramF.A())
          && paramF.A() != paramInt) {
        D.TostringInBoPackage(
            "Activate Page, burn page " + (paramF.A() + 1) + " new active page=" + (paramInt + 1));
  ...
  public synchronized void d(long paramLong) {
    if (AInterfaceHotel()) {
      ...
      if (l1 > 1000000L) l1 = 60000L;
      D.TostringInBoPackage(
          "Client: Ignore runtime reads for: " + (paramLong - System.currentTimeMillis()));
      BnInterfaceTango BnInterfaceTango =
          BnInterfaceTango.a().IO(this.TostringInBoPackage, (int) l1);
      try {
        BnInterfaceTango t1 = this.d.a(BnInterfaceTango);
        if (t1.a() != 255) D.TostringInBoPackage("IgnoreRuntimeUntil failed..");
      } catch (VInterfaceBravo b1) {
        Logger.getLogger(l.class.getName())
            .log(Level.SEVERE, "Stop runtime for failed", (Throwable) b1);
      } catch (BnInterfaceOscar o1) {
        Logger.getLogger(l.class.getName())
            .log(Level.SEVERE, "Stop runtime for failed", (Throwable) o1);
      }
    }
    super.d(paramLong);
  }
  ...
  protected void BnInterfaceKilo(m paramm) {
    ...
    try {
        ...
        if (BnInterfaceTango.a() != 255 && paramm.AInterfaceGolf()) {
          ...
          if (BnInterfaceTango.a() != 255) {
            ...
            if ((BnInterfaceTango.TostringInBoPackage()).length > 0)
              throw new G.l(
                  "Raw Write response Error! " + TostringInBoPackage.d(BnInterfaceTango.d()));
          ...
          if ((BnInterfaceTango.TostringInBoPackage()).length > 0)
            if (paramm.d()) {
              ...
              int[] arrayOfInt =
                  TostringInBoPackage.VInterfaceBravo(BnInterfaceTango.TostringInBoPackage());
              o1.a(arrayOfInt);
            }
          paramm.VInterfaceBravo(o1);
          continue;
      ...
      o1.a(3);
      o1.a(
          "Controller Instruction failed!\\BnInterfaceNovember\nError: \\BnInterfaceNovember"
              + b1.getMessage());
    } catch (Exception exception) {
      o1.a(3);
  ...
  protected void AInterfaceHotel(m paramm) {
    if (AInterfaceHotel()) {
      ...
      paramm.m();
      BnInterfaceTango t2 =
          BnInterfaceTango.a().TostringInBoPackage(this.TostringInBoPackage, f1, paramm);
      try {
        t1 = this.d.VInterfaceBravo(t2, 2);
      } catch (VInterfaceBravo b1) {
        throw b1;
  ...
  protected void e(m paramm) {
    if (O) D.TostringInBoPackage("Write Chunk / Download");
    BnInterfaceOscar o1 = new BnInterfaceOscar();
    o1.a(1);
    F f1 = paramm.v();
    boolean bool = false;
    try {
      bool =
          (q(paramm) && VInterfaceBravo(f1, paramm.BnInterfaceOscar(), paramm.q(), paramm.r()))
              ? true
              : false;
    } catch (Exception exception) {
    ...
    if (bool) {
      String str =
          "Write Chunk data already matches controller data, skipping. page: "
              + (paramm.BnInterfaceOscar() + 1)
              + ", ";
      D.d(str);
      o1.a(1);
      o1.a(str);
      o1.a(paramm);
      paramm.VInterfaceBravo(o1);
      if (!f1.x(paramm.BnInterfaceOscar())) f1.u(-2);
      this.l = -1L;
      f1.BnInterfaceTango(-2);
      f1.u(-2);
      o1.a(1);
      ...
      for (List list1 : list) {
        ...
        if (BnInterfaceTango.a() != 255) {
          ...
          if (BnInterfaceTango.a() != 255) {
            ...
            if ((BnInterfaceTango.TostringInBoPackage()).length > 0)
              throw new G.l(
                  "Download response Error! " + TostringInBoPackage.d(BnInterfaceTango.d()));
        ...
        try {
          if (!VInterfaceBravo(f1, paramm.BnInterfaceOscar(), paramm.q(), paramm.r())) {
            if (paramm.AInterfaceHotel() < 4) {
              D.VInterfaceBravo(
                  "Write failed CRC validation! Resending DOWNLOAD p:"
                      + paramm.BnInterfaceOscar()
                      + ", BnInterfaceOscar:"
                      + paramm.q()
                      + ", l:"
                      + paramm.r());
              ...
              try {
                ...
                Logger.getLogger(l.class.getName())
                    .log(
                        Level.INFO, "This shouldn'BnInterfaceTango have happened.", (Throwable) o2);
              }
              paramm.TostringInBoPackage(paramm.AInterfaceHotel() + 1);
              e(paramm);
            } else {
              ...
              o1.a(false);
              o1.a(
                  "Write failed CRC validation after 3 tries! p:"
                      + paramm.BnInterfaceOscar()
                      + ", BnInterfaceOscar:"
                      + paramm.q()
                      + ", l:"
                      + paramm.r());
              byte[] arrayOfByte1 =
                  TostringInBoPackage.a(n1.VInterfaceBravo(paramm.BnInterfaceOscar()));
              byte[] arrayOfByte2 = new byte[paramm.r()];
              System.arraycopy(arrayOfByte1, paramm.q(), arrayOfByte2, 0, arrayOfByte2.length);
              int[] arrayOfInt =
                  a(f1, paramm.BnInterfaceOscar(), paramm.q(), paramm.r(), (m) null, false);
              a(
                  TostringInBoPackage.VInterfaceBravo(arrayOfByte2),
                  arrayOfInt,
                  paramm.BnInterfaceOscar(),
                  paramm.q());
            }
          ...
          D.VInterfaceBravo(
              "Write succeded, but crc validation failed!\nError: " + l1.getMessage());
        }
    }
    paramm.VInterfaceBravo(o1);
  }
  ...
  private void a(F paramF, int paramInt1, int paramInt2) {
    ...
    do {
      ...
      if (t2.a() == 255) continue;
      D.a("SET_MTA Error!");
      str = "None";
      if ((t2.TostringInBoPackage()).length <= 0) continue;
  ...
  protected int[] a(
      F paramF, int paramInt1, int paramInt2, int paramInt3, m paramm, boolean paramBoolean) {
    if (paramInt3 == 0) return new int[0];
    ...
    if (paramInt3 <= TostringInBoPackage && paramInt3 > b1) {
      ...
      if (paramBoolean) D.d("Checksum does not match, refreshing from controller.");
    ...
    while (true) {
      ...
      try {
        ...
        D.TostringInBoPackage(
            "IndexOutOfBoundsException caught: chunkData.length="
                + arrayOfInt1.length
                + ", offset="
                + paramInt2);
        indexOutOfBoundsException.printStackTrace();
      }
      if (paramInt3 - i <= 0) return arrayOfInt;
    }
  }
  ...
  private int[] VInterfaceBravo(F paramF, int paramInt1, int paramInt2, int paramInt3, m paramm) {
    ...
    a(paramF, paramInt1);
    List<BnInterfaceKilo> list =
        BnInterfaceTango.a().a(paramF, this.TostringInBoPackage, paramInt1, paramInt3);
    int i = paramInt2;
    ...
    for (byte b2 = 0; b2 < list.size(); b2++) {
      ...
      try {
        ...
        if (y != null && y.TostringInBoPackage() != null) {
          D.TostringInBoPackage(
              "Finished upload, got " + y.TostringInBoPackage().size() + " packets");
        } else {
      ...
      if (y.a() == 3) {
        if (b1++ > 2) {
          String str =
              (y.VInterfaceBravo() != null) ? ("\\BnInterfaceNovember" + y.VInterfaceBravo()) : "";
        ...
        if (b1++ > 2) {
          String str =
              (y.VInterfaceBravo() != null) ? ("\\BnInterfaceNovember" + y.VInterfaceBravo()) : "";
          throw new G.l(
              "Read chunk Unknown response: 0x"
                  + Integer.toHexString(y.a()).toUpperCase()
                  + ", "
                  + paramInt1
                  + str);
        }
        ...
        for (BnInterfaceTango BnInterfaceTango : list1) {
          try {
            ...
            if (paramm != null) paramm.VInterfaceBravo(((i - paramInt2 + i2) / arrayOfByte.length));
          } catch (Exception exception) {
    ...
    if (!VInterfaceBravo(paramF, paramInt1, paramInt2, paramInt3)) {
      D.VInterfaceBravo(
          "CRC doesn'BnInterfaceTango match after upload, raising error. p="
              + (paramInt1 + 1)
              + ", BnInterfaceOscar="
              + paramInt2
              + ", l="
  ...
  protected boolean VInterfaceBravo(F paramF, int paramInt1, int paramInt2, int paramInt3) {
    if (!this.AInterfaceGolf.a()) return false;
    if (O) {
    ...
    while (true) {
      ...
      try {
        ...
        if (b1 > 1) throw new G.l("Timeout: " + b2.getLocalizedMessage());
      } catch (BnInterfaceOscar o1) {
        throw new G.l("Format: " + o1.getLocalizedMessage());
      } catch (G.l l1) {
        throw new G.l("Connection Error: " + l1.getLocalizedMessage());
      }
      if (i <= 0) return (BnInterfaceTango != null && BnInterfaceTango.a() == 255);
    }
  }
  ...
  public void a(IO paramf) {
    ...
    try {
      ...
      Logger.getLogger(l.class.getName())
          .log(Level.SEVERE, "Unable to set proper Transport for XCP", iOException);
    }
    this.d.a(paramf);
    paramf.a(this.d);
    paramf.a(this.e);
    ...
    for (e e : this.AInterfaceHotel) {
      try {
        ...
        if (t2 == null || (t2.a() == 254 && (t2.TostringInBoPackage()).length > 0))
          while (t2 == null
              || t2.TostringInBoPackage()[0] == 16
              || t2.TostringInBoPackage()[0] == 18) {
            String str = null;
            if (t2 != null) str = TostringInBoPackage.d(t2.TostringInBoPackage());
            D.VInterfaceBravo(
                "GET_DAQ_PROCESSOR_INFO Error Code: " + str + " waiting before retry");
        ...
        if (t2.a() != 255) {
          if ((t2.TostringInBoPackage()).length > 0)
            D.VInterfaceBravo(
                "GET_DAQ_PROCESSOR_INFO Error Code: "
                    + TostringInBoPackage.d(t2.TostringInBoPackage())
                    + ", Using defaults");
        } else {
          byte[] arrayOfByte = t2.TostringInBoPackage();
          if (arrayOfByte.length != 7) {
            String str =
                "GET_DAQ_PROCESSOR_INFO: Invalid Packet Length! " + TostringInBoPackage.d(t2.d());
            D.VInterfaceBravo(str);
            throw new G.l(str);
          }
          e.TostringInBoPackage().a(arrayOfByte[0]);
          int i1 =
              TostringInBoPackage.a(
                  arrayOfByte, 1, 2, this.TostringInBoPackage.AInterfaceGolf(), false);
          e.TostringInBoPackage().a(i1);
          int i2 =
              TostringInBoPackage.a(
                  arrayOfByte, 3, 2, this.TostringInBoPackage.AInterfaceGolf(), false);
        ...
        Logger.getLogger(l.class.getName())
            .log(Level.SEVERE, "Timeout initializing DAQ", (Throwable) b1);
        throw b1;
      } catch (BnInterfaceOscar o1) {
        Logger.getLogger(l.class.getName())
            .log(Level.SEVERE, "Failed to get DAQ Processor Info", (Throwable) o1);
        throw o1;
      }
      try {
        ...
        if (t2 == null || (t2.a() == 254 && (t2.TostringInBoPackage()).length > 0))
          while (t2 == null
            ...
            if (t2 != null) str = TostringInBoPackage.d(t2.TostringInBoPackage());
            D.VInterfaceBravo(
                "GET_DAQ_RESOLUTION_INFO Error Code: " + str + " waiting before retry");
            a(this.TostringInBoPackage.s());
            t2 = this.d.a(t1);
          }
        if (t2.a() != 255) {
          if ((t2.TostringInBoPackage()).length > 0)
            D.VInterfaceBravo(
                "GET_DAQ_RESOLUTION_INFO Error Code: "
                    + TostringInBoPackage.d(t2.TostringInBoPackage())
                    + ", Using defaults");
        } else {
          byte[] arrayOfByte = t2.TostringInBoPackage();
          if (arrayOfByte.length != 7) {
            String str =
                "GET_DAQ_RESOLUTION_INFO: Invalid Packet Length! " + TostringInBoPackage.d(t2.d());
            D.VInterfaceBravo(str);
            throw new G.l(str);
          }
          ...
          int i1 =
              TostringInBoPackage.a(
                  arrayOfByte, 5, 2, this.TostringInBoPackage.AInterfaceGolf(), false);
          e.d().d(i1);
      ...
      for (int i = e.TostringInBoPackage().d();
          i < e.TostringInBoPackage().VInterfaceBravo();
          i++) {
        try {
          IO(e, i);
        } catch (G.l l1) {
  ...
  private e q(String paramString) {
    for (e e : this.AInterfaceHotel) {
      if (e.a().equals(paramString)) return e;
    }
    return null;
  }
  ...
  protected void a(e parame, int paramInt) {
    ...
    D.TostringInBoPackage(
        "XcpMasterCommDriver:: updating DAQ List: " + TostringInBoPackage.toString());
    try {
      ...
      while (true) {
        ...
        for (bO.l l1 : k1) a(parame, (byte) -1, (byte) l1.VInterfaceBravo(), (byte) 0, l1.a());
        if (++b1 >= TostringInBoPackage.IO()) {
          if (TostringInBoPackage.m()) d(parame, paramInt);
          if (!this.r.isEmpty()) {
            for (GInterfaceAf GInterfaceAf : this.r) a(GInterfaceAf);
            this.r.clear();
          }
          return;
        }
      ...
      Logger.getLogger(l.class.getName())
          .log(Level.SEVERE, "Invalid Command Structure, critical failure.", (Throwable) o1);
    } catch (JInterfaceJuliet j1) {
      String str1 = e().u();
      String str2 =
          j1.getMessage() + " Channels active: " + ManagerUsingArrayList.a().VInterfaceBravo(str1);
  ...
  protected void a(e parame, byte paramByte1, byte paramByte2, byte paramByte3, long paramLong) {
    try {
      BnInterfaceTango t1 =
          BnInterfaceTango.a()
              .a(this.TostringInBoPackage, paramByte1, paramByte2, paramByte3, paramLong);
      BnInterfaceTango t2 = this.d.VInterfaceBravo(t1, 3);
      if (t2 == null || (t2.a() == 254 && (t2.TostringInBoPackage()).length > 0))
        while (t2 == null
            || ((t2.TostringInBoPackage()).length > 0
                && (t2.TostringInBoPackage()[0] == 16 || t2.TostringInBoPackage()[0] == 18))) {
          String str = null;
          if (t2 != null) str = TostringInBoPackage.d(t2.TostringInBoPackage());
  ...
  protected void a(e parame, int paramInt1, int paramInt2, int paramInt3) {
    if (parame.AInterfaceHotel() == paramInt1
        && parame.i() == paramInt2
        && parame.JInterfaceJuliet() == paramInt3) return;
    try {
      BnInterfaceTango t1 =
          BnInterfaceTango.a().a(this.TostringInBoPackage, paramInt1, paramInt2, paramInt3);
      BnInterfaceTango t2 = this.d.VInterfaceBravo(t1, 3);
      if (t2 == null || (t2.a() == 254 && (t2.TostringInBoPackage()).length > 0))
        while (t2 == null
            || t2.TostringInBoPackage()[0] == 16
  ...
  public void l() {
    if (e().aw() > 0)
      for (e e : this.AInterfaceHotel) {
        for (int i = e.VInterfaceBravo().VInterfaceBravo().d();
            i < e.VInterfaceBravo().VInterfaceBravo().VInterfaceBravo();
            i++) {
          boolean bool = false;
          byte b1 = 0;
          try {
            ...
            Logger.getLogger(l.class.getName())
                .log(Level.SEVERE, "FormatException??", (Throwable) o1);
          }
        }
      }
  }
  ...
  protected void a(byte paramByte) {
    try {
      ...
      if (t2 != null && t2.a() != 255) {
        ...
        if ((t2.TostringInBoPackage()).length > 0 && t2.TostringInBoPackage()[0] == 0) Q();
      }
    } catch (VInterfaceBravo b1) {
    ...
    try {
      ...
      if (t2.a() != 255) {
        ...
        if (TostringInBoPackage == null) {
          ...
          long l1 =
              TostringInBoPackage.VInterfaceBravo(
                  arrayOfByte, 3, 4, this.TostringInBoPackage.AInterfaceGolf(), false);
          D.TostringInBoPackage(
              "Set timestamp of size: " + parame.d().d().a() + " to value: " + l1);
      ...
      Logger.getLogger(l.class.getName())
          .log(Level.SEVERE, "Failed to get DAQ clock", (Throwable) o1);
      throw o1;
    }
  }
  ...
  private void IO(e parame, int paramInt) {
    try {
      BnInterfaceTango t1 =
          BnInterfaceTango.a().TostringInBoPackage(this.TostringInBoPackage, paramInt);
      BnInterfaceTango t2 = this.d.VInterfaceBravo(t1, 3);
      if (t2 == null || (t2.a() == 254 && (t2.TostringInBoPackage()).length > 0))
        while (t2 == null
            || t2.TostringInBoPackage()[0] == 16
  ...
  private void AInterfaceGolf(e parame, int paramInt) {
    try {
      ...
      BnInterfaceTango t1 =
          BnInterfaceTango.a()
              .a(
                  this.TostringInBoPackage,
                  parame.TostringInBoPackage().a().VInterfaceBravo(),
                  false,
                  paramInt,
                  parame.VInterfaceBravo(paramInt).d(),
                  (byte) i,
                  (byte) parame.VInterfaceBravo(paramInt).JInterfaceJuliet());
      ...
      if (t2 == null || (t2.a() == 254 && (t2.TostringInBoPackage()).length > 0))
        while (t2 == null
          ...
          if (t2 != null) str = TostringInBoPackage.d(t2.TostringInBoPackage());
          D.VInterfaceBravo(
              "SET_DAQ_LIST_MODE Error Code: "
                  + str
                  + " Error: "
                  + BnInterfaceNovember.a(t2.TostringInBoPackage()[0])
  ...
  protected boolean d(int paramInt) {
    try {
      ...
      D.d(
          "Connected with Controller, Protocol version: "
              + arrayOfByte1[5]
              + " Transport version: "
              + arrayOfByte1[6]);
      ...
      this.TostringInBoPackage.AInterfaceGolf(
          TostringInBoPackage.a(
              arrayOfByte1, 3, 2, this.TostringInBoPackage.AInterfaceGolf(), false));
      if (arrayOfByte1[5] > 1) {
      ...
      if (t1 == null || t1.a() != 255) {
        ...
        if (TostringInBoPackage.a(arrayOfByte1[6]) > al) {
          String str1 =
              "Dash Echo Server has greater driver version than client, app needs to be updated.\n"
                  + "Server version: "
                  + TostringInBoPackage.a(arrayOfByte1[6])
                  + ", Client Version: "
                  + al;
          D.a(str1);
      ...
      if (t1 == null || t1.a() != 255) {
        D.a(
            "Received Valid Connect, but failed GET_ID type 1. Support for Type 1 Get_ID is"
                + " required to connect.");
        return false;
      }
      ...
      int i =
          TostringInBoPackage.a(
              arrayOfByte1, 3, 4, this.TostringInBoPackage.AInterfaceGolf(), false);
      if (i == 0) {
      ...
      if (f1.al() != null && f1.al().equals("basicRequestReply")) {
        try {
          BnInterfaceTango BnInterfaceTango =
              BnInterfaceTango.a().VInterfaceBravo(VInterfaceBravo.a);
        ...
        try {
          BnInterfaceTango BnInterfaceTango =
              BnInterfaceTango.a().VInterfaceBravo(VInterfaceBravo.VInterfaceBravo);
          t1 = this.d.VInterfaceBravo(BnInterfaceTango, 2);
          if (t1 == null || t1.a() != 255)
          ...
          if (arrayOfByte1 != null && arrayOfByte1.length == 4) {
            ...
            D.VInterfaceBravo(
                "Unexpected response size for Get Blocking factors: "
                    + TostringInBoPackage.d(arrayOfByte1));
          }
        } catch (Exception exception) {
        ...
        try {
          BnInterfaceTango BnInterfaceTango =
              BnInterfaceTango.a().VInterfaceBravo(VInterfaceBravo.TostringInBoPackage);
          t1 = this.d.VInterfaceBravo(BnInterfaceTango, 2);
          if (t1 == null || t1.a() != 255)
          ...
          if (arrayOfByte1 != null && arrayOfByte1.length == 1) {
            ...
            D.VInterfaceBravo(
                "Unexpected response size for Get Local CAN ID: "
                    + TostringInBoPackage.d(arrayOfByte1));
          }
        } catch (Exception exception) {
      ...
      if (!VInterfaceBravo(arrayOfByte2)) {
        ...
        VInterfaceBravo(
            AeInterfaceMikeTostring.VInterfaceBravo(), "Invalid data received from controller.");
        return false;
      }
      this.E = true;
      this.F = true;
  ...
  public void a(byte[] paramArrayOfbyte, double paramDouble) {
    ...
    if (bool) {
      if (this.JInterfaceJuliet == null || !this.JInterfaceJuliet.isAlive()) {
        if (this.JInterfaceJuliet != null) this.JInterfaceJuliet.a();
  ...
  protected void VInterfaceBravo(String paramString) {
    if (I()) System.out.println(BnInterfaceKilo.v() + ": " + paramString);
  }

  private boolean VInterfaceBravo(IO paramf) {
    if (paramf != null)
      for (IO f1 : aq.values()) {
        if (f1.equals(paramf)) return true;
      }
    return false;
  }
}
