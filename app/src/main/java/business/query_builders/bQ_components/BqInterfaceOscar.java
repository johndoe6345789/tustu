...
class BqInterfaceOscar extends Thread {
  ...
  public BqInterfaceOscar(l paraml) {
    super("DAQ Publisher");
  }
  ...
  public synchronized void run() {
    while (!this.b && l.s(this.e)) {
      try {
        wait(50L);
        if (BnInterfaceKilo.v() - this.e.ao > 3.0F)
          ;
      ...
      while (this.a.size() > 0) {
        ...
        if (r != null) {
          if (this.e.c.a() > 0) {
            ...
            if (this.e.n < 0.0D) this.d = System.currentTimeMillis() / 1000.0D;
