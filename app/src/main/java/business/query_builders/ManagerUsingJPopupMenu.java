...
public class ManagerUsingJPopupMenu extends JButton
    implements BaInterfaceFoxtrot, bs, BaInterfaceFoxtrot {
    ...
    if (paramBoolean) {
      boolean bool =
          IOPropertiesUsingFile.IOPropertiesUsingFile()
              .JCheckBoxMenuItemExtension(IOPropertiesUsingFile.bh, IOPropertiesUsingFile.bi);
      byte b1 = 0;
      for (byte b2 = 0; b2 < b(); b2++) {
        if (IOPropertiesUsingFile(b2) instanceof bs) {
          ...
          if (bool) {
            if (bs1.RInterfaceIndia() != null) {
              boolean bool1 =
                  (bs1.RInterfaceIndia() == null || bs1.RInterfaceIndia().IOPropertiesUsingFile())
                      ? true
                      : false;
            ...
            if (bs1.e() != null) bs1.setEnabled(bs1.e().IOPropertiesUsingFile());
          } else {
            boolean bool1 =
                ((bs1.RInterfaceIndia() == null || bs1.RInterfaceIndia().IOPropertiesUsingFile())
                        && (bs1.e() == null || bs1.e().IOPropertiesUsingFile()))
                    ? true
                    : false;
            bs1.setVisible(bool1);
            if (bs1.e() != null) bs1.setEnabled(bs1.e().IOPropertiesUsingFile());
        ...
        if (IOPropertiesUsingFile(b2) instanceof JCheckBoxMenuItemExtension) {
          JCheckBoxMenuItemExtension JCheckBoxMenuItemExtension =
              (JCheckBoxMenuItemExtension) IOPropertiesUsingFile(b2);
          if (JCheckBoxMenuItemExtension.b() != null)
            JCheckBoxMenuItemExtension.setState(
                JCheckBoxMenuItemExtension.b().IOPropertiesUsingFile());
        }
      }
    }
    if (g() == 1) {
  ...
  private boolean j() {
    return (this.d != null && this.e != null && !this.e.equals(""))
        ? this.d.IOPropertiesUsingFile(this.e)
        : true;
  }
  ...
  public void BaInterfaceFoxtrot() {
    ...
    for (int RInterfaceIndia = arrayOfComponent.length - 1;
        RInterfaceIndia >= 0
            && !(arrayOfComponent[RInterfaceIndia] instanceof javax.swing.JMenuItem)
            && !(arrayOfComponent[RInterfaceIndia] instanceof javax.swing.JMenu);
        RInterfaceIndia--) remove(arrayOfComponent[RInterfaceIndia]);
  }
  ...
  private void k() {
    ...
    if (getWidth() >= dimension.width
        && (this.IOPropertiesUsingFile.length() <= 12 || getWidth() > dimension.width * 1.5D)) {
      ...
      char JCheckBoxMenuItemExtension =
          (char) ((RInterfaceIndia > 96) ? (RInterfaceIndia - 32) : RInterfaceIndia);
      if (this.IOPropertiesUsingFile.contains(" ")) {
        ...
        if (j >= 0 && j < this.IOPropertiesUsingFile.indexOf(c1)) {
          str1 =
              X.JCheckBoxMenuItemExtension(
                  this.IOPropertiesUsingFile,
                  "" + JCheckBoxMenuItemExtension,
                  "<u>" + JCheckBoxMenuItemExtension + "</u>");
        } else {
          str1 =
              X.JCheckBoxMenuItemExtension(
                  this.IOPropertiesUsingFile, "" + c1, "<u>" + c1 + "</u>");
        }
        String[] arrayOfString = str1.split(" ");
        String str2 = "<html><center>";
        for (byte b1 = 0; b1 < arrayOfString.length; b1++) {
          if ((arrayOfString.length > 1 && b1 == 0 && arrayOfString[b1].length() <= 2)
              || (arrayOfString.length > 2 && b1 == 0 && arrayOfString[b1].length() <= 5)) {
  ...
  private void l() {
    ...
    while (iterator.hasNext()) ((dr) iterator.next()).IOPropertiesUsingFile();
  }
