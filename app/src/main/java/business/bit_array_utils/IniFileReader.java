...
public class F implements Serializable {
  ...
  public void a(String paramString1, String paramString2) {
    ...
    if (!file.exists()) file = new File(c, paramString2);
    if (!file.exists())
  ...
  public double b(double paramDouble) {
    boolean bool =
        (((E) this.a.get(0)).b() > ((E) this.a.get(this.a.size() - 1)).b()) ? true : false;
    for (byte b = 1; b < this.a.size(); b++) {
      E e = this.a.get(b);
  ...
  public String a(String paramString) {
    if (paramString == null || paramString.length() == 0) paramString = "0.0";
    double d = Double.parseDouble(paramString);
    String str = a(d) + "";
    int i = str.indexOf('.');
    if (i != -1 && str.length() - i > 4) str = str.substring(0, i + 3);
    return str;
  }
