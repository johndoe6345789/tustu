...
public class X {
  ...
  public static boolean a(String paramString1, String paramString2) {
    return ((((paramString1 == null) ? 1 : 0) ^ ((paramString2 == null) ? 1 : 0)) != 0)
        ? false
        : ((paramString1 == null) ? true : paramString1.equals(paramString2));
  }
  ...
  public static String a(String paramString) {
    ...
    for (byte b = 0; b < arrayOfChar.length; b++) {
      if (a.indexOf(arrayOfChar[b]) != -1) str = str + arrayOfChar[b];
    }
    return str;
  }
  ...
  public static int a(String paramString, char paramChar) {
    ...
    boolean bool = false;
    for (byte b = 0; b < arrayOfChar.length; b++) {
      if (arrayOfChar[b] == '"') bool = !bool ? true : false;
      if (!bool && arrayOfChar[b] == paramChar) return b;
    }
    return -1;
  }
  ...
  public static String d(String paramString) {
    if (paramString.contains("<br>")) paramString = b(paramString, "\n", "");
    if (paramString.contains("  ")) paramString = b(paramString, "  ", "&nbsp;");
  ...
  public static StringBuilder a(
      StringBuilder paramStringBuilder, String paramString1, String paramString2) {
    for (int i = paramStringBuilder.indexOf(paramString1);
        i >= 0;
        i = paramStringBuilder.indexOf(paramString1, i + paramString2.length()))
      paramStringBuilder = paramStringBuilder.replace(i, i + paramString1.length(), paramString2);
    return paramStringBuilder;
  }

  public static String a(String paramString1, String paramString2, String paramString3) {
    for (int i = paramString1.toLowerCase().indexOf(paramString2.toLowerCase());
        i >= 0;
        i =
            paramString1
                .toLowerCase()
                .indexOf(paramString2.toLowerCase(), i + paramString3.length()))
      paramString1 =
  ...
  public static String b(String paramString1, String paramString2, String paramString3) {
    for (int i = paramString1.indexOf(paramString2);
        i >= 0;
        i = paramString1.indexOf(paramString2, i + paramString3.length())) {
      StringBuilder stringBuilder = new StringBuilder();
      stringBuilder.append(paramString1.substring(0, i));
      if (!paramString3.isEmpty()) stringBuilder.append(paramString3);
  ...
  public static String[] c(String paramString1, String paramString2) {
    StringTokenizer stringTokenizer =
        new StringTokenizer(paramString1 + paramString2, paramString2);
    ArrayList<String> arrayList = new ArrayList();
    while (stringTokenizer.hasMoreTokens()) {
      String str = stringTokenizer.nextToken();
      if (str.trim().startsWith("\""))
        while (str.length() > 1
            && str.trim().indexOf('"', 1) == -1
    ...
    for (byte b = 0; b < arrayOfString.length; b++) arrayOfString[b] = arrayList.get(b);
  ...
  public static double[][] a(
      double[][] paramArrayOfdouble, String paramString, boolean paramBoolean) {
    ...
    for (byte b = 0; b < paramArrayOfdouble.length; b++) {
      ...
      for (byte b1 = 0;
          b1 < (paramArrayOfdouble[b]).length && stringTokenizer1.hasMoreTokens();
          b1++) {
  ...
  public static String a(String paramString, int paramInt) {
    ...
    if (paramString.indexOf(".") == -1 && paramInt > 0) paramString = paramString + ".0";
  ...
  public static String a(String paramString, char paramChar, int paramInt) {
    ...
    while (stringBuilder.length() < paramInt) stringBuilder.insert(0, paramChar);
    return stringBuilder.toString();
  }
  ...
  public static String b(String paramString, char paramChar, int paramInt) {
    StringBuilder stringBuilder = new StringBuilder();
    stringBuilder.append(paramString);
    while (stringBuilder.length() < paramInt) stringBuilder.append(paramChar);
    return stringBuilder.toString();
  }
  ...
  public static int e(String paramString1, String paramString2) {
    byte b = 0;
    for (int i = 0; (i = paramString1.indexOf(paramString2, i)) != -1; i++) b++;
    return b;
  }
  ...
  public static StringBuilder a(
      StringBuilder paramStringBuilder, int paramInt, String paramString) {
    byte b = 0;
  ...
  public static String[] j(String paramString) {
    ...
    if (i < paramString.length()) arrayList.add(paramString.substring(i, paramString.length()));
  ...
  public static boolean a(String[] paramArrayOfString, String paramString) {
    for (byte b = 0; b < paramArrayOfString.length; b++) {
      if (paramArrayOfString[b].equalsIgnoreCase(paramString)) return true;
    }
    return false;
  }
}
