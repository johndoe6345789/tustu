...
public class c {
  ...
  private static final long[] b =
      new long[] {
        ...
        1048576L, 2097152L, 4194304L, 8388608L, 16777216L, 33554432L, 67108864L, 134217728L,
  ...
  public static boolean a(ArrayList paramArrayList) {
    for (Byte byte_ : paramArrayList) {
      if (byte_.intValue() < 9 || byte_.byteValue() > 126) return false;
    }
    return true;
  }
  ...
  public static byte[] a(int[] paramArrayOfint) {
    ...
    for (byte b = 0; b < paramArrayOfint.length; b++) arrayOfByte[b] = (byte) paramArrayOfint[b];
    return arrayOfByte;
  }

  public static int[] b(byte[] paramArrayOfbyte) {
    int[] arrayOfInt = new int[paramArrayOfbyte.length];
    for (byte b = 0; b < arrayOfInt.length; b++) arrayOfInt[b] = a(paramArrayOfbyte[b]);
    return arrayOfInt;
  }
  ...
  public static int[] b(String paramString) {
    ...
    for (String str : arrayOfString) {
      if (!str.contains(".") && str.length() > 1 && str.length() < 5) arrayList.add(str);
    }
  ...
  public static byte[] a(Byte[] paramArrayOfByte) {
    ...
    for (byte b = 0; b < arrayOfByte.length; b++) arrayOfByte[b] = paramArrayOfByte[b].byteValue();
    return arrayOfByte;
  }
  ...
  public static BigInteger a(
    ...
    for (byte b = 0; b < paramInt2; b++) arrayOfByte[b] = (byte) paramArrayOfint[paramInt1 + b];
    return new BigInteger(arrayOfByte);
  }

  public static byte[] a(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    if (paramArrayOfbyte1.length == 0) return paramArrayOfbyte2;
    if (paramArrayOfbyte2.length == 0) return paramArrayOfbyte1;
    byte[] arrayOfByte = new byte[paramArrayOfbyte1.length + paramArrayOfbyte2.length];
    System.arraycopy(paramArrayOfbyte1, 0, arrayOfByte, 0, paramArrayOfbyte1.length);
    System.arraycopy(
        paramArrayOfbyte2, 0, arrayOfByte, paramArrayOfbyte1.length, paramArrayOfbyte2.length);
    return arrayOfByte;
  }

  public static byte[] a(
      byte[] paramArrayOfbyte, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean) {
  ...
  public static byte[] a(byte[] paramArrayOfbyte, byte paramByte) {
    for (byte b = 0; b < paramArrayOfbyte.length; b++) paramArrayOfbyte[b] = paramByte;
    return paramArrayOfbyte;
  }
  ...
  public static int a(
    ...
    if (paramBoolean2 && (paramArrayOfint[paramInt1] | 0x80) == paramArrayOfint[paramInt1]) {
      i += paramInt3;
      for (j = paramInt2; j < 4; j++) i += 255 << j * 8;
      i -= paramInt3;
    }
    return i;
  }
  ...
  public static long c(
    ...
    if (paramBoolean2 && (paramArrayOfint[paramInt1] | 0x80) == paramArrayOfint[paramInt1])
      for (i = paramInt2; i < 4; i++) l += (255 << i * 8);
    return l;
  }
  ...
  public static byte[] a(long paramLong, byte[] paramArrayOfbyte, boolean paramBoolean) {
    ...
    for (b = 0; b < paramArrayOfbyte.length; b++) {
      paramArrayOfbyte[paramArrayOfbyte.length - b - 1] =
          (byte) (int) (paramLong & (l ^ 0xFFFFFFFFFFFFFFFFL));
      if (bool)
        paramArrayOfbyte[paramArrayOfbyte.length - b - 1] =
            (byte) (255 - paramArrayOfbyte[paramArrayOfbyte.length - b - 1]);
      paramLong >>= 8L;
  ...
  public static String a(int[] paramArrayOfint, int paramInt) {
    if (paramArrayOfint == null) return "null";
    ...
    if (stringBuilder2.length() > 0)
      stringBuilder1.append(
          X.a(
              ...
              ' ',
              stringBuilder2.length() + 4 * paramInt + 6 - 4 * stringBuilder2.length()));
    ...
    if (stringBuilder2.length() > 0)
      stringBuilder1.append(
          X.a(
              stringBuilder2.toString(),
              ' ',
              stringBuilder2.length() + 4 * paramInt1 + 6 - 4 * stringBuilder2.length()));
    return stringBuilder1.toString();
  }
  ...
  public static String a(int paramInt, int[] paramArrayOfint1, int[] paramArrayOfint2) {
    ...
    int i =
        (paramArrayOfint1.length > paramArrayOfint2.length)
            ? paramArrayOfint1.length
            : paramArrayOfint2.length;
    byte b2 = 0;
    String str4 = "";
    String str5 = "";
    int j = 0;
    for (byte b3 = 0; b3 < i; b3++) {
      ...
      if (paramArrayOfint1.length <= b3
          || paramArrayOfint2.length <= b3
          || paramArrayOfint1[b3] != paramArrayOfint2[b3]) {
        bool = true;
      ...
      if (b3 == i - 1 || (b1 > 0 && b3 > 0 && (b3 + 1) % b1 == 0)) {
        ...
        if ((b3 + 1) % b1 != 0)
          for (byte b = 0; (b3 + 1 + b) % b1 != 0; b++) str4 = str4 + "      ";
    ...
    if (b2 > 0) {
      ...
      str1 =
          "No difference detected in the following data sets:\n"
              + "                          Set 1                                                   "
              + "     Set 2\n"
              + str1;
    }
  ...
  public static boolean b(int[] paramArrayOfint1, int[] paramArrayOfint2) {
    if (paramArrayOfint1 == null && paramArrayOfint2 == null) return true;
    if (paramArrayOfint1 == null || paramArrayOfint2 == null) return false;
    if (paramArrayOfint1.length != paramArrayOfint2.length) return false;
    for (byte b = 0; b < paramArrayOfint1.length; b++) {
      if (paramArrayOfint1[b] >= 0
          && paramArrayOfint2[b] >= 0
          && paramArrayOfint1[b] != paramArrayOfint2[b]) return false;
    }
    return true;
  }
  ...
  public static boolean a(
    ...
    if (paramArrayOfdouble1 == null
        || paramArrayOfdouble2 == null
        || paramArrayOfdouble1.length != paramArrayOfdouble2.length) return false;
    if (paramArrayOfdouble1.length == 0 || (paramArrayOfdouble1[0]).length == 0) return true;
    for (byte b = 0; b < paramArrayOfdouble1.length; b++) {
      for (byte b1 = 0; b1 < (paramArrayOfdouble1[0]).length; b1++) {
        if (paramArrayOfdouble1[b][b1] != paramArrayOfdouble2[b][b1]) {
          ...
          if (d4 >= paramDouble) return false;
        }
      }
    }
    return true;
  ...
  public static boolean b(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    if (paramArrayOfbyte1 == null && paramArrayOfbyte2 == null) return true;
    if (paramArrayOfbyte1 == null || paramArrayOfbyte2 == null) return false;
    if (paramArrayOfbyte1.length != paramArrayOfbyte2.length) return false;
    for (byte b = 0; b < paramArrayOfbyte1.length; b++) {
      if (paramArrayOfbyte1[b] != paramArrayOfbyte2[b]) return false;
    }
    return true;
  }
  ...
  public static boolean c(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    if (paramArrayOfbyte1 == null
        ...
        || paramArrayOfbyte1.length != paramArrayOfbyte2.length) return false;
    for (byte b = 0; b < paramArrayOfbyte1.length; b++) {
      if (paramArrayOfbyte1[b] != paramArrayOfbyte2[b]) return false;
    }
    return true;
  ...
  public static boolean c(int[] paramArrayOfint1, int[] paramArrayOfint2) {
    if (paramArrayOfint1 == null
        || paramArrayOfint2 == null
        || paramArrayOfint1.length != paramArrayOfint2.length) return false;
    for (byte b = 0; b < paramArrayOfint1.length; b++) {
      if (paramArrayOfint1[b] != paramArrayOfint2[b]) return false;
    }
    return true;
  }
  ...
  private static int a(int paramInt1, int paramInt2) {
    int i = 0;
    for (int j = paramInt1; j <= paramInt2; j++) i |= a[j];
    return i;
  }
  ...
  public static boolean e(byte[] paramArrayOfbyte) {
    for (byte b = 0; b < paramArrayOfbyte.length; b++) {
      if (paramArrayOfbyte[b] != 0) return false;
    }
    return true;
  }
  ...
  public static boolean c(int[] paramArrayOfint) {
    for (byte b = 0; b < paramArrayOfint.length; b++) {
      if (paramArrayOfint[b] != 0) return false;
    }
    return true;
  }
