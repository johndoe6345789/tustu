...
public class D {
  ...
  public static void a(String paramString) {
    ...
    f(paramString);
    ArrayList<String> arrayList = b(Thread.currentThread());
    if (arrayList != null) arrayList.add("Error: " + paramString);
  }

  public static void b(String paramString) {
    g("Warning: " + paramString);
    ArrayList<String> arrayList = a(Thread.currentThread());
    if (arrayList != null) arrayList.add("Warning: " + paramString);
  }

  public static void c(String paramString) {
    if (a()) g("Debug: " + paramString);
  }
      ...
      if (j == null || !j.equals(paramString) || System.currentTimeMillis() - l > m) {
        ...
        if (k > 1) {
          if (g != null) {
            try {
              g.append(str)
                  .append("[Duplicate entry] received ")
                  .append(k + " times: ")
                  .append(j)
                  .append('\n');
              g.flush();
          ...
          for (l l : h) l.a(str + " [Duplicate entries] received " + k + " times: " + j);
        }
        if (!e) {
          if (g != null) {
            try {
        ...
        for (l l : h) l.a(paramString);
        k = 1;
        j = paramString;
        l = Long.MAX_VALUE;
      } else {
        if (k == 1) l = System.currentTimeMillis();
        k++;
      }
    }
  }
    ...
    if (f != null) {
      ...
      if (paramException != null) {
        ...
        if (paramException.getMessage() != null
            && paramString.indexOf(paramException.getMessage()) == -1)
  ...
  public static String f() {
    ...
    if (arrayList1 == null && arrayList2 == null) return "No errors or warnings captured.";
    String str = "";
    if (arrayList1 != null) {
