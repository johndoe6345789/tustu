...
public class f {
  public static String a(
    ...
    if (paramString1 == null
        ...
        || paramString3 == null
        || paramString4 == null
        || paramString1.length() == 0
        || paramString2.length() == 0
        || paramString3.length() == 0
        || paramString4.length() == 0) return null;
    byte[] arrayOfByte =
        new byte
            [paramString1.length()
                + paramString2.length()
    ...
    System.arraycopy(
        paramString3.getBytes(), 0, arrayOfByte, paramString2.length(), paramString3.length());
    System.arraycopy(
        paramString1.getBytes(),
        0,
        arrayOfByte,
        paramString2.length() + paramString3.length(),
        paramString1.length());
    System.arraycopy(
        paramString2.getBytes(),
        0,
        arrayOfByte,
        paramString2.length() + paramString3.length() + paramString1.length(),
        paramString2.length());
    System.arraycopy(
        paramString4.getBytes(),
        0,
        arrayOfByte,
        paramString2.length()
            + paramString3.length()
    ...
    for (b = 0; b < arrayOfByte.length; b++) {
      if (arrayOfByte[b] == 96
          ...
          || arrayOfByte[b] == 93
          || arrayOfByte[b] == 59
          || arrayOfByte[b] == 46) arrayOfByte[b] = (byte) (arrayOfByte[b] + 6 + b % 10);
    }
  ...
  public static String a(
    ...
    try {
      if (paramString1 == null
          ...
          || paramString2.length() == 0
          || paramString3.length() == 0
          || paramString5.length() == 0) return null;
        ...
        str =
            str
                + "123456789ABCDEFGHIJKLMNPQRSTUVWXYZ"
                    .charAt(
                        Math.abs(arrayOfByte4[b]) % "123456789ABCDEFGHIJKLMNPQRSTUVWXYZ".length());
      return str;
  ...
  public static String a(
    ...
    try {
      if (paramString1 == null
          ...
          || paramString2.length() == 0
          || paramString3.length() == 0
          || paramString5.length() == 0
          || paramString6.length() == 0
          || paramString7.length() == 0) return null;
      byte[] arrayOfByte1 =
          (a(
                      paramString1.toLowerCase(),
                      paramString2.toLowerCase(),
                      paramString3,
                      paramString5.toLowerCase())
                  + paramString6
                  + paramString7)
              .getBytes();
      MessageDigest messageDigest = MessageDigest.getInstance("MD5");
        ...
        str =
            str
                + "23456789ABCDEFGHJKLMNPQRSTUVWXYZ"
                    .charAt(
                        Math.abs(arrayOfByte4[b]) % "23456789ABCDEFGHJKLMNPQRSTUVWXYZ".length());
      return str;
    } catch (NoSuchAlgorithmException noSuchAlgorithmException) {
      D.a("Unable to perform check with this machine");
      return null;
  ...
  public static String a(
    ...
    try {
      if (paramString1 == null
          ...
          || paramString5.length() == 0
          || paramString6.length() == 0
          || paramString7.length() == 0
          || paramString8.length() == 0) return null;
      byte[] arrayOfByte1 =
          (a(
                      paramString1.toLowerCase(),
                      paramString2.toLowerCase(),
