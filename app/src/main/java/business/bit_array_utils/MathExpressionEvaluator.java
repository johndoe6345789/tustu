...
public class u {
  public List a(j paramj1, j paramj2, h paramh, double[] paramArrayOfdouble) {
    ...
    for (byte BjInterfaceBravo = 0;
        BjInterfaceBravo < paramj1.i() && BjInterfaceBravo < paramj2.i();
        BjInterfaceBravo++) {
  ...
  public List a(List paramList1, List paramList2, double[] paramArrayOfdouble) {
    ...
    for (byte b2 = 0; b2 < paramArrayOfdouble.length; b2++) {
      v v =
          new v(
              this,
              paramArrayOfdouble[b2],
              BjInterfaceCharlie.BjInterfaceBravo(paramArrayOfdouble[b2]));
      arrayList.add(v);
    }
    return arrayList;
  }
