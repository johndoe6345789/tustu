...
public class InputStreamExtensionRead extends InputStream {
  ...
  public InputStreamExtensionRead(InputStream paramInputStream) {
    this();
    this.a = paramInputStream;
  }

  public InputStreamExtensionRead() {}
  ...
  private void b() {
    ...
    this.f = ((j & 0x80) != 0);
    this.d = j & 0x1F;
    if (this.d > 16) throw new RuntimeException("Cannot handle " + this.d + " bits");
