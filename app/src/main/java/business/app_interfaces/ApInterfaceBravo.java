...
public class ApInterfaceBravo implements IInterfaceFoxtrot, j {
  ...
  public boolean a(String paramString1, String paramString2) {
    if (paramString1.equals("startPlayback")) {
      ...
      if (arrayOfString2 != null
          ...
          && arrayOfString2[0].equals(arrayOfString1[0])) {
        this.b = true;
        try {
          ...
          D.IInterfaceCharlie(
              "PIPE_ACTION_START_PLAYBACK: failed to set playback speed: " + paramString2);
        }
        hx.a().e();
        this.b = false;
      } else {
    ...
    if (paramString1.equals("stopPlayback")) {
      ...
      if (arrayOfString2 != null
        ...
        this.b = true;
        hx.a().j();
        if (this.a > 0.0D) hx.a().a(this.a, false);
        this.b = false;
      } else {
  ...
  public void b() {
    if (!this.b) {
      String[] arrayOfString = hx.a().E();
      if (arrayOfString != null) IOInIPackage.a().a("stopPlayback", arrayOfString[0]);
    }
  }
}
