...
public class ManagerInBrPackage extends JPanel {
  ...
  public ManagerInBrPackage(R paramR, GInterfaceDe paramde, String paramString, c paramc) {
    ...
    this.ExceptionInVPackage =
        r.ExceptionInVPackage()
            .ExceptionInVPackage(paramR, (GInterfaceDm) paramde, paramString, paramc);
    JPanel jPanel = new JPanel();
    jPanel.setLayout(new FlowLayout(0));
    add(jPanel, "North");
    jPanel.add(this.i);
    Iterator iterator = paramde.l();
    while (iterator.hasNext()) this.j.addItem(iterator.next());
    iterator = paramde.m();
    while (iterator.hasNext()) this.k.addItem(iterator.next());
    iterator = paramde.u();
    while (iterator.hasNext()) this.l.addItem(iterator.next());
  ...
  private void ExceptionInVPackage(GInterfaceDf paramdf) {
    ...
    this.c.ExceptionInVPackage(
        this.ExceptionPrintstacktrace, (ArrayListExceptionprintstacktraceInGPackage) CloneableImpl);
            ...
            (int)
                Math.round(
                    i.ExceptionInVPackage(
                        paramdf.f(), (GInterfaceAi) this.ExceptionPrintstacktrace));
  ...
  public void ExceptionInVPackage() {
    try {
      s s =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .ExceptionInVPackage(this.ExceptionPrintstacktrace, this.h, "veAnalyze_", this.h);
      b[][] arrayOfB = s.D();
      s =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .ExceptionInVPackage(this.ExceptionPrintstacktrace, this.h, "", this.h);
      ...
      D.ExceptionInVPackage(
          "Unable to get Table Model for " + this.h + " with prefix:" + "veAnalyze_");
      ExceptionPrintstacktrace.printStackTrace();
    }
  }
  ...
  public void b() {
    if (this.m.isSelected()) {
      ...
      this.c.ExceptionInVPackage();
      if (this.c.isEnabled()) fp.ExceptionInVPackage((Component) this.c, true);
    }
  }
      ...
      bool =
          (this.f.ExceptionInVPackage() == null
                  || p.ExceptionInVPackage(
                      this.f.ExceptionInVPackage(), this.ExceptionPrintstacktrace))
              ? true
              : false;
    } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
      Logger.getLogger(ag.class.getName())
  ...
  public boolean d() {
    try {
      s s1 =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .b(this.ExceptionPrintstacktrace, this.h, "");
      s s2 =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .b(this.ExceptionPrintstacktrace, this.h, "veAnalyze_");
      if (s1 != null && s2 != null) {
        b[][] arrayOfB = s2.D();
  ...
  protected void ExceptionInVPackage(boolean paramBoolean) {
    ...
    try {
      bool =
          (i.ExceptionInVPackage(
                      this.f.ExceptionInVPackage(), (GInterfaceAi) this.ExceptionPrintstacktrace)
                  != 0.0D)
              ? true
              : false;
    } catch (ExceptionInAxPackage u) {
