...
public class CloseInBrPackage implements GInterfaceAf, bc {
  ...
  protected CloseInBrPackage(R paramR, GInterfaceDm paramdm, String paramString, c paramc) {
    ...
    this.d = paramR;
    try {
      this.BlInterfacePapa =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .ExceptionInVPackage(paramR, paramString, "", paramString);
      this.q =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .ExceptionInVPackage(paramR, paramString, "veAnalyze_", paramString);
      this.r = ExceptionInVPackage(paramR, paramdm);
      this.s =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .ExceptionInVPackage(this.BlInterfacePapa, paramString);
      ...
      ArrayList arrayList =
          e.ExceptionInVPackage().ExceptionInVPackage(paramR, this.ExceptionInVPackage);
    ...
    if (this.i == null)
      throw new ExceptionInVPackage(
          "VE Analyze can not locate OutputChannel:"
              + paramdm.e()
    ...
    if (this.e == null)
      throw new ExceptionInVPackage(
          "VE Analyze can not locate OutputChannel:"
              + paramdm.ExceptionPrintstacktrace()
              + " in the current Configuration.");
  ...
  private s ExceptionInVPackage(R paramR, GInterfaceDm paramdm) {
    s s1 =
        ManagerBfcomponentcharlie.ExceptionInVPackage()
            .ExceptionInVPackage(paramR, paramdm.c(), paramdm.b());
    if (ManagerBfcomponentcharlie.ExceptionInVPackage().b(paramdm.c())) return s1;
    CloneableImpl CloneableImpl = (CloneableImpl) paramR.e().c(paramdm.c());
    if (CloneableImpl == null) return null;
    ...
    if (Manager.BlInterfacePapa() != null && Manager.BlInterfacePapa().equalsIgnoreCase("Volts")) {
      ...
      if (aH1 == null)
        throw new ExceptionPrintstacktrace(
            "Unable to calculate AFR based on current sensor configuration.");
      ...
      for (byte b = 0; b < s2.getRowCount(); b++) {
        for (byte b1 = 0; b1 < s2.getColumnCount(); b1++) {
          ...
          try {
            ...
            throw new ExceptionPrintstacktrace(
                "Error calculating target AFR with formula:\n"
                    + str
  ...
  public void ExceptionInVPackage(String paramString, byte[] paramArrayOfbyte) {
    if (!b()
        || !f()
        || !paramString.equals(this.d.c())
        || System.currentTimeMillis() - this.u < this.v) return;
    BlInterfacePapa p1 = null;
    if (p1 == null) {
      p1 = new BlInterfacePapa();
      p1.ExceptionInVPackage(System.currentTimeMillis());
      if (this.j == null) p1.c(100.0D);
    }
    try {
      if (this.j != null) {
  ...
  public void c() {
    ManagerUsingArrayList.ExceptionInVPackage()
        .ExceptionInVPackage(this.d.c(), this.i.aL(), this.BlInterfaceLima);
    ManagerUsingArrayList.ExceptionInVPackage()
        .ExceptionInVPackage(this.d.c(), this.e.aL(), this.BlInterfaceLima);
    ManagerUsingArrayList.ExceptionInVPackage()
        .ExceptionInVPackage(this.d.c(), this.f.aL(), this.BlInterfaceLima);
    ManagerUsingArrayList.ExceptionInVPackage()
        .ExceptionInVPackage(this.d.c(), this.ExceptionPrintstacktrace.aL(), this.BlInterfaceLima);
    ManagerUsingArrayList.ExceptionInVPackage()
        .ExceptionInVPackage(this.d.c(), this.h.aL(), this.BlInterfaceLima);
    if (this.j != null)
      ManagerUsingArrayList.ExceptionInVPackage()
          .ExceptionInVPackage(this.d.c(), this.j.aL(), this.BlInterfaceLima);
    this.c.b();
    ExceptionInVPackage();
    this.c.c();
  }
  ...
  public boolean f() {
    ...
    try {
      ...
      D.c(
          "VE Analyze Live is Unable to evaluate TableActiveCondition :\n\t"
  ...
  public void ExceptionInVPackage(String paramString) {
    ...
    if (aH1 == null)
      throw new ExceptionPrintstacktrace(
          paramString + " is not ExceptionInVPackage valid channel in configuration " + this.d.c());
    this.i = aH1;
  }
  ...
  public void b(String paramString) {
    ...
    if (aH1 == null)
      throw new ExceptionPrintstacktrace(
          paramString + " is no ExceptionInVPackage valid channel in configuration " + this.d.c());
    this.j = aH1;
  }
}
