...
public class BrInterfaceBravo {
  ...
  public void a(byte[] paramArrayOfbyte) {
    ...
    int i = 0;
    System.arraycopy(
        paramArrayOfbyte, i, this.a.BnInterfaceDelta(), 0, (this.a.BnInterfaceDelta()).length);
    i += (this.a.BnInterfaceDelta()).length;
    System.arraycopy(
        paramArrayOfbyte, i, this.b.BnInterfaceDelta(), 0, (this.b.BnInterfaceDelta()).length);
  }

  public byte[] b(byte[] paramArrayOfbyte) {
    int i = a();
    if (paramArrayOfbyte.length != i) throw new a(i, paramArrayOfbyte.length);
    int j = 0;
    System.arraycopy(
        this.a.BnInterfaceDelta(), 0, paramArrayOfbyte, j, (this.a.BnInterfaceDelta()).length);
    j += (this.a.BnInterfaceDelta()).length;
    System.arraycopy(
        this.b.BnInterfaceDelta(), 0, paramArrayOfbyte, j, (this.b.BnInterfaceDelta()).length);
