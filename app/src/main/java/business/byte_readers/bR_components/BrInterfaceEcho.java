...
public class BrInterfaceEcho {
  ...
  public void a(byte[] paramArrayOfbyte, int paramInt) {
    System.arraycopy(
        paramArrayOfbyte,
        paramInt,
        this.a.BnInterfaceDelta(),
        0,
        (this.a.BnInterfaceDelta()).length);
    paramInt += (this.a.BnInterfaceDelta()).length;
    System.arraycopy(
        paramArrayOfbyte,
        paramInt,
        this.b.BnInterfaceDelta(),
        0,
        (this.b.BnInterfaceDelta()).length);
  }
  ...
  public byte[] a(byte[] paramArrayOfbyte) {
    ...
    int j = 0;
    System.arraycopy(
        this.a.BnInterfaceDelta(), j, paramArrayOfbyte, 0, (this.a.BnInterfaceDelta()).length);
    j += (this.a.BnInterfaceDelta()).length;
    System.arraycopy(
        this.b.BnInterfaceDelta(), j, paramArrayOfbyte, 0, (this.b.BnInterfaceDelta()).length);
