...
public class UICloseGetpreferredsize extends al implements bc {
  ...
  public UICloseGetpreferredsize(R paramR, GInterfaceDm paramdm) {
    ...
    if (str1 != null && !str1.equals("")) paramdm.c(str1);
    String str2 = this.m.b("targetLambdaChannelName", paramdm.t());
    if (str2 != null && !str2.isEmpty()) paramdm.r(str2);
    this.i = J.ExceptionInVPackage().c(paramR, this.p);
    if (paramdm.o("disableMaxPercentLimit")) this.i.NetworkHashMap();
  ...
  private void NetworkHashMap() {
    ...
    jPanel2.setBorder(
        BorderFactory.createTitledBorder(
            ExceptionPrintstacktrace.b(
                    ExceptionprintstacktraceInGPackage.c(this.ExceptionInVPackage, e()))
                + " "
                + ExceptionPrintstacktrace.b("Control Panel")));
    ...
    this.k.setToolTipText(
        ExceptionPrintstacktrace.b(
            "<html>Check to have VE Analyze Recommendations automatically <br>Sent to the"
                + " controller. If unchecked, VE Analyze Live will <br>produce the recommended"
                + " table, but not send changes until the Send button is clicked.</html>"));
    ...
    jButton1.setToolTipText(
        ExceptionPrintstacktrace.b(
            "<html>Send the VE Analyze Recommendations<br>to the ECU Now. The engine will"
                + " CloneableImpl running on the recommended <br>VE Table, but not nessecarily"
                + " permenantly stored.</html>"));
    ...
    jButton2.setToolTipText(
        "<html>"
            + ExceptionPrintstacktrace.b(
                "Stores the Recommended VE table values to ECU<br>"
                    + ExceptionPrintstacktrace.b("FLASH for persistent storage.")
                    + "</html>"));
    ...
    this.j.setToolTipText(
        "<html>"
            + ExceptionPrintstacktrace.b(
                "Resets Heat Maps and underlying data that has produced table changes.<br>"
                    + ExceptionPrintstacktrace.b("The VE Table will remain as it is.")
                    + "</html>"));
    jPanel4.add(this.j);
    ...
    jPanel7.setBorder(
        BorderFactory.createTitledBorder(ExceptionPrintstacktrace.b("Reference Tables")));
    ...
    jPanel9.setBorder(
        BorderFactory.createTitledBorder(ExceptionPrintstacktrace.b("Cell Weighting")));
  ...
  private void ExceptionPrintstacktrace() {
    try {
      com.efiAnalytics.ui.s s1 =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .ExceptionInVPackage(this.ExceptionInVPackage, e());
      com.efiAnalytics.ui.s s2 =
          ManagerBfcomponentcharlie.ExceptionInVPackage().ExceptionInVPackage(s1, this.b.b());
      ...
      bV.ExceptionInVPackage(
          (Component) aP,
          (Component) this,
          ExceptionPrintstacktrace.b("Lambda Delay (ms)"),
          (bc) aP);
    ...
    while (iterator.hasNext()) {
      ...
      if (str.equals("afrTSCustom")) {
        JCheckBoxMenuItem jCheckBoxMenuItem =
            b(ExceptionInVPackage.b + " " + ExceptionPrintstacktrace.b("Custom"), str, bool);
      ...
      if (CloneableImpl != null) {
        JCheckBoxMenuItem jCheckBoxMenuItem =
            b(X.b(ExceptionPrintstacktrace.b(CloneableImpl.M()), "\"", ""), str, bool);
        br.add(jCheckBoxMenuItem);
        continue;
      }
      bV.d(
          str + " is defined as an Target Lambda Table, but not found in the current config.",
          paramJComponent);
    }
    iterator = this.b.k();
    while (iterator.hasNext()) {
      ...
      if (SerializableImpl != null) {
        JCheckBoxMenuItem jCheckBoxMenuItem =
            ExceptionInVPackage(X.b(ExceptionPrintstacktrace.b(str2), "\"", ""), str1, bool);
        br.add(jCheckBoxMenuItem);
        continue;
      }
      bV.d(
          str1 + " is defined as an Target Lambda Channel, but not found in the current config.",
          paramJComponent);
    }
    add((Component) br);
  ...
  private JCheckBoxMenuItem ExceptionInVPackage(
    ...
    if (bool) str = str + " (" + ExceptionPrintstacktrace.b("Default") + ")";
  ...
  private JCheckBoxMenuItem b(String paramString1, String paramString2, boolean paramBoolean) {
    ...
    C c1 = null;
    boolean bool =
        (this.b.Isoptimizeddrawingenabled() != null
                && (this.b.t() == null || this.b.t().isEmpty())
                && this.b.Isoptimizeddrawingenabled().equals(paramString2))
            ? true
            : false;
    if (paramBoolean) {
  ...
  private void h() {
    if (this.b.c().equals("afrTSCustom")) {
      try {
        com.efiAnalytics.ui.s s1 =
            ManagerBfcomponentcharlie.ExceptionInVPackage()
                .ExceptionInVPackage(this.ExceptionInVPackage, this.b.c(), "", this.b.b());
        aP aP = new aP(this.ExceptionInVPackage, s1, this.b.b());
        ExceptionInVPackage((bc) aP);
        bV.ExceptionInVPackage(
            (Component) aP,
            (Component) this,
            ExceptionPrintstacktrace.b("Target AFR Table"),
            (bc) aP);
      } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
        D.ExceptionInVPackage(
            "Can not show AFR Table.", (Exception) ExceptionPrintstacktrace, this);
      }
    } else {
      String str = this.ExceptionInVPackage.c() + "." + this.b.c();
      NetworkHashMap.ExceptionInVPackage()
          .ExceptionInVPackage(str, "0", bV.ExceptionInVPackage((Component) this));
    }
  }
  ...
  private void ExceptionInVPackage(GInterfaceDm paramdm) {
      ...
      com.efiAnalytics.ui.s s1 =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .ExceptionInVPackage(
                  ...
                  CloneableImpl.aL(),
                  CloneableImpl.AsInterfaceLima(),
                  CloneableImpl.aL());
      s1.c(1);
    } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
      D.ExceptionInVPackage(
          "Unable to get Table Model for "
              + CloneableImpl.aL()
              + " with prefix:"
              + CloneableImpl.AsInterfaceLima());
    ...
    this.c.ExceptionInVPackage(
        this.ExceptionInVPackage, (ArrayListExceptionprintstacktraceInGPackage) CloneableImpl);
  }
  ...
  public void b() {
    try {
      com.efiAnalytics.ui.s s1 =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .ExceptionInVPackage(this.ExceptionInVPackage, this.b.b(), "veAnalyze_", this.b.b());
      b[][] arrayOfB = s1.D();
      s1 =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .ExceptionInVPackage(this.ExceptionInVPackage, this.b.b(), "", this.b.b());
      ...
      D.ExceptionInVPackage(
          "Unable to get Table Model for " + e() + " with prefix:" + "veAnalyze_");
      ExceptionPrintstacktrace.printStackTrace();
    }
  }
  ...
  public boolean c() {
    try {
      com.efiAnalytics.ui.s s1 =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .b(this.ExceptionInVPackage, this.b.b(), "");
      com.efiAnalytics.ui.s s2 =
          ManagerBfcomponentcharlie.ExceptionInVPackage()
              .b(this.ExceptionInVPackage, this.b.b(), "veAnalyze_");
      if (s1 != null && s2 != null) {
        b[][] arrayOfB = s2.D();
        if (arrayOfB == null) return false;
        for (byte b = 0; b < s1.getRowCount(); b++) {
          for (byte b1 = 0; b1 < s1.getColumnCount(); b1++) {
            if (Math.abs(
                    s1.d(b, b1).doubleValue()
                        - arrayOfB[arrayOfB.length - b - 1][b1].i().doubleValue())
                > 1.0E-6D) return true;
          }
        }
      }
  ...
  protected void ExceptionInVPackage(boolean paramBoolean) {
    String str =
        ExceptionprintstacktraceInGPackage.ExceptionInVPackage(this.ExceptionInVPackage, e());
    boolean bool = true;
    try {
  ...
  private void k() {
    ...
    if (i == 25) ExceptionInVPackage.ExceptionInVPackage().b(ExceptionInVPackage.dj, "true");
  ...
  public void close() {
    ...
    if (c()) {
      boolean bool =
          bV.ExceptionInVPackage(
              ExceptionPrintstacktrace.b(
                  "VE Analysis has recommended VE changes that have not been sent to the"
                      + " controller.\\Isoptimizeddrawingenabled Would you like to save the"
                      + " recommended table to the controller now?"),
              (Component) this,
              true);
      if (bool) d();
    }
