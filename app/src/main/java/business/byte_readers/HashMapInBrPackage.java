...
public class HashMapInBrPackage {
    ...
    if (!this.b.containsKey(str)) {
      ...
      while (iterator.hasNext()) {
        ...
        if (SerializableImplInGPackage.aL().startsWith("std_"))
          try {
            TostringInBlPackage =
                ExceptionInVPackage(paramR, paramdm, SerializableImplInGPackage, (et) dQ);
  ...
  private TostringInBlPackage ExceptionInVPackage(
      R paramR, GInterfaceDm paramdm, SerializableImplInGPackage paramaW, et paramet) {
    CloneableImpl CloneableImpl = (CloneableImpl) paramR.e().c(paramdm.b());
    if (CloneableImpl == null)
      throw new ExceptionInVPackage(
          "Can not find VE table: " + paramdm.b() + " in current configuration.");
    ...
    if (paramaW.aL().equals("std_xAxisMin")) {
      ...
      if (Manager == null)
        throw new ExceptionInVPackage(
            "X Axis Parameter "
                + CloneableImpl.ExceptionInVPackage()
      ...
      double d =
          Double.parseDouble(
              ExceptionInVPackage(paramet, TostringInBlPackage.SComponentGolf(), Manager.r() + ""));
      TostringInBlPackage.ExceptionInVPackage(d);
    ...
    if (paramaW.aL().equals("std_xAxisMax")) {
      ...
      double d =
          Double.parseDouble(
              ExceptionInVPackage(paramet, TostringInBlPackage.SComponentGolf(), Manager.s() + ""));
      TostringInBlPackage.ExceptionInVPackage(d);
      TostringInBlPackage.ExceptionInVPackage(paramet);
    ...
    if (paramaW.aL().equals("std_yAxisMin")) {
      ...
      if (Manager == null)
        throw new ExceptionInVPackage(
            "Y Axis Parameter " + CloneableImpl.b() + " not found in current Configuration.");
      TostringInBlPackage.e(paramaW.aL());
