...
public class BuComponentAlpha {
  ...
  public boolean h() {
    return (!Double.isNaN(this.b) || !Double.isNaN(this.c) || !Double.isNaN(this.e) || !Double.isNaN(this.f) || !Double.isNaN(this.g) || !Double.isNaN(this.h) || !Double.isNaN(this.i));
  }
