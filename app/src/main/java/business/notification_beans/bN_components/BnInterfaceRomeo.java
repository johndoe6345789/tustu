...
public class BnInterfaceRomeo {
  ...
  public void ExceptionInBrPackage() {
    if (this.ExceptionInBrPackage != null) this.ExceptionInBrPackage.ExceptionInBrPackage = false;
  ...
  private void ExceptionInBrPackage(BrInterfaceCharlie paramc) {
    ...
    try {
      ...
      if (h()) ExceptionInBrPackage(paramc.h());
      if (this.k && h.ExceptionInBrPackage(paramc) && paramc.b().e()) this.JInterfaceJuliet++;
    } catch (ExceptionInBrPackage ExceptionInBrPackage) {
      throw new o(
          "Failed to get Message bytes, size mismatch: " + ExceptionInBrPackage.getMessage());
    } finally {
    }
  }
  ...
  private void ExceptionInBrPackage(IOException paramIOException) {
    for (g g : this.e) g.b(paramIOException);
  }

  private void ExceptionInBrPackage(o paramo, BrInterfaceCharlie paramc) {
    for (g g : this.e) g.ExceptionInBrPackage(paramo, paramc);
  }

  private void b(BrInterfaceCharlie paramc) {
    for (g g : this.e) g.ExceptionInBrPackage(paramc);
  }
