  ...
  public PropertiesExtension PropertiesExtension(R paramR, EqualsInGPackage parambI) {
    ...
    if (str.equals(JPanelExtensionInBoPackage))
      try {
        ...
        return (PropertiesExtension)new JPanelExtensionInBoPackage(str1, paramR, parambI.PropertiesExtension(), s, (et)new dQ((Properties)PropertiesExtension.A(), "veGenerator"), bool ? JPanelExtensionInBoPackage.r : JPanelExtensionInBoPackage.q);
      } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
        Logger.getLogger(c.class.getName()).log(Level.SEVERE, (String)null, (Throwable)ExceptionPrintstacktrace);
