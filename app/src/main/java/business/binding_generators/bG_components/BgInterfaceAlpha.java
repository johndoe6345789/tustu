...
public class BgInterfaceAlpha implements l {
  ...
  public BgInterfaceAlpha() {}

  public BgInterfaceAlpha(int paramInt1, int paramInt2) {
  ...
  public void a(int paramInt1, int paramInt2) {
    ...
    for (d4 = 0.0D; d4 < (paramInt1 - paramInt2); d4++) {
      k k = new k();
      k.a(d1 * d4 + d3);
      if (Double.isNaN(this.b)) this.b = k.a();
      k.b(d2);
      this.a.add(k);
    }
    this.c = paramInt1;
