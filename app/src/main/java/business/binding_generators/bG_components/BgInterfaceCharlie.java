...
public class BgInterfaceCharlie implements GInterfaceAn, E, G, p {
  ...
  public BgInterfaceCharlie(R paramR, PInterfaceAlpha parama, m paramm) {
    ...
    if (this.d == null) throw new ExceptionPrintstacktrace("BitArrayParameter not found.");
    try {
      ManagerUsingConcurrentHashMap.PInterfaceAlpha()
          .PInterfaceAlpha(paramR.c(), this.d.aL(), this);
    ...
    if (parama.d() != null) {
      ...
      if (this.e != null)
        try {
          ManagerUsingConcurrentHashMap.PInterfaceAlpha()
              .PInterfaceAlpha(paramR.c(), this.e.aL(), this);
        } catch (PInterfaceAlpha a1) {
          Logger.getLogger(c.class.getName()).log(Level.SEVERE, (String) null, (Throwable) a1);
        }
    }
    if (parama.c() != null) {
      ...
      if (this.f != null)
        try {
          ManagerUsingConcurrentHashMap.PInterfaceAlpha()
              .PInterfaceAlpha(paramR.c(), this.f.aL(), this);
        } catch (PInterfaceAlpha a1) {
          Logger.getLogger(c.class.getName()).log(Level.SEVERE, (String) null, (Throwable) a1);
        }
    }
  ...
  public void PInterfaceAlpha() {
    ...
    for (byte b1 = 0; b1 < arrayOfByte.length; b1++) arrayOfDouble[b1] = arrayOfByte[b1];
    try {
  ...
  public void PInterfaceAlpha(String paramString1, String paramString2) {
    if (paramString2.equals(this.d.aL())) b();
  }
