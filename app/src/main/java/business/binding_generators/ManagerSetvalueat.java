...
class ManagerSetvalueat extends DefaultTableModel {
  String[] a =
      new String[] {
        SComponentGolf.b("Name"),
        SComponentGolf.b("Tab Title"),
        SComponentGolf.b("Enabled Condition"),
        SComponentGolf.b("Default Index")
      };
  ...
  public Object getValueAt(int paramInt1, int paramInt2) {
    return (paramInt2 == 0)
        ? ((GInterfaceBf) this.b.b.get(paramInt1)).aL()
        : ((paramInt2 == 1)
            ? ((GInterfaceBf) this.b.b.get(paramInt1)).c()
            : ((paramInt2 == 2)
                ? (((GInterfaceBf) this.b.b.get(paramInt1)).aJ().trim().isEmpty()
                    ? "Always"
                    : ((GInterfaceBf) this.b.b.get(paramInt1)).aJ())
                : ((paramInt2 == 3)
                    ? Integer.valueOf(((GInterfaceBf) this.b.b.get(paramInt1)).f())
                    : null)));
  }
  ...
  private void a() {
    ...
    for (byte b = 0; b < this.b.b.size(); b++) ((GInterfaceBf) this.b.b.get(b)).a(b);
    s s = new s(this);
