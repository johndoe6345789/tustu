...
public class AzInterfaceCharlie {
  ...
  public static String g =
      "OS X and Linux require a network interface to be installed even if the Internet is"
          + " unavailable.";
  ...
  public static String j =
      "The Hardware Identifiers have changed since the registration was activated.\n"
  ...
  public static String c(ab paramab) {
    return paramab.a("You have reached the maximum number of activations for this registration.")
        + "\n"
        + paramab.a(
            "To activate more computers, you must purchase an additional registration or different"
                + " class licensing.");
  }

  public static String d(ab paramab) {
    return paramab.a(
            "Error: Either this computer is not connected to the Internet or there is a Firewall"
        ...
        + "\n  "
        + paramab.a(
            "This will require a USB drive or similar medium to save the activation file and a"
