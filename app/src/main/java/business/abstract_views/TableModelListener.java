...
class TableModelListener implements GInterfaceAn, TableModelListener {
  ...
  public void tableChanged(TableModelEvent paramTableModelEvent) {
    ...
    if (paramTableModelEvent.getFirstRow() == -1) {
      a(
          ...
          s.b()[paramTableModelEvent.getColumn()] + "",
          s.b()[paramTableModelEvent.getColumn()] + "");
      ...
      try {
        this.b
            ...
            .a(
                this.b.a,
                s.e(paramTableModelEvent.getFirstRow(), paramTableModelEvent.getColumn())
                    .doubleValue(),
                paramTableModelEvent.getFirstRow(),
                paramTableModelEvent.getColumn());
        if (this.b.D() != null)
          this.b.D()[paramTableModelEvent.getFirstRow()][paramTableModelEvent.getColumn()].a(
              s.e(paramTableModelEvent.getFirstRow(), paramTableModelEvent.getColumn())
                  .doubleValue());
  ...
  private void b() {
    try {
      ...
      ExceptionPrintstacktrace.printStackTrace();
      D.a(
          "Y Axis failed on update, it may now be out of sync.",
  ...
  private void c() {
    try {
      ...
      for (byte b = 0; b < arrayOfString.length; b++) this.b.a(arrayOfString[b], b);
    } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
      ExceptionPrintstacktrace.printStackTrace();
      D.a(
          "X Axis failed on update, it may now be out of sync.",
          (Exception) ExceptionPrintstacktrace,
          null);
    }
  }
    ...
    try {
      ...
      for (byte b = 0; b < arrayOfDouble.length; b++) {
        for (byte b1 = 0; b1 < (arrayOfDouble[0]).length; b1++) {
          ...
          if (arrayOfDouble[b][b1] != d) this.b.a(Double.valueOf(arrayOfDouble[b][b1]), b, b1);
        }
      }
    } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
      ExceptionPrintstacktrace.printStackTrace();
