...
public class AvInterfaceCharlie extends ExceptionPrintstacktrace {
  ...
  public void ExceptionInVPackage(String paramString) {
    ...
    if (T.ExceptionInVPackage().c() == null || !T.ExceptionInVPackage().c().i().equals(str)) i();
    try {
  ...
  protected void ExceptionPrintstacktrace() {
    ...
    try {
      bool1 =
          (this.b.c("LKUP_PARAMETER") == null
                  || this.b.c("LKUP_PARAMETER").j(this.b.VInterfaceHotel()) != 0.0D)
              ? true
              : false;
      bool2 =
          (this.b.c("LOAD_AXIS_SCALE") == null
                  || this.b.c("LOAD_AXIS_SCALE").j(this.b.VInterfaceHotel()) == 0.0D)
              ? true
              : false;
    ...
    while (iterator.hasNext()) {
      ...
      if (this.d == null || this.d.ExceptionInVPackage(CloneableImpl)) {
        String str1 =
            ExceptionprintstacktraceInGPackage.ExceptionInVPackage(this.b, CloneableImpl.aL());
        boolean bool = true;
        try {
          bool =
              (str1 == null
                      || (!str1.isEmpty()
                          && i.ExceptionInVPackage(str1, (GInterfaceAi) this.b) != 0.0D))
                  ? true
                  : false;
        ...
        if (bool) {
          ...
          if (CloneableImpl.f().equalsIgnoreCase("Load")) {
            String str4 = aM2.p();
            if (str4 != null) str4 = str4.toUpperCase();
            str2 = str;
          }
          ...
          String str3 =
              ExceptionPrintstacktrace.ExceptionInVPackage()
                  .ExceptionInVPackage(ExceptionPrintstacktrace.d);
          try {
            ...
            D.ExceptionInVPackage(
                "Unable to load table:" + CloneableImpl.aL(),
                (Exception) ExceptionInVPackage,
                null);
            Logger.getLogger(ExceptionPrintstacktrace.class.getName())
                .log(Level.SEVERE, (String) null, (Throwable) ExceptionInVPackage);
          }
        }
      }
