...
public final class NetworkLoggerInBwPackage {
  ...
  public static final e a(
      e parame,
      InetAddress paramInetAddress1,
      int paramInt,
      InetAddress paramInetAddress2,
      String paramString,
      c[] paramArrayOfc) {
    if (parame == null) throw new NullPointerException("request is null");
    if (!parame.n()) throw new a("request is BOOTP");
    Byte byte_ = parame.w();
    if (byte_ == null) throw new a("request has no message type");
    if (byte_.byteValue() != 1) throw new a("request is not DHCPDISCOVER");
    ...
    if (paramArrayOfc != null) for (c c1 : paramArrayOfc) e1.a(c1.a(parame));
  ...
  public static final e b(
    ...
    e1.a(parame.i());
    e1.b(parame.f());
    if (byte_.byteValue() != 8) e1.b(paramInetAddress1);
    e1.c(parame.k());
    e1.a(parame.c());
    e1.d((byte) 5);
    if (byte_.byteValue() == 3) e1.a((byte) 51, paramInt);
    e1.a((byte) 54, paramInetAddress2);
    e1.a((byte) 56, paramString);
    if (paramArrayOfc != null) for (c c1 : paramArrayOfc) e1.a(c1.a(parame));
  ...
  public static final e a(e parame, InetAddress paramInetAddress, String paramString) {
    ...
    Byte byte_ = parame.w();
    if (byte_ == null) throw new a("request has no message type");
    if (byte_.byteValue() != 3) throw new a("request is not DHCPREQUEST");
    e e1 = new e();
    e1.c((byte) 2);
    e1.b(parame.m());
    e1.a(parame.l());
  ...
  public static InetSocketAddress a(e parame, byte paramByte) {
    ...
    if (parame == null) throw new IllegalArgumentException("request is null");
