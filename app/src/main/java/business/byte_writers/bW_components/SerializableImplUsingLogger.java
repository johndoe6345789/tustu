...
public class SerializableImplUsingLogger implements Serializable {
  ...
  public SerializableImplUsingLogger(
      byte paramByte, byte[] paramArrayOfbyte, boolean paramBoolean) {
    if (paramByte == 0)
  ...
  public boolean equals(Object paramObject) {
    ...
    if (!(paramObject instanceof c)) return false;
    c c1 = (c) paramObject;
  ...
  public byte c() {
    ...
    if (this.e == null) throw new IllegalStateException("value is null");
    if (this.e.length != 1)
  ...
  public c a(e parame) {
    if (parame == null) throw new NullPointerException("request is null");
    if (this.f) {
      c c1 = parame.h(a());
  ...
  public void a(StringBuilder paramStringBuilder) {
    ...
    if (this.f) paramStringBuilder.append("<mirror>");
    if (this.e == null) {
      ...
      try {
        switch (((d) a.get(Byte.valueOf(this.d))).ordinal()) {
          ...
          case 3:
            ...
            return;
          case 4:
            for (short s : h()) paramStringBuilder.append(s).append(' ');
            return;
          case 5:
          ...
          case 7:
            ...
            return;
          case 6:
            if (this.e != null) for (byte b : this.e) paramStringBuilder.append(i(b)).append(' ');
            return;
        }
  ...
  public static byte[] a(int paramInt) {
    return new byte[] {
      (byte) ((paramInt & 0xFF000000) >>> 24),
      (byte) ((paramInt & 0xFF0000) >>> 16),
      (byte) ((paramInt & 0xFF00) >>> 8),
      (byte) (paramInt & 0xFF)
    };
  }

  public static byte[] a(InetAddress paramInetAddress) {
    if (paramInetAddress == null) return null;
  ...
  static {
    ...
    g =
        new Object[] {
          Byte.valueOf((byte) 1), d.a, Byte.valueOf((byte) 2), d.c, Byte.valueOf((byte) 3), d.b,
              Byte.valueOf((byte) 4), d.b, Byte.valueOf((byte) 5), d.b,
          Byte.valueOf((byte) 6), d.b, Byte.valueOf((byte) 7), d.b, Byte.valueOf((byte) 8), d.b,
              Byte.valueOf((byte) 9), d.b, Byte.valueOf((byte) 10), d.b,
          Byte.valueOf((byte) 11), d.b, Byte.valueOf((byte) 12), d.h, Byte.valueOf((byte) 13), d.d,
              Byte.valueOf((byte) 14), d.h, Byte.valueOf((byte) 15), d.h,
          Byte.valueOf((byte) 16), d.a, Byte.valueOf((byte) 17), d.h, Byte.valueOf((byte) 18), d.h,
              Byte.valueOf((byte) 19), d.f, Byte.valueOf((byte) 20), d.f,
          Byte.valueOf((byte) 21), d.b, Byte.valueOf((byte) 22), d.d, Byte.valueOf((byte) 23), d.f,
              Byte.valueOf((byte) 24), d.c, Byte.valueOf((byte) 25), d.e,
          Byte.valueOf((byte) 26), d.d, Byte.valueOf((byte) 27), d.f, Byte.valueOf((byte) 28), d.a,
              Byte.valueOf((byte) 29), d.f, Byte.valueOf((byte) 30), d.f,
          Byte.valueOf((byte) 31), d.f, Byte.valueOf((byte) 32), d.a, Byte.valueOf((byte) 33), d.b,
              Byte.valueOf((byte) 34), d.f, Byte.valueOf((byte) 35), d.c,
          Byte.valueOf((byte) 36), d.f, Byte.valueOf((byte) 37), d.f, Byte.valueOf((byte) 38), d.c,
              Byte.valueOf((byte) 39), d.f, Byte.valueOf((byte) 41), d.b,
          Byte.valueOf((byte) 42), d.b, Byte.valueOf((byte) 44), d.b, Byte.valueOf((byte) 45), d.b,
              Byte.valueOf((byte) 46), d.f, Byte.valueOf((byte) 47), d.h,
          Byte.valueOf((byte) 48), d.b, Byte.valueOf((byte) 49), d.b, Byte.valueOf((byte) 50), d.a,
              Byte.valueOf((byte) 51), d.c, Byte.valueOf((byte) 52), d.f,
          Byte.valueOf((byte) 53), d.f, Byte.valueOf((byte) 54), d.a, Byte.valueOf((byte) 55), d.g,
              Byte.valueOf((byte) 56), d.h, Byte.valueOf((byte) 57), d.d,
          Byte.valueOf((byte) 58), d.c, Byte.valueOf((byte) 59), d.c, Byte.valueOf((byte) 60), d.h,
              Byte.valueOf((byte) 62), d.h, Byte.valueOf((byte) 64), d.h,
          Byte.valueOf((byte) 65), d.h, Byte.valueOf((byte) 66), d.h, Byte.valueOf((byte) 67), d.h,
              Byte.valueOf((byte) 68), d.b, Byte.valueOf((byte) 69), d.b,
          Byte.valueOf((byte) 70), d.b, Byte.valueOf((byte) 71), d.b, Byte.valueOf((byte) 72), d.b,
              Byte.valueOf((byte) 73), d.b, Byte.valueOf((byte) 74), d.b,
          Byte.valueOf((byte) 75), d.b, Byte.valueOf((byte) 76), d.b, Byte.valueOf((byte) 85), d.b,
              Byte.valueOf((byte) 86), d.h, Byte.valueOf((byte) 87), d.h,
          Byte.valueOf((byte) 91), d.c, Byte.valueOf((byte) 92), d.b, Byte.valueOf((byte) 98), d.h,
              Byte.valueOf((byte) 116), d.f, Byte.valueOf((byte) 117), d.e,
          Byte.valueOf((byte) 118), d.a, Byte.valueOf((byte) 119), d.h
        };
    a = new LinkedHashMap<>();
    for (byte b = 0; b < g.length / 2; b++) a.put((Byte) g[b * 2], (d) g[b * 2 + 1]);
  }
}
