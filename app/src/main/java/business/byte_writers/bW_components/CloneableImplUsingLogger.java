...
public class CloneableImplUsingLogger implements Cloneable {
  ...
  public static e a(DatagramPacket paramDatagramPacket) {
    if (paramDatagramPacket == null) throw new IllegalArgumentException("datagram is null");
    e e1 = new e();
    e1.a(
        paramDatagramPacket.getData(),
        paramDatagramPacket.getOffset(),
  ...
  public boolean equals(Object paramObject) {
    ...
    if (!(paramObject instanceof e)) return false;
    e e1 = (e) paramObject;
  ...
  private void A() {
    if (!a && this.c == null) throw new AssertionError();
    if (!a && this.k == null) throw new AssertionError();
    if (!a && this.k.length != 4) throw new AssertionError();
    if (!a && this.l == null) throw new AssertionError();
    if (!a && this.l.length != 4) throw new AssertionError();
    if (!a && this.m == null) throw new AssertionError();
    if (!a && this.m.length != 4) throw new AssertionError();
    if (!a && this.n == null) throw new AssertionError();
    if (!a && this.n.length != 4) throw new AssertionError();
    if (!a && this.o == null) throw new AssertionError();
    if (!a && this.o.length != 16) throw new AssertionError();
    if (!a && this.p == null) throw new AssertionError();
    if (!a && this.p.length != 64) throw new AssertionError();
    if (!a && this.q == null) throw new AssertionError();
    if (!a && this.q.length != 128) throw new AssertionError();
    if (!a && this.u == null) throw new AssertionError();
    if (!a && this.r == null) throw new AssertionError();
    for (Map.Entry entry : this.r.entrySet()) {
      Byte byte_ = (Byte) entry.getKey();
      c c = (c) entry.getValue();
      if (!a && byte_ == null) throw new AssertionError();
      if (!a && byte_.byteValue() == 0) throw new AssertionError();
      if (!a && byte_.byteValue() == -1) throw new AssertionError();
      if (!a && c == null) throw new AssertionError();
      if (!a && c.a() != byte_.byteValue()) throw new AssertionError();
      if (!a && c.b() == null) throw new AssertionError();
    }
  }
  ...
  protected e a(
    ...
    if (paramArrayOfbyte == null) throw new IllegalArgumentException("null buffer not allowed");
    if (paramInt1 < 0) throw new IndexOutOfBoundsException("negative offset not allowed");
    if (paramInt2 < 0) throw new IllegalArgumentException("negative length not allowed");
    ...
    if (paramInt2 > 1500) throw new a("DHCP Packet too big (" + paramInt2 + ") max MTU is " + 'ל');
    this.v = paramInetAddress;
    this.w = paramInt3;
    try {
      ByteArrayInputStream byteArrayInputStream =
          new ByteArrayInputStream(paramArrayOfbyte, paramInt1, paramInt2);
      ...
      if (this.s) {
        ...
        this.t = (b != -1);
        if (paramBoolean && this.t) throw new a("Packet seams to be truncated");
      }
  ...
  public byte[] a(int paramInt1, int paramInt2) {
    ...
    try {
      ...
      if (this.s) {
        ...
        for (c c : x()) {
          if (!a && c == null) throw new AssertionError();
          if (!a && c.a() == 0) throw new AssertionError();
          if (!a && c.a() == -1) throw new AssertionError();
          if (!a && c.b() == null) throw new AssertionError();
          int j = (c.b()).length;
          if (!a && j < 0) throw new AssertionError();
          if (j > 255) throw new a("Options larger than 255 bytes are not yet supported");
  ...
  public String toString() {
    ...
    try {
      stringBuilder
          .append(this.s ? "DHCP Packet" : "BOOTP Packet")
          .append("\ncomment=")
          .append(this.c)
          .append("\naddress=")
          .append((this.v != null) ? this.v.getHostAddress() : "")
          .append('(')
          .append(this.w)
          .append(')')
          .append("\nop=");
      ...
      stringBuilder
          ...
          .append(this.i)
          .append("\nflags=0x")
          .append(Integer.toHexString(this.j))
          .append("\nciaddr=");
    ...
    if (paramArrayOfbyte != null) {
      if (paramArrayOfbyte.length > this.o.length)
        throw new IllegalArgumentException(
            "chaddr is too long: " + paramArrayOfbyte.length + ", max is: " + this.o.length);
  ...
  public void b(byte[] paramArrayOfbyte) {
    if (paramArrayOfbyte.length != 4) throw new IllegalArgumentException("4-byte array required");
  ...
  public c h(byte paramByte) {
    ...
    if (!a && c.a() != paramByte) throw new AssertionError();
    if (!a && c.b() == null) throw new AssertionError();
    return c;
  }
  ...
  static String a(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    ...
    if (paramInt1 >= paramArrayOfbyte.length) return "";
  ...
  static void a(
      StringBuilder paramStringBuilder, byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    if (paramArrayOfbyte == null) return;
    if (paramInt1 < 0) {
      paramInt2 += paramInt1;
      paramInt1 = 0;
    }
    if (paramInt2 <= 0 || paramInt1 >= paramArrayOfbyte.length) return;
    if (paramInt1 + paramInt2 > paramArrayOfbyte.length)
      paramInt2 = paramArrayOfbyte.length - paramInt1;
    for (int i = paramInt1; i < paramInt1 + paramInt2; i++)
  ...
  public static byte[] a(String paramString) {
    ...
    for (byte b = 0; b < i; b++) arrayOfByte[b] = (byte) arrayOfChar[b];
    return arrayOfByte;
  }

  public static void a(StringBuilder paramStringBuilder, InetAddress paramInetAddress) {
    if (paramInetAddress == null) throw new IllegalArgumentException("addr must not be null");
    if (!(paramInetAddress instanceof java.net.Inet4Address))
      throw new IllegalArgumentException("addr must be an instance of Inet4Address");
    byte[] arrayOfByte = paramInetAddress.getAddress();
    paramStringBuilder
        .append(arrayOfByte[0] & 0xFF)
        .append('.')
        .append(arrayOfByte[1] & 0xFF)
        .append('.')
        .append(arrayOfByte[2] & 0xFF)
        .append('.')
        .append(arrayOfByte[3] & 0xFF);
  }
