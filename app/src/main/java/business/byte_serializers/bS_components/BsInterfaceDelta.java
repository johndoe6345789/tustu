...
public class BsInterfaceDelta {
  ...
  public TostringInBoPackage b(int paramInt) {
    ...
    if (paramInt >= this.e.b().b()) return null;
  ...
  public BoInterfaceLima BoInterfaceAlpha(int paramInt1, int paramInt2, int paramInt3) {
    ...
    ArrayListExtensionInBoPackage ArrayListExtensionInBoPackage =
        TostringInBoPackage.TostringInBoPackage(paramInt2);
    if (paramInt3 < 0 || paramInt3 >= TostringInBoPackage.TostringInBoPackage())
      throw new ExceptionInBoPackage(
          "Invalid ODT Entry Number: "
              + paramInt3
              + " ,max ODT Entries: "
              + TostringInBoPackage.TostringInBoPackage());
  ...
  public void ExceptionInBoPackage(int paramInt) {
    if (!this.b.contains(Integer.valueOf(paramInt))) this.b.add(Integer.valueOf(paramInt));
  }
  ...
  public void i() {
    for (b b : this.BoInterfaceAlpha) b.b();
  }
}
