...
public class BsInterfaceLima {
  ...
  public void a(q paramq) {
    if (!this.a.contains(paramq)) this.a.add(paramq);
  }
  ...
  private void c(r paramr) {
    for (q q : this.a) q.a(paramr);
    paramr.a(new m(this, paramr));
  }

  private void d(r paramr) {
    this.b.remove(paramr);
    if (c() && a(paramr.h()) < paramr.x()) b(paramr);
  }

  private int a(String paramString) {
    byte b = 0;
    for (n n : this.c) {
      if (n.b().h().equals(paramString)) b++;
    }
    return b;
  }
