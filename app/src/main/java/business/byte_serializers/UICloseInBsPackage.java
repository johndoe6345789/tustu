...
public class UICloseInBsPackage extends d implements bc {
  ...
  public UICloseInBsPackage(R paramR, GInterfaceDp paramdp) {
    ...
    this.Isoptimizeddrawingenabled =
        new dQ((Properties) ExceptionInVPackage.A(), "WueAnalyzePanel_" + paramdp.c());
    String str =
        this.Isoptimizeddrawingenabled.b("targetLambdaTableName", paramdp.NetworkHashMap());
    if (str != null && !str.equals("")) paramdp.NetworkHashMap(str);
    this.b = new D(paramR, paramdp);
    paramR.C().ExceptionInVPackage(this.b);
    boolean bool =
        Boolean.parseBoolean(this.Isoptimizeddrawingenabled.b("extendBeyondData", "true"));
    this.b.b(bool);
  ...
  private JPanel ExceptionInVPackage() {
    ...
    jPanel1.setBorder(
        BorderFactory.createTitledBorder(
            ExceptionPrintstacktrace.b(this.j.M())
                + " - "
    ...
    this.JComponentExtension =
        new JCheckBox(ExceptionPrintstacktrace.b("Update Controller") + "   ");
    this.JComponentExtension.setToolTipText(
        "<html>"
            + ExceptionPrintstacktrace.b(
                "Check to have WUE Analyze Recommendations automatically <br>sent to the"
                    + " controller. If unchecked, WUE Analyze Live will <br>produce the recommended"
                    + " warmup enrichment curve, but not send changes until the Apply button is"
                    + " clicked.</html>"));
    ...
    jButton2.setToolTipText(
        ExceptionPrintstacktrace.b(
            "<html>Stores the Recommended VE table values to ECU <br>FLASH for persistent"
                + " storage.</html>"));
    ...
    jCheckBox.setToolTipText(
        "<html>"
            + ExceptionPrintstacktrace.b(
                "Predict warmup values beyond the temperature range <br>of data collected during"
                    + " this session.<br>This will produce best guess estimates for very cold"
                    + " temperatures <br>that may CloneableImpl difficult to collect data"
                    + " for.</html>"));
    boolean bool =
        Boolean.parseBoolean(this.Isoptimizeddrawingenabled.b("extendBeyondData", "true"));
  ...
  private JPanel b() {
    if (this.c.e().c(this.ExceptionInVPackage.ExceptionPrintstacktrace()) == null)
      throw new ExceptionPrintstacktrace(
          "WUE Analyzer: Can not locate AFR Compensation Curve "
              + this.ExceptionInVPackage.ExceptionPrintstacktrace()
              + " in "
              + this.c.c());
    if (this.j == null)
      throw new ExceptionPrintstacktrace(
          "WUE Analyzer: Can not locate Warm up Curve "
    ...
    ExceptionEqualsinaipackage ExceptionEqualsinaipackage =
        new ExceptionEqualsinaipackage(this.c, bv1);
  ...
  private JPanel d() {
    ...
    jPanel.setBorder(
        BorderFactory.createTitledBorder(ExceptionPrintstacktrace.b("WUE Error vs Coolant")));
    return jPanel;
  }
  ...
  private JPanel e() {
    ...
    jPanel.add("East", (Component) fF2);
    jPanel.setBorder(
        BorderFactory.createTitledBorder(ExceptionPrintstacktrace.b("Recommended WUE Data")));
    return jPanel;
  }
  ...
  private Isoptimizeddrawingenabled NetworkHashMap() {
    ...
    ExceptionInVPackage ExceptionInVPackage =
        new ExceptionInVPackage(this.c, this.ExceptionInVPackage);
    ...
    while (iterator.hasNext()) {
      ...
      if (str.equals("afrTSCustom")) {
        JCheckBoxMenuItem jCheckBoxMenuItem =
            ExceptionInVPackage(
                ExceptionInVPackage.b + " " + ExceptionPrintstacktrace.b("Custom"), str, bool);
      ...
      if (CloneableImpl != null) {
        JCheckBoxMenuItem jCheckBoxMenuItem =
            ExceptionInVPackage(
                X.b(ExceptionPrintstacktrace.b(CloneableImpl.M()), "\"", ""), str, bool);
        br.add(jCheckBoxMenuItem);
        continue;
      }
      bV.d(
  ...
  private JCheckBoxMenuItem ExceptionInVPackage(
    ...
    boolean bool =
        (this.ExceptionInVPackage.JComponentExtension() != null
                && this.ExceptionInVPackage.JComponentExtension().equals(paramString2))
            ? true
            : false;
    if (paramBoolean) {
      ...
      try {
        ...
        s s =
            ManagerBfcomponentcharlie.ExceptionInVPackage()
                .ExceptionInVPackage(this.c, this.ExceptionInVPackage.NetworkHashMap(), "", str);
  ...
  private void ExceptionInVPackage(boolean paramBoolean) {
    if (paramBoolean) {
      ...
      try {
        ...
        bV.d(
            "Could not start WUE Analyze!\\Isoptimizeddrawingenabled"
      ...
      try {
        ...
        Logger.getLogger(k.class.getName())
            .log(Level.SEVERE, (String) null, (Throwable) ExceptionInVPackage);
        bV.d(
            "Could not stop WUE Analyze!\\Isoptimizeddrawingenabled"
                + ExceptionInVPackage.getLocalizedMessage(),
            (Component) this);
      }
      j();
  ...
  private void h() {
    try {
      this.b.e();
      if (this.ExceptionInVPackage.l(GInterfaceDp.e)) i();
    } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
      Logger.getLogger(k.class.getName())
          .log(Level.SEVERE, (String) null, (Throwable) ExceptionPrintstacktrace);
      bV.d(
          "Error Applying Recommended WUE.\\Isoptimizeddrawingenabled"
