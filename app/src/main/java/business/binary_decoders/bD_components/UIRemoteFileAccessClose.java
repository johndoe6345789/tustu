...
public class UIRemoteFileAccessClose extends JPanel implements a, bc {
  ...
  public UIRemoteFileAccessClose(RemoteFileAccess paramRemoteFileAccess, ab paramab) {
  ...
  private void a(List paramList) {
    ...
    while (iterator.hasNext()) this.g.a(iterator.next());
