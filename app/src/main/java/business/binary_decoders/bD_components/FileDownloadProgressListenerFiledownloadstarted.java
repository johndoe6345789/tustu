...
public class FileDownloadProgressListenerFiledownloadstarted
    implements FileDownloadProgressListener {
  ...
  public void fileDownloadStarted(RemoteFileDescriptor paramRemoteFileDescriptor) {
    if (!this.c) {
      ...
      while (iterator.hasNext()) this.d += ((RemoteFileDescriptor) iterator.next()).getSize();
      this.c = true;
      String str = "Beginning download of " + paramRemoteFileDescriptor.getName();
      if (this.f > 1) str = str + ", File 1 of " + this.f;
      this.i.b().a(str);
      this.i.b().a(-1.0D);
  ...
  public void fileDownloadCompleted(
    ...
    if (paramRemoteFileDescriptor == null || paramFile == null) return;
    ...
    this.i.b().a(d);
    if (paramFile != null && paramFile.length() > 0L) this.b.add(paramFile);
    if (this.a.isEmpty())
      try {
        if (this.i.c() != null) {
          g g = this.i.c();
