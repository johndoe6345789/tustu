...
public class Timer implements a {
  ...
  public void c(String paramString) {
    ...
    if (!f()) i.b(this.c, paramString, this.e);
    h();
  }
      ...
      try {
        ...
        D.b(
            exception.getLocalizedMessage()
                + ". Trigger Condition not valid for currently loaded config: "
                + d());
        d = 0.0D;
  ...
  public boolean b(String paramString, byte[] paramArrayOfbyte) {
    ...
    if (c() && e() != null && !f() && !e().equals("")) {
      ...
      try {
        bool =
            (i.a(e(), (GInterfaceAi) r, paramArrayOfbyte) != 0.0D
                    && i.a(d(), (GInterfaceAi) r, paramArrayOfbyte) == 0.0D)
                ? true
                : false;
      } catch (ExceptionInAxPackage u) {
        D.b(
            u.getLocalizedMessage()
                + ". Trigger Reset Condition not valid for current config: "
                + e());
        this.i.add(paramString);
        bool = false;
        return false;
  ...
  public boolean b(String paramString) {
    ...
    if (c() && e() != null && !f() && !e().equals("") && !this.i.contains(paramString)) {
      ...
      try {
        bool =
            (i.a(e(), (GInterfaceAi) r) != 0.0D && i.a(d(), (GInterfaceAi) r) == 0.0D)
                ? true
                : false;
      } catch (ExceptionInAxPackage u) {
