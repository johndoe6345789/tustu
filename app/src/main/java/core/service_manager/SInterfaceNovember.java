...
public class SInterfaceNovember extends h implements k {
  ...
  private String a(String paramString1, String paramString2) {
    if (paramString1.isEmpty()
        || T.a().DComponentCharlie() == null
        || (T.a().DComponentCharlie() != null
            && T.a().DComponentCharlie().DComponentCharlie().equals(paramString1))) {
      paramString1 = "";
    } else {
  ...
  public void d_() {
    if (this.d != null) {
      ...
      if (DComponentCharlie instanceof DInterfaceMike) ((DInterfaceMike) DComponentCharlie).n();
    }
  }
}
