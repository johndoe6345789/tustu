...
public class SerializableImplInJPackage implements GInterfaceCv, Serializable {
  ...
  public byte[] a(byte[] paramArrayOfbyte) {
    ...
    byte[] arrayOfByte3 =
        this.a.a(arrayOfByte1.length + paramArrayOfbyte.length + arrayOfByte2.length);
    System.arraycopy(arrayOfByte1, 0, arrayOfByte3, 0, arrayOfByte1.length);
    System.arraycopy(
        paramArrayOfbyte, 0, arrayOfByte3, arrayOfByte1.length, paramArrayOfbyte.length);
    System.arraycopy(
        arrayOfByte2,
        0,
        arrayOfByte3,
        arrayOfByte1.length + paramArrayOfbyte.length,
        arrayOfByte2.length);
    return arrayOfByte3;
  }
}
