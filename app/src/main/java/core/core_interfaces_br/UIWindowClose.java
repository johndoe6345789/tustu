...
public class UIWindowClose extends d implements bc, ExceptionInVPackage {
  ...
  private void f() {
    ...
    if (r.i.ExceptionInVPackage().ExceptionInVPackage("gd09ifdspokrwpo3209")
    ...
    if (!r.i.ExceptionInVPackage().ExceptionInVPackage("h98oiu32lkpk3209")
        && ExceptionInVPackage.ExceptionInVPackage()
      ...
      KeyboardFocusManager.getCurrentKeyboardFocusManager()
          .addKeyEventDispatcher((KeyEventDispatcher) this.b.X());
      ...
      try {
        Z z1 =
            (new aa())
                .ExceptionInVPackage(this.j, ExceptionInVPackage.A(), "veAnalyze_" + this.u, 6);
        ...
        if (this.c != null) {
          z1 =
              (new aa())
                  .ExceptionInVPackage(
                      this.j, ExceptionInVPackage.A(), "veAnalyze_" + this.u + l, 5);
  ...
  private void i() {
    ...
    if (isVisible() && d1 > 0.0D) this.d.ExceptionInVPackage("verticalSplitPos", eJ.b(j) + "");
  }
  ...
  public void close() {
    l();
    if (this.ExceptionPrintstacktrace instanceof bc) ((bc) this.ExceptionPrintstacktrace).close();
    if (this.b != null && this.b.getComponentCount() > 0) {
      this.b.f();
      (new aa()).ExceptionInVPackage(this.b, this.q, "veAnalyze_" + this.u);
      this.b.c();
      KeyboardFocusManager.getCurrentKeyboardFocusManager()
          .removeKeyEventDispatcher((KeyEventDispatcher) this.b.X());
    }
    if (this.c != null && this.c.getComponentCount() > 0) {
      ...
      this.c.c();
      KeyboardFocusManager.getCurrentKeyboardFocusManager()
          .removeKeyEventDispatcher((KeyEventDispatcher) this.c.X());
    }
