  ...
  public boolean dispatchKeyEvent(KeyEvent paramKeyEvent) {
    ...
    if (paramKeyEvent.getID() == 401) {
      ...
      if (paramKeyEvent.getSource() instanceof Component) {
        ...
        if (frame != null && window != null && !frame.equals(window)) return false;
      }
      if (paramKeyEvent.getSource() != null
          && (paramKeyEvent.getSource() instanceof javax.swing.JTextArea
              || paramKeyEvent.getSource() instanceof javax.swing.JTextField
              || paramKeyEvent.getSource() instanceof javax.swing.JMenu
              || paramKeyEvent.getSource() instanceof javax.swing.JMenuItem
              || paramKeyEvent.getSource() instanceof javax.swing.JRootPane
              || paramKeyEvent.getSource() instanceof java.awt.TextComponent)) return false;
      ...
      } else if (paramKeyEvent.getSource() != null
          && !(paramKeyEvent.getSource() instanceof com.efiAnalytics.ui.de)) {
        switch (i) {
          case 36:
            this.a.n();
            break;
      ...
      if (paramKeyEvent.getSource() != null
          && !(paramKeyEvent.getSource() instanceof com.efiAnalytics.ui.BinTableView)
          && !(paramKeyEvent.getSource() instanceof com.efiAnalytics.ui.eM)
          && !(paramKeyEvent.getSource() instanceof com.efiAnalytics.ui.de)) {
        aw aw;
        switch (i) {
          case 38:
