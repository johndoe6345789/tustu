...
public class hZ extends w implements TableModelListener {
  ...
  public void a(hY paramhY) {
    int IOProperties = paramhY.g();
    h().a(IOProperties);
    h().b(paramhY.h());
    b(paramhY.IOProperties());
    if (this.w != null) {
      String str = this.w.a("yAxis_" + paramhY.z());
      if (str != null && !str.equals("")) paramhY.d(str);
    }
    a(paramhY);
    h().c(b(paramhY));
  }
  ...
  private boolean b(hY paramhY) {
    return ((int) Math.log10(paramhY.F()) + paramhY.IOProperties() <= 3
        && paramhY.h() < 1
        && J.a()
        && (int) Math.log10(paramhY.B()) + paramhY.g() <= 3);
  }
  ...
  public void a() {
    s s = (s) h().getModel();
    String str = IOProperties.a("yAxisField", "MAP");
    s.d(str);
    if (this.w != null) this.w.a("yAxis_" + s.z(), "");
  }
  ...
  public void b() {
    ...
    String str =
        IOJFileChooser.a(
            "{Y-Axis Override for " + s.z() + "}",
            false,
            "Override Y-Axis Field.",
            true,
            (Component) this);
    if (str != null && !str.equals("")) {
      s.d(str);
      if (this.w != null) this.w.a("yAxis_" + s.z(), str);
    }
  }
