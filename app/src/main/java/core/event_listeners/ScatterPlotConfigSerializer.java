...
public class fI {
  ...
  public static fH ExceptionInVPackage(String paramString) {
    ...
    try {
      ...
      if (AkInterfaceAe.ExceptionInVPackage()) fH.b(AkInterfaceAe.b());
      if (AkInterfaceAe.ExceptionInVPackage())
        fH.ExceptionInVPackage(Double.parseDouble(AkInterfaceAe.b()));
      if (AkInterfaceAe.ExceptionInVPackage()) fH.b(Double.parseDouble(AkInterfaceAe.b()));
      if (AkInterfaceAe.ExceptionInVPackage())
        fH.ExceptionInVPackage(Boolean.valueOf(AkInterfaceAe.b()).booleanValue());
      if (AkInterfaceAe.ExceptionInVPackage()) fH.c(AkInterfaceAe.b());
      if (AkInterfaceAe.ExceptionInVPackage()) fH.c(Double.parseDouble(AkInterfaceAe.b()));
      if (AkInterfaceAe.ExceptionInVPackage()) fH.d(Double.parseDouble(AkInterfaceAe.b()));
      if (AkInterfaceAe.ExceptionInVPackage())
        fH.b(Boolean.valueOf(AkInterfaceAe.b()).booleanValue());
      if (AkInterfaceAe.ExceptionInVPackage()) fH.d(AkInterfaceAe.b());
      if (AkInterfaceAe.ExceptionInVPackage()) fH.e(Double.parseDouble(AkInterfaceAe.b()));
      if (AkInterfaceAe.ExceptionInVPackage()) fH.f(Double.parseDouble(AkInterfaceAe.b()));
      if (AkInterfaceAe.ExceptionInVPackage())
