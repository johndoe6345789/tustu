...
public class hx implements ft {
  ...
  public void b(boolean paramBoolean) {
    for (hf hf : this.f) hf.b(paramBoolean);
  }
  ...
  public void a(int paramInt, boolean paramBoolean) {
    ...
    for (hi hi : this.c) {
      if (hi != null) hi.c(this.k[this.s]);
    }
    if (paramBoolean) IOProperties.c("playbackSpeed", "" + this.k[this.s]);
  }
  ...
  public void a(double paramDouble, boolean paramBoolean) {
    for (byte b = 0; b < this.k.length; b++) {
      if (this.k[b] == paramDouble) {
        a(b, paramBoolean);
        if (paramBoolean) IOProperties.c("playbackSpeed", paramDouble + "");
        break;
      }
    }
  }
  ...
  public void g() {
    if (this.s < this.k.length - 1) a(++this.s, true);
  }

  public void h() {
    if (this.s > 0) a(--this.s, true);
  }
  ...
  public void a(Color paramColor, int paramInt) {
    for (k k : this.b) k.a(paramColor, paramInt);
  }

  public void a(Color paramColor) {
    for (k k : this.b) k.a(paramColor);
  }
  ...
  protected void q() {
    for (b b : this.d) {
      if (b != null && this.p != null) b.a((this.n + 1) / this.p.d());
    }
  }

  protected void a(n paramn) {
    for (b b : this.d) {
      if (b != null && paramn != null) b.a(paramn);
    }
  }
  ...
  public void b(n paramn) {
    ...
    if (paramn == null || paramn.isEmpty()) this.t = null;
  }
  ...
  public void b(double paramDouble, boolean paramBoolean) {
    if (this.o != paramDouble) {
      this.o = paramDouble;
      if (paramBoolean) IOProperties.c("zoom", paramDouble + "");
      for (fE fE : this.IOProperties) {
        if (fE != null) fE.b(paramDouble);
      }
    }
  }
