...
public class bx extends JPanel {
  ...
  public void b() {
    ...
    if (this.g.equals(d)) {
      ...
      for (byte b = 0; b < arrayOfString.length; b++) this.a.a(gX.D()[0][b].j(), b);
    } else if (this.g.equals(e)) {
      this.a.e("Total Weight");
      String[] arrayOfString = gX.b();
      for (byte b = 0; b < arrayOfString.length; b++) this.a.a(gX.D()[0][b].k(), b);
    } else {
      this.a.e(this.b.d.getSelectedItem() + "");
      String[] arrayOfString = gX.b();
      for (byte b = 0; b < arrayOfString.length; b++) this.a.a(gX.D()[0][b].i().doubleValue(), b);
    }
