...
class hw extends Thread {
  ...
  public void run() {
    while (true) {
      ...
      if ((this.a && System.currentTimeMillis() - this.c > 500L)
          || (System.currentTimeMillis() - this.b > 2000L && !c())) {
        this.e.e();
        this.a = false;
      }
    }
  ...
  private boolean c() {
    try {
      ...
      return (point1.x > point2.x
          && point1.y > point2.y
          && point1.x < point2.x + this.e.getWidth()
          && point1.y < point2.y + this.e.getHeight());
    } catch (Exception exception) {
      return false;
    }
  }
