  ...
  public void start() {
    ...
    if (this.b != null) {
      ...
      eJ eJ =
          new eJ(
              cd,
              "No Time Column detected in log. This input is required for log playback.\n"
                  + "Would you like to add mapping now",
              true);
      if (eJ.a) {
  ...
  public void run() {
    ...
    while (Float.isNaN(this.b.c(this.a.p()))) {
      ...
      try {
        ...
        if (this.b.i() - 1 > this.a.p()) this.a.l();
    ...
    this.a.d();
    D.c(
        "PlayBackThread ended. System.currentTimeMillis() - lastIncrementTime = "
