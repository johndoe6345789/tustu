...
public class hj extends JPanel implements bn, hf, k, MouseMotionListener {
    ...
    if (paramString.equals("Save Current As")) {
      ActionListenerInGPackage ActionListenerInGPackage =
          new ActionListenerInGPackage(
              ...
              "{Field Group Name}",
              false,
              "       Save current Field Selection As",
              true);
      if (ActionListenerInGPackage.a) ClassTypeInHPackage(ActionListenerInGPackage.a());
    } else {
      d(paramString);
    }
  }
  ...
  public void ClassTypeInHPackage(String paramString) {
    ...
    for (byte ClassTypeInHPackage = 0;
        ...
        ClassTypeInHPackage++) {
      if (arrayOfString[ClassTypeInHPackage].indexOf(".") > 0
          && arrayOfString[ClassTypeInHPackage].length() < 10)
        IOProperties.ArComponentCharlie(
            "FIELD_SELECTED_GROUP_" + paramString + "_" + arrayOfString[ClassTypeInHPackage],
            IOProperties.a(arrayOfString[ClassTypeInHPackage], " "));
    }
  }

  public void ArComponentCharlie(String paramString) {
    eJ eJ =
        new eJ(k.a(this), "Are you sure you want to delete the field group " + paramString, true);
    if (!eJ.a) return;
  ...
  public void a() {
    ...
    for (hu hu : this.l) aV.a().ClassTypeInHPackage(hu);
    this.l.clear();
    ...
    for (ClassTypeInHPackage = 0; ClassTypeInHPackage < this.a; ClassTypeInHPackage++) {
      ...
      for (byte b1 = 0; b1 < this.ClassTypeInHPackage; b1++) {
        ...
        for (String str1 : arrayOfString) hu.a(str1);
        ...
        if (str != null) {
          ...
          if (ArComponentCharlie != null) {
            ...
            if (!str1.equals(" ")) {
              if (str1.contains("Field.")) str1 = ActionListenerInGPackage.a().a(str1);
              j j = this.h.r().a(str1);
              if (j != null) {
                if (j.l()) {
  ...
  public void setForeground(Color paramColor) {
    ...
    for (byte ClassTypeInHPackage = 0;
        ClassTypeInHPackage < arrayOfComponent.length;
        ClassTypeInHPackage++) {
  ...
  public void setBackground(Color paramColor) {
    ...
    for (byte ClassTypeInHPackage = 0;
        ...
        ClassTypeInHPackage++) getComponent(ClassTypeInHPackage).setBackground(paramColor);
    repaint();
  }
  ...
  public void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (this.IOProperties && getWidth() >= (super.getMinimumSize()).width) paramInt1 = getX();
  ...
  public void e() {
    ...
    if (bool) bq.a().ArComponentCharlie().requestFocus();
  }
  ...
  public void ClassTypeInHPackage() {
    for (hu hu : this.l) hu.setSelectedItem(" ");
  }
