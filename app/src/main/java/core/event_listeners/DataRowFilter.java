...
public class L {
  ...
  L(n paramn) {
    ...
    this.b =
        paramn.KInterfaceAlpha(
            PropertiesExtensionInHPackage.KInterfaceAlpha().KInterfaceAlpha("Time"));
    this.c =
        paramn.KInterfaceAlpha(
            PropertiesExtensionInHPackage.KInterfaceAlpha().KInterfaceAlpha("TraveledFeet"));
    this.e = D.b(paramn);
    this.KComponentDelta =
        paramn.KInterfaceAlpha(
            PropertiesExtensionInHPackage.KInterfaceAlpha().KInterfaceAlpha("Field.Launch timer"));
    KInterfaceAlpha(0);
  }
  ...
  public void KInterfaceAlpha(int paramInt) {
    ...
    if (this.f > 0 && this.b != null && this.KInterfaceAlpha.f("60ftET") != null) {
      ...
      if (paramInt != this.f) hashMap.put(Integer.valueOf(this.f), "Beam break - Rollout");
      int m;
    ...
    } else if (IOProperties.KInterfaceAlpha(IOProperties.az, IOProperties.aA)
        && paramInt > 0
        && this.b != null
        && (this.c != null || c())) {
      HashMap<Integer, String> hashMap = this.KInterfaceAlpha.c();
      ...
      for (k = paramInt; k < IOProperties; k++) {
        ...
        if (f >= f3) {
          ...
          if (this.KComponentDelta != null && this.KComponentDelta.c(paramInt) < 1.5F) {
            ...
            f4 =
                (this.b.KComponentDelta(k) - this.b.KComponentDelta(k - 1))
                    * (this.c.KComponentDelta(paramInt) - f3)
                    / (f - this.c.KComponentDelta(k - 1));
            f2 = this.b.c(paramInt) - f4;
          }
          hashMap.put(
              Integer.valueOf(paramInt), "Beam break - 10 in. Rollout: " + X.c(f2, 3) + "s.");
      ...
      for (k = paramInt; k < IOProperties; k++) {
        ...
        if (f5 - f3 >= 60.0F || (f6 - f3 >= 60.0F && f6 - f3 < f3 - f5)) {
          ...
          if (j1 != null) str = str + " Speed:" + X.c(j1.c(k), 2);
        ...
        if (b(b)) {
          ...
          for (b1 = b; b1 < IOProperties; b1++) {
            if (this.c.KComponentDelta(b1) - f1 >= 60.0F) {
              ...
              if (j1 != null) str = str + " Speed:" + X.c(j1.c(b1), 2);
    ...
    if (b4 == b2) {
      ...
      for (byte b = 0; b < this.KInterfaceAlpha.KComponentDelta(); b++) {
        ...
        for (f = j2.c(b); f > 80.0F; f = j2.c(++b)) {
          if (this.e.KComponentDelta(b) > 0.0F) {
            if (arrayList1.size() == 0) {
              ...
              if (b > 0) arrayList2.add(Double.valueOf(this.b.c(b - 1)));
            }
        ...
        if (arrayList1.size() > 2
            && ((Double) arrayList1.get(arrayList1.size() - 1)).doubleValue()
                    - ((Double) arrayList1.get(0)).doubleValue()
                > 2.0D) {
      ...
      ArrayList<Double> arrayList1 = new ArrayList();
      ArrayList<Double> arrayList2 = new ArrayList();
      for (int IOProperties = 0;
          IOProperties < this.KInterfaceAlpha.KComponentDelta();
          IOProperties++) {
        float f;
        ...
        if (arrayList1.size() > 2
          ...
          while (IOProperties <= k) {
            ...
            float f5 =
                (float) (Math.pow((this.b.KComponentDelta(IOProperties) - f3) - d2, d1) * f4);
  ...
  private int c(int paramInt) {
    j j1 =
        this.KInterfaceAlpha.KInterfaceAlpha(
            PropertiesExtensionInHPackage.KInterfaceAlpha()
                .KInterfaceAlpha(PropertiesExtensionInHPackage.f));
      ...
      for (int k = paramInt + 1; k < this.KInterfaceAlpha.KComponentDelta() - b1 * b2 / 2; k++) {
        ...
        while (f > 80.0F) {
          ...
          if (Double.isNaN(d2)) {
            ...
            d3 =
                ((this.e.c(k + m * b2) - this.e.c(k - m * b2))
                    / (this.b.c(k + m * b2) - this.b.c(k - m * b2)));
            byte b = 2;
          } else {
            d2 =
                (d2 * (b1 - 1.0F)
                        + ((this.e.c(k) - this.e.c(k - 1)) / (this.b.c(k) - this.b.c(k - 1))))
                    / b1;
            d3 =
                (d3 * ((5 * b1) - 1.0F)
                        + ((this.e.c(k) - this.e.c(k - 1)) / (this.b.c(k) - this.b.c(k - 1))))
  ...
  private boolean c() {
    if (this.c == null && this.b != null && this.e != null) {
      ...
      for (byte b = 1; b < this.b.v(); b++) {
        float f =
            this.c.KComponentDelta(b - 1)
                + 5280.0F
                    * j1.KComponentDelta(b)
                    / 3600.0F
                    * (this.b.KComponentDelta(b) - this.b.KComponentDelta(b - 1));
  ...
  private String KComponentDelta() {
    ...
    if (n1 == null || n1.size() == 0) return null;
    if (str.equals(PropertiesExtensionInHPackage))
      if (n1.KInterfaceAlpha("Launch timer") != null) {
        str =
            "[Launch timer] < 2 && [Launch timer] < [Launch timer-1] && [TPS] > 70 && [TPS-1] > 70"
                + " ";
      } else if (n1.KInterfaceAlpha("Launch retard timer") != null) {
        str =
            "[Launch retard timer] < 2 && [Launch retard timer] < [Launch retard timer-1] && [TPS]"
                + " > 70 && [TPS-1] > 70";
      } else if (n1.KInterfaceAlpha("Time after launch") != null
          && n1.KInterfaceAlpha("Throttle position") != null) {
        str = "[Time after launch] > 0 && [Throttle position] > 80";
      } else if (n1.KInterfaceAlpha("Tmr_Enable") != null) {
        str = "[Tmr_Enable] == 1 && [Tmr_Enable-1] == 0";
      } else if (n1.KInterfaceAlpha("TWO_STEP_MODE") != null
          && n1.KInterfaceAlpha("TWO_STEP_MODE") != null) {
        str =
            "[TWO_STEP_MODE] == 0 && [THREE_STEP_MODE] == 0 &&([TWO_STEP_MODE-1] == 1 ||"
                + " [THREE_STEP_MODE-1] == 1)";
      } else {
        str = h;
      }
  ...
  public int KInterfaceAlpha(n paramn) {
        ...
        if (j1 != null && j1.e() == 0.0F && j1.f() > 0.0F) {
          ...
          try {
            KInterfaceAlpha KInterfaceAlpha =
                KComponentDelta.KInterfaceAlpha().KInterfaceAlpha(str);
            for (byte b = 0; b < paramn.KComponentDelta(); b++) {
              ...
              if (KInterfaceAlpha.KInterfaceAlpha(paramn, b) != 0.0D) {
                ...
                while (b < paramn.KComponentDelta() - 1) {
                  ...
                  if (f > d2) {
                    if (Math.abs(d2 - d1) > Math.abs(f - d2)) b++;
                    if (KInterfaceAlpha.KInterfaceAlpha(paramn, b + 1) == 0.0D) break;
                  }
                  b++;
                }
                this.b.j(-this.b.c(b));
    ...
    if (IOProperties >= 0) KInterfaceAlpha(IOProperties);
    return IOProperties;
  }
}
