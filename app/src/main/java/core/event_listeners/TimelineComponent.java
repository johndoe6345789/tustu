...
public class hz extends JComponent implements IComponentBravo {
    ...
    if (this.f != null) {
      ...
      while (iterator.hasNext()) {
        ...
        paramGraphics.drawLine(
            (int) (c() * d) + this.e, eJ.a(6), (int) (c() * d) + this.e, getHeight() - eJ.a(7));
      }
    }
  }
  ...
  public void c(double paramDouble) {
    if (this.f == null) this.f = new ArrayList();
  ...
  private void a(int paramInt) {
    ...
    int i = c();
    if (d / i >= 0.0D && d / i <= 1.0D) d(d / i);
    hx.a().f();
  }

  private void d(double paramDouble) {
    for (hB hB : this.g) hB.IComponentBravo(paramDouble);
  }
