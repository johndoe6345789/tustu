...
public class u extends JPanel
    implements fE, hf, hi, IOJFileChooser, l, JPanelExtensionInAqPackage, ClassTypeInHPackage {
  ...
  public u(hx paramhx) {
    this.h = paramhx;
    int IOProperties =
        IOProperties.JPanelExtensionInAqPackage("prefFontSize", eJ.JPanelExtensionInAqPackage(12))
            * 11
            / 12;
    ...
    this.o.JPanelExtensionInAqPackage(
        IOProperties.JPanelExtensionInAqPackage(IOProperties.E, IOProperties.F));
    add(this.d, "Center");
  ...
  public void c(n paramn) {
    if (this.ClassTypeInHPackage != null
        && paramn != null
        && this.ClassTypeInHPackage.equals(paramn)) return;
    ...
    this.d.removeAll();
    if (this.ClassTypeInHPackage == null) return;
    ArrayList<Object> arrayList = new ArrayList();
    if (ClassTypeInHPackage.JPanelExtensionInAqPackage()
        .JPanelExtensionInAqPackage("selectableFields")) {
      ...
      for (byte b2 = 0; b2 < this.ClassTypeInHPackage.size(); b2++) {
        if (!list.contains(((j) this.ClassTypeInHPackage.get(b2)).JPanelExtensionInAqPackage())
            || ((j) this.ClassTypeInHPackage.get(b2)).JPanelExtensionInAqPackage().equals("Engine"))
    ...
    for (byte b1 = 0; b1 < arrayOfJ.length; b1++) {
      ...
      if (j.u() != null && !j.JPanelExtensionInAqPackage().equals(j.u())) {
        ar.setToolTipText(
            "Standardized Name: " + j.JPanelExtensionInAqPackage() + ", Name in File: " + j.u());
      } else {
  ...
  private int e() {
    ...
    for (byte b1 = 0; b1 < arrayOfComponent.length; b1++) {
      if (arrayOfComponent[b1] instanceof ar) {
        ...
        if (IOProperties < j) IOProperties = j;
      }
    }
    IOProperties +=
        (IOProperties > eJ.JPanelExtensionInAqPackage(120)) ? 0 : eJ.JPanelExtensionInAqPackage(20);
    return IOProperties;
  }
  ...
  public void c() {
    if (this.ClassTypeInHPackage != null) {
      ...
      String str3 =
          (hx.JPanelExtensionInAqPackage().s() == null)
              ? null
              : hx.JPanelExtensionInAqPackage()
                  .s()
                  .d(
                      this.JPanelExtensionInAqPackage
                          - bq.JPanelExtensionInAqPackage().g().JPanelExtensionInAqPackage());
      String str4 = this.ClassTypeInHPackage.c(this.JPanelExtensionInAqPackage);
      String str5 =
          (this.ClassTypeInHPackage.d() > 0) ? ("" + (this.JPanelExtensionInAqPackage + 1)) : "0";
      if (str1 != null) {
        this.c.setText(str1);
        ...
        this.c.setText(
            "Record "
                ...
                + this.ClassTypeInHPackage.d()
                + " - Zoom: "
                + X.ClassTypeInHPackage(this.h.t(), b1)
                + "x - Play speed: "
                + (this.IOJFileChooser * 100.0D)
                + "%                                   ");
      }
    }
  }
  ...
  public void e(boolean paramBoolean) {
    Component[] arrayOfComponent = this.d.getComponents();
    for (byte b1 = 0; b1 < arrayOfComponent.length; b1++) {
      if (arrayOfComponent[b1] instanceof ar) ((ar) arrayOfComponent[b1]).c(paramBoolean);
    }
