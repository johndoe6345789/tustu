...
final class P implements ActionListener {
  ...
  public void actionPerformed(ActionEvent paramActionEvent) {
    String str1 = "";
    for (String str : this.a) str1 = str1 + str + ", ";
    if (str1.endsWith(", ")) str1 = str1.substring(0, str1.length() - 2);
    String str2 =
        IOJFileChooser.a(
            "{Save the fields in '" + this.b + "' As}",
            false,
            "Selected Fields: " + str1,
            true,
            this.c);
    if (str2 != null && !str2.isEmpty()) O.a(str2, this.a);
  }
}
