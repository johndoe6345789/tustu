...
class hk extends MouseAdapter {
  ...
  public void mouseEntered(MouseEvent paramMouseEvent) {
    if (System.currentTimeMillis() - 700L > this.a.j && paramMouseEvent.getModifiers() == 0) {
      ...
      if (hj.a(this.a) != null) hj.a(this.a).a();
      this.a.d();
    }
  }

  public void mouseExited(MouseEvent paramMouseEvent) {
    if ((this.a.i && (paramMouseEvent.getPoint()).x < 5)
        || (paramMouseEvent.getPoint()).x > this.a.n.getWidth()
        || (paramMouseEvent.getPoint()).y < 10
        || (paramMouseEvent.getPoint()).y > this.a.n.getHeight() - 10) {
