...
public class UIInPPackage extends JPanel {
  ...
  private void c() {
    ...
    if (str != null && !str.isEmpty()) this.b.setText(str);
  }
  ...
  public void a(DInterfaceIndia parami) {
    ...
    if (this.f.a() == 0 && this.f.b() != null) {
      ...
      for (Object object : list) this.c.addItem(object);
  ...
  public String b() {
    return (this.f.a() == 0)
        ? ((this.c.getSelectedItem() instanceof TostringInDPackage)
            ? ((TostringInDPackage) this.c.getSelectedItem()).a()
            : ((this.c.getSelectedItem() != null) ? this.c.getSelectedItem().toString() : ""))
        : this.b.getText();
  }
