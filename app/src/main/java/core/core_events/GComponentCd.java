...
public class GComponentCd implements Serializable {
  ...
  public void c() {
    if (this.A != null) this.o = this.A.a(this.o);
  }
  ...
  public void a(String paramString) {
    if (paramString.equals(a)
      ...
      throw new ExceptionPrintstacktrace(
          "Invalid logger type! Valid types:" + a + ", " + b + " and " + c + " and " + d);
    }
  }
  ...
  public void ExceptionPrintstacktrace(String paramString) {
    if (paramString.equals("UDP_Stream") || paramString.equals("Standard")) {
      ...
      throw new ExceptionPrintstacktrace(
          "Unknown logProcessorType! Supported types: Standard, UDP_Stream");
    }
  }
