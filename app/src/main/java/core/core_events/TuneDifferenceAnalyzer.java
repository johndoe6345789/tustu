...
public class TuneDifferenceAnalyzer {
  ...
  public ArrayList a(R paramR, Y paramY1, Y paramY2) {
    ...
    for (byte b = 0; b < arrayOfString.length; b++) {
      ...
      try {
        ...
        if (aM.n(paramY1)
            && aM.C()
            && aM.aL().indexOf("test") == -1
            && !a(arrayOfDouble1, arrayOfDouble2, aM.v(), aM.B())
            && !aM.N()) arrayList.add(aM);
  ...
  public ArrayList a(R paramR, ArrayList paramArrayList) {
    ...
    for (String str : a(paramR)) {
      ...
      if (bv instanceof ag) {
        ag ag = (ag) bv;
        if (a(paramArrayList, ag.b()) || a(paramArrayList, ag.a())) arrayList.add(ag);
        continue;
      }
      if (bv == null) continue;
      if (bv.H() > 0) {
        ...
        while (iterator.hasNext()) {
          ...
          if (bA instanceof bq) {
            bq bq = (bq) bA;
            if (a(paramArrayList, bq.b()) && !arrayList.contains(bv) && !bq.i()) arrayList.add(bv);
            continue;
          }
          if (bA instanceof E) {
            E e = (E) bA;
            if (a(paramArrayList, e.a()) && !arrayList.contains(bv)) arrayList.add(bv);
          }
        }
        continue;
      }
      ...
      for (String str1 : list) {
        if (a(paramArrayList, str1) && !arrayList.contains(bv)) arrayList.add(bv);
      }
    }
    return arrayList;
  }
  ...
  private boolean a(ArrayList paramArrayList, String paramString) {
    ...
    while (iterator.hasNext()) {
      if (((aM) iterator.next()).aL().equals(paramString)) return true;
    }
    return false;
  }
  ...
  private boolean a(ArrayList paramArrayList, bm parambm) {
    if (!parambm.z())
      for (byte b1 = 0; b1 < parambm.j(); b1++) {
        if (a(paramArrayList, parambm.d(b1))) return true;
      }
    for (byte b = 0; b < parambm.d(); b++) {
      if (a(paramArrayList, parambm.b(b))) return true;
    }
    return false;
  }
