...
public abstract class AbstractController implements Serializable {
  ...
  protected void u() {
    ...
    while (iterator.hasNext()) ((F) iterator.next()).t(-2);
  }

  public void v() {
    if (x() || (e().B() >= 0 && e().x(e().B()))) {
      SerializableImpl(
          "Going offline before all changes were permanently saved to the Controller.\n"
              + "These writes will be lost!");
      D.ExceptionGetmessage(
          "Going offline before all changes were permanently saved to the Controller.");
      this.L = -2;
    }
    this.p.clear();
  ...
  private int SerializableImpl(F paramF) {
    ...
    if (this.p.size() > 0)
      synchronized (this.p) {
        for (m m : this.p) {
          if (m.v() != null && m.v().equals(paramF) && (m.n() == 5 || m.n() == 4)) i = m.o();
        }
      }
    if (i < 0) i = paramF.B();
    if (i < 0) i = paramF.A();
  ...
  public void VInterfaceBravo(m paramm) {
    if (O) VInterfaceBravo("Received Instruction: " + paramm.aL() + ", Page: " + (paramm.o() + 1));
    if (!this.F || !this.G)
      if (paramm.n() == 7) {
        try {
          c(paramm);
    ...
    if (paramm.n() == 5 || paramm.n() == 4) {
      if (paramm.o() == -1 || paramm.q() < 0) D.c("Impossible Write Chunk Instruction!!!");
      synchronized (this.p) {
    ...
    if (paramm.n() == 6) {
      if (paramm.o() == this.L) {
        if (O) D.c("CommManager got a burn for page " + (this.L + 1) + ", cleared lastWritePage");
        this.L = -2;
        this.M = null;
        ...
        D.ExceptionGetmessage(
            "skip burn to page:" + (paramm.o() + 1) + ", lastWritePage = " + this.L);
      }
  ...
  public boolean c(int paramInt) {
    for (m m : this.p) {
      if (m.o() == paramInt && (m.n() == 5 || m.n() == 4)) return true;
    }
    return false;
  }
  ...
  protected void y() {
    while (!this.p.isEmpty()) {
      ...
      o(str);
      try {
        if (e().D() == null && e().al().equals("basicRequestReply")) a(25L);
        if (m.c()) {
          cR cR = m.v().D();
          m.v().a((cR) null);
          cV cV = m.v().C();
        ...
        if (VInterfaceBravo()) {
          D.ExceptionGetmessage(
              "Exception caught processing instruction, but stop has already been initiated. Doing"
                  + " nothing.");
          if (exception instanceof l) throw new IOException(exception.getMessage());
          continue;
        }
        D.a(
            "Could not process CommInstruction. writing last "
                + this.D
                + " controller interactions to the log followed by the stack trace");
        G();
    ...
    try {
      if (e().D() == null && e().al().equals("basicRequestReply")) Thread.sleep(e().Abstract());
  ...
  protected void c(m paramm) {
    ...
    switch (paramm.n()) {
      ...
      default:
        D.VInterfaceBravo(
            "Attempted to process CommInstruction, but type is not supported by this driver:"
                + paramm.n());
        break;
    }
    if (O) VInterfaceBravo("Processing Complete: " + paramm.aL());
  }
  ...
  protected void z() {
    if (!N() && M() < System.currentTimeMillis() && e().aw() > 0) {
      ...
      try {
        ...
        for (VInterfaceBravo = 0; VInterfaceBravo < arrayOfByte.length; VInterfaceBravo++) {
          ...
          if (f2.F() && !f2.ap() && f2.o() != null) {
            if (f2.ac() && f2.ad() >= 0) {
              boolean bool3 = false;
              boolean bool4 = true;
              if (I()) D.c("Real OchDelay for " + f2.u() + ": " + bool4 + ", timeout=" + f2.av());
              ...
              try {
                ...
                D.c(
                    "Controller reported Comms error, skipping runtime data read. "
              ...
              if (I()) D.c("time to read scattered outpc: " + i + " ms.");
            } else if (!f2.N()) {
              long l = System.nanoTime();
              byte[] arrayOfByte1 = f2.o().a(0, f2.n(), null);
              try {
                boolean bool3 =
                    (((F) this.A.get(0)).D() == null)
                        ? (((F) this.A.get(0)).t() / arrayOfByte.length)
                        : false;
                if (I())
                  D.c("Real OchDelay for " + f2.u() + ": " + f2.t() + ", timeout=" + f2.av());
                byte[] arrayOfByte2 =
                    a(arrayOfByte1, bool3, f2.av(), this.aa[VInterfaceBravo], (m) null);
                if (arrayOfByte2.length != this.aa[VInterfaceBravo]) {
                  D.c(
                      "unexpected runtime response size: "
                          + arrayOfByte2.length
                          + ", expected: "
                          + this.aa[VInterfaceBravo]);
                ...
                System.arraycopy(
                    arrayOfByte2, 0, arrayOfByte[VInterfaceBravo], 0, arrayOfByte2.length);
              } catch (ExceptionGetmessage ExceptionGetmessage) {
                if (f2.D() != null && f2.D().c(ExceptionGetmessage.a())) return;
                if (VInterfaceBravo == 0) {
                  D.c(
                      "Controller reported Comms error, skipping runtime data read. "
                          + ExceptionGetmessage.getMessage());
                ...
                VInterfaceBravo(f2.u(), 2);
                throw new VInterfaceBravo(
                    "Failed to communicate with CAN device.\n" + ExceptionGetmessage.getMessage());
              }
              i = (int) ((System.nanoTime() - l) / 1000000L);
              if (I()) D.c("old style time to read outpc: " + i + " ms.");
              if (VInterfaceBravo < arrayOfByte.length - 1) a(1L);
            } else {
              boolean bool3 =
                  (((F) this.A.get(0)).D() == null)
                      ? (((F) this.A.get(0)).t() / arrayOfByte.length)
                      : false;
              if (I()) D.c("Real OchDelay for " + f2.u() + ": " + bool3 + ", timeout=" + f2.av());
              long l = System.nanoTime();
              boolean bool4 = false;
              arrayOfByte[VInterfaceBravo] = this.X.VInterfaceBravo(f2.n());
              try {
                ...
                if (list != null && !list.isEmpty()) {
                  ...
                  VInterfaceBravo(
                      f2, arrayOfByte[VInterfaceBravo], bool4, this.aa[VInterfaceBravo], bool3);
                }
              } catch (ExceptionGetmessage ExceptionGetmessage) {
                D.c(
                    "Controller reported Comms error, skipping runtime data read. "
              ...
              i = (int) ((System.nanoTime() - l) / 1000000L);
              if (I()) D.c("Blocked time to read outpc: " + i + " ms.");
            }
            if (VInterfaceBravo == 0) this.ab = i;
            if (this.aa[VInterfaceBravo] != (arrayOfByte[VInterfaceBravo]).length) {
              D.VInterfaceBravo(
                  "Och is "
                      + (arrayOfByte[VInterfaceBravo]).length
                      + ", expected:"
                      + this.aa[VInterfaceBravo]
                      + ", turn on Comm debug for more data.");
        ...
        for (VInterfaceBravo = 0; VInterfaceBravo < this.A.size(); VInterfaceBravo++) {
          if (((F) this.A.get(VInterfaceBravo)).F() && !((F) this.A.get(VInterfaceBravo)).ap())
            if (VInterfaceBravo > 0
                || VInterfaceBravo(
                    ((F) this.A.get(VInterfaceBravo)).u(), arrayOfByte[VInterfaceBravo])) {
      ...
      boolean bool =
          (e().aw() == 0) ? true : (int) (1.0E9D / e().aw() - (System.nanoTime() - this.ag));
      if (this.P > 0L) {
  ...
  private byte[] a(F paramF, byte[] paramArrayOfbyte, int paramInt1, int paramInt2, int paramInt3) {
    ...
    while (i < paramInt2) {
      ...
      if (paramInt2 > k && arrayOfByte1.length == 1) {
        D.VInterfaceBravo(
            "blockingFactor smaller than ochBlockSize, but ochCommand does not support blocking."
                + " Will Attempt reading entire outpc");
        m = paramInt2;
      }
      ...
      ExceptionGetmessage ExceptionGetmessage =
          new ExceptionGetmessage(
              "Unexpected runtime response size, expected: "
                  + m
                  + ", received: "
                  + arrayOfByte2.length);
  ...
  private byte[] VInterfaceBravo(
      F paramF, byte[] paramArrayOfbyte, int paramInt1, int paramInt2, int paramInt3) {
    int i = 0;
    while (i < paramInt2) {
      int j = paramF.G(0);
  ...
  protected void VInterfaceBravo(F paramF) {
    if (this.A.contains(paramF)) return;
    this.A.add(paramF);
    if (paramF.l() != null) {
      N n = new N(this);
      n.a(paramF);
  ...
  protected F ExceptionGetmessage(String paramString) {
    if (paramString == null || paramString.equals("")) return this.A.get(0);
    for (F f1 : this.A) {
      if (f1.aL().equals(paramString)) return f1;
    }
  ...
  protected void ExceptionGetmessage(m paramm) {
    ...
    if (f1.B() < 0) {
      D.c(
          "Request to burn page, but no writes have been performed. Ignoring burn. page: "
              + (paramm.o() + 1));
      return;
    }
    ...
    if (arrayOfByte == null || arrayOfByte.length == 0) {
      D.ExceptionGetmessage(
          "Burn Command empty for page " + (paramm.o() + 1) + ", bypassing burn and verification.");
      f1.u(-2);
      o.a(2);
    ...
    try {
      ...
      if (e().D() != null) {
        ...
        if (f1.Abstract() > 0) a(f1.Abstract());
      }
    ...
    try {
      ...
      aB.a()
          .VInterfaceBravo(
              f1.u(),
              "Serial Communication error during page burn.\n"
    ...
    if (!bool) {
      SerializableImpl(
          "Burn Page failed CRC Check.\nCheck Log for full data dump of local and controller Page "
              + (paramm.o() + 1)
              + " data.");
      o.a(3);
      F();
      D.c(
          "Writing the last "
              + this.D
              + " comm interactions including the burn, crc and page read to the log file here:");
      G();
    }
  }
  ...
  protected void e(m paramm) {
    ...
    try {
      ...
      try {
        ...
        if (VInterfaceBravo instanceof VInterfaceBravo) throw VInterfaceBravo;
        if (VInterfaceBravo instanceof ExceptionGetmessage)
          D.VInterfaceBravo("Retrying Controller Rejected Write after " + f1.i() + "ms wait");
        D.VInterfaceBravo(
            "Controller Rejected Write again, Comm Manager will report error for additional"
                + " handling.");
        o.a(3);
  ...
  protected void a(int[] paramArrayOfint1, int[] paramArrayOfint2, int paramInt1, int paramInt2) {
    String str =
        "Controller page "
            + (paramInt1 + 1)
            + " Does not match Local store:\n                 Controller "
            + c.ExceptionGetmessage(a(paramArrayOfint2))
            + "                      Local Data Store "
            + c.ExceptionGetmessage(a(paramArrayOfint1))
            + "\n"
  ...
  private void s(m paramm) {
    ...
    try {
      ...
      if (f1.C() != null) {
        ...
        a(arrayOfByte1);
        if (f1.Abstract() > 0) Thread.sleep(f1.Abstract());
  ...
  protected boolean a(F paramF, int paramInt1, int paramInt2, int paramInt3) {
    ...
    if (!c(paramF, paramInt1)) return false;
    ...
    try {
      ...
      throw new l(
          "Error reading from Controller, command:"
              + c.ExceptionGetmessage(arrayOfByte1)
              + "Error:"
              + iOException.getMessage());
    } catch (VInterfaceBravo b1) {
      throw new l(
          "Timeout during CRC, command:"
              + c.ExceptionGetmessage(arrayOfByte1)
              + "Error:"
              + b1.getMessage());
    } catch (ExceptionGetmessage ExceptionGetmessage) {
    ...
    if (!c.c(arrayOfByte3, arrayOfByte5)) {
      ...
      D.ExceptionGetmessage(
          "   CRC from controller page "
              + (paramInt1 + 1)
              + ":"
              + c.ExceptionGetmessage(arrayOfByte3));
      D.ExceptionGetmessage(
          "   Local Data CRC for page "
              + (paramInt1 + 1)
              + ": "
              + c.ExceptionGetmessage(arrayOfByte5));
      bool = false;
    } else if (O) {
  ...
  protected void k(m paramm) {
    ...
    try {
      ...
      for (byte b1 = 0; b1 < arrayOfByte1.length; b1++) arrayOfByte1[b1] = (byte) arrayOfInt[b1];
      byte[] arrayOfByte2 = null;
      byte b2 = 0;
      do {
        try {
          boolean bool = (paramm.SerializableImpl() >= 0) ? paramm.SerializableImpl() : true;
          if (e().D() != null) e().D().a(false);
          ...
          if (paramm.o() >= 0) {
            this.L = paramm.o();
            if (f1 != null) ExceptionGetmessage(f1.u(), this.L);
          }
    ...
    paramm.VInterfaceBravo(1.0D);
    paramm.VInterfaceBravo(o);
    if (O) VInterfaceBravo("All processing complete for " + paramm.aL());
  }
      ...
      try {
        if (c(f1, VInterfaceBravo)) {
          if (VInterfaceBravo(f1, VInterfaceBravo)) {
            ...
            D.ExceptionGetmessage(
                "CrC matched skipped controller read on page:" + (VInterfaceBravo + 1));
            ...
            D.ExceptionGetmessage(
                "Checksum page "
                    + (VInterfaceBravo + 1)
                    + " data read: "
                    + c.ExceptionGetmessage(arrayOfByte));
          }
        } else {
          arrayOfInt[VInterfaceBravo] = a(f1, VInterfaceBravo, m1);
          D.c("Read page time: " + (System.currentTimeMillis() - l) + "ms.");
        ...
        if (f1.i() < f1.m()) f1.c(f1.i() + 50);
        D.ExceptionGetmessage(
            "Timeout reading page "
                + (VInterfaceBravo + 1)
                + ", increased blockReadTimeout to "
                + f1.i()
                + ", trying once more.");
        try {
          Thread.sleep((f1.i() * 2));
  ...
  protected void m(m paramm) {
    ...
    try {
      ...
      if (f1.i() > f1.m()) {
        D.ExceptionGetmessage(
            "Timeout reading page " + (i + 1) + ", blockReadTimeout=" + f1.i() + ", giving up..");
        throw l;
      }
      f1.c(f1.i() + 50);
      D.ExceptionGetmessage(
  ...
  protected int[] a(F paramF, int paramInt, m paramm) {
    try {
      ...
      if (paramF.aH() == null
          || paramF.aH()[paramInt] <= 0
          || paramF.SerializableImpl(paramInt) < paramF.aH()[paramInt]) {
        boolean bool;
        if (paramF.D() != null) {
        ...
        arrayOfByte =
            a(paramF.g(paramInt), bool, paramF.i(), paramF.SerializableImpl(paramInt), paramm);
        if (arrayOfByte == null || paramF.SerializableImpl(paramInt) != arrayOfByte.length)
          throw new IOException(
              "Response size mis-match! Expected:"
                  + paramF.SerializableImpl(paramInt)
                  + ", received:"
                  + arrayOfByte.length);
      } else {
        int i = 0;
        ...
        while (i < paramF.SerializableImpl(paramInt)) {
          int k =
              (i + j < paramF.SerializableImpl(paramInt))
                  ? j
                  : (paramF.SerializableImpl(paramInt) - i);
      ...
      Logger.getLogger(J.class.getName())
          .log(Level.INFO, "Error Reading Page", (Throwable) VInterfaceBravo);
      throw VInterfaceBravo;
    } catch (Exception exception) {
      throw new l(
          "Error Reading data page "
              + (paramInt + 1)
              + "\nReported Error: "
              + exception.getMessage());
    }
  ...
  protected void n(m paramm) {
    ...
    try {
      ...
      if (f1.i() > f1.m()) {
        D.ExceptionGetmessage(
            "Timeout reading chunk " + (i + 1) + ", blockReadTimeout=" + f1.i() + ", giving up..");
        throw l;
      }
      f1.c(f1.i() + 50);
      D.ExceptionGetmessage(
          "Timeout reading chunk "
              + (i + 1)
              + ", increased blockReadTimeout to "
              + f1.i()
              + ", trying once more.");
  ...
  protected int[] a(F paramF, int paramInt1, int paramInt2, int paramInt3, m paramm) {
    if (paramF.B(paramInt1))
      try {
        ...
        byte[] arrayOfByte = null;
        if (paramF.aH() == null
            || paramF.aH()[paramInt1] <= 0
            || paramInt3 < paramF.aH()[paramInt1]) {
          boolean bool;
          if (paramF.D() != null) {
            bool = (paramF.i() > 0) ? paramF.t() : true;
          } else {
          ...
          arrayOfByte =
              a(paramF.a(paramInt1, paramInt2, paramInt3), bool, paramF.i(), paramInt3, paramm);
          if (arrayOfByte == null || paramInt3 != arrayOfByte.length)
            throw new IOException(
                "Response size mis-match! Expected:"
                    + paramF.SerializableImpl(paramInt1)
                    + ", received:"
                    + arrayOfByte.length);
        } else {
          int i = 0;
          ...
          while (i < paramInt3) {
            ...
            VInterfaceBravo =
                (paramF.t() / 3 > VInterfaceBravo) ? (paramF.t() / 3) : VInterfaceBravo;
            byte[] arrayOfByte1 =
                a(paramF.a(paramInt1, paramInt2 + i, k), VInterfaceBravo, paramF.i(), k, (m) null);
            if (arrayOfByte1 == null || k != arrayOfByte1.length)
              throw new IOException(
                  "Response size mis-match! Expected:"
                      + paramF.SerializableImpl(paramInt1)
  ...
  protected String a(byte[] paramArrayOfbyte, long paramLong) {
    ...
    if (arrayOfByte != null) {
      ...
      for (byte VInterfaceBravo = 0;
          VInterfaceBravo < arrayOfByte.length
              && arrayOfByte[VInterfaceBravo] != 0
              && arrayOfByte[VInterfaceBravo] != 255;
          VInterfaceBravo++) stringBuilder.append((char) arrayOfByte[VInterfaceBravo]);
  ...
  protected synchronized void a(long paramLong, int paramInt) {
    ...
    if (l2 < this.ai) {
      ...
      if (l2 < 500000L || Math.random() > ExceptionGetmessage) return;
    } else {
      l2 -= this.ai;
    ...
    try {
      if (this.W) D.c("nap:" + paramLong + "ms, " + paramInt + " nanos");
  ...
  protected synchronized byte[] VInterfaceBravo(
  ...
  protected synchronized byte[] a(
    ...
    if (cR != null && (paramm == null || !paramm.c()) && (k() || ((F) this.A.get(0)).G()))
      try {
        if (paramLong1 == paramLong2) paramLong1 = 1L;
        ...
        if (bool && cR.a(ExceptionGetmessage.a())) {
          ...
          if (ExceptionGetmessage.a() == 138) VInterfaceBravo = 100;
          D.c(
              "Protocol reported error after write 0x"
                  + Integer.toHexString(ExceptionGetmessage.a())
                  + ", waiting "
                  + VInterfaceBravo
                  + "ms and retry ");
          a(VInterfaceBravo);
          try {
            byte[] arrayOfByte =
                VInterfaceBravo(paramArrayOfbyte, paramLong1, paramLong2, paramInt, paramm);
            D.c("Protocol retry successful on 2nd try! ");
            return arrayOfByte;
          } catch (ExceptionGetmessage d1) {
            try {
              D.c(
                  "Protocol reported error on 2nd attempt after write 0x"
                      + Integer.toHexString(ExceptionGetmessage.a())
                      + ", waiting "
                      + VInterfaceBravo
                      + "ms and retry ");
  ...
  protected void e(String paramString) {
    D.c(
        "Settings Error detected! Writing the last "
            + this.D
            + " comm interactions with the controller to the log file here:");
    G();
  ...
  public void a(cJ paramcJ) {
    if (!this.v.contains(paramcJ)) this.v.add(paramcJ);
  }
  ...
  protected void SerializableImpl(String paramString) {
    ...
    while (iterator.hasNext()) ((cJ) iterator.next()).a(paramString);
    this.Q = System.currentTimeMillis();
  }
  ...
  public void a(aG paramaG) {
    if (!this.VInterfaceBravo.contains(paramaG)) this.VInterfaceBravo.add(paramaG);
  }
  ...
  protected boolean a(String paramString1, String paramString2, bT parambT) {
    ...
    for (aG aG : this.VInterfaceBravo) {
      try {
        ...
        D.VInterfaceBravo(
            "Exception while notifiying EcuOnlineListener of going online.\nlistener: " + aG);
        Logger.getLogger(J.class.getName()).log(Level.INFO, (String) null, exception);
      }
    }
    return bool;
  ...
  protected boolean VInterfaceBravo(String paramString, byte[] paramArrayOfbyte) {
    for (aD aD : this.x) {
      if (!aD.a(paramString, paramArrayOfbyte)) return false;
    }
    return true;
  }
  ...
  protected boolean B() {
    for (ai ai : this.y) {
      if (!ai.a(this.ak)) return false;
    }
    return true;
  }

  public void a(u paramu) {
    if (!this.z.contains(paramu)) this.z.add(paramu);
  }

  protected void Abstract(String paramString) {
    for (u u : this.z) u.a(paramString);
  }
  ...
  protected void i(String paramString) {
    for (aV aV : this.t) aV.VInterfaceBravo(paramString);
  }

  protected void j(String paramString) {
    for (aV aV : this.t) aV.c(paramString);
  }

  protected void k(String paramString) {
    for (aV aV : this.t) aV.ExceptionGetmessage(paramString);
  }

  protected void l(String paramString) {
    for (aV aV : this.t) aV.e(paramString);
  }
  ...
  protected void c(String paramString, int paramInt) {
    try {
      synchronized (this.u) {
        for (g g : this.u) {
          if (g != null) g.VInterfaceBravo(paramString, paramInt);
        }
      }
    } catch (Exception exception) {
    ...
    try {
      synchronized (this.u) {
        ...
        if (f1 == null || f1.x(paramInt))
          for (g g : this.u) {
            if (g != null) g.a(paramString, paramInt);
          }
      }
    } catch (Exception exception) {
      D.a("Failed to notify all burn listeners. Stack to follow.");
  ...
  public Abstract D() {
    return (e().D() instanceof SerializableImpl)
        ? ((SerializableImpl) e().D()).ExceptionGetmessage()
        : null;
  }
  ...
  protected void a(String paramString, boolean paramBoolean) {
    synchronized (this.u) {
      ...
      while (iterator.hasNext()) ((g) iterator.next()).a(paramString, paramBoolean);
    }
  }
  ...
  public void a(g paramg) {
    if (!this.u.contains(paramg)) this.u.add(paramg);
  }
  ...
  protected boolean ExceptionGetmessage(int paramInt) {
    ...
    while (iterator.hasNext()) {
      ...
      if (VInterfaceBravo) {
        try {
          if (((F) this.A.get(0)).D() != null) {
            ...
            f1.a(cR);
            f1.a(cV);
            if (cV != null) ((F) this.A.get(0)).ExceptionGetmessage(true);
          }
          boolean bool3 = false;
          if (cP.a().VInterfaceBravo() != null)
            try {
              ...
              if (I())
                D.c(
                    "CommException during ProtocolInitialization of "
                        + f1.u()
                        + ": "
              ...
              if (I())
                D.c(
                    "CommTimeoutException during ProtocolInitialization of "
                        + f1.u()
                        + ": "
                        + b1.getLocalizedMessage());
            }
          if (bool3) {
            if (((F) this.A.get(0)).G(0) < f1.G(0)) f1.I(((F) this.A.get(0)).G(0));
            if (((F) this.A.get(0)).ay() < f1.ay()) f1.H(((F) this.A.get(0)).ay());
          }
          try {
          ...
          if (arrayOfByte == null) {
            SerializableImpl(
                "Failed to communicate with Device :"
                    ...
                    + "Setttings Changes Made to this controller during this session will not be"
                    + " sent\n"
        ...
        try {
          if (cP.a().VInterfaceBravo() != null) {
            ...
            try {
              ...
              if (I())
                D.c(
                    "CommTimeoutException during ProtocolInitialization: "
                        + b1.getLocalizedMessage());
            }
          }
          try {
            ...
            throw new VInterfaceBravo(
                "Protocol Error communicating with main controller: "
                    + ExceptionGetmessage.getLocalizedMessage());
          }
          if (cP.a().VInterfaceBravo() != null && !this.E)
            try {
              int j = cP.a().VInterfaceBravo().a(this.ak);
              if (j > 0) this.E = true;
              if (j > 1) cP.a().VInterfaceBravo().a(this.ak, f1, f1.x());
            } catch (l l) {
              if (I())
                D.c("CommException during ProtocolInitialization: " + l.getLocalizedMessage());
            } catch (VInterfaceBravo b1) {
      ...
      if (!B()) throw new cn("GoOnlineApprover rejected.");
      if (bool) D.ExceptionGetmessage("Device Removed, no further interrogation.");
      if (!bool1 && VInterfaceBravo(arrayOfByte)) {
          ...
          try {
            try {
              ...
              if (arrayOfByte1 != null && arrayOfByte1.length == 2) {
                ...
                str =
                    X.a("" + Integer.toHexString(k), '0', 2)
                        + X.a("" + Integer.toHexString(j), '0', 2);
                str = str.toUpperCase();
              } else {
            ...
            if (I()) D.c("CommTimeoutException during versionInfo: " + b1.getLocalizedMessage());
            if (arrayOfByte != null && arrayOfByte.length > 0) {
        ...
        if (!bool1)
          if (a(f1.u(), str, bT)) {
            this.E = true;
            cR cR = e().D();
            if (cR != null) cR.ExceptionGetmessage().a();
            c(f1);
          } else {
            this.E = false;
            break;
  ...
  private void g(F paramF) {
    if (p() && paramF.S() != null)
      if (!paramF.U() || this.aj++ % 2 == 0) {
        ...
        a(i);
        paramF.i(false);
        if (I()) D.ExceptionGetmessage("Trying normal baud: " + i);
      } else {
        int i = (int) paramF.S().a();
        a(i);
        paramF.i(true);
        if (I()) D.ExceptionGetmessage("Trying Turbo Baud: " + i);
      }
  }

  protected void m(String paramString) {
    if (this.D > 0 && this.C.size() > this.D) this.C.remove(0);
    this.C.add(paramString);
  }

  protected void G() {
    if (this.D <= 0 || I()) return;
    D.ExceptionGetmessage(
        "------------------   Begin Historical Commands ---------------------------");
  ...
  public synchronized void ExceptionGetmessage(long paramLong) {
    ...
    if (paramLong < System.currentTimeMillis()) notify();
  }
