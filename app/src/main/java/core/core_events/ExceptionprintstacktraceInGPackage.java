...
public class ExceptionprintstacktraceInGPackage {
  ...
  public static String a(R paramR, String paramString) {
    ...
    while (iterator.hasNext()) {
      ...
      if (aA.d() != null && aA.d().equals(paramString)) {
        ...
        if (bv1 != null && bv1.aJ() != null && !bv1.aJ().isEmpty()) str = a(str, bv1.aJ());
        break;
      }
      ...
      while (iterator1.hasNext()) {
        ...
        if (aA1.d() == null || !aA1.d().equals(paramString)) {
          if (bv1 != null && bv1.L() && a(bv1, paramString)) break label34;
          continue;
        }
        str = a(aA.aJ(), aA1.aJ());
      }
    ...
    if (bv != null && bv.aJ() != null && !bv.aJ().isEmpty()) str = a(str, bv.aJ());
    return str;
  }
        ...
        if (bv != null) {
          ...
          if (bq != null)
            return b(aA.e())
                ...
                + b(aA1.e())
                + " --> "
                + b(ExceptionPrintstacktrace(paramR, paramString));
        }
      }
    }
    return null;
  ...
  public static boolean a(bv parambv, String paramString) {
    ...
    while (iterator.hasNext()) {
      ...
      if (bv1.aL() != null && bv1.aL().equals(paramString)) return true;
      if (bv1.L() && a(bv1, paramString)) return true;
    }
    return false;
  }
  ...
  public static String c(R paramR, String paramString) {
    ...
    while (iterator.hasNext()) {
      ...
      while (iterator1.hasNext()) {
        aA aA1 = iterator1.next();
        if (aA1.d() != null && aA1.d().equals(paramString)) str = aA1.e();
      }
    }
    return str;
  }
  ...
  public static ArrayList a(R paramR, ArrayList paramArrayList) {
    ...
    for (bv bv : paramArrayList) {
      if ((bv.aL() == null || bv.aL().isEmpty()) && bv.Z() == 1) bv = bv.j(0);
      String str1 = (bv.aL() != null && bv.aL().length() > 0) ? bv.aL() : bv.M();
      String str2 = a(paramR, str1);
      try {
        if (str2 == null || str2.equals("") || p.a(str2, paramR)) arrayList.add(bv);
  ...
  public static ArrayList a(R paramR, bv parambv) {
    ...
    if (parambv instanceof be) {
      ...
      aS aS = (aS) parambv;
      if (aS.m() != null) arrayList.add(aS.m());
      if (aS.d() != null) arrayList.add(aS.d());
      if (aS.j() != null) arrayList.add(aS.j());
      if (aS.h() != null) arrayList.add(aS.h());
      if (aS.o() != null) arrayList.add(aS.o());
      if (aS.ExceptionPrintstacktrace() != null) arrayList.add(aS.ExceptionPrintstacktrace());
      if (aS.f() != null) arrayList.add(aS.f());
      if (aS.k() != null) arrayList.add(aS.k());
      if (aS.i() != null) arrayList.add(aS.i());
      if (aS.l() != null) arrayList.add(aS.l());
    } else if (parambv instanceof ag) {
      ag ag = (ag) parambv;
      if (ag.a() != null) arrayList.add(ag.a());
      if (ag.b() != null) arrayList.add(ag.b());
    } else {
        ...
        if (bA instanceof bq) {
          ...
          if (arrayOfString != null)
            for (byte b = 0; b < arrayOfString.length; b++) {
              ...
              if (str != null && str.length() > 0 && !arrayList.contains(str)) arrayList.add(str);
            }
        }
      }
    }
  ...
  public static cj[] b(R paramR, ArrayList paramArrayList) {
    ...
    return (hashMap.size() == 0)
        ? null
        : (cj[]) hashMap.values().toArray((Object[]) new cj[hashMap.size()]);
  }
  ...
  public static aM a(R paramR, int paramInt1, int paramInt2, int paramInt3) {
    ...
    while (iterator.hasNext()) {
      aM aM = iterator.next();
      if (aM != null && aM.a(paramInt1, paramInt2, paramInt3)) return aM;
    }
    return null;
  }
  ...
  public static bq b(bv parambv, String paramString) {
    ...
    while (iterator.hasNext()) {
      ...
      if (bA instanceof bq) {
        bq bq = (bq) bA;
        if (bq.b() != null && bq.b().equals(paramString)) return bq;
      }
    }
    try {
      iterator = parambv.K();
  ...
  private static String a(StringBuilder paramStringBuilder, int paramInt) {
    ...
    for (String str = paramStringBuilder.substring(paramInt - 1, paramInt);
        str.equals(" ") && paramInt > 0;
        str = paramStringBuilder.substring(--paramInt - 1, paramInt))
      ;
  ...
  private static String b(StringBuilder paramStringBuilder, int paramInt) {
    if (paramInt > paramStringBuilder.length()) return "";
    String str;
    for (str = paramStringBuilder.substring(paramInt, paramInt + 1);
        str.equals(" ") && paramInt + 1 < paramStringBuilder.length();
        str = paramStringBuilder.substring(++paramInt, paramInt + 1))
      ;
    StringBuilder stringBuilder = new StringBuilder(str);
    while (paramInt < paramStringBuilder.length()
        && i.a.indexOf(paramStringBuilder.charAt(paramInt)) != -1) {
      stringBuilder.insert(0, paramStringBuilder.charAt(paramInt));
      paramInt++;
    }
    return stringBuilder.toString();
  ...
  public static String ExceptionPrintstacktrace(R paramR, String paramString) {
    ...
    if (bq != null && bq.l().length() > 0) return bq.l();
  ...
  public static ac h(R paramR, String paramString) {
    ...
    for (byte b = 0; b < arrayList.size(); b++) {
      ...
      if (ac != null && ac.a() != null && ac.a().equals(paramString)) return ac;
    }
    return null;
  }

  public static boolean a(bv parambv) {
    if (parambv instanceof bm || parambv instanceof bi || parambv instanceof be) return true;
    if (parambv.L()) {
      Iterator<bv> iterator = parambv.K();
      while (iterator.hasNext()) {
        bv bv1 = iterator.next();
        if (a(bv1)) return true;
      }
    }
    return false;
  }
  ...
  public static boolean i(R paramR, String paramString) {
    ...
    for (bv bv : arrayList) {
      if (bv.e().contains(paramString)) {
        ...
        if (str1 != null && !str1.equals("")) str = str1;
        break;
      }
    }
    try {
  ...
  private static List a(List<String> paramList, dj paramdj) {
    if (paramdj instanceof bR) {
      ...
      for (byte b = 0; b < arrayOfString.length; b++) {
        if (!paramList.contains(arrayOfString[b])) paramList.add(arrayOfString[b]);
      }
    }
    return paramList;
  }
  ...
  public static String j(R paramR, String paramString) {
    for (ac ac : paramR.ExceptionPrintstacktrace()) {
      if (ac.a() != null && ac.a().equals(paramString)) return ac.b();
    }
    aH aH = paramR.ExceptionPrintstacktrace(paramString);
    if (aH != null
        && aH.b().equals("formula")
        && aH.k() != null
        && aH.k().trim().startsWith("selectExpression("))
      try {
        ...
        Logger.getLogger(bM.class.getName())
            .log(Level.WARNING, "Failed to get DataLogField for {0}", aH.k());
      }
    return null;
  }
  ...
  public static int k(R paramR, String paramString) {
    ...
    while (iterator.hasNext()) {
      ...
      if (aA.d() != null && aA.d().equals(paramString)) {
        bv bv = paramR.e().c(paramString);
        if (bv != null && bv.aJ() != null && !bv.aJ().isEmpty()) i = aA.f();
        break;
      }
      Iterator<aA> iterator1 = aA.a();
      label29:
      while (iterator1.hasNext()) {
        ...
        bv bv = (aA1.d() == null) ? null : paramR.e().c(aA1.d());
        if (aA1.d() == null || !aA1.d().equals(paramString)) {
          if (bv != null && bv.L() && a(bv, paramString)) break label29;
          continue;
        }
        i = aA1.f();
      }
    ...
    while (iterator.hasNext()) {
      ...
      try {
        if (!aA.c() && p.a(aA.i(), paramR) && p.a(aA.aJ(), paramR)) {
          ...
          if (aA.d() != null && !aA.d().isEmpty()) arrayList.add(aA);
        }
      } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
      }
    }
  ...
  private static void a(R paramR, Iterator<aA> paramIterator, List<aA> paramList) {
    ...
    while (paramIterator.hasNext()) {
      ...
      try {
        ...
        if (aA1.c() && aA != null && !aA.c() && paramIterator.hasNext()) aA = aA1;
      } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
      }
    }
  }
  ...
  public static boolean a(String paramString) {
    return (paramString != null
        && (paramString.equals("std_injection")
            || paramString.equals("std_realtime")
            || paramString.equals("std_accel")
            || paramString.equals("std_ms3Rtc")
            || paramString.equals("std_ms3SdConsole")
            || paramString.equals("std_ftpSdBrowser")
            || paramString.equals("std_separator")
            || paramString.equals("std_ms2gentherm")
            || paramString.equals("std_ms2geno2")
            || paramString.equals("std_constants")
            || paramString.equals("std_warmup")
            || paramString.equals("std_tpscal")
            || paramString.equals("std_port_edit")
            || paramString.equals("std_replay_upload")
            || paramString.equals("std_bootstrap")
            || paramString.equals("std_trigwiz")));
  }

  public static boolean b(bv parambv) {
    if (parambv == null) return false;
    if (parambv.aL() != null && a(parambv.aL())) return true;
    for (bv bv1 : parambv.d) {
      if (b(bv1)) return true;
    }
    return false;
  }
}
