...
public class GComponentCf implements Serializable {
  private int d = 2;
  ...
  public String[] a() {
    ...
    for (byte b = 0; b < arrayOfString.length; b++) arrayOfString[b] = ((ce) this.a.get(b)).b();
    return arrayOfString;
  }

  public String[] b() {
    String[] arrayOfString = new String[this.a.size()];
    for (byte b = 0; b < this.a.size(); b++) arrayOfString[b] = ((ce) this.a.get(b)).g();
    return arrayOfString;
  }
  ...
  public int b(String paramString) {
    for (byte b = 0; b < this.a.size(); b++) {
      ce ce = this.a.get(b);
      if (ce.b().equals(paramString)) return b;
    }
    return -1;
  }
