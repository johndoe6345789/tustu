...
public class ArrayListExceptionprintstacktraceInGPackage extends Q implements Serializable {
  private db a = new c("");
  ...
  public List G() {
    ...
    for (bv bv1 : this.d) arrayList.addAll(bv1.G());
    return arrayList;
  }
  ...
  public Iterator I() {
    ...
    for (bv bv1 : this.d) {
      ...
      while (iterator1.hasNext()) arrayList.add(iterator1.next());
    }
  ...
  public ArrayList O() {
    ...
    for (db db1 : arrayList) {
      try {
        if (!arrayList1.contains(db1.a())) arrayList1.add(db1.a());
      } catch (ExceptionPrintstacktrace ExceptionPrintstacktrace) {
        Logger.getLogger(bv.class.getName())
            .log(Level.SEVERE, (String) null, (Throwable) ExceptionPrintstacktrace);
      }
  ...
  public ArrayList P() {
    if (this.d.size() > 0) {
      ...
      while (iterator.hasNext()) arrayList.addAll(((bv) iterator.next()).P());
      return arrayList;
    }
    return this.f;
  }
  ...
  public void t(String paramString) {
    if (paramString == null || paramString.equals("")) paramString = "yAxis";
    if (paramString.equals("Center")
        || paramString.equals("East")
        || paramString.equals("North")
        || paramString.equals("South")
        || paramString.equals("West")
        || paramString.equals("xAxis")
        || paramString.equals("yAxis")
        || paramString.equals("Default")) {
  ...
  public boolean n() {
    ...
    while (iterator.hasNext()) {
      if (((bv) iterator.next()).n()) return true;
    }
    return false;
  }
  ...
  public boolean S() {
    if (this instanceof be) return true;
    Iterator<bv> iterator = K();
    while (iterator.hasNext()) {
      bv bv1 = iterator.next();
      if (bv1 instanceof be || bv1.S()) return true;
    }
    return false;
  }

  public boolean T() {
    if (this instanceof bm) return true;
    Iterator<bv> iterator = K();
    while (iterator.hasNext()) {
      bv bv1 = iterator.next();
      if (bv1 instanceof bm || bv1.T()) return true;
    }
    return false;
  }
  ...
  public List e() {
    ...
    if (this instanceof aS) {
      ...
      for (bA bA : this.c) {
        if (bA instanceof bq) {
          bq bq = (bq) bA;
          if (bq.b() != null && bq.b().length() > 0) arrayList.add(bq.b());
        }
      }
      if (this.d.size() > 0) {
        Iterator<bv> iterator = this.d.iterator();
  ...
  public List U() {
    ...
    Iterator<bv> iterator = this.d.iterator();
    while (iterator.hasNext()) arrayList.addAll(((bv) iterator.next()).U());
    return arrayList;
  }
  ...
  public String i(String paramString) {
    String str = null;
    for (bA bA : this.c) {
      if (bA.aL() != null && bA.aL().equals(paramString)) return (bA.aJ() != null) ? bA.aJ() : "";
    }
    for (bv bv1 : this.d) {
      str = bv1.i(paramString);
      if (str != null) {
        if (aJ() != null && aJ().length() > 0) str = str + " && (" + aJ() + ") ";
        break;
      }
    }
    return str;
  ...
  public String X() {
    if (this.l != null && !this.l.isEmpty()) return this.l;
    if (L())
      for (bv bv1 : this.d) {
        if (bv1.X() != null && !bv1.X().isEmpty()) return bv1.X();
      }
    return null;
  }
  ...
  public boolean Y() {
    if (this.l != null && !this.l.isEmpty()) return true;
    if (L())
      for (bv bv1 : this.d) {
        if (bv1.Y()) return true;
      }
    return false;
  }
  ...
  protected List a(ArrayList<String> paramArrayList) {
    if (this.m != null && !this.m.isEmpty()) paramArrayList.add(this.m);
    if (L()) for (bv bv1 : this.d) bv1.a(paramArrayList);
