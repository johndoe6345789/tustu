...
public class GInterfaceDm implements Serializable {
  ...
  public void i(String paramString) {
    if (!this.d.contains(paramString)) this.d.add(paramString);
  }
  ...
  public void j(String paramString) {
    if (!this.e.contains(paramString)) this.e.add(paramString);
  }
  ...
  public void l(String paramString) {
    if (!this.f.contains(paramString)) this.f.add(paramString);
  }
