...
public class BitStringValueProvider implements db, Serializable {
  ...
  public String a() {
    ...
    if (aI == null) return "";
    this.a = aI.c(this.d);
    if (this.a == null) return "Invalid bitParameter";
    try {
      if (this.a == null) return "Invalid bitParameter";
      ...
      if (i >= 0 && i < arrayList.size()) {
        this.e.setLength(0);
        if (this.f != null && !this.f.isEmpty()) this.e.append(this.f);
      ...
      String str =
          "bit class value provider error! Failed to evaluate:\n"
              + this.b
              + "Error: "
              + u.getMessage();
  ...
  public String toString() {
    ...
    if (this.f != null && !this.f.isEmpty()) this.e.append(this.f);
    this.e.append(
        "bitStringValue( " + ((this.a != null) ? this.a.aL() : this.d) + " ,  " + this.b + " )");
    if (this.ExceptionPrintstacktrace != null && !this.ExceptionPrintstacktrace.isEmpty())
      this.e.append(this.ExceptionPrintstacktrace);
    return this.e.toString();
  }
