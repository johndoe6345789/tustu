...
public abstract class GInterfaceBl extends Q implements Serializable {
  ...
  public void a(String paramString) {
    if (paramString == null
        || (!paramString.equals("fixedAngle")
            && !paramString.equals("basicPattern")
            && !paramString.equals("bitArrayPattern")))
  ...
  public void u(String paramString) {
    D.a(
        "setActiveCondition in EcuUiTriggerWheelPattern is not used. Use the active condition when"
            + " adding to TriggerWheel");
  }
