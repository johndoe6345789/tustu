...
public class SerializableImpl extends Q implements Serializable {
  ...
  public SerializableImpl(String paramString) {
    this.q = paramString;
  }
  ...
  public void a(String paramString) {
    if (paramString.equals("scalar")
        || paramString.equals("bits")
        || paramString.equals("dotScalar")
        || paramString.equals("formula")) {
      this.h = paramString;
    } else {
  ...
  public void d(String paramString) {
    if (this.u == null) this.u = new ArrayList();
  ...
  public double o() {
    if (this.h.equals("formula")) {
      ...
      if (this.B) {
        ...
        try {
          if (this.b != 1) this.p = i.a(str, v());
        } catch (ExceptionInAxPackage u) {
          if (bool) {
            D.d(
                "EcuOutputChannel::Error executing formula (fastMath):"
                    + str
                    + "\nWas:"
                    + this.n
                    + "\nReported Error:\n"
                    + u.getMessage()
                    + "\n\tUsing last set value for "
                    + aL());
          } else {
            D.b(
                "EcuOutputChannel::Error executing formula (fastMath):"
        ...
        try {
          ...
          D.b(
              "EcuOutputChannel::Error executing formula(legacy) for last value:"
                  + str
                  + "\nWas:"
                  + this.n
                  + "\n\tUsing last set value for "
  ...
  public String a(byte[] paramArrayOfbyte) {
    ...
    return this.h.equals("bits")
        ? ((this.u != null && d < this.u.size()) ? this.u.get((int) d) : Integer.toString((int) d))
        : ((this.j >= 0) ? X.b(d, this.j) : X.a(d));
  }
      ...
      if (this.B) {
        try {
          ...
          StringBuilder stringBuilder =
              new StringBuilder("EcuOutputChannel::Error executing formula for ");
          ...
          try {
            ...
            if (arrayOfString != null) {
              ...
              for (b = 0; b < arrayOfString.length; b++)
                stringBuilder
                    .append(arrayOfString[b])
                    .append(" = ")
                    .append(arrayOfDouble[b])
                    .append("\n");
            }
          } catch (ExceptionInAxPackage u1) {
        ...
        try {
          ...
          throw new ExceptionPrintstacktrace(
              "EcuOutputChannel::Error executing formula(legacy):" + str + "\nWas:" + this.n);
        }
      }
    } else {
      throw new ExceptionPrintstacktrace(
          "EcuOutputChannel::getValueFromResponse not intialized, paramClass=" + this.h);
    }
    return this.p;
  }
  ...
  public boolean w() {
    return (this.h.equals("formula")
        && (this.n.toLowerCase().contains("accumulate(")
            || this.n.toLowerCase().contains("persistentaccumulate(")));
  }
  ...
  public boolean a(byte[] paramArrayOfbyte, double paramDouble) {
    if (this.d == null || this.d.length != this.o) this.d = new byte[this.o];
    if (this.h.equals("scalar")) {
      long l = Math.round(paramDouble / this.l.a() - this.m.a());
      if (t()) l = Float.floatToIntBits((float) paramDouble);
    ...
    if (this.h.equals("formula") && (this.e == null || this.e.length == 1)) {
      ...
      if (this.e == null)
        try {
          ...
          if (this.e == null || this.e.length != 1) return false;
        } catch (ExceptionInAxPackage u) {
          Logger.getLogger(aH.class.getName())
              .log(Level.SEVERE, "Failed to get Channel Terms", (Throwable) u);
          this.e = new String[0];
          return false;
        }
      aI aI = h.a().a(this.q);
      aH aH1 = aI.K().ExceptionPrintstacktrace(this.e[0]);
      if (aH1 != null) return aH1.a(paramArrayOfbyte, paramDouble);
    }
    return false;
  }
