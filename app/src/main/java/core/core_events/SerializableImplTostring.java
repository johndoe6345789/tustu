...
public class SerializableImplTostring implements dj, Serializable {
  ...
  public SerializableImplTostring(aI paramaI, String paramString) {
    String str = paramaI.c();
    this.a = new bS(this, str);
    this.b = paramString;
  }

  public SerializableImplTostring(cZ paramcZ, String paramString) {
    this.a = paramcZ;
    this.b = paramString;
    if (paramString.equals("fuelLoadRes")) D.c("break 1209873");
  }

  public double a() {
    R r = T.a().c(this.a.a());
    if (r == null || this.b == null) return Double.NaN;
    try {
      return i.a(r, this.b);
    ...
    if (r != null) {
      ...
      for (String str : arrayOfString) {
        try {
          ...
          D.b(
              "Disabling expression evaluation, Variable not found '"
                  + str
                  + "' in expression: "
                  + this.b);
          this.b = null;
  ...
  public HashMap d() {
    if (this.c == null) this.c = new HashMap<>();
    return this.c;
  }
}
