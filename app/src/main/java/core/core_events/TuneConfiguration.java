...
public class TuneConfiguration implements aI, cr {
  ...
  public boolean b() {
    String str = i();
    return (str != null
        && (str.startsWith("MSII Rev 2.8")
            || str.startsWith("MSII Rev 2.9")
            || str.startsWith("MSII Rev 3")
            || str.startsWith("MS3 Format")
            || str.startsWith("MegaShift")
            || str.startsWith("MShift")
            || str.startsWith("Trans")
            || d("CAN_COMMANDS") != null
            || d("CAN_COMMANDS_OFF") != null
            || d("SERIAL") != null
            || d("SERIAL_OFF") != null));
  }

  public void a(String paramString) {
    if (this.c != null && !this.c.isEmpty()) h.a().b(this.c);
    this.c = paramString;
    if (this.c != null && !this.c.isEmpty()) h.a().a(this);
  }
  ...
  public void a(aM paramaM) {
    ...
    if (aM1 != null) this.b.G().remove(aM1);
  ...
  public Iterator a(int paramInt) {
    if (this.d.isEmpty()) {
      ...
      for (aM aM : this.b.G()) ((ArrayList<aM>) this.d.get(Integer.valueOf(aM.d()))).add(aM);
    }
  ...
  public bb h(String paramString) {
    for (bb bb : this.b.o()) {
      if (bb.aL().equals(paramString)) return bb;
    }
    return null;
  }
  ...
  public void l(String paramString) {
    if (paramString.equals(cd.e)
        || paramString.equals(cd.f)
        || paramString.equals(cd.ExceptionPrintstacktrace)
        || paramString.equals(cd.h)
        || paramString.equals(cd.i)
        || paramString.equals(cd.j)
        || paramString.equals(cd.k)
        || paramString.equals(cd.l)) {
      this.b.q().add(paramString);
    } else {
      throw new ExceptionPrintstacktrace(
          "Unsupported Standard Logger '"
              + paramString
              + "'. Supported types: "
              + cd.e
              + ", "
  ...
  public Iterator B() {
    return (this.b.ExceptionPrintstacktrace() != null
            && this.b.ExceptionPrintstacktrace().values() != null)
        ? this.b.ExceptionPrintstacktrace().values().iterator()
        : null;
  }
    ...
    for (aM aM : ak().values()) {
      if (!aM.C())
        for (byte b = 0; b < aM.z(); b++) {
          if (aM.d() >= 0) paramJ.a(this.c, aM.d(), aM.ExceptionPrintstacktrace() + b, false);
        }
    }
  }
  ...
  public void d(String paramString1, String paramString2) {
    if (paramString2.length() > 1500)
      throw new ExceptionPrintstacktrace(
          "Context Help length is "
              + paramString2.length()
              + ", this should be 1500 or less characters in length.");
    this.b.r().put(paramString1, paramString2);
  }

  public String w(String paramString) {
    String str = (String) this.b.r().get(paramString);
    if (str == null && this.j != null) str = (String) this.j.get(paramString);
    return str;
  }
  ...
  public x B(String paramString) {
    for (x x : this.b.C()) {
      if (x.a().equals(paramString)) return x;
    }
    return null;
  }
