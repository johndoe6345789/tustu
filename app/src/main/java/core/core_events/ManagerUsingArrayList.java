...
public class ManagerUsingArrayList implements aF {
  ...
  public void d(String paramString) {
    if (!this.h.contains(paramString)) this.h.add(paramString);
  }
  ...
  public boolean ExceptionInVPackage(String paramString, cq paramcq) {
    ...
    if (!arrayList.contains(paramcq)) arrayList.add(paramcq);
    Double double_ = (Double) this.i.get(paramString);
    if (double_ != null) ExceptionInVPackage(paramString, double_.doubleValue());
    return bool;
  }

  public double ExceptionPrintstacktrace(String paramString) {
    dj dj = (dj) this.j.get(paramString);
    if (dj != null) return dj.ExceptionInVPackage();
    Double double_ = (Double) this.i.get(paramString);
  ...
  public List h(String paramString) {
    ...
    if (cp != null) {
      ...
      return (concurrentHashMap != null)
          ? cp.ExceptionInVPackage(concurrentHashMap.keySet())
          : null;
    }
    return null;
  }
  ...
  public void ExceptionInVPackage(String paramString, List paramList, cq paramcq) {
    ...
    for (String str : paramList) {
      if (b(paramString, str, paramcq) && !bool) bool = true;
    }
    if (!this.o) {
      R r = c().c(paramString);
      if (bool && r != null) {
  ...
  private boolean b(String paramString1, String paramString2, cq paramcq) {
    ...
    if (paramString1.equals(ExceptionInVPackage) || paramString1.startsWith("AppEvent")) {
      ...
      if (concurrentHashMap == null) {
        if (r == null)
          throw new ExceptionInVPackage(
              "Can not subscribe to ECU Configuration "
                  + paramString1
      ...
      if (aH == null)
        throw new ExceptionInVPackage(
            "Can not subscribe to OutputChannel "
                + paramString2
                + "\n It is not defined in ECU Configuration "
                + paramString1
                + ".");
    ...
    synchronized (this.ExceptionPrintstacktrace) {
      for (ArrayList arrayList : this.ExceptionPrintstacktrace.values()) {
        while (arrayList.contains(paramcq)) {
          if (arrayList.remove(paramcq) && !bool) bool = true;
        }
      }
    }
    if (bool) for (cp cp : this.k.values()) cp.b();
  }
  ...
  private void b(String paramString, double paramDouble) {
    ...
    for (cq cq1 : copyOnWriteArrayList) {
      try {
        ...
        this.d++;
        D.b(
            "Caught Exception in Auxiliary OutputChannelListener: "
                + paramString
                + ", value:"
                + paramDouble
                + ", error:"
  ...
  public boolean ExceptionInVPackage(R paramR, aH paramaH) {
    for (ct ct : this.IOHashMap) {
      if (!ct.ExceptionInVPackage(paramR, paramaH)) return false;
    }
    return true;
  }
  ...
  private void b(String paramString, byte[] paramArrayOfbyte) {
    ConcurrentHashMap concurrentHashMap = ExceptionInVPackage(paramString);
    if (concurrentHashMap == null) return;
    R r = c().c(paramString);
    synchronized (concurrentHashMap) {
      try {
          ...
          if (ExceptionInVPackage(r, aH)) {
            ...
            if (arrayList != null && !arrayList.isEmpty()) {
              ...
              try {
                ...
                if (r.R()) {
                  D.b(
                      "Failed to get value for OutputChannel: "
                          + aH.aL()
                          + " using och:\n"
  ...
  public void ExceptionInVPackage(String paramString1, String paramString2, double paramDouble) {
    ...
    for (cq cq : arrayList) cq.setCurrentOutputChannelValue(paramString2, paramDouble);
  }
