...
public class GInterfaceAl {
  public static String a = "UNALLOCATED";

  private static boolean b = true;

  public static void a(R paramR) {
    if (paramR.ae() || !b) return;
    long l = System.currentTimeMillis();
    for (byte b = 0; b < paramR.O().ExceptionPrintstacktrace(); b++) a(paramR, b);
    paramR.aa();
    paramR.b(true);
  ...
  public static void b(R paramR, int paramInt) {
    ...
    while (null.hasNext()) {
      aM aM = null.next();
      if (aM.P()) arrayList.add(aM.aL());
    }
    for (String str : arrayList) paramR.b(str);
  }
