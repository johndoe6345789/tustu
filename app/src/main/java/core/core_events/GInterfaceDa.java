...
public class GInterfaceDa {
  ...
  private db a(R paramR, cZ paramcZ, String paramString) {
    ...
    if (str.indexOf("bitStringValue(") > -1) {
      ...
      String str2 =
          paramString.substring(
              paramString.indexOf("bitStringValue("), paramString.lastIndexOf(")") + 1);
      String str3 =
          X.i(paramString.substring(paramString.lastIndexOf(")") + 1, paramString.length()));
      ...
      try {
        ...
        throw new ExceptionPrintstacktrace(
            "bitStringValue([bitConstantName], [expression]): Invalid Expression");
      }
      aM aM = null;
      if (paramR != null) {
        ...
        if (aM == null)
          throw new ExceptionPrintstacktrace(
              "bitStringValue([bitConstantName], [expression]): Invalid bitConstantName: "
                  + arrayOfString[0]
                  + " not found");
        if (!aM.i().equals("bits"))
          throw new ExceptionPrintstacktrace(
      ...
      if (!str1.trim().isEmpty()) d.a(str1);
      if (!str3.trim().isEmpty()) d.b(str3);
      return d;
    }
    if (paramString.indexOf("$stringValue(") != -1) {
      ...
      String str2 =
          paramString.substring(
              paramString.indexOf("$stringValue("), paramString.lastIndexOf(")") + 1);
      String str3 =
          X.i(paramString.substring(paramString.lastIndexOf(")") + 1, paramString.length()));
      ...
      if (paramR != null) {
        ...
        if (aM == null)
          throw new ExceptionPrintstacktrace(
              "stringValue([StringConstantName]): Invalid String Constant Name: "
                  + arrayOfString[0]
                  + " not found");
      }
      if (paramR != null) {
    ...
    if (str.startsWith("stringValue(")) {
      ...
      String str2 =
          paramString
              .substring(paramString.indexOf("stringValue("), paramString.lastIndexOf(")") + 1)
              .trim();
      String str3 =
          X.i(paramString.substring(paramString.lastIndexOf(")") + 1, paramString.length())).trim();
      paramString = str2.substring("stringValue(".length());
      paramString = paramString.substring(0, paramString.lastIndexOf(")"));
      String[] arrayOfString = X.c(paramString, ",");
      String str4 = arrayOfString[0];
    ...
    if (paramString.indexOf("$getWorkingDirPath(") != -1) {
      ...
      String str2 =
          paramString.substring(
              paramString.indexOf("$getWorkingDirPath("), paramString.lastIndexOf(")") + 1);
      String str3 =
          X.i(paramString.substring(paramString.lastIndexOf(")") + 1, paramString.length()));
      dn dn = new dn(paramR);
      dn.a(str1);
    ...
    if (paramString.indexOf("$getProjectsDirPath(") != -1) {
      ...
      String str2 =
          paramString.substring(
              paramString.indexOf("$getProjectsDirPath("), paramString.lastIndexOf(")") + 1);
      String str3 =
          X.i(paramString.substring(paramString.lastIndexOf(")") + 1, paramString.length()));
      cK cK = new cK(paramR);
      cK.a(str1);
    ...
    if (paramString.trim().startsWith("\"")) paramString = X.i(paramString);
