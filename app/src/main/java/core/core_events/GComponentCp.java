...
public class GComponentCp {
  ...
  private void a(aH paramaH) {
    if (paramaH.b().equals("formula")) {
      ...
      w.a(i);
      w.b(j);
      if (!this.d.contains(w)) this.d.add(w);
      boolean bool = false;
      byte b;
