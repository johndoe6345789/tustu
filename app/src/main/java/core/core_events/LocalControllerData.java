...
public class LocalControllerData implements Serializable {
  ...
  public void a(F paramF) {
    ...
    for (byte b = 0; b < arrayOfInt.length; b++) a(b, arrayOfInt[b]);
  }
  ...
  private void a(int paramInt1, int paramInt2) {
    ...
    for (byte b = 0; b < (this.b[paramInt1]).length; b++) this.b[paramInt1][b] = true;
  }

  public void a(int paramInt1, int paramInt2, int[] paramArrayOfint, boolean paramBoolean) {
    for (byte b = 0; b < paramArrayOfint.length; b++) {
      if (paramInt1 == -1 || paramInt2 + b == -1) D.c("Local Controller Data Write Error!!!");
      if ((paramBoolean || this.b[paramInt1][paramInt2 + b])
  ...
  public int[] b(int paramInt) {
    ...
    for (byte b = 0; b < arrayOfInt1.length; b++) arrayOfInt2[b] = arrayOfInt1[b];
    return arrayOfInt2;
  }

  public int[] a(int paramInt1, int paramInt2, int paramInt3) {
    int[] arrayOfInt1 = a(paramInt1);
    if (arrayOfInt1 == null) return new int[0];
