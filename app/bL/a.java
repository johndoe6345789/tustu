...
public class a extends JPanel {
  ...
  static String c = g.b("Maximum Cell Value Change");
  
  static String d = g.b("Maximum Cell Percentage Change");
  ...
  public a(c paramc, et paramet) {
    ...
    jPanel1.add("Center", new JLabel(g.b("Cell Change Resistance") + ": ", 4));
    jPanel1.add("East", this.g);
    Iterator iterator = e();
    while (iterator.hasNext())
      this.g.addItem(iterator.next()); 
    a();
    this.g.addActionListener(new b(this));
    add("North", jPanel1);
    JPanel jPanel2 = new JPanel();
    jPanel2.setBorder(BorderFactory.createTitledBorder(g.b("Authority Limits")));
