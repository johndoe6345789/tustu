...
public class a extends JPanel implements t {
  R a;
  ...
  private JPanel c() {
    ...
    try {
      ...
      this.g.setToolTipText(g.b("Create New Component"));
      ...
      this.h.setToolTipText(g.b("Edit Selected Component"));
      ...
      this.i.setToolTipText(g.b("Delete Selected Component"));
      ...
      imageIcon = new ImageIcon(image);
      this.j = new JButton(imageIcon);
      this.j.setToolTipText(g.b("Save Configuration"));
      this.j.setPreferredSize(new Dimension(i, i));
  ...
  public void a(F paramF) {
    ...
    //   139: invokevirtual c : (Ljava/lang/String;)V
    //   142: aload #4
    //   144: aload #5
  ...
  public void a(Component paramComponent) {
    this.f = new JDialog(bV.a(paramComponent), g.b("Ini Based Tuning View Editor"));
    ...
    this.f.add("South", jPanel);
    this.f.pack();
    bV.a(bV.a(paramComponent), this.f);
