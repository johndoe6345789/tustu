...
public class f extends d implements bc, a {
  n a = null;
  ...
  public f(R paramR, dp paramdp) {
    this.j = paramR;
    this.i = paramdp;
    this.k = bM.a(paramR, paramdp.c());
    this.d = new dQ((Properties)a.A(), "WueAnalyzeConsole." + paramdp.c());
    try {
      if (this.k == null || this.k.equals("") || p.a(this.k, paramR))
        f(); 
    } catch (g g) {
      D.b("Unable to determine if table " + paramdp.c() + " should be active, so defaulting to yes...");
      f();
    } 
  }
  ...
  private void f() {
    ...
    if (i.a().a("gd09ifdspokrwpo3209") || !a.a().c(a.bN, a.bO)) {
      this.f.remove((Component)bh);
      this.f.setDividerSize(0);
      bh = null;
      this.o = true;
    } 
    if (!i.a().a("h98oiu32lkpk3209") && a.a().c(a.bL, a.bM)) {
      this.b = new x(this.j);
      this.b.setName("WueAnalyzeConsole." + this.i.c());
      if (i.a().a("64865e43s5hjhcurd")) {
        ...
        this.c = new x(this.j);
        this.c.setName("WueAnalyzeConsole.Histogram." + this.i.c());
        jPanel = new JPanel();
        jPanel.setLayout(new BorderLayout());
      ...
      try {
        Z z1 = (new aa()).a(this.j, a.A(), "wueAnalyze_" + this.t, 6);
        this.b.a(z1);
        Z z2 = (new aa()).a(this.j, "wueAnalyze_" + this.t, 6);
        this.b.b(z2);
        this.b.n(a.A().m());
        ...
        if (this.c != null) {
          z1 = (new aa()).a(this.j, a.A(), "wueAnalyze_" + this.t + l, 5);
          this.c.a(z1);
          z2 = (new aa()).a(this.j, "wueAnalyze_" + this.t + l, 5);
          this.c.b(z2);
          this.c.n(a.A().m());
  ...
  public boolean a() {
    try {
      if (!this.n || (this.t == null && (this.k == null || this.k.equals("") || p.a(this.k, this.j)))) {
        f();
        this.m = true;
        return true;
      } 
  ...
  private void g() {
    ...
    this.f.addPropertyChangeListener("dividerLocation", new i(this));
  }
  
  private void h() {
    int i = Integer.parseInt(this.d.b("horizontalSplitPos", "200"));
    this.e.setDividerLocation(i);
    int m = (this.f.getPreferredSize()).height - (this.g.getPreferredSize()).height;
  ...
  private void i() {
    int i = this.f.getDividerLocation();
    double d1 = i / this.f.getHeight();
    if (isVisible() && d1 > 0.0D)
      this.d.a("verticalSplitPos", i + ""); 
  }
  
  private br a(R paramR, dp paramdp) {
    br br = new br();
    bs bs = a(paramR, paramdp.d());
    if (bs != null)
      br.a(bs); 
    bs = a(paramR, paramdp.e());
    if (bs != null)
      br.a(bs); 
    if (paramdp.k() != null) {
      bs = a(paramR, paramdp.k());
      if (bs != null)
        br.a(bs); 
    } 
    if (paramdp.h() != null) {
      bs = a(paramR, paramdp.h());
      if (bs != null)
        br.a(bs); 
    } 
    return br;
  ...
  public void close() {
    ...
    if (this.b != null && this.b.getComponentCount() > 0) {
      this.b.f();
      (new aa()).a(this.b, this.q, "wueAnalyze_" + this.t);
      this.b.c();
    } 
    if (this.c != null && this.c.getComponentCount() > 0) {
      this.b.f();
      (new aa()).a(this.c, this.q, "wueAnalyze_" + this.t + l);
      this.c.c();
    } 
    if (this.a != null)
