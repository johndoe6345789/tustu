...
public class a extends d implements aN, aO {
  aV a = null;
  ...
  public a(R paramR) {
    ...
    jPanel2.add(new JLabel(g.b("Match above value with timing light reading."), 0));
    JPanel jPanel3 = new JPanel();
    jPanel3.setLayout(new FlowLayout(2));
    bq bq = new bq();
    bq.v("offsetField");
    bq.e(g.b("Ignition Offset angle"));
    bq.b("triggerOffset");
    ...
    jPanel3.add(jPanel4);
    jPanel2.add(jPanel3);
    jPanel2.add(new JLabel(g.b("Press Up/Down arrows to adjust. Hold Shift to adjust by 5x"), 0));
    add("South", jPanel2);
    this.a.requestFocus();
  }
  ...
  public void a() {
    try {
      ...
      bV.d("Unable to increment offset.\nThe configuration does not support this operation.", (Component)this);
