...
public class EventPacketProcessor implements i {
  ...
  public void a(F paramF, k paramk, t paramt) {
    if (paramt.a() != a())
      throw new h("PID:EVENT_PACKET Wrong handler! this handler is for 0x" + Integer.toHexString(a()).toUpperCase()); 
    byte[] arrayOfByte1 = paramt.c();
    if (arrayOfByte1 == null)
      throw new h("PID:EVENT_PACKET valid packet data not found."); 
    if (arrayOfByte1.length < 1)
      throw new h("PID:EVENT_PACKET invalid packet data length, expected at least 2 byte, found: " + (arrayOfByte1.length + 1)); 
