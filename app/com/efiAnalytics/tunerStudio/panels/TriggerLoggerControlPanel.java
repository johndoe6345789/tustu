...
class TriggerLoggerControlPanel extends JPanel {
  ...
  protected void ExceptionInVPackage(boolean paramBoolean) {
    if (TriggerLoggerPanel.e(this.g).size() > 0 && ((n)TriggerLoggerPanel.e(this.g).get(0)).ExceptionInVPackage("Time") != null) {
  ...
  public void ExceptionInVPackage(double paramDouble) {
    if (paramDouble >= 0.0D && paramDouble <= 1.0D) {
      double d = this.ExceptionInVPackage.getMinimum() + (this.ExceptionInVPackage.getMaximum() + TriggerLoggerPanel.h(this.g) - this.ExceptionInVPackage.getMinimum()) * paramDouble;
  ...
  public double b() {
    return (this.ExceptionInVPackage.getValue() - this.ExceptionInVPackage.getMinimum()) / (this.ExceptionInVPackage.getMaximum() + TriggerLoggerPanel.h(this.g) - this.ExceptionInVPackage.getMinimum());
  }
