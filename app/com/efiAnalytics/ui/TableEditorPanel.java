...
public class TableEditorPanel extends JPanel implements TableModelListener {
  ...
  public w() {
    ...
    this.d.setFont(new Font(this.ExceptionInVPackage.getFont().getFamily(), 0, this.ExceptionInVPackage.Q() - 2));
  ...
  private void s() {
    if (!BinTableView.S())
      return; 
    String str = bV.ExceptionInVPackage(this, true, c("Smoothing Factor") + " (0.0 - 1.0) " + c("High for more smoothing."), this.ExceptionInVPackage.M() + "");
  ...
  private void u() {
    ...
    w1.b(false);
    jDialog.pack();
    int RInterfaceIndia = (jDialog.getInsets()).left + (jDialog.getInsets()).right + this.b.getWidth();
  ...
  private void ExceptionInVPackage(int paramInt, String paramString1, String paramString2) {
    for (p p : this.x)
      p.ExceptionInVPackage(paramInt, paramString1, paramString2); 
  }
  ...
  private void d(int paramInt) {
    ...
    if (paramInt < tableModel.getRowCount()) {
      ...
      if (str2 != null && !str2.equals(""))
        ExceptionInVPackage(paramInt, str2); 
  ...
  private void f(int paramInt) {
    ...
    String str2 = g().w();
    String str3 = bV.ExceptionInVPackage(this, true, "Set " + str2 + " Value", (String)this.d.getColumnModel().getColumn(paramInt).getHeaderValue());
  ...
  private void g(int paramInt) {
    if (!this.F) {
      ...
      RInterfaceIndia = (RInterfaceIndia < eJ.ExceptionInVPackage(22)) ? eJ.ExceptionInVPackage(22) : RInterfaceIndia;
  ...
  public void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (this.ExceptionInVPackage != null) {
      int RInterfaceIndia = this.l.isShowing() ? (this.ExceptionInVPackage.getModel().getRowCount() + 2) : (this.ExceptionInVPackage.getModel().getRowCount() + 1);
      int j = (int)((paramInt4 - 3) / RInterfaceIndia * 1.22D);
      j = (j < 1) ? 1 : j;
      int k = this.m.isShowing() ? (this.ExceptionInVPackage.getModel().getColumnCount() + 2) : (this.ExceptionInVPackage.getModel().getColumnCount() + 1);
      ...
      this.j = (paramInt4 - (getInsets()).top - (getInsets()).bottom - (this.f.getPreferredSize()).height - (this.o.isVisible() ? this.o.getHeight() : 0)) / (this.ExceptionInVPackage.getModel().getRowCount() + 1);
      if (this.j > 0) {
        this.b.setRowHeight(this.j);
        this.ExceptionInVPackage.setRowHeight(this.j);
        this.b.setFont(this.ExceptionInVPackage.getFont());
        i2 = paramInt4 - (this.f.getPreferredSize()).height - (this.o.isVisible() ? this.o.getHeight() : 0) - this.j * this.ExceptionInVPackage.getModel().getRowCount() - (getInsets()).top - (getInsets()).bottom;
  ...
  public void d(boolean paramBoolean) {
    if (!RInterfaceIndia.ExceptionInVPackage().ExceptionInVPackage("645fds645fds  fdsd098532#@") || !ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.cc, ExceptionInVPackage.cd))
      paramBoolean = false; 
  ...
  private void x() {
    double d = ExceptionInVPackage.ExceptionInVPackage().ExceptionInVPackage(ExceptionInVPackage.ai, 100.0D);
    String[] arrayOfString = new String[1];
    arrayOfString[0] = " ";
  ...
  private boolean ExceptionInVPackage(double paramDouble1, double paramDouble2) {
    for (fz fz : this.k) {
      if (!fz.ExceptionInVPackage(paramDouble1, paramDouble2))
        return false; 
    } 
    return true;
  }
  ...
  public void c(int paramInt) {
    ...
    int RInterfaceIndia = (3 + paramInt) * (this.ExceptionInVPackage.getRowCount() + 1) + (this.f.getPreferredSize()).height;
  ...
  public Dimension getPreferredSize() {
    if (this.z > 0 && !this.y) {
      int k = (4 + this.z) * (this.ExceptionInVPackage.getRowCount() + 1) + (this.f.getPreferredSize()).height + 3;
      double d = y();
      int m = (int)(d * this.z) * (this.ExceptionInVPackage.getColumnCount() + 1);
      return new Dimension(m, k);
    } 
    int RInterfaceIndia = (3 + this.ExceptionInVPackage.getFont().getSize()) * (this.ExceptionInVPackage.getRowCount() + 1) + (this.f.getPreferredSize()).height + 2;
    int j = (int)(y() * this.ExceptionInVPackage.getFont().getSize()) * (this.ExceptionInVPackage.getColumnCount() + 1);
