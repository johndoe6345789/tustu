...
class Calculator$MyKeyDispacher implements KeyEventDispatcher {
  ...
  public boolean dispatchKeyEvent(KeyEvent paramKeyEvent) {
    ...
    if (paramKeyEvent.getID() == 401)
      if (paramKeyEvent.getKeyChar() == '0' || paramKeyEvent.getKeyChar() == '1' || paramKeyEvent.getKeyChar() == '2' || paramKeyEvent.getKeyChar() == '3' || paramKeyEvent.getKeyChar() == '4' || paramKeyEvent.getKeyChar() == '5' || paramKeyEvent.getKeyChar() == '6' || paramKeyEvent.getKeyChar() == '7' || paramKeyEvent.getKeyChar() == '8' || paramKeyEvent.getKeyChar() == '9') {
        this.a.a(paramKeyEvent.getKeyChar() + "");
        bool = true;
      } else if (paramKeyEvent.getKeyChar() == '/' || paramKeyEvent.getKeyChar() == '+' || paramKeyEvent.getKeyChar() == '-' || paramKeyEvent.getKeyChar() == 'x' || paramKeyEvent.getKeyChar() == '=') {
