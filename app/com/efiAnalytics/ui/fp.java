...
public class fp {
  public static void a(Component paramComponent, boolean paramBoolean) {
    if (paramComponent instanceof Container) {
      ...
      for (byte b = 0; b < arrayOfComponent.length; b++)
        a(arrayOfComponent[b], paramBoolean); 
    } 
  ...
  public static boolean c() {
    ...
    return (graphicsDevice.isWindowTranslucencySupported(GraphicsDevice.WindowTranslucency.PERPIXEL_TRANSLUCENT) && graphicsDevice.isWindowTranslucencySupported(GraphicsDevice.WindowTranslucency.TRANSLUCENT));
  }
  ...
  public static boolean a(Component[] paramArrayOfComponent, Component paramComponent) {
    for (Component component : paramArrayOfComponent) {
      if (component.equals(paramComponent))
        return true; 
    } 
    return false;
  }
  ...
  public static JPopupMenu a(JPopupMenu paramJPopupMenu) {
    for (Component component : paramJPopupMenu.getComponents()) {
      if (component instanceof bs) {
        bs bs = (bs)component;
        if (bs.i() != null)
          bs.setVisible(bs.i().a()); 
        if (bs.e() != null)
          bs.setEnabled(bs.e().a()); 
      } 
