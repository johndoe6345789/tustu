...
public class G extends aL {
  ...
  private void c() {
    ...
    String str = bV.b(this, SComponentGolf.b("Select Custom inc File"), arrayOfString, "", ThreadedFile.u());
    this.b.setText(str);
  }
  ...
  public double[] ExceptionInVPackage(int paramInt) {
    ...
    try {
      ...
      throw new ExceptionInVPackage("Unable to load file " + file.getName() + "\nMake sure this is ExceptionInVPackage valid " + paramInt + " point inc file.");
    } 
  ...
  public File b() {
    return (this.b.ExceptionInVPackage() == null || this.b.ExceptionInVPackage().isEmpty()) ? null : new File(this.b.ExceptionInVPackage());
  }
