...
public class e {
  ...
  public void a(String paramString, Document paramDocument) {
    ...
    if (!file.exists()) {
      ...
      try {
        ...
        throw new a("Error writing to file. \n" + paramString);
      } 
    } 
    a(file, paramDocument);
  }
  
  public void a(File paramFile, Document paramDocument) {
  ...
  public Element a(Document paramDocument, Element paramElement, Object paramObject) {
    Class<?> clazz = paramObject.getClass();
    paramElement.setAttribute("type", a.a(paramObject));
          ...
          try {
            ...
            synchronized (element) {
              ...
              if (str1.equals("java.awt.Color")) {
                ...
                str1 = "GaugePainter";
                element.setTextContent(com.efiAnalytics.apps.ts.dashboard.renderers.e.a(method.invoke(paramObject, new Object[0])));
                ...
                str1 = "Properties";
                String str2 = a((Properties)method.invoke(paramObject, new Object[0]));
            ...
            D.a("Error writing Object to XML\n" + paramObject);
            exception.printStackTrace();
            throw new a("Error writing Object to XML");
          } 
        } 
      } 
  ...
  public String a(Node paramNode, String paramString) {
  ...
  public Object a(Node paramNode) {
    ...
    //   1: aload_1
    //   2: ldc 'type'
    //   4: invokevirtual a : (Lorg/w3c/dom/Node;Ljava/lang/String;)Ljava/lang/String;
    //   7: astore_2
    //   8: aconst_null
    //   9: astore_3
    //   10: aload_0
    //   11: invokespecial a : ()V
    //   14: aload_2
    //   15: invokestatic a : (Ljava/lang/String;)Ljava/lang/Class;
    //   18: astore #4
    //   20: aload #4
    ...
    //   87: aload #9
    //   89: ldc 'type'
    //   91: invokevirtual a : (Lorg/w3c/dom/Node;Ljava/lang/String;)Ljava/lang/String;
    //   94: astore #11
    //   96: aload #11
    //   98: ifnull -> 856
    ...
    //   124: aload #6
    //   126: aload #12
    //   128: invokespecial a : ([Ljava/lang/reflect/Method;Ljava/lang/String;)Ljava/lang/reflect/Method;
    //   131: astore_3
    //   132: aload_3
    //   133: ifnull -> 856
    //   136: aload #9
    ...
    //   224: goto -> 856
    //   227: aload #11
    //   229: getstatic v/a.g : Ljava/lang/String;
    ...
    //   677: ifeq -> 710
    //   680: aload #13
    //   682: invokestatic a : (Ljava/lang/String;)Lcom/efiAnalytics/apps/ts/dashboard/renderers/GaugePainter;
    //   685: astore #14
    //   687: iconst_1
    ...
    //   816: aload_0
    //   817: aload #13
    //   819: invokespecial a : (Ljava/lang/String;)Ljava/util/Properties;
    //   822: astore #14
    //   824: goto -> 836
  ...
  private void a(Method[] paramArrayOfMethod) {
    ...
    while (paramArrayOfMethod != null && paramArrayOfMethod[0] != null && clazz.getPackage().getName().indexOf("efiAnalytics") != -1) {
      for (byte b = 0; b < paramArrayOfMethod.length; b++)
        this.a.put(paramArrayOfMethod[b].getName(), paramArrayOfMethod[b]); 
      clazz = clazz.getSuperclass();
      paramArrayOfMethod = clazz.getMethods();
    } 
  }
  
  private Method a(Method[] paramArrayOfMethod, String paramString) {
    if (this.a.isEmpty())
      a(paramArrayOfMethod); 
    return (Method)this.a.get(paramString);
  }
  
  private String a(Properties paramProperties) {
    ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
    try {
      paramProperties.store(byteArrayOutputStream, "");
      return byteArrayOutputStream.toString("UTF-8");
    } catch (IOException iOException) {
      D.a("Failed to Save a properties to XML");
      Logger.getLogger(e.class.getName()).log(Level.SEVERE, (String)null, iOException);
      return "";
    } finally {
      try {
  ...
  private Properties a(String paramString) {
    ...
    try {
      ...
      D.a("Failed to load Properties from String: " + paramString);
      Logger.getLogger(e.class.getName()).log(Level.SEVERE, (String)null, iOException);
    } finally {
      try {
