...
public class VInterfaceAlpha {
  ...
  public static Class a(String paramString) {
    return (paramString.equals("com.efiAnalytics.tunerStudio.Gauge") || paramString.equals(a)) ? Gauge.class : ((paramString.equals("com.efiAnalytics.tunerStudio.Indicator") || paramString.equals(b)) ? Indicator.class : ((paramString.equals(d) || paramString.equals(c) || paramString.equals("com.efiAnalytics.tunerStudio.dashboard.DashLabel")) ? DashLabel.class : (paramString.equals(h) ? TuneViewGaugeCluster.class : (paramString.equals(i) ? SelectableTable.class : (paramString.equals(j) ? TuneSettingsPanel.class : (paramString.equals(k) ? BurnButtonTv.class : (paramString.equals(l) ? TableCellCrossHair.class : Class.forName(paramString))))))));
  }
  
  public static String a(Object paramObject) {
    Class<?> clazz = paramObject.getClass();
    return (paramObject instanceof Gauge) ? a : ((paramObject instanceof Indicator) ? b : ((paramObject instanceof DashLabel) ? c : ((paramObject instanceof G.dj) ? g : ((paramObject instanceof TuneViewGaugeCluster) ? h : ((paramObject instanceof SelectableTable) ? i : ((paramObject instanceof TuneSettingsPanel) ? j : ((paramObject instanceof BurnButtonTv) ? k : ((paramObject instanceof TableCellCrossHair) ? l : clazz.getName()))))))));
  }
}
