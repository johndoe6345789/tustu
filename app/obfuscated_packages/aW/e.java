...
class e extends JPanel {
  ...
  public e(a parama, r paramr) {
    ...
    k k = new k(this, g.b(this.a.c()) + ": ");
    if (this.a.d() != null && !this.a.d().isEmpty()) {
      j j = new j(g.b(this.a.d()));
      j.setOpaque(false);
    ...
    if (this.a.a() == 2 || this.a.a() == 0 || this.a.a() == 4) {
      ...
      i i = new i(this, g.b(this.a.c()));
      i.setToolTipText(k.getToolTipText());
      k.setText("");
      this.b = i;
      a(i);
    } else if (this.a.a() == 5 && r.a().a(this.a.c())) {
      JButton jButton = new JButton(g.b(this.a.d()));
      jButton.addActionListener(new g(this, parama));
      a(jButton);
    } else {
