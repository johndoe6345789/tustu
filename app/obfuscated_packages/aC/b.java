...
public class b {
  ...
  public static List b() {
    ...
    try {
      ...
      D.a("Failed to retrieve BT Devices");
    } 
    return arrayList;
  }
  ...
  public static List a(boolean paramBoolean) {
    ...
    a(new c(arrayList, paramBoolean));
  ...
  public static void a(d paramd) {
    ...
    try {
      synchronized (a) {
        boolean bool1 = LocalDevice.getLocalDevice().getDiscoveryAgent().startInquiry(10390323, paramd);
        if (bool1) {
  ...
  public static boolean a(RemoteDevice paramRemoteDevice, String paramString) {
    try {
  ...
  public static String a(RemoteDevice paramRemoteDevice) {
    try {
