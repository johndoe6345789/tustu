...
class d extends Thread {
  ...
  public void run() {
    while (!this.a) {
      try {
        DatagramSocket datagramSocket = c.a(this.b);
        ...
        try {
          ...
          D.d("BroadcastListener: Packet received from: " + datagramPacket.getAddress().getHostAddress() + ": " + str);
          boolean bool = (e.a(c.b(this.b)).b() && c.b(datagramPacket.getAddress().getAddress(), InetAddress.getLocalHost().getAddress())) ? true : false;
          if (str.equals(c.l) && !bool) {
            String str1 = c.c(this.b);
            String str2 = c.a + ":" + c.d(this.b) + "\n" + c.d + ":";
            if (this.b.m != null) {
              if (this.b.m.P() != null) {
              ...
              DatagramPacket datagramPacket1 = new DatagramPacket(arrayOfByte1, arrayOfByte1.length, datagramPacket.getAddress(), datagramPacket.getPort());
        ...
        D.a("UnknownHostException! Can not listen for broadcast. \n" + unknownHostException.getMessage());
        try {
          Thread.sleep(5000L);
        } catch (InterruptedException interruptedException) {
          Logger.getLogger(c.class.getName()).log(Level.SEVERE, (String)null, interruptedException);
        ...
        D.a("Socket Exception! Can not listen for broadcast. \n" + socketException.getMessage());
        try {
          Thread.sleep(5000L);
        } catch (InterruptedException interruptedException) {
          Logger.getLogger(c.class.getName()).log(Level.SEVERE, (String)null, interruptedException);
