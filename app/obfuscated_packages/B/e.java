...
public class e {
  ...
  public static String l = "CAN_DEVICE_";
  
  public static String m = "DISCOVER_SLAVE_SERVER";
  
  private f q = null;
  
  private String r = l.b;
  ...
  private void a(String paramString1, String paramString2, List paramList, bT parambT) {
    for (o o : this.n)
      o.a(paramString1, paramString2, paramList, parambT); 
  }
  ...
  private void a(String paramString1, String paramString2) {
    ...
    if (hashMap.get(c) != null && !((String)hashMap.get(c)).isEmpty())
      str1 = str1 + " - " + (String)hashMap.get(c); 
    ...
    String str6 = l.a + ":" + this.r;
    ArrayList<c> arrayList = new ArrayList();
    c c = new c(l.j, paramString1);
    arrayList.add(c);
    c = new c(l.k, str4);
    arrayList.add(c);
    ...
    if (!this.o.isEmpty()) {
      ...
      if (i.j() == null)
        i.g((String)hashMap.get(c)); 
      i.b(paramString1);
      i.h(paramString1);
      if (hashMap.get(g) == null) {
        i.c("TCP");
      } else {
        i.c((String)hashMap.get(g));
      } 
      ...
      for (byte b1 = 1; hashMap.containsKey(l + b1 + "_" + b); b1++) {
        ...
        try {
          ...
          D.c("Unable to get port from: " + (String)hashMap.get(str + f));
        } 
        try {
    ...
    for (byte b = 1; hashMap.containsKey(l + b + "_" + b); b++) {
      String str = l + b + "_";
      str1 = (String)hashMap.get(a);
      if (hashMap.get(str + c) != null && !((String)hashMap.get(str + c)).isEmpty())
        str1 = str1 + " - " + (String)hashMap.get(str + c); 
      str1 = str1 + " IP:" + paramString1;
      ...
      c = new c(l.j, paramString1);
      arrayList.add(c);
      c = new c(l.k, hashMap.getOrDefault(str + f, "-1"));
      arrayList.add(c);
      try {
