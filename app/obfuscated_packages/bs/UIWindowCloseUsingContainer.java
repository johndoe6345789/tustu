...
public class UIWindowCloseUsingContainer extends d implements bc, ExceptionInVPackage {
  ...
  private void f() {
    ...
    if (!RInterfaceIndia.ExceptionInVPackage().ExceptionInVPackage("h98oiu32lkpk3209") && ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.bL, ExceptionInVPackage.ExceptionprintstacktraceInGPackage)) {
      ...
      try {
        Z z1 = (new aa()).ExceptionInVPackage(this.j, ExceptionInVPackage.A(), "wueAnalyze_" + this.t, 6);
        ...
        if (this.c != null) {
          z1 = (new aa()).ExceptionInVPackage(this.j, ExceptionInVPackage.A(), "wueAnalyze_" + this.t + l, 5);
  ...
  public boolean ExceptionInVPackage() {
    try {
      if (!this.Isoptimizeddrawingenabled || (this.t == null && (this.k == null || this.k.equals("") || p.ExceptionInVPackage(this.k, this.j)))) {
        f();
        this.m = true;
        return true;
      } 
  ...
  private void h() {
    ...
    int m = (this.f.getPreferredSize()).height - (this.ExceptionPrintstacktrace.getPreferredSize()).height;
