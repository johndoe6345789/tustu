...
public class f implements bO {
  ...
  public f(String paramString, aT paramaT) {
    this.k = paramaT;
    this.l = paramString;
  }
  ...
  public int a(v paramv) {
    ...
    try {
      ...
      byte[] arrayOfByte3 = g.a(arrayOfByte2);
      ...
      byte[] arrayOfByte6 = b(arrayOfByte4);
      arrayOfByte6 = a(arrayOfByte6);
      byte[] arrayOfByte7 = g.a(arrayOfByte6);
      int j;
  ...
  private byte[] b(byte[] paramArrayOfbyte) {
    d();
    System.arraycopy(this.f, 0, paramArrayOfbyte, this.b, this.f.length);
    byte[] arrayOfByte = new byte[55];
    for (byte b = 0; b < arrayOfByte.length; b++)
      arrayOfByte[b] = paramArrayOfbyte[b]; 
    return arrayOfByte;
  ...
  private byte[] a(int paramInt) {
    ...
    for (byte b = 0; b < arrayOfByte.length; b++)
      arrayOfByte[b] = (byte)(int)(254.0D * Math.random() + 1.0D); 
    return arrayOfByte;
  }
