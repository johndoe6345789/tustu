...
public class b implements f, j {
  ...
  public boolean a(String paramString1, String paramString2) {
    if (paramString1.equals("startPlayback")) {
      ...
      if (arrayOfString2 != null && arrayOfString2.length > 0 && arrayOfString2[0].equals(arrayOfString1[0])) {
        ...
        try {
          ...
          D.c("PIPE_ACTION_START_PLAYBACK: failed to set playback speed: " + paramString2);
        } 
        hx.a().e();
        this.b = false;
      } else {
        D.c("PIPE_ACTION_START_PLAYBACK: Wrong File open");
      } 
      return true;
    } 
    if (paramString1.equals("stopPlayback")) {
      ...
      if (arrayOfString2 != null && arrayOfString2.length > 0 && arrayOfString2[0].equals(arrayOfString1[0])) {
        ...
        D.c("PIPE_ACTION_STOP_PLAYBACK: Wrong File open");
      } 
      return true;
    } 
    return false;
  ...
  public void a() {
    if (!this.b) {
      ...
      double d = hx.a().i();
      i.a().a("startPlayback", arrayOfString[0] + "|" + d);
    } 
  }
  ...
  public void b() {
    if (!this.b) {
      ...
      if (arrayOfString != null)
        i.a().a("stopPlayback", arrayOfString[0]); 
    } 
  }
}
