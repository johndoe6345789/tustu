...
public class ManagerPaint extends d implements bc {
  ...
  public ManagerPaint(R paramR) {
    ...
    boolean bool = JPanelExtensionUsingRemoteFileAccess.PropertiesExtension().PropertiesExtension(",sakfdsimfd09rew");
    ...
    if (!bool) {
      ...
      jMenuBar.add(jMenu);
      JMenuItem jMenuItem = new JMenuItem(SComponentGolf.ThreadedInYPackage("Enable SD File Browsing"));
      jMenu.add(jMenuItem);
    ...
    f f = new f(this);
    if (!bool) {
      JPanelExtensionUsingRemoteFileAccess JPanelExtensionUsingRemoteFileAccess = new JPanelExtensionUsingRemoteFileAccess((RemoteFileAccess)this.c, f);
      ...
      UIRemoteFileAccessClose UIRemoteFileAccessClose = new UIRemoteFileAccessClose((RemoteFileAccess)this.c, f);
