...
public class ExceptionExtensionGetmessage extends Exception {
  ...
  public ExceptionExtensionGetmessage(String paramString, int paramInt1, double paramDouble1, double paramDouble2, int paramInt2, int paramInt3) {
    super(paramString);
    this.a = paramInt1;
    this.c = paramDouble2;
    this.b = paramDouble1;
  ...
  public ExceptionExtensionGetmessage(String paramString, int paramInt, double paramDouble1, double paramDouble2) {
    super(paramString);
    this.a = paramInt;
    this.c = paramDouble2;
    this.b = paramDouble1;
