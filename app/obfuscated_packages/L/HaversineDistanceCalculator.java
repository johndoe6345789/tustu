...
public class HaversineDistanceCalculator {
  public double a(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4) {
    ...
    Double double_3 = Double.valueOf(Math.sin(double_1.doubleValue() / 2.0D) * Math.sin(double_1.doubleValue() / 2.0D) + Math.cos(a(Double.valueOf(paramDouble1)).doubleValue()) * Math.cos(a(Double.valueOf(paramDouble3)).doubleValue()) * Math.sin(double_2.doubleValue() / 2.0D) * Math.sin(double_2.doubleValue() / 2.0D));
    Double double_4 = Double.valueOf(2.0D * Math.atan2(Math.sqrt(double_3.doubleValue()), Math.sqrt(1.0D - double_3.doubleValue())));
