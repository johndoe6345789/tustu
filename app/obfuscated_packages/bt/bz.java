...
class bz implements fz {
  ...
  public boolean a(double paramDouble1, double paramDouble2) {
    if (paramDouble1 > this.a.d.s()) {
      String str1 = this.a.g.getText();
      if (str1.isEmpty())
        str1 = this.a.d.aL(); 
      String str2 = str1 + " " + g.b("value") + " " + paramDouble1 + " " + g.b("is too high.") + "\n" + g.b("Must be less than:") + " " + this.a.d.s();
    ...
    if (paramDouble1 < this.a.d.r()) {
      ...
      if (str1.isEmpty())
        str1 = this.a.d.aL(); 
      String str2 = str1 + " " + g.b("value") + " " + paramDouble1 + " " + g.b("is too low.") + "\n" + g.b("Must be greater than:") + " " + this.a.d.r();
  ...
  public boolean b(double paramDouble1, double paramDouble2) {
    if (paramDouble1 > this.a.c.s()) {
      ...
      if (str1.isEmpty())
        str1 = this.a.c.aL(); 
      String str2 = str1 + " " + g.b("value") + " " + paramDouble1 + " " + g.b("is too high.") + "\n" + g.b("Must be less than:") + " " + this.a.c.s();
    ...
    if (paramDouble1 < this.a.c.r()) {
      ...
      if (str1.isEmpty())
        str1 = this.a.c.aL(); 
      String str2 = str1 + " " + g.b("value") + " " + paramDouble1 + " " + g.b("is too low.") + "\n" + g.b("Must be greater than:") + " " + this.a.c.r();
