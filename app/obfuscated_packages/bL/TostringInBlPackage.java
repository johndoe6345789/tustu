...
public class TostringInBlPackage {
  ...
  public void b(String paramString) {
    if (paramString != null && !paramString.equals(""))
      a(Double.parseDouble(paramString)); 
  }
  
  public void a(double paramDouble) {
    this.e = paramDouble;
    if (this.h != null)
      this.h.a(g(), paramDouble + ""); 
  }
  ...
  public void c(String paramString) {
    this.c = paramString;
    if (this.h != null)
      this.h.a(g(), paramString + ""); 
  }
  
  public String a() {
    return (this.g != null && !this.g.equals("")) ? this.g : ((this.f == 128) ? this.c : ((this.b != null) ? this.b : "Undefined"));
  }
