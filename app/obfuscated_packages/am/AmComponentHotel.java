...
public class AmComponentHotel extends a {
  ...
  public AmComponentHotel(SeekableByteChannel paramSeekableByteChannel) {
  ...
  public String toString() {
    return "HDBLOCK [lnkDgFirst=" + this.c + ", lnkFhFirst=" + this.AbstractInAlPackage + ", lnkChFirst=" + this.e + ", lnkAtFirst=" + this.f + ", lnkEvFirst=" + this.g + ", lnkMdComment=" + this.h + ", startTimeNs=" + this.i + ", tzOffsetMin=" + this.j + ", dstOffsetMin=" + this.k + ", timeFlags=" + this.l + ", timeClass=" + this.m + ", flags=" + this.n + ", startAngleRad=" + this.o + ", startDistanceM=" + this.p + "]";
  }
  ...
  public static h a(SeekableByteChannel paramSeekableByteChannel) {
    ...
    byteBuffer.rewind();
    h1.a(AbstractInAlPackage.a(byteBuffer, 4));
    if (!h1.b().equals(b))
      throw new IOException("Wrong block type - expected '" + b + "', found '" + h1.b() + "'"); 
    byteBuffer.get(new byte[4]);
    h1.a(AbstractInAlPackage.e(byteBuffer));
    h1.b(AbstractInAlPackage.e(byteBuffer));
    h1.c(AbstractInAlPackage.g(byteBuffer));
    h1.AbstractInAlPackage(AbstractInAlPackage.g(byteBuffer));
    h1.e(AbstractInAlPackage.g(byteBuffer));
    h1.f(AbstractInAlPackage.g(byteBuffer));
    h1.g(AbstractInAlPackage.g(byteBuffer));
    h1.h(AbstractInAlPackage.g(byteBuffer));
    h1.i(AbstractInAlPackage.e(byteBuffer));
    h1.a(AbstractInAlPackage.c(byteBuffer));
    h1.b(AbstractInAlPackage.c(byteBuffer));
    h1.a(AbstractInAlPackage.a(byteBuffer));
    h1.b(AbstractInAlPackage.a(byteBuffer));
    h1.c(AbstractInAlPackage.a(byteBuffer));
    if (h1.e() != 0)
      throw new IOException("HDBLOCK hd_flags!=0 not yet supported"); 
    byteBuffer.get();
    h1.a(AbstractInAlPackage.f(byteBuffer));
    h1.b(AbstractInAlPackage.f(byteBuffer));
    return h1;
  }
}
