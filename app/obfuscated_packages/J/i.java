...
public class i extends h implements cr, Serializable {
  public static String b = "protocolError";
  
  protected String[] c = new String[] { 
      "okCount", "runtimeDataCount", "pageReadCount", "configErrorCount", "burnOk", "pageTenOk", "underrunCount", "overrunCount", "unrecognizedCommand", "remoteCrcFailureCount", 
      "busyCount", "outOfRangeCount", "flashLockedCount", "pcCrcFailureCount", "undefinedErrorCount", "parityErrorCount", "framingErrorCount", "serialNoiseErrorCount", "txmodeErrorCount", "unknownErrorCount", 
      "sequenceFailure1", "sequenceFailure2", "canQueueFull", "canTimeout", "canFailure", "canData", "protocolError", "canDeviceUnavailable", "genericError", "criticalError" };
