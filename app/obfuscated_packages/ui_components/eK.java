...
public class eK extends JDialog implements a, a {
  hZ a = null;
  ...
  public eK(hW paramhW, hY paramhY1, hY paramhY2, n paramn, Frame paramFrame, String paramString) {
    ...
    this.d = new hV();
    if (paramn.a("Load") != null)
      this.x = "Load"; 
    this.x = i.a("yAxisField", g.a().a(g.j));
    ...
    jPanel2.add("North", (Component)this.a);
    ...
    String[] arrayOfString = hQ.a(paramhW);
    boolean bool1 = hQ.a(arrayOfString, fq, new fk(this));
    boolean bool2 = hQ.a(arrayOfString, fq, new fl(this));
    if (bool2 && !bool1)
      g.a().a(g.h, g.a().a(g.i)); 
    fq.c(this.g.z());
    ...
    this.o.setMinimum(0);
    this.o.setMaximum(9);
    this.o.setValue(i.a("WBafrOffSet", 2));
    ...
    this.o.setEnabled(b.a().a("advancedVeAnalyze"));
    ...
    jComboBox.setEnabled(b.a().a("advancedVeAnalyze"));
    ...
    JButton jButton5 = new JButton("Min RPM: " + i.a("veAnalysisMinRPM", "500"));
    ...
    jButton5 = new JButton("Max RPM: " + i.a("veAnalysisMaxRPM", "18000"));
    ...
    jPanel14.add(jButton5);
    this.u = i.a("veAnalyzeYAxisKeyMin", "0");
    jButton5 = new JButton("Min " + this.x + ": " + this.u);
    jButton5.setToolTipText("<html>Log entries with " + this.x + " below this value will be<br>filtered and not included in VE Analysis.<br>Used to perform VE Analyze on part of a log file.<br>Leave at 0 for whole log file</html>");
    jButton5.addActionListener(new eV(this));
    jPanel14.add(jButton5);
    this.v = i.a("veAnalyzeYAxisKeyMax", "600");
    jButton5 = new JButton("Max " + this.x + ": " + this.v);
    jButton5.setToolTipText("<html>Log entries with " + this.x + " greater than this will be<br>filtered and not included in VE Analysis.<br>Used to perform VE Analyze on part of a VE table.<br>Leave at number higher than maximum for whole log file.</html>");
    jButton5.addActionListener(new eX(this));
    jPanel14.add(jButton5);
    jButton5 = new JButton("Min Time: Log Start");
    jButton5.setToolTipText("<html>Log entries with Time before that this will be<br>filtered and not included in VE Analysis.<br>Used to perform VE Analyze on part of a VE table.<br>Leave at 0.0 for whole log file</html>");
    jButton5.addActionListener(new eY(this));
    this.n.add(jButton5);
    jButton5 = new JButton("Max Time: Log End");
    jButton5.setToolTipText("<html>Log entries with Time after this will be<br>filtered and not included in VE Analysis.<br>Used to perform VE Analyze on part of a log file.<br>Leave at number higher than maximum Time for whole log file.</html>");
    jButton5.addActionListener(new eZ(this));
    this.n.add(jButton5);
    String str2 = g.a().a(g.c);
    ...
    jButton5.setEnabled(b.a().a("advancedVeAnalyze"));
    if (b.a().a("advancedVeAnalyze")) {
    ...
    a(i.a("showVeAnalyzeAdvanced", false));
  ...
  private JMenuBar d() {
    ...
    jCheckBoxMenuItem1.setState(i.a("veAnalysisDisableOverrunFilter", false));
    ...
    jCheckBoxMenuItem2.setState(i.a("veAnalysisBit6Bit7Filter", false));
    ...
    jCheckBoxMenuItem3.setState(i.a(i.aG, i.aH));
  ...
  public void a(boolean paramBoolean) {
    if (paramBoolean) {
      this.p.a("Hide Advanced Settings");
    } else {
      this.p.a("Advanced Settings");
    } 
  ...
  protected void a(JButton paramJButton) {
    String str = k.a("{New Min RPM}", true, "Log Records with RPM below this valuewill be filtered from VE Analysis.", true, this);
  ...
  protected void b(JButton paramJButton) {
    String str = k.a("{New Max RPM}", true, "Log Records with RPM above this value will be filtered from VE Analysis.", true, this);
    if (str == null || str.equals(""))
      return; 
  ...
  protected void c(JButton paramJButton) {
    String str1 = g.a().a("Time");
    String str2 = k.a("{New Min " + str1 + "}", true, "Log Records with " + str1 + " before this valuewill be filtered from VE Analysis.", true, this);
  ...
  protected void d(JButton paramJButton) {
    String str1 = g.a().a("Time");
    String str2 = k.a("{New Max Time}", true, "Log Records with Time after this value will be filtered from VE Analysis.", true, this);
    if (str2 == null || str2.equals(""))
      return; 
    this.t = str2;
  ...
  protected void e(JButton paramJButton) {
    String str = k.a("{New Min " + this.x + "}", true, "Log Records with " + this.x + " below this valuewill be filtered from VE Analysis.", true, this);
    if (str == null || str.equals(""))
      return; 
    this.u = str;
  ...
  protected void f(JButton paramJButton) {
    String str = k.a("{New Max " + this.x + "}", true, "Log Records with " + this.x + " greater than this value will be filtered from VE Analysis.", true, this);
    if (str == null || str.equals(""))
      return; 
    this.v = str;
  ...
  protected void g(JButton paramJButton) {
    String str1 = g.a().a(g.c);
    String str2 = k.a("{New Minimum " + str1 + " (Coolant temperature)}", true, "Log Records with " + str1 + " less than this value\nwill be filtered from VE Analysis. Fuel enrichments during engine warm up \nwill negatively impact results. Air cooled or other special setups may need to \nlower this, otherwise normally 160" + T.a() + "F to 180" + T.a() + "F or 71" + T.a() + "C to 82" + T.a() + "C", true, this);
    if (str2 == null || str2.equals(""))
      return; 
  ...
  public void b(String paramString) {
    if (this.h.b(paramString) != null)
      this.f = this.h.b(paramString); 
    if (paramString.equals(this.g.z()))
      this.f = this.g; 
    a(this.f.z(), this.f);
    this.a.b("Ve: " + this.e.z());
    this.a.a("<html>Perform Analysis on <b>" + this.e.z() + "</b>, using AFR table: <b>" + this.f.z() + "</b><html>");
  }
  ...
  private void e() {
    ...
    try {
      s s = null;
      if (b.a().a("advancedVeAnalyze"))
        s = bQ.a().a(this.a.g(), this.a.getName()); 
      this.d.a(this.e, this.f, s, this.l, b, this.j, this.k, arrayOfE);
    } catch (h h) {
      k.a(h.getMessage(), this);
    } catch (g g) {
      k.a(g.getMessage(), this);
      Logger.getLogger(eK.class.getName()).log(Level.WARNING, "Failed to get Lambda Delay Table", (Throwable)g);
    } 
  }
  
  public void a(b[][] paramArrayOfb, int paramInt1, int paramInt2) {
    if (paramInt1 % 50 == 0 || paramInt1 == paramInt2)
      this.b.b(paramInt1 / paramInt2); 
    this.a.h().m();
  }
  
  public void a(b[][] paramArrayOfb, hY paramhY, int paramInt) {
    this.a.repaint();
    ...
    str = str + "Filtered log records: " + paramInt + " (" + k.a(d1) + "&#37;)<br>";
    ...
    str = str + "Cells Analyzed: " + b2 + " (" + k.a(d5) + "&#37;)<br>";
    str = str + "Average cell weight: " + k.a(d3) + "<br>";
    str = str + "Cell values altered more than " + numberFormat.format(d4) + " : " + b1 + " (" + k.a(d6) + "&#37;)<br>";
  ...
  public void a(h paramh) {
    k.a(paramh.getMessage(), this);
    paramh.printStackTrace();
  }
  
  public void a(hY paramhY) {
    this.a.h().setModel((TableModel)paramhY);
    paramhY.q();
  }
  ...
  private void f() {
    try {
      s s = bQ.a().a(this.a.g(), this.a.getName());
      aP aP = new aP(null, s, this.a.getName());
      a((bc)aP);
      aP.setPreferredSize(new Dimension(eJ.a(290), eJ.a(170)));
      bV.a((Component)aP, this, "Lambda Delay (ms)", (bc)aP);
    } catch (g g) {
  ...
  public E[] a() {
    ...
    e.b(4);
    e.a("RPM");
    e.b(i.a("veAnalysisMinRPM", "500"));
    e.d("Min RPM");
    arrayList.add(e);
    e = new E();
    e.b(2);
    e.a("RPM");
    e.b(i.a("veAnalysisMaxRPM", "18000"));
    e.d("Max RPM");
    arrayList.add(e);
    e = new E();
    e.b(32);
    ...
    arrayList.add(e);
    if (!i.a("veAnalysisBit6Bit7Filter", false)) {
      e = new E();
      e.b(32);
      e.a("Engine");
      e.a(64);
    ...
    e.d("Max " + this.x);
    arrayList.add(e);
    if (!i.a("veAnalysisDisableOverrunFilter", false)) {
      e = new E();
      str1 = g.a().a(g.g);
      e.b(1);
      e.a(str1);
    ...
    if (!X.c(str3) && str3.toLowerCase().contains("lambda") && this.l.a(str3) != null) {
      e = new E();
      e.b(64);
    ...
    e.d("No O2 Reading");
    arrayList.add(e);
    if (this.l.a("Engine") != null && !i.a("veAnalysisBit6Bit7Filter", false)) {
      e = new E();
      e.b(64);
  ...
  public void a(int paramInt) {
    if (this.l == null || !isVisible() || this.a == null || !this.a.isVisible())
      return; 
    String str1 = "";
    String str2 = "";
    try {
      str1 = Float.toString(this.l.a(this.e.v()).d(paramInt));
      str2 = Float.toString(this.l.a(this.e.w()).d(paramInt));
      this.a.h().a(str1, str2);
      if (this.i != null) {
        BinTableView binTableView = this.i.h();
        try {
          str1 = Float.toString(this.l.a(this.i.g().v()).d(paramInt));
          str2 = Float.toString(this.l.a(this.i.g().w()).d(paramInt));
        } catch (Exception exception) {}
        binTableView.a(str1, str2);
      } 
    } catch (Exception exception) {
  ...
  public void a(String paramString, hY paramhY) {
    ...
    this.i.a(paramhY);
    this.i.h().getTableHeader().setToolTipText("RPM");
  ...
  private String b(n paramn) {
    ...
    return (paramn.a(str3) != null) ? str3 : ((paramn.a(str2) != null) ? str2 : ((this.l.a(str1) != null) ? str1 : ((this.l.a("Lambda") != null) ? "Lambda" : ((this.l.a(str4) != null) ? str4 : ""))));
  }
  
  private String h() {
    return i.e(i.ad, g.a().a(g.e));
  }
  
  private String i() {
    return i.a("veAnalysisMaxValChange", "50");
  }
  
  private void i(JButton paramJButton) {
    String str = k.a("{New Maximum Cell Value Change}", true, "This is the most a cell will be changed in valuefrom the starting value", true, this);
    if (str == null || str.equals(""))
      return; 
  ...
  private String j() {
    return i.a("veAnalysisMaxPercentChange", "50");
  }
  
  private void j(JButton paramJButton) {
    String str = k.a("{New Maximum Cell Percent Change}", true, "This is the most a cell will be changed in percent from the starting value", true, this);
    if (str == null || str.equals(""))
      return; 
