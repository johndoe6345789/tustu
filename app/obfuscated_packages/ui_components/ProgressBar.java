...
public class ap extends JComponent {
  ...
  public ap(String paramString, Image paramImage, Dimension paramDimension1, Dimension paramDimension2) {
  ...
  public void paint(Graphics paramGraphics) {
    ...
    if (this.o != null)
      if (this.a != null) {
        i = (this.s == null) ? (((getSize()).height - this.o.getHeight(null) - getFontMetrics(getFont()).getHeight()) / 2) : (((getSize()).height - this.s.height - getFontMetrics(getFont()).getHeight()) / 2);
      } else {
        i = (this.s == null) ? (((getSize()).height - this.o.getHeight(null)) / 2) : (((getSize()).height - this.s.height) / 2);
      }  
    int j = (this.o != null) ? ((getSize()).height - getFontMetrics(getFont()).getHeight() / 3) : (((getSize()).height + getFontMetrics(getFont()).getHeight() / 2) / 2 + 1);
    ...
    if (this.i) {
      ...
      if (this.o != null)
        if (this.s == null) {
          paramGraphics.drawImage(this.o, ((getSize()).width - this.o.getWidth(null)) / 2 + 1, i + 1, this);
        } else {
          paramGraphics.drawImage(this.o, ((getSize()).width - this.s.width) / 2 + 1, i + 1, this.s.width, this.s.height, this);
        }  
      paramGraphics.setColor(UIManager.getColor("Button.foreground"));
      if (this.a != null)
        paramGraphics.drawString(this.a, this.u, j); 
      if (this.h != null)
        a(paramGraphics, 0); 
    } else if (this.j) {
      paramGraphics.setColor(Color.lightGray);
      ...
      paramGraphics.setColor(UIManager.getColor("Button.foreground"));
      if (this.a != null)
        paramGraphics.drawString(this.a, this.u - 1, j - 1); 
      if (this.o != null)
        if (this.s == null) {
          paramGraphics.drawImage(this.o, ((getSize()).width - this.o.getWidth(null)) / 2, i, this);
        } else {
          paramGraphics.drawImage(this.o, ((getSize()).width - this.s.width) / 2, i, this.s.width, this.s.height, this);
        }  
      if (this.h != null)
        a(paramGraphics, -1); 
    } else {
  ...
  private void a(Graphics paramGraphics, int paramInt) {
    ...
    paramGraphics.fillRect(getWidth() - this.v - 2 + paramInt, (getHeight() - this.v) / 2 + paramInt, this.v, this.v);
  }
  ...
  private int c() {
    return (this.a == null) ? 0 : (this.w ? (((getSize()).width - getFontMetrics(getFont()).stringWidth(this.a)) / 2) : 4);
  }
  
  public void validate() {
    if (this.m && !isValid() && this.p != null)
      this.p = b(); 
    super.validate();
    if (!this.k)
  ...
  public void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (this.m && this.p != null && this.r != null && (this.r.width < (getLocation()).x + (getSize()).width || this.r.height < (getLocation()).y + (getSize()).height))
      this.p = b(); 
  }
