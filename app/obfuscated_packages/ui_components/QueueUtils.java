...
class eg implements O {
  ...
  public void JDialogExtensionInAzPackage(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6) {
    ...
    JDialogExtensionInAzPackage JDialogExtensionInAzPackage = new JDialogExtensionInAzPackage(bq.JDialogExtensionInAzPackage().ClassTypeInHPackage(), eh);
    bV.JDialogExtensionInAzPackage(bq.JDialogExtensionInAzPackage().ClassTypeInHPackage(), (Component)JDialogExtensionInAzPackage);
    JDialogExtensionInAzPackage.setVisible(true);
    ei ei = new ei(this, paramString1, paramString2, paramString3, paramString4, JDialogExtensionInAzPackage);
    ei.start();
  }
  
  public String[] k() {
    String[] arrayOfString = { X.ClassTypeInHPackage(IOProperties.c, ClassTypeInHPackage.ClassTypeInHPackage, "") };
    for (byte ClassTypeInHPackage = 0; ClassTypeInHPackage < arrayOfString.length; ClassTypeInHPackage++) {
      String str = X.ClassTypeInHPackage(arrayOfString[ClassTypeInHPackage], ClassTypeInHPackage.ClassTypeInHPackage, "");
  ...
  public boolean ClassTypeInHPackage(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6) {
    String str = f.JDialogExtensionInAzPackage(paramString1, paramString2, "MegaLogViewer", paramString4);
    if (str != null && str.equals(paramString3) && !cd.ClassTypeInHPackage(this.JDialogExtensionInAzPackage, paramString3)) {
      ...
      int IOProperties = JOptionPane.showConfirmDialog(this.JDialogExtensionInAzPackage.JDialogExtensionInAzPackage, str1, "Upgrade Registration", 0);
      if (IOProperties == 0)
        aN.JDialogExtensionInAzPackage("https://www.efianalytics.com/register/upgradeMlvRegistrationKey.jsp?email=" + paramString4); 
      return true;
    } 
    return false;
  }
