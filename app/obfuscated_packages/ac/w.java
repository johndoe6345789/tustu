...
public abstract class w {
  ...
  public static byte[] a(byte[] paramArrayOfbyte, String paramString) {
    ...
    try {
      ...
      if (arrayOfByte.length > paramArrayOfbyte.length)
        D.c("String too large for buffer! Will truncate. buffer size: " + paramArrayOfbyte.length + ", string len: " + arrayOfByte.length + ", string val: " + paramString); 
      int i = (arrayOfByte.length <= paramArrayOfbyte.length) ? arrayOfByte.length : paramArrayOfbyte.length;
      System.arraycopy(arrayOfByte, 0, paramArrayOfbyte, 0, i);
      if (i < paramArrayOfbyte.length)
        System.arraycopy(B, 0, paramArrayOfbyte, i, B.length); 
  ...
  public int m() {
    return (this.a == c || this.a == d || this.a == s) ? 1 : ((this.a == e || this.a == f || this.a == l || this.a == m || this.a == t) ? 2 : ((this.a == g || this.a == h || this.a == u || this.a == j) ? 4 : ((this.a == i) ? 8 : 0)));
  }
