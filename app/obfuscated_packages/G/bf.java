...
public class bf extends Q implements Serializable {
  ...
  public void a(String paramString) {
    try {
      ...
      Logger.getLogger(bf.class.getName()).log(Level.SEVERE, "Unable to set TuningView", iOException);
    } 
  }
