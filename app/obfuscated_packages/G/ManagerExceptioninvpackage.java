...
public class ManagerExceptioninvpackage implements S {
  ...
  public void ExceptionInVPackage(aM paramaM, R paramR, String paramString) {
    if (paramaM == null)
      throw new ExceptionPrintstacktrace("EcuPrameter not optional."); 
  ...
  public void b(R paramR) {
    for (aO aO : ExceptionInVPackage(paramR.c()))
      aR.ExceptionInVPackage().ExceptionInVPackage(aO); 
    ...
    for (aO aO : arrayList) {
      ...
      for (String str : arrayOfString) {
        try {
          ...
          Logger.getLogger(aQ.class.getName()).log(Level.SEVERE, (String)null, (Throwable)ExceptionInVPackage);
        } 
      } 
