...
public class d extends JPanel implements TableModelListener {
  D a = null;
  ...
  public d(y paramy) {
    ...
    if (bool) {
      ...
      this.b.setPreferredSize(new Dimension(this.a.g(), 0));
  ...
  public Dimension c(int paramInt) {
    byte b1 = (!d() || this.a.h().f()) ? 0 : (this.g.getPreferredSize()).height;
    byte b2 = (d() && this.a.h().f()) ? (this.g.getPreferredSize()).width : 0;
  ...
  public Dimension getPreferredSize() {
    ...
    if (this.a.h().f())
      i = Math.max((this.g.getPreferredSize()).height, i); 
  ...
  public void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    if (this.a != null && paramInt3 > 0 && paramInt4 > 0) {
      if (Math.abs(paramInt4 - this.n) > 3 || this.o != paramInt3) {
        this.n = paramInt4;
        byte b1 = (this.a.h().f() || !this.g.isVisible()) ? 0 : (this.g.getPreferredSize()).height;
        byte b2 = (this.a.h().f() && this.g.isVisible()) ? (this.g.getPreferredSize()).width : 0;
  ...
  public void a(ef[] paramArrayOfef) {
    if (!b(paramArrayOfef)) {
      ...
      for (ef ef1 : paramArrayOfef) {
        int i1;
        int i2;
        int i3 = this.a.h().g() ? (ef1.a() + 1) : ef1.a();
        if (this.a.h().f()) {
          i2 = i3;
          i1 = ef1.b();
        } else {
  ...
  private List k() {
    ...
    for (byte b = 0; b < arrayOfInt1.length; b++) {
      for (byte b1 = 0; b1 < arrayOfInt2.length; b1++) {
        ...
        if ((!this.a.h().g() || r.a() != 0) && (!this.a.h().h() || r.a() != this.a.h().a() - 1))
          if (this.a.h().g()) {
            r.a(r.a() - 1);
            arrayList.add(r);
          } else {
