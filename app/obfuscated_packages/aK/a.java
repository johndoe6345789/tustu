...
public class a implements g {
    ...
    if (str.equals("$GPGGA") || str.equals("$GNGGA")) {
      ...
      if (str6 != null && !str6.equals("") && !str6.equals("0")) {
        ...
        if (str4 != null && !str4.equals(""))
          this.d.b(b(str4, str5)); 
        if (str8 != null && !str8.equals(""))
          this.d.c(Float.parseFloat(str8) * this.l); 
        if (str9 != null && !str9.equals(""))
          this.d.c(Double.parseDouble(str9)); 
      ...
      if (str2 != null && !str2.equals("") && str2.equals("A")) {
        ...
        if (str3 != null && !str3.equals(""))
          this.d.a(a(str3, str4)); 
        if (str5 != null && !str5.equals(""))
          this.d.b(b(str5, str6)); 
        if (str7 != null && !str7.equals(""))
          this.d.a(c(str7, "N")); 
        if (str8 != null && !str8.equals(""))
          this.d.b(Float.parseFloat(str8)); 
        this.o = true;
        if (this.n && this.o)
          a(this.d); 
  ...
  private SimpleDateFormat i() {
    if (this.f == null) {
      this.f = new SimpleDateFormat("HHmmss.SSS");
  ...
  private long b(String paramString) {
    ...
    try {
      if (paramString != null && paramString != null) {
        ...
        long l3 = simpleDateFormat.parse(String.format((Locale)null, "%010.3f", new Object[] { Double.valueOf(Double.parseDouble(paramString)) })).getTime();
        long l4 = l2 + l3;
        if (l4 - l1 > 43200000L) {
          l = l4 - 86400000L;
  ...
  private void a(int paramInt, HashMap paramHashMap, long paramLong) {
    ...
    synchronized (this.s) {
      for (g g1 : this.s)
        g1.a(this.k, paramInt, paramHashMap); 
    } 
    if (this.m != paramInt) {
      this.d = new f(this.k);
      this.m = paramInt;
  ...
  private void c(String paramString) {
    if (J.I()) {
      if (this.v == null) {
        File file = new File(j.A(), "NEMA_Log.txt");
        if (file.exists())
          file.delete(); 
        try {
          file.createNewFile();
