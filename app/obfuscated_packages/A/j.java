...
public class j {
  ...
  private void b(List<x> paramList) {
    ...
    for (byte b = 0; b < paramList.size() && !e; b++) {
      x x = paramList.get(b);
      f f = x.d();
      if (f == null) {
        D.b("Null ControllerInterface for searchInterface, skippings");
      } else {
        for (String str1 : ((x)paramList.get(b)).b()) {
          String str2 = (String)((x)paramList.get(b)).b(str1).get(0);
          try {
            f.a(str1, str2);
          } catch (s s) {
        ...
        List<String> list1 = ((x)paramList.get(b)).b();
        byte b1;
        for (b1 = 0; b1 < list1.size() && !e; b1++) {
          String str = list1.get(b1);
          for (Object object : ((x)paramList.get(b)).b(str)) {
            try {
              f.a(str, object);
            } catch (s s) {
            ...
            if (list1.size() > 1) {
              for (String str1 : ((x)paramList.get(b)).b()) {
                for (String str2 : ((x)paramList.get(b)).b(str1)) {
                  if (str2 != null && !str1.equals(str) && !this.l.contains(object.toString() + str2) && !this.l.contains(str2.toString() + object)) {
                    try {
                      f.a(str1, str2);
                    } catch (s s) {
                      D.d("Invalid Search Setting: " + str1 + "=" + str2 + ", " + s.getLocalizedMessage());
        ...
        a(x);
        for (b1 = 0; this.q && paramList.size() - 1 == b; b1 = 1) {
          try {
        ...
        if (b1 != 0 && paramList.size() > b + 1)
          this.i += ((x)paramList.get(b + 1)).c(); 
      } 
    } 
    if (!this.h) {
      e();
    ...
    if (this.s == null || !this.s.c(paramObject2.toString())) {
      if (!a(paramx, paramf)) {
        ...
        try {
          ...
          if (this.s != null)
            this.s.b(paramObject1.toString()); 
        } 
        if (bT != null && bT.b() != null && !bT.b().equals("")) {
          this.g++;
  ...
  private void b(x paramx, f paramf) {
    for (String str : paramx.a()) {
