  ...
  private void a(String paramString1, String paramString2) {
    ...
    if (i == 1) {
      ...
      for (byte b = 0; b <= j; b++) {
        ...
        if (this.h && paramString1.charAt(b) == '"')
      ...
      int k = 0;
      int m;
      for (m = paramString1.indexOf(paramString2, k); m != -1; m = paramString1.indexOf(paramString2, k)) {
        String str = paramString1.substring(k, m);
        if (!this.g || !str.trim().isEmpty())
          this.c.add(str); 
        k = m + i;
      } 
      if (m < paramString1.length())
        this.c.add(paramString1.substring(k, j)); 
    } 
    this.d = true;
  }
