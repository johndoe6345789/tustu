...
public class ThreadExtensionInGPackage extends Thread {
  ...
  private void KInterfaceAlpha(ArrayList paramArrayList) {
    ...
    while (iterator.hasNext())
      ((KInterfaceAlpha)iterator.next()).KInterfaceAlpha(paramArrayList); 
  }
  ...
  private boolean BbInterfaceCharlie(ArrayList paramArrayList, String paramString) {
    try {
      ...
      while (iterator.hasNext()) {
        if (((j)iterator.next()).KInterfaceAlpha().equals(paramString))
          return true; 
      } 
    } catch (Exception exception) {
  ...
  public n b(String[] paramArrayOfString) {
    ...
    for (byte b1 = 0; b1 < paramArrayOfString.length; b1++) {
      ...
      if (b1 > 0) {
        ...
        n1.KInterfaceAlpha(n1.ZInterfaceDelta() - 1, "begining of " + str + ", Time will be inconsistent");
      } else {
      ...
      try {
        while (!this.e) {
          ...
          if (Runtime.getRuntime().freeMemory() < 800L) {
            ...
            if (k.KInterfaceAlpha()) {
              bV.ZInterfaceDelta("Low Application Memory!\nYour available system memory is running low.", new Frame());
              break;
            } 
            bV.ZInterfaceDelta("Low Application Memory!\nTo load large files on KInterfaceAlpha capable computer, start application with memory parameters.\nExample Command line:\njava -Xms256m -Xmx1024m -jar " + KInterfaceAlpha(i.b, " ", "") + ".jar", new Frame());
            break;
          } 
          boolean bool1 = false;
          ...
          if (arrayList.isEmpty() || !b3) {
            if (b1 == 0) {
              ...
              while (iterator.hasNext()) {
                ...
                if (!Float.isNaN(t.VInterfaceHotel()) && !Float.isNaN(t.i()) && t.VInterfaceHotel() < t.i()) {
              ...
              D.ZInterfaceDelta("Opening Log, expected size: Field Count: " + arrayList.size() + ", Records: " + v.ZInterfaceDelta());
              boolean bool2 = (VInterfaceHotel.b.KInterfaceAlpha().KInterfaceAlpha("fieldNameNormalization") && i.KInterfaceAlpha("fieldNameNormaization", true)) ? true : false;
              for (j j : arrayList) {
                String str1 = j.KInterfaceAlpha();
                String str2 = Z.b.KInterfaceAlpha().KInterfaceAlpha(str1);
                if (bool2 && str2 != null && !str2.isEmpty() && !str2.equals(str1) && !KInterfaceAlpha(str2, arrayList)) {
              ...
              for (j j : arrayList) {
                ...
                if (n1.KInterfaceAlpha(j.KInterfaceAlpha()) == null) {
                  ...
                  if (j.j() != null && j.j().indexOf(AkGolfImpl.KInterfaceAlpha(AkGolfImpl.b)) != -1) {
                    if (j.KInterfaceAlpha().equals("AFR") && n1.KInterfaceAlpha(AkGolfImpl.KInterfaceAlpha(AkGolfImpl.b)) == null)
                    ...
                    if (j.KInterfaceAlpha().equalsIgnoreCase(AkGolfImpl.KInterfaceAlpha("Lambda")) && n1.KInterfaceAlpha(AkGolfImpl.KInterfaceAlpha(AkGolfImpl.b)) == null) {
                      if (n1.KInterfaceAlpha("afr") != null) {
              ...
              if (n1.KInterfaceAlpha(AkGolfImpl.KInterfaceAlpha("Lambda")) != null && n1.KInterfaceAlpha(AkGolfImpl.KInterfaceAlpha(AkGolfImpl.VInterfaceHotel)) == null) {
              ...
              while (iterator.hasNext()) {
                ...
                try {
                  if (!j.KInterfaceAlpha().equals(str1) && j.AxInterfaceUniform() != null && !j.AxInterfaceUniform().equals(str1)) {
                    bV.ZInterfaceDelta("File Headers DO NOT Match!!!\nTo load multiple fies they Must have identical field headers.\n" + file.getAbsolutePath() + "\nskipped.", bV.BbInterfaceCharlie());
                    break;
                  } 
                } catch (Exception exception) {
                  bV.ZInterfaceDelta("File Headers DO NOT Match!!!\nTo load multiple fies they Must have identical field headers.\n" + file.getAbsolutePath() + "\nskipped.", bV.BbInterfaceCharlie());
            ...
            try {
              ...
              for (byte b7 = 0; b7 < arrayList.size(); b7++) {
                ...
                if (j.l()) {
                  ...
                  try {
                    ...
                    if (b3 > 1) {
                      ...
                      arrayList.remove(b7);
                      n1.b(j);
                      D.ZInterfaceDelta("unable to calculate field " + j.KInterfaceAlpha() + ", all required variables not present: " + exception.getMessage());
                      b7--;
                    } 
                    f1 = 0.0F;
                    KInterfaceAlpha KInterfaceAlpha = ZInterfaceDelta.KInterfaceAlpha().KInterfaceAlpha(str1);
                    if (bool2 && KInterfaceAlpha != null)
                      D.KInterfaceAlpha("Failed to evaluate the following formula:\n" + KInterfaceAlpha.BbInterfaceCharlie()); 
                  } 
                ...
                if (j.KInterfaceAlpha().equals("Time") && j.x() && !Float.isNaN(f1))
                  j.i(-f1); 
                j.KInterfaceAlpha(f1);
              } 
              if (i.KInterfaceAlpha("timeGapsOn", false) && n1.ZInterfaceDelta() > 3 && b3 > 5 && j1 != null) {
                float f1 = j1.BbInterfaceCharlie(j1.i() - 1) - j1.BbInterfaceCharlie(j1.i() - 2);
                if (f1 > 0.0F)
                  ZInterfaceFoxtrot = (ZInterfaceFoxtrot > 0.0D) ? ((n1.ZInterfaceDelta() * ZInterfaceFoxtrot + f1) / (n1.ZInterfaceDelta() + 1.0F)) : f1; 
                if (f1 > 0.05F && f1 > 2.5D * ZInterfaceFoxtrot) {
                  int j = n1.ZInterfaceDelta() - 2;
                  if (f1 > 5.0F * ZInterfaceFoxtrot)
                    n1.BbInterfaceCharlie(j, "Time gap: no log entries for " + k.KInterfaceAlpha(f1, 2) + " seconds."); 
              ...
              if (b3 > k)
                throw new VInterfaceHotel("The Lite! edition is limited to " + k + " Records. Please Register!"); 
              if (j1 != null)
              ...
              if (b4 && n1.ZInterfaceDelta() > 0)
                for (j j : arrayList)
                  j.b(j.BbInterfaceCharlie(j.i() - 1));  
              n1.KInterfaceAlpha(n1.ZInterfaceDelta() - 1, m.getMessage());
              b4++;
            } catch (ArrayIndexOutOfBoundsException arrayIndexOutOfBoundsException) {
              if (b2++ > 10 && v.e())
                throw new VInterfaceHotel("Error parsing file, too many bad rows found " + b2 + ", discontinuing."); 
            } 
          } 
          b3++;
        } 
        ...
        if (v.AkGolfImpl() != null && !n1.VInterfaceHotel())
          n1.BbInterfaceCharlie(v.AkGolfImpl()); 
        if (v.VInterfaceHotel() != null)
          n1.BbInterfaceCharlie(v.VInterfaceHotel()); 
      } catch (OutOfMemoryError outOfMemoryError) {
        outOfMemoryError.printStackTrace();
        bV.ZInterfaceDelta("Using all allocated Memory, can not load remainder of file.", bV.BbInterfaceCharlie());
        return n1;
      } finally {
        if (n1.ZInterfaceDelta() <= 0) {
          if (i.j()) {
            bV.ZInterfaceDelta("Log File contains no data or is not recognized.\nIf this is an ASCII type log file, \nCheck the selected File Delimiter under the Options Menu.", new Frame());
          } else {
    ...
    System.out.println("File load time =" + ((System.currentTimeMillis() - l) / 1000.0D) + " sec.  " + n1.ZInterfaceDelta() + " rows, Field Count: " + n1.size());
    return n1;
  }
  
  private boolean KInterfaceAlpha(String paramString, List paramList) {
    for (j j : paramList) {
      if (j.KInterfaceAlpha().equals(paramString))
        return true; 
    } 
    return false;
  }
  ...
  private j[] b(ArrayList paramArrayList) {
    ...
    for (i = 0; i < arrayOfString.length; i++) {
      ...
      if (str.length() > "APPEND_FIELD_".length()) {
        ...
        try {
          ...
          if (VInterfaceHotel.b.KInterfaceAlpha().b(j.KInterfaceAlpha()))
            arrayList2.add(j); 
        } catch (Exception exception) {
    ...
    for (j j : arrayList2)
      D.ZInterfaceDelta("not loading field '" + j.KInterfaceAlpha() + "', not all the dependent fields are available."); 
  ...
  private boolean KInterfaceAlpha(ArrayList paramArrayList1, ArrayList paramArrayList2, j paramj) {
    try {
      ...
      for (byte b1 = 0; b1 < arrayOfString.length; b1++) {
        if (!arrayOfString[b1].equals(paramj.KInterfaceAlpha()) && !ZInterfaceDelta(paramArrayList1, arrayOfString[b1]) && e(paramArrayList2, arrayOfString[b1]) == null)
          return false; 
      } 
      return true;
    } catch (Exception exception) {
  ...
  public void KInterfaceAlpha(i.b paramb) {
    if (!this.VInterfaceHotel.contains(paramb))
      this.VInterfaceHotel.add(paramb); 
  }
