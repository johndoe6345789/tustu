...
public AfInterfaceCharlielass AfInterfaceCharlie implements n {
  ...
  public boolean AdInterfaceAlpha(AeInterfaceMike paramm, File paramFile) {
    ...
    return (paramFile.getName().equals("microsquirt.s19") || (paramFile.getName().startsWith("iobox") && paramFile.getName().endsWith(".s19")) || (paramFile.getName().startsWith("trans") && paramFile.getName().endsWith(".s19"))) ? (((paramm.b() & AeInterfaceOscar.D) > 0)) : (paramFile.getName().equals("microsquirt-module.s19") ? (((paramm.b() & AeInterfaceOscar.G) > 0)) : (paramFile.getName().equals("mspnp2.s19") ? (((paramm.b() & AeInterfaceOscar.E) > 0)) : (paramFile.getName().equals("megasquirt2.s19") ? (((paramm.b() & AeInterfaceOscar.w) > 0)) : false)));
  }
  
  public boolean b(AeInterfaceMike paramm, File paramFile) {
    return paramFile.getName().equals("microsquirt.s19") ? (((paramm.b() & AeInterfaceOscar.D) > 0)) : (paramFile.getName().equals("microsquirt-module.s19") ? (((paramm.b() & AeInterfaceOscar.G) > 0)) : (paramFile.getName().equals("mspnp2.s19") ? (((paramm.b() & AeInterfaceOscar.E) > 0)) : (paramFile.getName().equals("megasquirt2.s19") ? (((paramm.b() & AeInterfaceOscar.C) > 0)) : (paramFile.getName().equals("trans.s19") ? (((paramm.b() & AeInterfaceOscar.w) > 0)) : (paramFile.getName().equals("iobox.s19") ? (((paramm.b() & AeInterfaceOscar.w) > 0)) : false)))));
  }
  ...
  public AdInterfaceDelta AdInterfaceAlpha(FileUsingHashMap paramk, IOInAePackage paramp, AeInterfaceUniform paramu) {
    ...
    try {
      ...
      Logger.getLogger(c.class.getName()).log(Level.SEVERE, "Unexpected Protocol Error", (Throwable)ExceptionExtensionInAePackage);
      AdInterfaceDelta.AdInterfaceAlpha(AdInterfaceDelta.b);
  ...
  public String AdInterfaceAlpha(File paramFile) {
    return paramFile.getName().equalsIgnoreCase("megasquirt2.s19") ? AeInterfaceOscar.SerializableImpl : ((paramFile.getName().equalsIgnoreCase("microsquirt.s19") || paramFile.getName().equalsIgnoreCase("ms2_extra_us.s19")) ? AeInterfaceOscar.e : (paramFile.getName().equalsIgnoreCase("microsquirt-module.s19") ? AeInterfaceOscar.SerializableImplInJPackage : (paramFile.getName().equalsIgnoreCase("ms2_extra.s19") ? AeInterfaceOscar.c : (paramFile.getName().equalsIgnoreCase("ms2_extra_us.s19") ? AeInterfaceOscar.SerializableImplInJPackage : (paramFile.getName().equalsIgnoreCase("mspnp2.s19") ? AeInterfaceOscar.i : (paramFile.getName().equalsIgnoreCase("trans.s19") ? AeInterfaceOscar.c : ""))))));
  }
