...
public class k implements s, a {
  ...
  public List a(ae.k paramk) {
    return this.d;
  }
  
  public List b(ae.k paramk) {
    return this.d;
  }
  
  public void a(String paramString, Object paramObject) {}
  
  public d a(ae.k paramk, p paramp, u paramu) {
    null = new d();
    int i = a(paramp);
    if (i == 0) {
      null.a(d.b);
    ...
    if (!a(i)) {
      null.a(d.b);
      null.a("Warning!! Wrong ECU TYPE found. MS2 expected, found MS3");
      return null;
    } 
    if ((i & o.z) > 0) {
      paramu.a("The firmware on your ECU does not support jumperless reflash.");
      ...
      i = 0;
      for (byte b = 0; b < 2 && i == 0; b++) {
        j.a(paramp);
        i = a(paramp);
        if (i == 0 && !paramu.b("ECU does not appear to be on, Turn on Megasquirt/Microsquirt.")) {
          null.a(d.b);
          null.a("Cancelled by user.");
          return null;
        } 
      } 
      if ((i & o.w) != o.w && (i & o.x) != o.x) {
        null.a(d.b);
        null.a("ECU not found, cannot continue.");
        return null;
      } 
    } 
    if (!j.b(paramp)) {
      if ((i & o.z) != 0) {
        try {
          null = b(paramp, paramu);
        } catch (v v) {
          null.a(d.b);
          null.a("Protocol Exception, should be no Envelope.");
          return null;
        } 
        if (null.a() == d.b)
          return null; 
      ...
      try {
        ...
        while (true) {
          ...
          if (!j.b(paramp)) {
            D.c("Bootstrap found ok!");
            null = j.a(paramp, false);
            if (null.a() == d.b)
              return null; 
            break;
          } 
  ...
  public d a(p paramp, u paramu) {
    ...
    if (this.f) {
      ...
      if (!paramu.b("Please remove the boot jumper or disconnect the boot wire from ground if fitted.")) {
        d.a(d.b);
        d.a("Cancelled by user.");
        return d;
      } 
  ...
  protected d b(p paramp, u paramu) {
    null = new d();
    paramu.a("Loading bootstrap");
    ...
    try {
      ...
      Logger.getLogger(k.class.getName()).log(Level.SEVERE, "Failed to parse bootstrap", (Throwable)c);
      null.a(d.b);
      null.a("Failed to parse bootstrap");
      return null;
    } 
    null = j.a(paramp);
    if (null.a() == d.b)
      return null; 
    null = j.c(paramp);
    return (null.a() == d.b) ? null : j.a(a1, paramp, paramu, (o)null);
  }
