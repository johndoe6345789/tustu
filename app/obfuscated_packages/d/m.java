...
public class m implements S, c {
  public static String a = "actionName";
  ...
  private String e(String paramString) {
    try {
      return a.a().a(paramString, paramString);
    } catch (b b1) {
  ...
  public void c(Properties paramProperties) {
    this.g = paramProperties.getProperty(a);
