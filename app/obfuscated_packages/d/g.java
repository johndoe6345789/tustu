...
public class g {
  ...
  public void a(String paramString, Properties paramProperties) {
    c c = b(paramString);
    if (c == null)
      throw new e("No Action found for action name: " + paramString); 
    try {
      c.a(paramProperties);
    } catch (Exception exception) {
      exception.printStackTrace();
      throw new e("An Exception occurred action name: " + paramString + "\n" + exception.getMessage());
    } catch (Error error) {
      error.printStackTrace();
      a(paramString);
      throw new e("An Error occurred action name: " + paramString + ", Action removed.\n" + error.getMessage());
    } 
  }
