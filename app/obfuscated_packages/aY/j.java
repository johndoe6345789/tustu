...
public class j extends JPanel {
  ...
  private void a(String paramString, ActionListener paramActionListener) {
    ...
    setBorder(BorderFactory.createTitledBorder(g.b("Data Rate")));
    setLayout(new GridLayout(0, 1));
    add(new JLabel(g.b("Speed may be limited by device or cable.")));
    add(new JLabel(g.b("i.e. Bluetooth cable may slow actual data rate") + "."));
    add(new JLabel(" "));
    ButtonGroup buttonGroup = new ButtonGroup();
    String str = g.b("Reads Per Second");
    ...
    add(jRadioButton);
    buttonGroup.add(jRadioButton);
    boolean bool = i.a().a(" 98 98  0gep9gds09kfg09");
  ...
  public void a(Component paramComponent) {
    bV.a(this, paramComponent, g.b("Set Data Rate"), null);
  }
}
