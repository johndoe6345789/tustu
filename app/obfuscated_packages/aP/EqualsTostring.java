...
public class EqualsTostring {
  ...
  public boolean equals(Object paramObject) {
    return (paramObject instanceof V) ? ((((V)paramObject).AhInterfaceAlpha() == this.c)) : ((paramObject instanceof Integer) ? ((((Integer)paramObject).intValue() == this.c)) : super.equals(paramObject));
  }
  ...
  public String toString() {
    ...
    if (this.b == null || this.AhInterfaceAlpha.SComponentGolf)
      return this.AhInterfaceAlpha.b.R() ? ("<html>" + SComponentGolf.b("Scanning for Devices") + "<br>CAN ID: " + this.c) : ("<html>" + SComponentGolf.b("Connect for device list") + "<br>CAN ID: " + this.c); 
    if (!this.b.c())
