...
public class ManagerJpanelextensioninnpackage extends d implements GInterfaceAb, GInterfaceDi, BtInterfaceBg, aO {
  ...
  public ManagerJpanelextensioninnpackage(R paramR, ArrayListExceptionprintstacktraceInGPackage parambv) {
    this(paramR, parambv, true);
  }
  
  public ManagerJpanelextensioninnpackage(R paramR, ArrayListExceptionprintstacktraceInGPackage parambv, boolean paramBoolean) {
    ...
    add("Center", this.l);
    boolean bool = IOPropertiesUsingFile.IOPropertiesUsingFile().c(IOPropertiesUsingFile.ci, IOPropertiesUsingFile.GComponentCj);
  ...
  public void RInterfaceIndia() {
    ...
    if (this.d.l()) {
      f();
      GComponentCj[] arrayOfCj = ExceptionprintstacktraceInGPackage.JPanelExtensionInNPackage(this.IOPropertiesUsingFile, this.JPanelExtensionInNPackage);
