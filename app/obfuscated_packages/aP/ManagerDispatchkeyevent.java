...
public class ManagerDispatchkeyevent implements S, KeyEventDispatcher {
  ...
  public boolean dispatchKeyEvent(KeyEvent paramKeyEvent) {
    ...
    if (paramKeyEvent.getID() == 401) {
      ...
      if (paramKeyEvent.getModifiers() == 2 && paramKeyEvent.getKeyCode() == 65 && ManagerUsingArrayList.ExceptionInVPackage().g("dataLogTime") > 0.0D && ManagerUsingArrayList.ExceptionInVPackage().g("dataLoggingActive") == 0.0D)
  ...
  private void ExceptionInVPackage(String paramString) {
    for (GInterfaceAm GInterfaceAm : this.c) {
      if (paramString.equals(GInterfaceAm.b()) && GInterfaceAm.c().equals("showPanel")) {
        ...
        ArrayListExceptionprintstacktraceInGPackage ArrayListExceptionprintstacktraceInGPackage = GInterfaceAm.ExceptionInVPackage().e().c(str);
        ...
        if (ArrayListExceptionprintstacktraceInGPackage != null) {
          f.ExceptionInVPackage().ExceptionInVPackage(GInterfaceAm.ExceptionInVPackage(), ArrayListExceptionprintstacktraceInGPackage, dd.ExceptionInVPackage().c());
          continue;
        } 
