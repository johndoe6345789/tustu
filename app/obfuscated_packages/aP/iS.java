...
public class iS {
  ...
  public void ExceptionInVPackage(File paramFile, String paramString, iV paramiV) {
    ...
    boolean bool = (ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.aQ, true) || !A.RInterfaceIndia().ExceptionInVPackage(ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.cF, ""))) ? true : false;
    if (l2 < l1 && bool) {
      try {
        ExceptionInVPackage ExceptionInVPackage = new ExceptionInVPackage();
        ArrayListInBvPackage ArrayListInBvPackage = null;
        try {
          ArrayListInBvPackage = ExceptionInVPackage.ExceptionInVPackage(ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.aN, ""), ExceptionInVPackage.b, str4, ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.aO, ""), ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.aT, ""), ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.cF, ""), str2, ExceptionInVPackage.ExceptionInVPackage().c(ExceptionInVPackage.cO, ""));
        ...
        if (ArrayListInBvPackage.ExceptionInVPackage() == 0) {
          ...
          try {
            ...
            str = X.b(str, ExceptionInVPackage.b + " Update available! Would you like Auto Update to upgrade to version ", "");
            str = X.b(str, " now?", "");
            ...
            if (paramiV != null)
              paramiV.ExceptionInVPackage(); 
          } catch (IOException iOException) {
            D.ExceptionInVPackage("Failed to update Start Screen: " + paramString + ", Error: " + iOException.getMessage());
          } 
        } else if (ArrayListInBvPackage.ExceptionInVPackage() == 1) {
          hq.ExceptionInVPackage().ExceptionInVPackage(ArrayListInBvPackage.b());
        } else if (ArrayListInBvPackage.ExceptionInVPackage() != 8 && ArrayListInBvPackage.ExceptionInVPackage() == 4) {
        
        } 
        ExceptionInVPackage.ExceptionInVPackage().b(str1, "" + (new Date()).getTime());
        ExceptionInVPackage.ExceptionInVPackage().e();
      } catch (ExceptionInVPackage ExceptionInVPackage) {
        Logger.getLogger(iS.class.getName()).log(Level.SEVERE, (String)null, (Throwable)ExceptionInVPackage);
      } 
    } else {
    ...
    for (byte b = 0; b < arrayOfString.length; b++) {
      if (arrayOfString[b].toLowerCase().endsWith(".zip"))
        try {
          ...
          if (ae.ExceptionInVPackage(file.getAbsolutePath(), paramFile.getAbsolutePath(), null).equals(ae.ExceptionInVPackage))
