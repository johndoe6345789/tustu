...
public class ManagerHinterfacebravo implements S {
  ...
  public void c(R paramR) {
    ...
    if (HInterfaceAlpha.HInterfaceAlpha().HInterfaceAlpha(HInterfaceAlpha.ArrayListInGPackage, HInterfaceAlpha.aC).equals("true")) {
      paramR.C();
      J.e(true);
    } 
    int i = HInterfaceAlpha.HInterfaceAlpha().HInterfaceBravo(HInterfaceAlpha.SerializableExtension, 0);
    paramR.C().e(i);
    ...
    if (HInterfaceAlpha.HInterfaceBravo.equals(HInterfaceAlpha.as) && paramR.i().length() < 3 && paramR.AcInterfaceGolf("Vbatt") != null) {
      ...
      try {
        ManagerUsingArrayList.HInterfaceAlpha().HInterfaceAlpha(paramR.c(), "Vbatt", (GComponentCq)HInterfaceAlpha);
    ...
    if (Manager != null)
      try {
        ManagerUsingConcurrentHashMap.HInterfaceAlpha().HInterfaceAlpha(paramR.c(), "tsCanId", new jG(this));
