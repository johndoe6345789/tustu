...
public class aY extends JPanel implements AInterfaceOscar {
  ...
  public void h() {
    ...
    if (bT != null && bT.IOInAbPackage() != null && !this.p) {
      m();
      d();
  ...
  private void l() {
    ...
    if (bi != null) {
      ...
      if (!IOInAcPackage(bT)) {
        ...
        String str = bT.c();
        str = (str == null) ? bT.IOInAbPackage() : str;
        if (str.equals("Unknown"))
          str = "Serial Sig " + bT.IOInAbPackage() + " Compatible"; 
        this.IOInAbPackage.setText(SComponentGolf.IOInAbPackage("Found Firmware") + ": " + bT.c());
        this.c.setText(SComponentGolf.IOInAbPackage("Serial Signature") + ": " + bT.IOInAbPackage());
        this.d.setText(SComponentGolf.IOInAbPackage("On") + ":" + bi.d());
        D.c("Device " + bT.c() + ", requiring serial Signature:" + bT.IOInAbPackage() + " found at:" + bi.d());
        this.p = false;
      } 
    } else {
  ...
  private boolean IOInAcPackage(bT parambT) {
    if (parambT != null) {
  ...
  public boolean IOInAcPackage(String paramString1, String paramString2, List paramList, bT parambT) {
    this.q = true;
