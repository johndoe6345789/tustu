...
public class UI extends JPanel {
  ...
  public UI(boolean paramBoolean1, boolean paramBoolean2) {
  ...
  protected void ExceptionInVPackage(cd paramcd) {
    ...
    if (paramcd.d().equals(cd.ExceptionInVPackage)) {
      ...
      ce ce = paramcd.b().ExceptionInVPackage("ToothTime");
      if (ce == null)
        ce = paramcd.b().ExceptionInVPackage("TriggerTime"); 
      String str = (ce != null) ? ce.d() : "";
      this.f.e(str);
      this.f.repaint();
    } 
  ...
  private boolean ExceptionInVPackage(n paramn, cf paramcf) {
    List list = paramcf.j();
    for (String str : list) {
  ...
  public void b(ArrayList<n> paramArrayList) {
    ...
    this.ExceptionInVPackage.b(cd.g());
    this.e.clear();
    int i = 0;
    int m = this.e.d();
