...
public class c extends JPanel {
  ...
  public String b() {
    return (this.f.a() == 0) ? ((this.c.getSelectedItem() instanceof h) ? ((h)this.c.getSelectedItem()).a() : ((this.c.getSelectedItem() != null) ? this.c.getSelectedItem().toString() : "")) : this.b.getText();
  }
  
  public void a(String paramString) {
    this.b.setText(paramString);
    if (this.c.getItemCount() > 0 && this.c.getItemAt(0) instanceof h) {
      h h = new h(paramString, "");
      this.c.setSelectedItem(h);
    } else {
