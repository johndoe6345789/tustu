...
public class b extends JPanel {
  ...
  String k = ac.a().a("To use:") + " \n" + ac.a().a("Enter the voltage and values measured or from your data sheet into the top 4 boxes. In the lower 2 Volt boxes enter the target voltages (Typically 0-5 Volts or 0-12V).");
  ...
  private void b() {
    setBorder(BorderFactory.createTitledBorder(g.b("Two Point Calculator")));
    ...
    this.g.addFocusListener(this.j);
  ...
  public void a() {
    if (!this.a.getText().isEmpty() && !this.c.getText().isEmpty() && !this.d.getText().isEmpty() && !this.b.getText().isEmpty() && !this.e.getText().isEmpty() && !this.f.getText().isEmpty()) {
