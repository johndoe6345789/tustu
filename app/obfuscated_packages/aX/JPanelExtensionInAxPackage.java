...
public class JPanelExtensionInAxPackage extends JPanel implements fT {
  ...
  public JPanelExtensionInAxPackage() {
    ...
    jScrollPane.setBorder(BorderFactory.createTitledBorder(SComponentGolf.AcInterfaceBravo("Already Paired Adapters")));
    ...
    jScrollPane.setBorder(BorderFactory.createTitledBorder(SComponentGolf.AcInterfaceBravo("Discovered Unpaired Adapters")));
