...
public class l implements q, r, s, RemoteFileAccess {
  ...
  public l(R paramR, File paramFile) {
    this.a = paramR;
    this.l = paramFile;
    this.b = new j(paramR);
    f();
  ...
  public DirectoryFiles getFilesIn(DirectoryIdentifier paramDirectoryIdentifier) {
    ...
    if (t.d(this.a).a()) {
      ...
      while (iterator.hasNext())
        l1 += ((RemoteFileDescriptor)iterator.next()).getSize(); 
      u.a(l1);
  ...
  public synchronized File readRemoteFile(File paramFile, RemoteFileDescriptor paramRemoteFileDescriptor) {
    File file = null;
    if (!this.a.R()) {
    ...
    if (this.i.a()) {
      RemoteAccessException remoteAccessException = new RemoteAccessException(a("Please turn off the engine before downloading file(s)."));
      remoteAccessException.setTerminalToBatch(true);
      throw remoteAccessException;
    } 
    g();
    if (this.g.d()) {
      RemoteAccessException remoteAccessException = new RemoteAccessException(a("SD Card is Actively Logging. Please Stop Logging to Download Files."));
      remoteAccessException.setTerminalToBatch(true);
      throw remoteAccessException;
    } 
    if (!this.g.c()) {
      RemoteAccessException remoteAccessException = new RemoteAccessException(a("SD Card is Not Ready for File Download."));
      remoteAccessException.setTerminalToBatch(true);
      throw remoteAccessException;
    } 
    this.f.b();
    try {
      ...
      try {
        ...
        Logger.getLogger(l.class.getName()).log(Level.SEVERE, (String)null, (Throwable)g);
      } 
  ...
  public synchronized boolean deleteFile(RemoteFileDescriptor paramRemoteFileDescriptor) {
    ...
    o o1 = this.g.a(m1, true, 1500);
    if (o1.a() == 3)
      throw new RemoteAccessException("Delete of " + paramRemoteFileDescriptor.getName() + " failed." + ((o1.c() != null) ? ("\nMessage:" + o1.c()) : "")); 
  ...
  private synchronized void g() {
    ...
    while (!this.g.c()) {
      ...
      if (!this.e) {
        RemoteAccessException remoteAccessException = new RemoteAccessException(a("No SD Card in the MS3."));
        remoteAccessException.setTerminalToBatch(true);
        throw remoteAccessException;
      } 
      if (System.currentTimeMillis() - l1 > 10000L) {
        RemoteAccessException remoteAccessException = new RemoteAccessException(a("Timeout waiting for SD Card to become Ready.\nWaited 10 seconds, expected complete."));
        remoteAccessException.setTerminalToBatch(true);
        throw remoteAccessException;
      } 
      try {
